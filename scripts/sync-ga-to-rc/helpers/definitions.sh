...
currDir=$(pwd)
rootDir=${currDir%"/web-unified-docs"*}                 # Local root directory of the repo
docRoot="${rootDir}/web-unified-docs/content/<PRODUCT>" # Root directory of product docs
rcTag=" (rc)"
betaTag=" (beta)"
...
prBranch="bot/<PRODUCT>-ga-to-rc-sync"
