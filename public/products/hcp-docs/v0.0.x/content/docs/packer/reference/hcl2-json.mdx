...
description: Different HCP Packer features are available for Packer templates written in HCL2 than Packer templates written in JSON. Compare the available features in HCL2 Packer templates and JSON Packer templates in this reference.
---
