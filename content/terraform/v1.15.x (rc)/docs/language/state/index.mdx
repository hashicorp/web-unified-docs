...
will record the identity of that remote object against a particular resource
instance, and potentially update or delete that object in response to future
...
Do not store your state in a Version Control System or other storage solution
