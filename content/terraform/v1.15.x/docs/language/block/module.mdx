...
In the following example, Terraform creates the storage module after creating the Azure resource group:
...
In the following example, the module uses two aliased AzureRM provider configurations:
