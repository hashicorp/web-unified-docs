...
last_modified: 2026-08-27T13:57:01.000Z
...
In the following example, Terraform imports an existing Azure resource group named `example` into the resource at `azurerm_resource_group.example`:
...
Refer to the [AzureRM provider documentation](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/resource_group#import) in the Terraform Registry for more information about importing Azure resource groups.
