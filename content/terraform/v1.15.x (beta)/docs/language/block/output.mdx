...
created_at: 2026-03-18T13:27:01-04:00
last_modified: 2026-04-03T18:59:24.000Z
...
| --- | --- | --- | --- |
| `type` | Specify a type constraint for the value of this ouput. | Type constraint | Optional |
...
The `type` argument in an `output` block constrains the type of value that you can assign to that output. If you do not set a type constraint, the output accepts a value of any type.
...
You can use any valid primitive, complex, or structural type as a constraint in an output block. For details about types, constructors, and conversions, refer to [Type constraints](/terraform/language/expressions/types).
