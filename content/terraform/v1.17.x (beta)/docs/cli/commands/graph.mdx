...
The `terraform graph` command generates a visual representation of a configuration or execution plan that you can use to generate charts. This command uses the DOT language to generate graphs. Refer to the [GraphViz documentation](https://graphviz.org/doc/info/lang.html) for additional information.
...
* `-draw-cycles` - Highlight any cycles in the graph with colored edges.
  ...
  selecting one of the real graph operation types using the `-type=...`
  option.
