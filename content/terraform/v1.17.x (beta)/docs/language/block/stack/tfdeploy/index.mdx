...
<<<<<<< HEAD
HCP Terraform supports up to 500 deployments per Stack.
=======
HCP Terraform supports up to 20 deployments per Stack.
>>>>>>> main
...
[Built-in Functions](/terraform/language/functions) for a list of
functions supported by Stacks deployments.
