...
[The Module `providers` Meta-Argument](/language/meta-arguments/module-providers)
and [Module Development: Providers Within Modules](/language/modules/develop/providers).)
...
[local name](/language/providers/requirements#local-names) of the provider to
...
You can use [expressions](/language/expressions) in the values of these
...
- [`version`, which we no longer recommend][inpage-versions] (use
  [provider requirements](/language/providers/requirements) instead)
...
[`required_providers` block](/language/providers/requirements). The version
