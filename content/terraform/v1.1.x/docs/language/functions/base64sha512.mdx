...
* [`filebase64sha512`](/language/functions/filebase64sha512) calculates the same hash from
  the contents of a file rather than from a string value.
* [`sha512`](/language/functions/sha512) calculates the same hash but returns the result
