...
* [Input variables](/terraform/language/reference/block/variable) to accept values from
  the calling module.
* [Output values](/terraform/language/reference/block/output) to return results to the
