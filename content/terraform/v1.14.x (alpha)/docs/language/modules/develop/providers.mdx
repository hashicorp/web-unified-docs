...
[several different configurations for the same provider](/terraform/language/reference/block/provider#select-an-alternate-provider-configuration).
...
[default provider configurations](/terraform/language/reference/block/provider#alias) from its parent. This means that
...
[multiple provider configurations](/terraform/language/reference/block/provider#using-an-alternate-provider-configuration),
...
[the `provider` argument](/terraform/language/reference/block/resource#provider)
