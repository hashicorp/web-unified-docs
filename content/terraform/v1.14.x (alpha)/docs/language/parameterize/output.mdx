---
page_title: Expose module data with outputs
description: Learn how to use outputs to expose data from your module.
---

# Expose module data with outputs
...
To learn more about the `outputs` block, refer to the [`outputs` block reference](/terraform/language/reference/block/output).

## Next steps

Refer to the following resources for more information:

- [Output block reference](/terraform/language/reference/block/output) - A complete reference of the `output` block.
