---
page_title: Reuse expressions with locals
description: Learn how to use locals to reuse expressions in your Terraform configuration.
---

# Reuse expressions with locals
...
To learn more about the `locals` block, refer to the [`locals` block reference](/terraform/language/reference/block/locals).

## Next steps

Refer to the following resources for more information:

- [Locals block reference](/terraform/language/reference/block/locals) - A complete reference of the `locals` block.
