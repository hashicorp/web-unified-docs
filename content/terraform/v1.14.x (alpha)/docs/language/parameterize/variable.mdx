---
page_title: Define input arguments with variables
description: Learn how to use variables to define input arguments for your module.
---

# Define input arguments with variables
...
Variables let you customize module behavior without altering the module's source code. Add `variable` blocks to your configuration so that module consumers can pass in specific input values. Variables define the interface of your module by specifying what values your module accepts as arguments.
...
To learn more about the best practices of defining variables, refer to the [Terraform style guide](/terraform/language/style#variables). To learn more about the `variable` block, refer to the [`variable` block reference](/terraform/language/reference/block/variable).
...
- [Variable block reference](/terraform/language/reference/block/variable) - A complete reference of the `variable` block.
- [Validate your configuration](/terraform/language/validate) - Validate your configuration to improve your module consumer's troubleshooting, make your runs more predictable, and help your maintainers understand your configuration's intent.
