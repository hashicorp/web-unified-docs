...
To keep your Stack configuration concise, you can use the [`locals` block](/terraform/language/reference/block/locals) to share values across your deployments.
