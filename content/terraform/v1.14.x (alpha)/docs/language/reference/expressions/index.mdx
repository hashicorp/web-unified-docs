...
[references to resource attributes](/terraform/language/reference/expressions/references#references-to-resource-attributes).
...
- [Version Constraints](/terraform/language/reference/expressions/version-constraints)
