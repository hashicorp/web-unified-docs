...
[the `jsonencode` function](/terraform/language/reference/functions/jsonencode) or
[the `yamlencode` function](/terraform/language/reference/functions/yamlencode) so that Terraform
