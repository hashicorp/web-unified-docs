...
The `?` character combined with the `:` character is part of a conditional expression in Terraform and is not considered an operator. For more information, refer to [Conditional Expressions](/terraform/language/reference/expressions/conditionals#conditional-expressions).
...
[functions](/terraform/language/reference/expressions/function-calls). For example, you can calculate exponents
using
[the `pow` function](/terraform/language/reference/functions/pow).
