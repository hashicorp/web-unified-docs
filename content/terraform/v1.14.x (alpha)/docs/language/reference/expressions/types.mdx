...
[Type Constraints](/terraform/language/reference/expressions/type-constraints) for a more detailed
...
Terraform, and have their own page of documentation. See [Strings](/terraform/language/reference/expressions/strings)
...
Lists and tuples each have different constraints on the types they allow. For more information on the types that each allows, refer to [tuples](/terraform/language/reference/expressions/type-constraints#tuple) and [lists](/terraform/language/reference/expressions/type-constraints#list).
...
usually doesn't matter), see [Type Constraints](/terraform/language/reference/expressions/type-constraints).
...
the [equality operator](/terraform/language/reference/expressions/operators#equality-operators).
