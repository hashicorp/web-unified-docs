...
[built-in functions](/terraform/language/reference/functions) that can be used
...
[the function reference](/terraform/language/reference/functions).
...
When using sensitive data, such as [an input variable](/terraform/language/reference/block/variable#sensitive)
or [an output defined](/terraform/language/reference/block/output#sensitive) as sensitive
...
[`file`](/terraform/language/reference/functions/file),
[`templatefile`](/terraform/language/reference/functions/templatefile),
[`timestamp`](/terraform/language/reference/functions/timestamp),
and [`uuid`](/terraform/language/reference/functions/uuid).
...
[unknown value](/terraform/language/reference/expressions/references#values-not-yet-known) results during the
