...
- [Specify a dependency during validation](/terraform/language/reference/block/check#resource-dependency)
- [Specify a dependency when querying a data source](/terraform/language/reference/block/data#specify-a-dependency)
- [Specify a dependency when calling a module](/terraform/language/reference/block/module#specify-dependencies)
- [Specify a dependency when outputting values](/terraform/language/reference/block/output#explicit-dependencies)
- [Specify a dependency during resource creation](/terraform/language/reference/block/resource#specify-a-dependency)
...
- [`depends_on` argument in `check` blocks](/terraform/language/reference/block/check#depends_on)
- [`depends_on` argument in `data` blocks](/terraform/language/reference/block/data#depends_on)
- [`depends_on` argument in `ephemeral` blocks](/terraform/language/reference/block/ephemeral#depends_on)
- [`depends_on` argument in `module` blocks](/terraform/language/reference/block/module#depends_on)
- [`depends_on` argument in `output` blocks](/terraform/language/reference/block/output#depends_on)
- [`depends_on` argument in `resource` blocks](/terraform/language/reference/block/resource#depends_on)
...
- [Create multiple ephemeral resources](/terraform/language/reference/block/ephemeral#create-multiple-ephemeral-resources)
- [Create multiple instances of module resources](/terraform/language/reference/block/module#create-multiple-instances-of-module-resources)
- [Create multiple instances of a resource](/terraform/language/reference/block/resource#create-multiple-instances-of-a-resource)
...
- [`count` argument in `data` blocks](/terraform/language/reference/block/data#count)
- [`count` argument in `ephemeral` blocks](/terraform/language/reference/block/ephemeral#count)
- [`count` argument in `module` blocks](/terraform/language/reference/block/module#count)
- [`count` argument in `resource` block ](/terraform/language/reference/block/resource#count)
...
- [Create multiple ephemeral resources](/terraform/language/reference/block/ephemeral#create-multiple-ephemeral-resources)
- [Import multiple existing resources](/terraform/language/reference/block/import#import-multiple-resources)
- [Create multiple instances of module resources](/terraform/language/reference/block/module#create-multiple-instances-of-module-resources)
- [Create multiple instances of a resource](/terraform/language/reference/block/resource#create-multiple-instances-of-a-resource)
...
- [`for_each` argument in `data` blocks](/terraform/language/reference/block/data#for_each)
- [`for_each` argument in `ephemeral` blocks](/terraform/language/reference/block/ephemeral#for_each)
- [`for_each` argument in `module` blocks](/terraform/language/reference/block/module#for_each)
- [`for_each` argument in. `resource` blocks](/terraform/language/reference/block/resource#for_each)
...
- [Specify an alternate provider configuration](/terraform/language/reference/block/data#select-an-alternate-provider-configuration) for a data source
- [Specify an alternate provider configuration](/terraform/language/reference/block/ephemeral#use-alternate-provider-configurations) for an ephemeral resource
- [Select an alternate provider configuration](/terraform/language/reference/block/import#select-an-alternate-provider-configuration) for imported resources
- [Select a provider without a default configuration](/terraform/language/reference/block/provider#provider-without-a-default-configuration)
- [Select an alternative provider configuration](/terraform/language/reference/block/resource#select-an-alternate-provider-configuration) for resources
...
- [`provider` argument in `check` blocks](/terraform/language/reference/block/check#provider)
- [`provider` argument in `data` blocks](/terraform/language/reference/block/data#provider)
- [`provider` argument in `ephemeral` blocks](/terraform/language/reference/block/ephemeral#provider)
- [`provider` argument in `import` block ](/terraform/language/reference/block/import#provider)
- [`provider` argument in `resource` blocks](/terraform/language/reference/block/resource#provider)
...
- [Apply different provider configurations](/terraform/language/reference/block/module#apply-different-provider-configurations-for-module-resources)  for module resources
...
- [`providers` argument in `module` blocks](/terraform/language/reference/block/module#providers)
...
- [Apply custom conditions to data sources](/terraform/language/reference/block/data#apply-custom-conditions)
- [Ignore attribute changes](/terraform/language/reference/block/resource#ignore-attribute-changes)
- [Specify triggers that replace resource](/terraform/language/reference/block/resource#specify-triggers-that-replace-resources)
- [Apply custom conditions to resources](/terraform/language/reference/block/resource#apply-custom-conditions)
...
- [`lifecycle` argument in `data` blocks](/terraform/language/reference/block/data#lifecycle)
- [`lifecycle` argument in `ephemeral` block ](/terraform/language/reference/block/ephemeral#lifecycle)
- [`lifecycle` argument in `removed` blocks](/terraform/language/reference/block/removed#lifecycle)
- [`lifecycle` argument in `resource` blocks](/terraform/language/reference/block/resource#lifecycle)
