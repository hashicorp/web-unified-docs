...
[`regex`](/terraform/language/reference/functions/regex). If using a regular expression for the substring
...
- [`regex`](/terraform/language/reference/functions/regex) searches a given string for a substring matching a
