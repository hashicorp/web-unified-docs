...
related function [`cidrsubnet`](/terraform/language/reference/functions/cidrsubnet). `cidrsubnet` calculates
...
* [`cidrsubnet`](/terraform/language/reference/functions/cidrsubnet) calculates a single subnet address, allowing
