...
- [`format`](/terraform/language/reference/functions/format) is a more general formatting function for arbitrary
  data.
- [`timestamp`](/terraform/language/reference/functions/timestamp) returns the current date and time in a format
