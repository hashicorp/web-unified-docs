...
[the same syntax as `format`](/terraform/language/reference/functions/format#specification-syntax).
...
* [`format`](/terraform/language/reference/functions/format) defines the specification syntax used by this
