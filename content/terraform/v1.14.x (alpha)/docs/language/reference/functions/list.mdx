...
Terraform language, see [Type Constraints](/terraform/language/reference/expressions/types).

## Related Functions

* [`concat`](/terraform/language/reference/functions/concat) produces a new list by concatenating together the
  elements from other lists.
* [`tolist`](/terraform/language/reference/functions/tolist) converts a set or tuple value to a list.
