...
as [`base64decode`](/terraform/language/reference/functions/base64decode).
...
* [`textencodebase64`](/terraform/language/reference/functions/textencodebase64) performs the opposite operation,
  applying target encoding and then Base64 to a string.
* [`base64decode`](/terraform/language/reference/functions/base64decode) is effectively a shorthand for
