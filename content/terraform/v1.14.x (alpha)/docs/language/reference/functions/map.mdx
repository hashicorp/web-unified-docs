...
* [`tomap`](/terraform/language/reference/functions/tomap) converts an object value to a map.
* [`zipmap`](/terraform/language/reference/functions/zipmap) constructs a map dynamically, by taking keys from
