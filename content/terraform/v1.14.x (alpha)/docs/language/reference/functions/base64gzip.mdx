...
* [`base64encode`](/terraform/language/reference/functions/base64encode) applies Base64 encoding to an HCL string without using gzip compression.
* [`filebase64`](/terraform/language/reference/functions/filebase64) reads a file from the local filesystem and encodes its raw bits using the Base64 format.
