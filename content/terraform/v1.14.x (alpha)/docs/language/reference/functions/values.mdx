...
returned from [`keys`](/terraform/language/reference/functions/keys).
...
* [`keys`](/terraform/language/reference/functions/keys) returns a list of the _keys_ from a map.
