...
- [`endswith`](/terraform/language/reference/functions/endswith) takes two values: a string to check and a suffix string. The function returns true if the first string ends with that exact suffix.