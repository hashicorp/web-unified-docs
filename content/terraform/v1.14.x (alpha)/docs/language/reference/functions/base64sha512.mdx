...
* [`filebase64sha512`](/terraform/language/reference/functions/filebase64sha512) calculates the same hash from
  the contents of a file rather than from a string value.
* [`sha512`](/terraform/language/reference/functions/sha512) calculates the same hash but returns the result
