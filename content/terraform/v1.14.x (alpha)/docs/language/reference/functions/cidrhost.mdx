...
[`cidrsubnet`](/terraform/language/reference/functions/cidrsubnet).
...
* [`cidrsubnet`](/terraform/language/reference/functions/cidrsubnet) calculates a subnet address under a given
