...
* [`filebase64sha256`](/terraform/language/reference/functions/filebase64sha256) calculates the same hash from
  the contents of a file rather than from a string value.
* [`sha256`](/terraform/language/reference/functions/sha256) calculates the same hash but returns the result
