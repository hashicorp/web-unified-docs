...
result as [`base64encode`](/terraform/language/reference/functions/base64encode).
...
* [`textdecodebase64`](/terraform/language/reference/functions/textdecodebase64) performs the opposite operation,
  decoding Base64 data and interpreting it as a particular character encoding.
* [`base64encode`](/terraform/language/reference/functions/base64encode) applies Base64 encoding of the UTF-8
