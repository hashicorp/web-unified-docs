...
The following example uses the expansion symbol (...) to transform the value into separate arguments. Refer to [Expanding Function Argument](/terraform/language/reference/expressions/function-calls#expanding-function-arguments) for details.
