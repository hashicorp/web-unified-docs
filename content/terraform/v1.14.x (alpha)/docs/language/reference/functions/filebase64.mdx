...
* [`file`](/terraform/language/reference/functions/file) also reads the contents of a given file,
  but interprets the data as UTF-8 text and returns the result directly
  as a string, without any further encoding.
* [`base64decode`](/terraform/language/reference/functions/base64decode) can decode a Base64 string representing
