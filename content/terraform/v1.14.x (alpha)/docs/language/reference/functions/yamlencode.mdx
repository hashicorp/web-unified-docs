...
This function maps
[Terraform language values](/terraform/language/reference/expressions/types)
...
JSON using [`jsonencode`](/terraform/language/reference/functions/jsonencode) instead, even if
...
[`jsonencode`](/terraform/language/reference/functions/jsonencode) instead: YAML flow-style is a superset
of JSON syntax.

## Related Functions

- [`jsonencode`](/terraform/language/reference/functions/jsonencode) is a similar operation using JSON instead
  of YAML.
- [`yamldecode`](/terraform/language/reference/functions/yamldecode) performs the opposite operation, _decoding_
