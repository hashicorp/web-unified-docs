...
for transient values, such as the argument to [`file`](/terraform/language/reference/functions/file) (where
...
* [`basename`](/terraform/language/reference/functions/basename) returns _only_ the last portion of a filesystem
