...
[`textdecodebase64`](/terraform/language/reference/functions/textdecodebase64) with the encoding name set to
`UTF-8`.
...
* [`base64encode`](/terraform/language/reference/functions/base64encode) performs the opposite operation,
  encoding the UTF-8 bytes for a string as Base64.
* [`textdecodebase64`](/terraform/language/reference/functions/textdecodebase64) is a more general function that
  supports character encodings other than UTF-8.
* [`base64gzip`](/terraform/language/reference/functions/base64gzip) applies gzip compression to a string
  and returns the result with Base64 encoding.
* [`filebase64`](/terraform/language/reference/functions/filebase64) reads a file from the local filesystem
