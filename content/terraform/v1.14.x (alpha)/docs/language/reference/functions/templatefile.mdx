...
[string templates](/terraform/language/reference/expressions/strings#string-templates)
...
call to either [`jsonencode`](/terraform/language/reference/functions/jsonencode) or
[`yamlencode`](/terraform/language/reference/functions/yamlencode), specifying the value to encode using
[normal Terraform expression syntax](/terraform/language/reference/expressions)
...
achieved by using a
[`for` expression](/terraform/language/reference/expressions/for)
rather than by using
[template directives](/terraform/language/reference/expressions/strings#directives).
...
[`jsonencode`](/terraform/language/reference/functions/jsonencode) and [`yamlencode`](/terraform/language/reference/functions/yamlencode).

## Related Functions

* [`file`](/terraform/language/reference/functions/file) reads a file from disk and returns its literal contents
  without any template interpretation.
* [`templatestring`](/terraform/language/reference/functions/templatestring) takes a simple reference to a string value containing the template and renders its content.
