...
- In [ephemeral variables](/terraform/language/reference/block/variable#ephemeral)
- In [local values](/terraform/language/reference/block/locals)
- In [ephemeral resources](/terraform/language/reference/block/ephemeral)
- In [ephemeral outputs](/terraform/language/reference/block/output#ephemeral)
