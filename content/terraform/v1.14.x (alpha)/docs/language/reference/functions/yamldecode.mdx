...
- [`jsondecode`](/terraform/language/reference/functions/jsondecode) is a similar operation using JSON instead
  of YAML.
- [`yamlencode`](/terraform/language/reference/functions/yamlencode) performs the opposite operation, _encoding_
  a value as YAML.
