...
and
[`dynamic` block](/terraform/language/reference/expressions/dynamic-blocks)
...
- [`contains`](/terraform/language/reference/functions/contains) tests whether a given list or set contains
  a given element value.
- [`flatten`](/terraform/language/reference/functions/flatten) is useful for flattening hierarchical data
  into a single list, for situations where the relationships between two
  object types are defined explicitly.
- [`setintersection`](/terraform/language/reference/functions/setintersection) computes the _intersection_ of
  multiple sets.
- [`setsubtract`](/terraform/language/reference/functions/setsubtract) computes the _relative complement_ of two sets
- [`setunion`](/terraform/language/reference/functions/setunion) computes the _union_ of multiple
  sets.
