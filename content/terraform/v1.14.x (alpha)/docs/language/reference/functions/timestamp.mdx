...
[the `ignore_changes` lifecycle meta-argument](/terraform/language/meta-arguments#lifecycle)
...
* [`formatdate`](/terraform/language/reference/functions/formatdate) can convert the resulting timestamp to
  other date and time formats.
* [`plantimestamp`](/terraform/language/reference/functions/plantimestamp) will return a consistent timestamp
