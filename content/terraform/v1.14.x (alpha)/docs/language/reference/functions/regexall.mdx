...
`regexall` is a variant of [`regex`](/terraform/language/reference/functions/regex) and uses the same pattern
...
- [`regex`](/terraform/language/reference/functions/regex) searches for a single match of a given pattern, and
