...
* [`trimprefix`](/terraform/language/reference/functions/trimprefix) removes a word from the start of a string.
* [`trimsuffix`](/terraform/language/reference/functions/trimsuffix) removes a word from the end of a string.
* [`trimspace`](/terraform/language/reference/functions/trimspace) removes all types of whitespace from
