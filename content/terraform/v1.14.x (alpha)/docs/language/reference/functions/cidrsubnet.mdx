...
Unlike the related function [`cidrsubnets`](/terraform/language/reference/functions/cidrsubnets), `cidrsubnet`
...
While [`cidrhost`](/terraform/language/reference/functions/cidrhost) allows calculating single host IP addresses,
...
[`cidrhost`](/terraform/language/reference/functions/cidrhost) function to calculate those host addresses by
...
* [`cidrhost`](/terraform/language/reference/functions/cidrhost) calculates the IP address for a single host
  within a given network address prefix.
* [`cidrnetmask`](/terraform/language/reference/functions/cidrnetmask) converts an IPv4 network prefix in CIDR
  notation into netmask notation.
* [`cidrsubnets`](/terraform/language/reference/functions/cidrsubnets) can allocate multiple consecutive
