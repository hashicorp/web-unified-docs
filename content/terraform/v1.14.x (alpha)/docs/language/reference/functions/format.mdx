...
The formatting verb `%#v` accepts a value of any type and presents it using JSON encoding. This can be useful for describing the values given to a module in error messages while [validating your configuration](/terraform/language/validate#error-messages).
...
* [`formatdate`](/terraform/language/reference/functions/formatdate) is a specialized formatting function for
  human-readable timestamps.
* [`formatlist`](/terraform/language/reference/functions/formatlist) uses the same specification syntax to
