...
- [Develop modules](/terraform/language/modules/develop)
- [`output` block reference](/terraform/language/reference/block/output)
- [References to Named Values](/terraform/language/reference/expressions/references)
...
Refer to [Module sources](/terraform/language/modules/sources) for more information.
...
The `version` argument accepts a [version constraint string](/terraform/language/reference/expressions/version-constraints). Terraform uses the newest installed version of the module that meets the constraint. When an acceptable version isn't installed, Terraform downloads the newest version that meets the constraint. We recommend explicitly constraining the acceptable version numbers to avoid unexpected or unwanted changes.
