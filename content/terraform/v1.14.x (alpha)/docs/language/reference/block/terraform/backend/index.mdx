...
- You cannot reference values declared within backend blocks elsewhere in the configuration. Refer to [References to Resource Attributes](/terraform/language/reference/expressions/references#references-to-resource-attributes) for more details.
