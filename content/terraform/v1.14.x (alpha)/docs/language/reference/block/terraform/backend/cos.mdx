...
To make use of the COS remote state in another configuration, use the [`terraform_remote_state` data source](/terraform/language/reference/remote-state-data).
