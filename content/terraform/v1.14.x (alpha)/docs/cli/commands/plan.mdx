...
- `-var 'NAME=VALUE'` - Sets a value for a single
  [input variable](/terraform/language/reference/block/variable) declared in the
...
- `-var-file=FILENAME` - Sets values for potentially many
  [input variables](/terraform/language/reference/block/variable) declared in the
...
[input variables](/terraform/language/reference/block/variable) declared in your
root module.
...
on the variable's [type constraint](/terraform/language/reference/expressions/type-constraints).
