...
A resource defined with [the `count` meta-argument](/terraform/language/reference/block/resource#count)
...
A resource defined with [the `for_each` meta-argument](/terraform/language/reference/block/resource#for_each)
