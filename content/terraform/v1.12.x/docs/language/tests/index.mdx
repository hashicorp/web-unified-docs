...
You can specify values for variables across all tests with the [Command Line](/terraform/language/block/variable#variables-on-the-command-line) and with [Variable Definition Files](/terraform/language/block/variable#variable-definitions-tfvars-files).
