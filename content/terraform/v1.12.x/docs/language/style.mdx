...
For more information, refer to [Locals block](/terraform/language/block/locals) and the [Simplify Terraform configuration with locals](/terraform/tutorials/configuration-language/locals) tutorial.
