...
Sensitive values, such as [sensitive input variables](/terraform/language/block/variable#sensitive),
[sensitive outputs](/terraform/language/block/output#sensitive),
...
If you are writing a module with an [input variable](/terraform/language/block/variable) that
