...
Learn more about using outputs, refer to [Define outputs to expose module data](/terraform/language/parameterize/configure#define-outputs-to-expose-module-data).
