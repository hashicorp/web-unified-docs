...
To learn more about using `output` blocks, refer to [Define outputs to expose module data](/terraform/language/parameterize/configure#define-outputs-to-expose-module-data).
