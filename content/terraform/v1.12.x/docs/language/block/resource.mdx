...
- [`precondition`](#precondition): Specifies a condition that Terraform evaluates before creating the resource. Refer to [Test and validate](/terraform/language/test-and-validate/validate#preconditions-and-postconditions) for more information.
- [`postcondition`](#postcondition): Specifies a condition that Terraform evaluates after creating the resource. Refer to [Test and validate](/terraform/language/test-and-validate/validate#preconditions-and-postconditions) for more information.
...
Refer to [Test and validate](/terraform/language/test-and-validate/validate#preconditions-and-postconditions) for information about adding validations to your Terraform configuration.
