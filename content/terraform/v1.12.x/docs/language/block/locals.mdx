...
Learn more about using locals, refer to [Define locals to reuse expressions](/terraform/language/parameterize/configure#define-locals-to-reuse-expressions).
