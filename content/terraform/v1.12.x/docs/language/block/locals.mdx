...
To learn more about using `locals` blocks in your configurations, refer to [Define locals to reuse expressions](/terraform/language/parameterize/configure#define-locals-to-reuse-expressions).
