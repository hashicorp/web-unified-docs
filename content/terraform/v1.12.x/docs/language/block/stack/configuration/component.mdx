...
The keys in the `providers` map must match the provider names that the source module expects, and the values must reference providers declared in your component configuration. Learn more about [Declaring providers in Stacks](/terraform/language/stacks/create/declare-providers).
...
To learn more about breaking down your infrastructure into components, refer to [Define component configuration](/terraform/language/stacks/create/config).
