...
Use the `removed` block to systematically remove components from your component configuration. Define `removed` blocks in a `<NAME>.tfcomponent.hcl` file, which is a configuration file for your Stack.
