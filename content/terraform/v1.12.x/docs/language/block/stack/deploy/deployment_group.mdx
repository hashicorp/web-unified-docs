...
HCP Terraform automatically approves any plan on the `web` deployment that does not remove resources. If a plan does include destroying resources, then it requires manual approval.
