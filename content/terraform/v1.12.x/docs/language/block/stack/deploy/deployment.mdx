...
The keys in the `inputs` map must correspond to the names of the variables defined in your component configuration, and the values must be valid HCL literals that meet the type constraints of those variables.
