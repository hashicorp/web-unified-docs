...
- Use the [`deployment_group`](/terraform/language/block/stack/deploy/deployment-auto-group) block to assign `deployment_auto_approve` rules to specific deployments.
