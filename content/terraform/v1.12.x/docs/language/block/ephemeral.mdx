...
- In a provisioner and provisioner connection configuration. Refer to [Use a provisioner](/terraform/language/resources/provisioners#use-a-provisioner) for more information.
