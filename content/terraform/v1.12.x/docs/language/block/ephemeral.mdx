...
You can only refer to ephemeral resources in specific ephemeral contexts in or Terraform throws an error when it plans your changes. The following are valid contexts for referring to ephemeral resources:
