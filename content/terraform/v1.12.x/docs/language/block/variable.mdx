...
To learn more about the different ways to use and set values for variables, refer to [Use variables to define module arguments](/terraform/language/parameterize/variables).
