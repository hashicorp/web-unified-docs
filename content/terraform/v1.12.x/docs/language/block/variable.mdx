...
<!--TODO: Add a link to the define variable page once I write it.
Learn more about the different ways to use and set values for variables, refer to [Define variables](/WIP-USAGE-PAGE).
...
| `validation` |
Specify a rule the value of this variable must meet, in addition to any type constraints. | Block | Optional |
