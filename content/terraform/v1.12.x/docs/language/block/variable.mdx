...
Learn more about the different ways to use and set values for variables, refer to [Define module input arguments with variables](/terraform/language/parameterize/configure#define-module-input-arguments-with-variables).
