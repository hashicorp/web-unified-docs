...
Learn more about defining ephemeral [input variables](/terraform/language/block/variable#ephemeral), [outputs](/terraform/language/block/output#ephemeral), and [resources](/terraform/language/resources/ephemeral).
