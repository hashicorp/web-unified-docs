...
- Providers can support ephemeral resources using [`ephemeral` blocks](/terraform/language/block/ephemeral)
- You can enable the `ephemeral`  argument on a [`variable` block](/terraform/language/block/variable#ephemeral)
- You can enable the `ephemeral`  argument on a [`output` block](/terraform/language/block/output#ephemeral)
