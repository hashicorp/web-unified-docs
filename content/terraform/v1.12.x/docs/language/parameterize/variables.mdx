---
page_title: Use variables to define module arguments
description: Learn how to variables define the interface of your module, and how to assign values to variables.
---

# Use variables to define module arguments
