...
For more information on which Terraform blocks can be ephemeral, refer to ephemeral [inputs](/terraform/language/block/variable#ephemeral), [outputs](/terraform/language/block/output#ephemeral), and [resources](/terraform/language/resources/ephemeral).
