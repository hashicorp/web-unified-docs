...
* `self`, in [provisioner](/terraform/language/resources/provisioners#use-a-provisioner) and
  [connection](/terraform/language/resources/provisioners#connect-to-remote-resources) blocks.
