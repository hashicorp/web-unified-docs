...
[The `replace_triggered_by` lifecycle argument](/terraform/language/meta-arguments#lifecycle) requires all of the given addresses to be for resources, because the decision to force replacement is based on the planned actions for all of the mentioned resources.
