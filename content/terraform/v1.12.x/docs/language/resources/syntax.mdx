...
You can write preconditions for resources in your configuration to help capture assumptions to help future maintainers understand your configuration design and intent. Validations return useful information about errors with context, helping consumers to diagnose issues in their configuration. Refer to [Validate your configuration](/terraform/language/test-and-validate/validate#preconditions-and-postconditions) for more details.
