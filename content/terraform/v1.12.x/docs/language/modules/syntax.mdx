...
[input variables](/terraform/language/block/variable). Modules are called
...
- Most other arguments correspond to [input variables](/terraform/language/block/variable)
...
declare [output values](/terraform/language/block/output) to selectively
