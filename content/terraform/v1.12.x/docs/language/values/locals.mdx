...
- [Input variables](/terraform/language/block/variable) are like function arguments.
- [Output values](/terraform/language/block/output) are like function return values.
