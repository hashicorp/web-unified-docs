...
last_modified: 2026-01-23T17:07:29-05:00
...
In the `terraform` block or `terraform.tf` file, replace `backend "remote"` with `cloud`. Terraform continues to use the same set of HCP Terraform workspaces.
