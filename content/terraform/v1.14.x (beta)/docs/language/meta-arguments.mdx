...
- [Specify a dependency during the creation of a Stack component](/terraform/language/block/stack/tfcomponent/component#depends_on)
...
- [Invoke an action multiple times](/terraform/language/block/action#invoke-an-action-multiple-times)
...
- [`count` argument in `action` block ](/terraform/language/block/action#count)
...
- [`for_each` argument in `action` block ](/terraform/language/block/action#for_each)
...
- [`for_each` argument in Stack `component` blocks](/terraform/language/block/stack/tfcomponent/component#for_each)
- [`for_each` argument in Stack `provider` blocks](/terraform/language/block/stack/tfcomponent/provider#for_each)
- [`for_each` argument in Stack `removed` blocks](/terraform/language/block/stack/tfcomponent/removed#for_each)
...
- [Specify an alternate provider configuration](/terraform/language/block/action#select-an-alternate-provider-configuration) for an action
...
- [`provider` argument in `action` block ](/terraform/language/block/action#provider)
