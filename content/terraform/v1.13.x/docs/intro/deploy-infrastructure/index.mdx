...
> __COPY OF THE CURRENT OVERVIEW IN THE CLI DOS, WHICH IS ACTUALLY PRETTY GOOD.__
> 
> __NOTES FROM THE PROPOSAL DOC: __
 tabbed for workflows: CE (CLI- driven, VCS-), Commercial offerings (API-, UI-, VCS-, CLI- driven)

# Deploy infrastructure overview
