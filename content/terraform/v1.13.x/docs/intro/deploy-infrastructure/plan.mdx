...
> 
> __COPY OF THE `terraform plan` CLI COMMAND REFERENCE IN THIS POC, WHICH ISN'T TOO BAD AS A USAGE TOPIC__
> 

Use the `terraform plan` command creates an execution plan, which lets you preview
