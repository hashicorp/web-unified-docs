...
> 
> COPIED FROM TERRAFORM SHOW COMMAND FROM CLI REF
> 


Use the `terraform show` command to view a human-readable output
...
Terraform state will be displayed in plain text. For more information, refer to [Manage sensitive data](/terraform/language/manage-sensitive-data).
