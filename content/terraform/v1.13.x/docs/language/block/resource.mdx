...
The beta release of Terraform 1.14 lets you trigger automations outside of Terraform with actions. Refer to the [Invoke an action](/terraform/language/v1.14.x/invoke-actions) beta documentation for more information.
