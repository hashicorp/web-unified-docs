...
#### GitHub Actions with separate backend and AzAPI identities
...
In default, unsuffixed mode, GitHub's ID token environment variables are automatically found. With suffix mode, explicitly map the broker variables as shown in [GitHub Actions with separate backend and AzAPI identities](#github-actions-with-separate-backend-and-azapi-identities).
