...
HCP Terraform supports up to 500 deployments for a Stack.
...
- The [`deployment_group`](/terraform/language/block/stack/tfdeploy/deployment_group) block groups deployments together to configure shared settings and orchestration rules.
...
## Organize deployments into groups

@include 'premium-deployment-groups.mdx'

You can organize deployments into deployment groups to control how HCP Terraform plans and applies them. To learn how to configure conditions for your deployments, refer to [Set conditions for deployment runs](/terraform/language/stacks/deploy/conditions).

## Supported Terraform functions

Deployment configurations support a subset of Terraform functions. Refer to
[Built-in Functions](/terraform/language/functions) for a list of functions
supported by Stacks deployments.
