...
- `-auto-approve` - Skips interactive approval of the plan before applying. Terraform ignores this
  ...
  Terraform interprets the act of passing the plan file as the approval. Use this flag with caution,
  as this can perform destructive operations without approval. If you use this option in automation,
  we recommend you first perform and review a plan operation before you apply the changes.
