...
- [`jsondecode`](/language/functions/jsondecode) is a similar operation using JSON instead
  of YAML.
- [`yamlencode`](/language/functions/yamlencode) performs the opposite operation, _encoding_
  a value as YAML.
