...
<!-- BEGIN: TFC:only -->
For beginning users on Terraform Cloud, we recommend using our [configuration-free GitHub App](/enterprise/admin/application/github-app-integration) to access repositories instead.
<!-- END: TFC:only -->
...
1.  Open Terraform Cloud in your browser and navigate to the "VCS Providers" settings for your organization. Click the "Add VCS Provider" button.
    ...
    3.  On the next page, click "Providers" in the "Version control" section of the left sidebar.
    4.  Click the "Add a VCS Provider" button.
