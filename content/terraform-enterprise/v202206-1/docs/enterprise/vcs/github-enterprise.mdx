...
2.  The "Add VCS Provider" page is divided into multiple steps to guide you through adding a new VCS provider.

    For the first step, select "GitHub" then select "Github Enterprise" from the dropdown. The page will move to the next step.

3.  In the "Set up provider" step, fill in the **HTTP URL** and **API URL** of your GitHub Enterprise instance, as well as an optional **Name** for this VCS connection.
    ...
    ![Terraform Cloud screenshot: add HTTP URL and API URL fields](/img/docs/ghe-tfe-add-url-fields.png)
...
1.  Enter the **Client ID** and **Client Secret** from the previous step.
    ...
    ![Terraform Cloud screenshot: add client fields](/img/docs/ghe-tfe-add-client-fields.png)
...
3.  In Terraform Cloud's "Add VCS Provider" page, paste the text of the **SSH private key** you just created, and click the "Add SSH Key" button.
    ...
    ![Terraform Cloud screenshot: the ssh key screen](/img/docs/ghe-ssh-key.png)
