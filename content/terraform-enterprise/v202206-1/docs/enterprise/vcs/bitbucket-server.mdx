...
[Bitbucket Cloud has separate instructions,](/enterprise/vcs/bitbucket-cloud) as do the [other supported VCS providers.](/enterprise/vcs)
...
1.  Open Terraform Cloud in your browser and navigate to the "VCS Provider" settings for your organization. Click the "Add VCS Provider" button.
    ...
    3.  On the next page, click "Providers" in the left sidebar.
...
5.  Click "Continue" to view the generated **Consumer Key** and **Public Key** you can use to create a new Application Link in BitBucket Server. Leave this page open so you can copy and paste these values in Step 2.
