...
-> **Note:** These requirements apply to the External Services operational mode, not the Mounted Disk operational mode. Refer to the [Pre-Install Checklist](/enterprise/install/pre-install-checklist) for more information.
...
In Terraform Enterprise v202103-1, the internally-managed PostgreSQL server was
been upgraded from PostgreSQL 9.5 to PostgreSQL 12. This change only affected
