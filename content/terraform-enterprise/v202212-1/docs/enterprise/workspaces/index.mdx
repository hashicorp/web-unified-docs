...
Click **Workspaces**. Terraform Cloud shows a list of all workspaces in the current organization.

This list only includes workspaces where the current user account has permission to read runs. ([More about permissions.](/enterprise/users-teams-organizations/permissions))
