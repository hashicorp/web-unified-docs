...
Separate from workspace permissions, you can grant teams permissions to manage certain resources or settings across an organization. To set these permissions for a team, go to your organization's **Settings**. Then click **Teams**, and select the team name from the list.
