...
-> **Note:** Once a user is a member of the organization, you can manage their team memberships using [the Team Membership API](/enterprise/api-docs/team-members).
...
-> **Note:** Organization membership management is restricted to members of the owners team, the owners [team API token](/enterprise/users-teams-organizations/api-tokens#team-api-tokens), and the [organization API token](/enterprise/users-teams-organizations/api-tokens#organization-api-tokens).
