...
[Run tasks](/terraform/enterprise/workspaces/settings/run-tasks) allow HCP Terraform to interact with external systems at specific points in the workspace run lifecycle.
...
| `stage`                              | string  | `pre_plan`, `post_plan`, `pre_apply`, `post_apply` | The [run stage](/terraform/enterprise/workspaces/run/states) when HCP Terraform triggers the run task.                                                                                                         |
...
| `is_speculative`                     | bool    |                                                    | Whether the task is part of a [speculative run](/terraform/enterprise/workspaces/run/remote-operations#speculative-plans).                                                                                     |
