...
You need [owners team](/terraform/enterprise/users-teams-organizations/permissions/organization#organization-owners) or [Manage Private Registry](/terraform/enterprise/users-teams-organizations/permissions/organization#manage-private-registry) permissions to add, update, or delete GPG keys in a private registry.
