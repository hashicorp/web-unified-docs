...
The Site Auditor role provides read-only, cross-organization visibility into all resources in a Terraform Enterprise instance, enabling auditors and security teams to perform platform-wide reviews without write access or organization membership. 
