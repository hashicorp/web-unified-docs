...
-   Add support for [streamlined run task reviews](/terraform/enterprise/integrations/run-tasks), enabling run task integrations to return high fidelity results.
    ...
    -   Updated the run task payload [JSON schema](https://github.com/hashicorp/web-unified-docs-internal/blob/main/content/terraform-docs-common/public/schema/run-tasks/runtask-result.json).
