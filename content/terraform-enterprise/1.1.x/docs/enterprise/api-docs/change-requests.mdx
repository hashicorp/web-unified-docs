...
| `data.query`                 | object | Optional | An [explorer query](/terraform/enterprise/api-docs/explorer#execute-a-query) with workspace data. You do not need to specify this field if you provide `data.target_ids`. |
