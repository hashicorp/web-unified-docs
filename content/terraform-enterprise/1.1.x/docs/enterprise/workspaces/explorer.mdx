...
-   [Organization owner](/terraform/enterprise/users-teams-organizations/permissions#organization-owners)
-   [View all workspaces](/terraform/enterprise/users-teams-organizations/permissions#view-all-workspaces) or greater
