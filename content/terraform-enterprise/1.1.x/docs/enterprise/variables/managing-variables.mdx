...
To learn more about authenticating Stacks using values from variable sets, refer to [Authenticate a Stack](/terraform/language/stacks/deploy/authenticate). To learn more about the syntax of referencing variable sets with examples, refer to [the `store` block reference](/terraform/language/stacks/deploy/store).
