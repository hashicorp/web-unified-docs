...
3. In the sidebar navigation, select **Product Usage**.
4. Click **Generate Bundle**.
5. Wait for the bundle generation to complete.
6. Download the generated bundle.

The product usage bundle becomes available for download once generation completes.
