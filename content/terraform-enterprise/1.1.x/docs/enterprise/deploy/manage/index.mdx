...
If you enabled the admin console in your deployment configuration, you can open the admin console web UI to perform tasks, such as generate product usage reports and generate support bundles. Refer to [Enable the admin console](/terraform/enterprise/deploy/configuration/admin-console) for instructions on how to include the admin console in your Terraform Enterprise deployment.
