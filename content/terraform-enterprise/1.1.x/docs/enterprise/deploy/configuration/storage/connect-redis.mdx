...
### Azure and GCP Redis requirements

For Azure and GCP for Redis, you must provision a Redis instance for the main Redis service and an additional instance for Sidekiq. This is because the managed services do not support numbered databases.
