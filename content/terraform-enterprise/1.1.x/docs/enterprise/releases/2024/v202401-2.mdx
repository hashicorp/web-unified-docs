...
last_modified: 2025-12-01T09:04:52-08:00
...
1. Terraform Enterprise now supports new [deployment options](/terraform/enterprise/flexible-deployments/) and we will be ending support for the Replicated Native Scheduler option. The final Replicated release of Terraform Enterprise will be in November 2024. We will support the final Replicated release until April 1, 2026.

To ensure you continue to receive the latest features and fixes, migrate to a new deployment option by November 2024. For more information, check out [flexible deployment options,](/terraform/enterprise/flexible-deployments) or contact your HashiCorp account representative.
