...
## 1.0.3
<span class="h4-size">2025-11-13</span>
...
1. Terraform Enterprise will now attempt to read and write from blob storage as a startup check, prior to running database migrations.
