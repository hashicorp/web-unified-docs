...
| ----------------- | ------------------------------------------------------------------- | --------------------------------------------------------------------------- | ---------------------------------- |
| [1.1.1](#1-1-1)   | [1.13.4](https://github.com/hashicorp/terraform/releases/tag/v1.13.4) | [0.40.0](https://developer.hashicorp.com/sentinel/docs/changelog#0-40-0-may-12-2025)  | [V2](https://docs.docker.com/compose/migrate/)                       | [V2](https://docs.docker.com/compose/migrate/)                       |
