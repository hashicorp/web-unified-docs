...
**Note**: [Automated license utilization reporting](/terraform/enterprise/replicated/administration/license/automated-license-utilization-reporting) automatically sends data to HashiCorp to validate your license entitlements.
