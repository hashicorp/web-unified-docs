...
To ensure you continue to receive the latest features and fixes, please plan to migrate to a new deployment option by <strong>November 2024</strong>. For more information, check out [Flexible Deployment Options](/terraform/enterprise/flexible-deployments) or contact your HashiCorp account representative.
