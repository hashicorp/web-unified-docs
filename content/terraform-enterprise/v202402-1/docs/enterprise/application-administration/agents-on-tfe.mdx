---
page_title: >-
  Terraform Cloud Agents on TFE - Application Administration - Terraform
  Enterprise
description: >-
...
Terraform Cloud Agents on TFE behave very similarly to [Terraform Cloud Agents on TFC](/terraform/cloud-docs/agents),
