...
There are specific [`tfectl` commands](/terraform/enterprise/flexible-deployments/admin/admin-cli#mounted-disk-exclusive-commands) available to help manage a mounted disk installation. 
