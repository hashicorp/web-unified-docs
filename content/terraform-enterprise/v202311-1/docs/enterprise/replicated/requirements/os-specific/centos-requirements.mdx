...
- A [supported version](/terraform/enterprise/replicated/requirements/os-specific/supported-os) of CentOS.
...
profile](/terraform/enterprise/replicated/install/pre-install-checklist#option-3-docker-engine-using-a-modified-libseccomp-profile).
