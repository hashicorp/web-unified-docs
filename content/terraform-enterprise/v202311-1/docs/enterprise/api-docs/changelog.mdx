...
<!-- BEGIN: TFC:only name:provisional -->

## 2023-08-10

-   Add `provisional` to `configuration-versions` endpoint.

<!-- END: TFC:only name:provisional -->
...
-   Updated the [Workspacess API](/terraform/enterprise/api-docs/workspaces) with a safe delete endpoint that guards against deleting workspaces that are managing resources.
