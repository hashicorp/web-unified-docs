---
page_title: Policy Evaluations - API Docs - Terraform Enterprise
description: >-
  Use the `/policy-evaluations` endpoint to manage the Sentinel and OPA policy
  evaluations performed on a Terraform run. List and show policy outcomes and
...
Run policy evaluations in [Terraform Cloud agents](/terraform/enterprise/api-docs/agents) in Terraform Cloud's infrastructure. Policy evaluations do not have access to cost estimation data.
...
| Parameter                | Description                                                                                                             |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| `:policy_set_outcome_id` | The ID of the policy outcome to show. Send a `GET` request to the `/policy-set-outcomes` endpoint to obtain the policy set outcome ID. |
