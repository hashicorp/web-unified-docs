---
page_title: Bitbucket Data Center - VCS Providers - Terraform Enterprise
...
3.  Choose **Bitbucket Data Center** from the **Bitbucket** drop-down menu.
...
6.  You can either generate new consumer and public keys that you can use to create a new application link in Bitbucket Data Center described in [Create an application link](#create-an-application-link) or use keys from an existing application link:
...
-   [Creating Workspaces](/terraform/enterprise/workspaces/creating) in HCP Terraform
