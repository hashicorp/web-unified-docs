...
- `https://yy0ffni7mf-dsn.algolia.net/` - this URL is specific to the Terraform Registry’s [Algolia](https://www.algolia.com/) application. The Terraform Registry uses Algolia to index the current resources in the registry and power Terraform Cloud public-facing search for public providers and module curation.
