...
description: Learn how to acquire and provide a Terraform Enterprise license so that you can deploy Terraform to one of the supported runtime environments.
