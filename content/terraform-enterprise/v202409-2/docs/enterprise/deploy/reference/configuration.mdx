...
last_modified: 2026-09-04T14:33:54.000Z
...
Whether to enable database reconnection in case of a failover. Defaults to 'false'.
We recommend setting this configuration to `true` when connecting to an external PostgreSQL cluster. 
