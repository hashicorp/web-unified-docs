...
This topic provides overview information about managing Terraform Enterprise deployed to non-Replicated runtimes. For information about managing Replicated deployments, refer to [Manage Terraform Enterprise on Replicated overview](/terraform/enterprise/deploy/replicated/administration/infrastructure).
