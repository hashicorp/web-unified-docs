...
-   Add API documentation for multiple [team tokens](/terraform/enterprise/users-teams-organizations/api-tokens), and update documentation around [legacy team tokens](/terraform/enterprise/api-docs/team-tokens##legacy-team-tokens-api-reference).
