...
When you enable health assessments for a workspace, Terraform Cloud will run the first health assessment based on whether there are active Terraform runs for the workspace:
