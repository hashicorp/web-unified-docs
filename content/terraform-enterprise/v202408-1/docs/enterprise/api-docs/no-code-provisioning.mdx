...
| `data.relationships.project.data.id`                    | string  | none | The ID of the project to create the workspace in. You must have permission to create workspaces in the project, either by organization-level permissions or team admin access to a specific project. | 
| `data.relationships.project.data.type`                  | string  | none | Must be `"project"`.                                                                                                                                                                                 | 
| `data.relationships.vars.data[].type`                   | string  | none | Must be `"vars"`.                                                                                                                                                                                    | 
| `data.relationships.vars.data[].attributes.key`         | string  | none | The name of the variable.                                                                                                                                                                            | 
| `data.relationships.vars.data[].attributes.value`       | string  | `""`      | The value of the variable.                                                                                                                                                                           | 
| `data.relationships.vars.data[].attributes.description` | string  | none | The description of the variable.                                                                                                                                                                     | 
| `data.relationships.vars.data[].attributes.category`    | string  | none | Whether this is a Terraform or environment variable. Valid values are `"terraform"` or `"env"`.                                                                                                      |
