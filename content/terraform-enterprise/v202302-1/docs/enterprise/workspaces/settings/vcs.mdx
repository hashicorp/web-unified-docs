...
This option instructs Terraform to begin new runs only for changes that affect specified files and directories. This behavior also applies to [speculative plans](/enterprise/run/remote-operations#speculative-plans) on pull requests.
