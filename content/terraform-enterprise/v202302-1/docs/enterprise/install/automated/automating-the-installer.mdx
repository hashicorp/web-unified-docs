...
If you want to use a [custom image](/enterprise/install/interactive/installer#custom-image), the following settings apply:

For a [legacy custom image](/enterprise/install/interactive/installer#legacy):
...
For an [agent custom image](/enterprise/install/interactive/installer#agent):
