...
2.  [Create a team](/enterprise/users-teams-organizations/teams) for that organization called "ServiceNow", and ensure that it has the organization-level ["Manage Workspaces" permission](/enterprise/users-teams-organizations/permissions#manage-workspaces). You do not need to add any users to this team.
