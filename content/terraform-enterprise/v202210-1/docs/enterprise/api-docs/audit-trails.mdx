...
-> **Note:** This endpoint cannot be accessed with a [user token](/enterprise/users-teams-organizations/users#api-tokens) or [team token](/enterprise/users-teams-organizations/api-tokens#team-api-tokens). You must access it with an [organization token](/enterprise/users-teams-organizations/api-tokens#organization-api-tokens).
