...
Site auditors can access all areas of the UI except for the following pages and subpages:
...
Call the API to audit data data that isn't accessible in the UI under the site auditor permission. Refer to the [API reference documentation](/terraform/enterprise/api-docs) for information about available endpoints.
