...
=======
Each team can have API tokens not associated with a specific user. You can manage a team's API tokens from the **Organization settings > API Tokens > Team Token** page. You can create, regenerate, and delete team tokens on the API token page. Refer to [Team API Tokens](/terraform/enterprise/users-teams-organizations/api-tokens#team-api-tokens) for details.
>>>>>>> tfe-release/2.0.0
...
Refer to [organization owners](/terraform/enterprise/users-teams-organizations/permissions/organization#organization-owners) for more details about owners team permissions.
...
<<<<<<< HEAD
You can manage many things about teams, including creating and deleting a team, team membership, and team access to workspaces, projects,<!-- BEGIN: TFC:only name:stacks-tfe --> Stacks,<!-- END: TFC:only name:stacks-tfe --> and organizations. Refer to [Manage teams](/terraform/enterprise/users-teams-organizations/teams/manage) to learn more.
=======
You can manage many things about teams, including creating and deleting a team, team membership, and team access to workspaces, projects, Stacks, and organizations. Refer to [Manage teams](/terraform/enterprise/users-teams-organizations/teams/manage) to learn more.
>>>>>>> tfe-release/2.0.0
