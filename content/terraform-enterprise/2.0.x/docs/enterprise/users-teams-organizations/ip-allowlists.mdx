---
page_title: IP Allowlists - Terraform Enterprise
description: >-
  Learn how to use IP allowlists to restrict access to Terraform Enterprise
  resources based on source IP addresses. Configure organization-wide, agent
  pool, or workspace-specific IP restrictions.
...
7.  Enable one of the following scope options. Refer to [Enforcement scopes](#enforcement-scopes) for more information:
