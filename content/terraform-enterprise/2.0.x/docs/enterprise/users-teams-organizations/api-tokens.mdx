...
last_modified: 2026-03-19T15:37:30.000Z
...
Organization owners can set a maximum token expiration time in the organization's settings. For more information, refer to the [Maximum Time to Live](/terraform/enterprise/users-teams-organizations/organizations/settings#maximum-time-to-live) documentation.
