...
Members do not have access to projects or workspaces and Stacks. You can grant permissions to individual projects or workspaces and Stacks through [Project Permissions](/terraform/enterprise/users-teams-organizations/permissions/set-permissions#set-project-level-roles) or [Workspace Permissions](/terraform/enterprise/users-teams-organizations/permissions/set-permissions#set-workspace-level-roles).
...
Enable this setting to allow team members to attach existing project tags to modules and providers in the registry. Use these tags to organize registry artifacts. Refer to [Define project tags](/terraform/enterprise/projects/manage#define-project-tags) for more information.
...
Reserved keys apply to projects, workspaces, and registry artifact versions, such as the specific version of a module or provider. Refer to [Create and manage reserved tag keys](/terraform/enterprise/users-teams-organizations/organizations/manage-reserved-tags) for more information.
...
Allow project and workspace managers to grant override permissions for **Soft mandatory** policy evaluations. When this setting is enabled, team members can't override failed policy unless the project or workspace manager manually enables the **Allow policy overrides** setting in their project or workspace. 

Refer to the [projects](/terraform/enterprise/users-teams-organizations/permissions/project#policy-overrides) and [workspaces](/terraform/enterprise/users-teams-organizations/permissions/workspace#policy-overrides) team permission references for more information. 
