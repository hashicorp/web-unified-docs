...
You can also create a configuration version using the HCP Terraform API. To learn more, refer to the [Stacks API](/terraform/enterprise/api-docs/stacks/configurations#create-a-stack-configuration).
