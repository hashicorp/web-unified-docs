...
You can define tags stored as key-value pairs to help you organize your projects and track resource consumption. <!-- BEGIN: TFC:only name:reg-artifact-tags -->You can also attach project tags to modules and providers uploaded to the private registry. Refer to [Manage artifact tags](/terraform/enterprise/registry/manage/tags) for more information.<!-- END: TFC:only name:reg-artifact-tags -->
...
In HashiCorp Cloud Platform (HCP) Europe organizations, you cannot set execution mode at the project level. Instead, you can set an execution mode at the [organization](/terraform/enterprise/users-teams-organizations/organizations/settings#general) or [workspace](/terraform/enterprise/workspaces/settings#execution-mode) level. To learn more about HCP Europe, refer to [Use HCP Terraform in Europe](/terraform/enterprise/europe).
