...
<<<<<<< HEAD
Projects let you group and scope access to your workspaces<!-- BEGIN: TFC:only name:stacks-tfe --> and Stacks<!-- END: TFC:only name:stacks-tfe -->. You can group related  workspaces <!-- BEGIN: TFC:only name:stacks-tfe -->and Stacks <!-- END: TFC:only name:stacks-tfe -->into projects and give teams more permissive access to individual projects rather than granting them permissions to the entire organization.
...
<<<<<<< HEAD
-   **Least privilege**: You can create teams and grant them access to projects with workspaces <!-- BEGIN: TFC:only name:stacks-tfe --> or Stacks<!-- END: TFC:only name:stacks-tfe --> of similar areas of ownership. For example, a production networking workspace should be in a separate project from a development compute workspace.
=======
