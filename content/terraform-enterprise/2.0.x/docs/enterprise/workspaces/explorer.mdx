...
last_modified: 2026-06-08T23:48:04.000Z
...
The explorer for workspace visibility supports five types:
...
The **Actions** dropdown on every query results and saved view page also includes **Give feedback**, which opens a Google Form where you can share feedback about the explorer.
