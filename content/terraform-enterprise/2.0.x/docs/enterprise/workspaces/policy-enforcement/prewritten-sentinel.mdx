...
Run a plan in the workspace to trigger the connected policies. Refer to [Start a Terraform run](/terraform/enterprise/workspaces/run/remote-operations#starting-runs) for additional information.
