...
You can search for unmanaged resources in [UI and VCS-driven](/terraform/enterprise/workspaces/run/ui) and [CLI-driven](/terraform/enterprise/workspaces/run/cli) workspaces. HCP Terraform presents results so that you can use the UI to import the resources and begin managing them as code. Complete the following steps to search for resources and import them into your Terraform state:
