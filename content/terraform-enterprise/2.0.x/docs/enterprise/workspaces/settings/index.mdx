...
-   **Project Default**: HCP Terraform uses a project's [default execution mode](/terraform/enterprise/projects#execution-mode) to choose the execution platform for a workspace. This is the default setting.
