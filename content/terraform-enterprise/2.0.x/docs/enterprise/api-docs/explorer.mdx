...
last_modified: 2026-06-10T22:51:39.000Z
...
| `module_name`              | `string`   | The name of the module for this resource. Top-level resources not inside a module use the value `root`. |
