...
last_modified: 2026-06-08T22:09:38.000Z
...
limiting](/terraform/enterprise/api-docs#rate-limiting). Explorer will return a
...
| `registry_type`   | `string` | The registry type for this provider (e.g. `public` or `private`). |
...
| `registry_type`   | `string`  | The registry type for this module (e.g. `public` or `private`). |
...
-> **Note**: The `resources` view type is currently in beta and subject to change without notice.

| Field                      | Type       | Description                                                               |
| -------------------------- | ---------- | ------------------------------------------------------------------------- |
| `name`                     | `string`   | The name of this resource. |
| `address`                  | `string`   | The address of this resource. |
| `provider_type`            | `string`   | The resource type identifier as defined by the provider (e.g., `aws_instance`, `random_pet`). |
| `provider_name`            | `string`   | The source address of the provider for this resource. For providers from the public registry, the `registry.terraform.io/` hostname is omitted (e.g., `hashicorp/aws`). For built-in providers, the full address is returned (e.g., `terraform.io/builtin/terraform`). |
