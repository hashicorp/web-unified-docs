...
last_modified: 2026-06-09T18:28:23.000Z
...
| `source_type`              | `string`   | The source type for this resource. |
| `source_id`                | `string`   | The source ID for this resource. |
| `source_updated_at`        | `datetime` | The time this resource's source was last updated. |
