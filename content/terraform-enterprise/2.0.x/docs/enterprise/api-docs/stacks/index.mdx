---
page_title: /stacks API reference for Terraform Enterprise
description: >-
  Use the Terraform Enterprise API's `/stacks` to create, read, update, and
  delete Stacks.
created_at: 2025-09-19T20:41:08.000Z
last_modified: 2026-03-16T23:10:23.000Z
source: terraform-docs-common
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-08T18:54:29.000Z
...
| `data.attributes.vcs-repo.oauth-token-id`             | string  |                  | The VCS Connection (OAuth Connection + Token) to use. You can obtain this ID from the [oauth-tokens](/terraform/enterprise/api-docs/oauth-tokens) endpoint.                                                                                                                                                           |
...
Stack read access is restricted to users or teams with the [**Read** project role](/terraform/enterprise/users-teams-organizations/permissions) and an [organization API token](/terraform/enterprise/users-teams-organizations/api-tokens#organization-api-tokens).
