---
page_title: /stack-deployments API reference for Terraform Enterprise
description: >-
  Use the Terraform Enterprise API's `/stack-deployments` to consume and
  propagate actions for Stack deployment groups, runs, and steps.
