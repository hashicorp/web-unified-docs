...
last_modified: 2026-04-08T18:54:09.000Z
>>>>>>> tfe-release/2.0.0
...
If you are using a Stack and want to interact with Stack deployment runs, refer to [deployment runs](/terraform/enterprise/stacks/runs). <!-- END: TFC:only name:stacks-tfe -->
=======
An apply represents the results of applying a Terraform workspace execution plan.  
If you are using a Stack and want to interact with Stack deployment runs, refer to [deployment runs](/terraform/enterprise/stacks/runs). 
>>>>>>> tfe-release/2.0.0
