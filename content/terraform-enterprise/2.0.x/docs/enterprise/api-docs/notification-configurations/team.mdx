---
page_title: Team notification configurations API reference for Terraform Enterprise
description: >-
  Use the Terraform Enterprise API's team notification configuration endpoints
  to read, create, update, verify, and delete team notification configurations.
...
| -------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `POST`   | `/teams/:team_id/notification-configurations`                                | [Create a new notification configuration for a team](#create-a-team-notification-configuration)               |
| `GET`    | `/teams/:team_id/notification-configurations`                                | [List all notification configurations for a team](#list-team-notification-configurations)                     |
| `GET`    | `/notification-configurations/:notification-configuration-id`                | [Retrieve details of a specific notification configuration](#show-a-team-notification-configuration)          |
| `PATCH`  | `/notification-configurations/:notification-configuration-id`                | [Update an existing notification configuration](#update-a-team-notification-configuration)                    |
| `POST`   | `/notification-configurations/:notification-configuration-id/actions/verify` | [Send a verification request to test a notification configuration](#verify-a-team-notification-configuration) |
| `DELETE` | `/notification-configurations/:notification-configuration-id`                | [Delete a notification configuration](#delete-a-team-notification-configuration)                              |

For workspace notification configurations, refer to [Workspace notification configurations API reference](/terraform/enterprise/api-docs/notification-configurations/workspace). For project notification configurations, refer to [Project notification configurations API reference](/terraform/enterprise/api-docs/notification-configurations/project).
