---
page_title: Workspace notification configurations API reference for Terraform Enterprise
description: >-
...
last_modified: 2025-09-05T19:41:13.000Z
source: terraform-docs-common
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-08T18:54:18.000Z
last_modified: 2026-04-08T18:54:18.000Z
...
For project notification configurations, refer to [Project notification configurations API reference](/terraform/enterprise/api-docs/notification-configurations/project). 
For team notification configurations, refer to [Team notification configurations API reference](/terraform/enterprise/api-docs/notification-configurations/team).

Interacting with notification configurations requires admin access to the relevant workspace. Refer to [Permissions overview](/terraform/enterprise/users-teams-organizations/permissions) for more information.

[Speculative plans](/terraform/enterprise/workspaces/run/modes-and-options#plan-only-speculative-plan) and workspaces configured with `Local` [execution mode](/terraform/enterprise/workspaces/settings#execution-mode) do not support notifications.
...
| ------------------------ | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Created                  | `"run:created"`                        | A run is created and enters the [Pending stage](/terraform/enterprise/workspaces/run/states#the-pending-stage)                                                                                          |
| Planning                 | `"run:planning"`                       | A run acquires the lock and starts to execute.                                                                                                                                                          |
| Needs Attention          | `"run:needs_attention"`                | A plan has changes and Terraform requires user input to continue. This input may include approving the plan or a [policy override](/terraform/enterprise/workspaces/run/states#the-policy-check-stage). |
| Applying                 | `"run:applying"`                       | A run enters the [Apply stage](/terraform/enterprise/workspaces/run/states#the-apply-stage), where Terraform makes the infrastructure changes described in the plan.                                    |
