---
page_title: Project notification configurations API reference for Terraform Enterprise
description: >-
  Use the Terraform Enterprise API's project notification configuration
  endpoints to read, create, update, verify, and delete project notification
  configurations.
