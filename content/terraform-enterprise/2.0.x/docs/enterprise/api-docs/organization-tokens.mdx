...
last_modified: 2026-03-09T20:49:00.000Z
source: terraform-docs-common
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-08T14:19:50-04:00
last_modified: 2026-04-08T18:54:19.000Z
...
| `data.attributes.expired-at` | string | `null`  | The UTC date and time that the organization token will expire, in ISO 8601 format. If omitted or set to `null`, the token will expire two years from the date of creation. |
