...
last_modified: 2026-03-09T20:49:01.000Z
source: terraform-docs-common
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-08T14:19:50-04:00
last_modified: 2026-04-08T18:54:29.000Z
...
Teams relying on the [legacy `/teams/:team_id/authentication-token`](/terraform/enterprise/api-docs/team-tokens#legacy-team-tokens-api-reference) endpoint can only create a single valid token at a time. Generating a new legacy token when a team token already exists revokes the existing legacy token and replaces it with a new team token.
