...
This action cannot be undone. After you disable SCIM, you must re-enable SCIM and create a new SCIM provisioning token before your identity provider can resume provisioning.
