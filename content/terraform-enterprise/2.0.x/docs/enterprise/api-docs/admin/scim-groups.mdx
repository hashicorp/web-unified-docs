...
This page documents the admin `GET /api/v2/admin/scim-groups` endpoint. For the public provisioning endpoints under `/scim/v2/Groups`, refer to the [SCIM Groups API](/terraform/enterprise/api-docs/scim/groups).
