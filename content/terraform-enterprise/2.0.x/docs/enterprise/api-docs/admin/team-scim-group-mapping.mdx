...
- Adding or removing users through `/teams/:team_id/relationships/users` or `/teams/:team_id/relationships/organization-memberships`
- Deleting the team using `DELETE /teams/:team_id`
- Changing the team name using `PATCH /teams/:team_id`
