...
last_modified: 2026-04-10T18:52:06.000Z
...
| `data.attributes.policy-overrides`       | boolean | false   | If `access` is `custom`, this permission allows the team to override policy checks for the workspace.                                                                                             |
