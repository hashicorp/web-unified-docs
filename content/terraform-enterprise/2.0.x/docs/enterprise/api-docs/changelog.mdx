...
last_modified: 2026-04-10T18:55:32.000Z
...
-   Update [Teams](/terraform/enterprise/api-docs/teams) API documentation to include the `organization-access.delegate-policy-overrides` field for delegating policy override permission to a team.
-   Update [Project team access](/terraform/enterprise/api-docs/project-team-access) API documentation to include the `workspace-access.policy-overrides` field for custom project permissions.
-   Update [Team access](/terraform/enterprise/api-docs/team-access) API documentation to include the `policy-overrides` field for custom workspace permissions.
-   Add documentation for the [Admin users](/terraform/enterprise/api-docs/admin/users) API endpoints that grant and revoke site auditor privileges.

## 2026-04-2

-   The notifications API now includes endpoints for configuring project notifications. Refer to [Project notification configurations API reference](/terraform/enterprise/api-docs/notification-configurations/project) for more information.

<!-- BEGIN: TFC:only name:stacks-tfe -->

## 2025-12-18

-   Document the new `/registry-components` endpoints that let you read, publish, update, and delete Stack component configurations in your organization's private registry. For more details, refer to the [Stack component configurations API reference](/terraform/enterprise/api-docs/private-registry/stack-component-configurations).

<!-- END: TFC:only name:stacks-tfe -->

## 2025-10-31

-   Document API filtering parameters when [`listing projects`](/terraform/enterprise/api-docs/projects)

<!-- BEGIN: TFC:only name:hcp-eu -->

## 2025-9-30

-   Add a new page for [group member roles](/terraform/enterprise/api-docs/group-member-roles) APIs for retrieving information about group permissions for HCP EU organizations. To learn more about HCP Europe, refer to [Use HCP Terraform in Europe](/terraform/enterprise/europe).
-   In HashiCorp Cloud Platform (HCP) Europe organizations, you manage user access through HCP groups. HCP Terraform inherits groups and roles from HCP.  To learn more about HCP Europe, refer to [Use HCP Terraform in Europe](/terraform/enterprise/europe).
    -   The following API endpoints are supported by HCP Europe organizations if you use group attributes instead of team attributes:
        -   [`project-team-access`](/terraform/enterprise/api-docs/project-team-access)
...
-   Update existing [workspaces API documentation](/terraform/enterprise/api-docs/workspaces) to reflect that a workspace's default execution mode now matches the project and not the organization default.
-   Update existing [projects API documentation](/terraform/enterprise/api-docs/projects) to include `default-execution-mode`, `default-agent-pool`, and `settings-overwrites` for projects.
-   Update existing [agent pools API documentation](/terraform/enterprise/api-docs/agents) to include new agent pool scoping options, including adding allowed projects and adding exclusions for workspaces.
...
-   Add API documentation for multiple [team tokens](/terraform/enterprise/users-teams-organizations/api-tokens#team-api-tokens), and update documentation around [legacy team tokens](/terraform/enterprise/api-docs/team-tokens##legacy-team-tokens-api-reference).
...
-   Update [Run Tasks](/terraform/enterprise/api-docs/run-tasks/run-tasks) to include the new `stages` attribute when attaching or updating workspace tasks.
...
-   Update [Run Tasks](/terraform/enterprise/api-docs/run-tasks/run-tasks) to include the new description attribute.
