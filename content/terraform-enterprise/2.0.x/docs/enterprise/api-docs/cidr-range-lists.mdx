---
page_title: /cidr-range-lists API reference for Terraform Enterprise
description: >-
  Use the Terraform Enterprise API's `/cidr-range-lists` endpoint to read,
  update, and destroy IP allowlists. Use the `/cidr-ranges` endpoint to read,
  update, destroy IP address ranges attached to an allowlist.
source: terraform-docs-common
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-08T14:54:06-04:00
last_modified: 2026-08-31T22:02:48.000Z
