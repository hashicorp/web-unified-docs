...
last_modified: 2026-04-10T18:52:03.000Z
...
| `data.attributes.workspace-access.move`             | boolean | false   | If `access` is `move`, this permission allows the team to move workspaces into and out of the project. The team must also have permissions to the project(s) receiving the workspace(s).                   |
...
| `data.attributes.workspace-access.policy-overrides` | boolean | false   | If `access` is `custom`, this permission allows the team to override policy checks within the project's workspaces.                                                                                        |
...
| workspace-access.policy-overrides | false  | false   | true       | true     | false            |
