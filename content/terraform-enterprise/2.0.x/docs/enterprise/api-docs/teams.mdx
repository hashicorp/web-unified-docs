...
In HCP Europe organizations, you use HCP **groups** to manage permissions instead of **teams**. To learn more about HCP Europe, refer to [Use HCP Terraform in Europe](/terraform/enterprise/europe).

To learn how to create and delete groups in HCP, refer to [Create a group](/hcp/docs/hcp/iam/groups#create-a-group). To assign groups permissions in HCP Terraform, refer to the [Member roles API](/terraform/enterprise/api-docs/member-roles).
