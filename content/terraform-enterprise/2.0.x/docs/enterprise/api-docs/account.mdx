...
created_at: 2026-04-08T18:19:34.000Z
last_modified: 2026-04-08T18:19:34.000Z
...
The `is-scim-managed`, `scim-username`, and `scim-updated-at` attributes are only returned when SCIM is enabled.
...
```json
{
  "data": {
    ...
    "attributes": {
      ...
      "is-scim-managed": true,
      "scim-username": "admin@example.com",
