...
<Note>
The `/_health_check` endpoint was deprecated in 1.2.0 and removed in 2.0.0. It now returns `410 Gone`. Use the [readiness endpoint](/terraform/enterprise/api-docs/readiness) at `/api/v1/health/readiness` instead.
</Note>
