...
<Note>
The `/_health_check` endpoint is deprecated as of 1.2.0. Use the [readiness endpoint](/terraform/enterprise/api-docs/readiness) at `/api/v1/health/readiness` instead.
</Note>
