...
last_modified: 2026-04-13T12:42:49.000Z
...
Refer to the [CLI reference](/terraform/enterprise/deploy/reference/cli) for additional diagnostics and troubleshooting commands.
