...
- `https://images.releases.hashicorp.com`: The endpoint hosts release container images in HashiCorp Registry.
- `https://cp.icr.io`: The endpoint hosts release container images in IBM Entitled Registry.
