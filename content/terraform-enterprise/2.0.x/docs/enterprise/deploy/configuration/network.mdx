...
- If your organization uses IBM Entitled Registry, use the applicable Passport Advantage Online (PAO) process and IBM Entitled Registry workflow to retrieve and mirror the image.
