...
last_modified: 2026-04-13T06:36:59.000Z
...
Start with `tfectl app health readiness` to confirm that Terraform Enterprise is ready to accept requests. For a detailed subsystem analysis, run `tfectl app diagnostics`.
