...
You must be a member of the [owners team](/terraform/enterprise/users-teams-organizations/permissions/organization#organization-owners) or a team with [Manage Private Registry permissions](/terraform/enterprise/users-teams-organizations/permissions/organization#manage-private-registry) to publish and delete private providers from the private registry.
