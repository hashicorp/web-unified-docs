...
| `data.attributes.drift_detection`             | boolean | `false`   | Whether Terraform Cloud will perform drift detection assessments for the workspace. Only available for Business tier organizations, in workspaces running Terraform version 0.15.4+ and operating in [Remote execution mode](/enterprise/workspaces/settings#execution-mode). Not available in Terraform Enterprise. |
