...
```
./install.sh docker-version=20.10.17http-proxy=http://internal.mycompany.com:8080
```
...
```
./install.sh docker-version=20.10.17additional-no-proxy=s3.amazonaws.com,internal-vcs.mycompany.com,example.com
```
...
![Terraform Enterprise docker image](/img/docs/tfe-docker-image.png)
...
[Pre-Install Checklist: Operational Mode Decision](/enterprise/before-installing/#operational-mode-decision)
for more details.
...
1. Airgap installations require Docker to be pre-installed. Double-check that your instance has a supported version of Docker (see [Pre-Install Checklist: Software Requirements](/enterprise/before-installing/#software-requirements) for details).
...
1. Configure the operational mode for this installation. See
   [Pre-Install Checklist: Operational Modes](/enterprise/before-installing/#operational-mode-decision) for information on what the different values are. Ensure that you've met the relevant pre-install requirements for the mode you chose.
