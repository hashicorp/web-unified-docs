...
For more information on using a GitHub App and GitHub Permissions in Terraform Cloud, see [GitHub Permissions in Terraform Cloud](/terraform/cloud-docs/admin/application/github-app-integration#github-permissions).
