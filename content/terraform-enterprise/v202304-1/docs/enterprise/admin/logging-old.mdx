...
This document contains information about interacting with Terraform Enterprise logs prior to release v202109-1. If you have updated to v202109-1 or later, please refer to the [latest version of this page](/terraform/enterprise/admin/infrastructure/logging).
...
1. The action
   ...
   \* Webhook API calls
1. The target of the action (any resource exposed by the V2 API)
1. The time that the action occurred
1. Where the action was taken (web/API request, background job, etc.)
