...
## Security
1. Fixed an issue where new state versions could be created by a user with a combination of permissions that should not have allowed write access ([CVE-2025-13432](https://discuss.hashicorp.com/t/hcsec-2025-34-terraform-enterprise-state-versions-can-be-created-by-users-without-sufficient-write-access/76821)).
