...
HashiCorp maintains [`go-tfe`](https://github.com/hashicorp/go-tfe), a Go client for HCP Terraform and Terraform Enterprise's APIs. HashiCorp also maintains [`pytfe`](https://github.com/hashicorp/python-tfe), a Python client for HCP Terraform's API.
