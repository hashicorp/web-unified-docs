...
| `current_rum_count`               | `number`   | The number of [resources under management](/terraform/enterprise/overview/estimate-hcp-terraform-cost#what-is-a-managed-resource) (RUM). Only available in HCP Terraform. |
