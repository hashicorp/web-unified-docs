...
## Known Issues
1. (Updated 11/03/2025) Product usage may generate heavy database queries that can overload the database and impact production workloads. This issue is fixed in 1.0.3 and in 1.1.0
...
3. (Updated 11/03/2025) Product usage may generate heavy database queries that can overload the database and impact production workloads. This issue is fixed in 1.0.3 and in 1.1.0
