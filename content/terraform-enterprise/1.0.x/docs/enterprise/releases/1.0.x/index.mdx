...
## Bug Fixes
1. The Terraform Enterprise API now returns the value of the x-tfe-version header in its response. This header indicates the current version of Terraform Enterprise.
