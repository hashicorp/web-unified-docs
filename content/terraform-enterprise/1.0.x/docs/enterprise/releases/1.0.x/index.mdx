...
## Known Issues
1. (Updated 10/30/2025) License reporting may generate heavy database queries that can overload the database and impact production workloads. As a workaround, set [`TFE_LICENSE_REPORTING_OPT_OUT`](/terraform/enterprise/deploy/reference/configuration#tfe_license_reporting_opt_out) to `true` to disable license reporting until this issue is resolved.
...
3. (Updated 10/30/2025) License reporting may generate heavy database queries that can overload the database and impact production workloads. As a workaround, set [`TFE_LICENSE_REPORTING_OPT_OUT`](/terraform/enterprise/deploy/reference/configuration#tfe_license_reporting_opt_out) to `true` to disable license reporting until this issue is resolved.
