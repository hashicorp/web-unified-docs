...
1. Fixes a bug in the memoization feature of the Terraform Registry which caused database resource exhaustion when Private Registry modules exceeded 300 module versions.
