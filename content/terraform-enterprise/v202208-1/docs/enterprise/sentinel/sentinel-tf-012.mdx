...
([`tfconfig`](/enterprise/sentinel/import/tfconfig),
[`tfplan`](/enterprise/sentinel/import/tfplan), and
[`tfstate`](/enterprise/sentinel/import/tfstate)) have been updated to
...
There are no explicit changes in the [`tfrun`](/enterprise/sentinel/import/tfrun) import for
Terraform 0.12, but the
[`cost_estimate` namespace](/enterprise/sentinel/import/tfrun#namespace-cost_estimate)
...
[`tfconfig`](/enterprise/sentinel/import/tfconfig) import has seen the
...
For more information, see [`references` in the `tfconfig` import](/enterprise/sentinel/import/tfconfig#references-with-terraform-0-12).
...
[`tfplan`](/enterprise/sentinel/import/tfplan) import generally behaves
the same way with Terraform 0.12 as it does with Terraform 0.11 with the
following exceptions:

1.  The behavior of unknown values within the
    [`applied`](/enterprise/sentinel/import/tfplan#value-applied) value when creating or changing resources.
...
[resource namespace](/enterprise/sentinel/import/tfplan#namespace-resources-data-sources)
...
check the
[`computed`](/enterprise/sentinel/import/tfplan#value-computed) key
within the [diff
namespace](/enterprise/sentinel/import/tfplan#namespace-resource-diff)
...
[`diff`](/enterprise/sentinel/import/tfplan#value-diff) value in the `tfplan` import is empty.
...
New [`destroy`](/enterprise/sentinel/import/tfplan#value-destroy) and
[`requires_new`](/enterprise/sentinel/import/tfplan#value-requires_new) values have been added
...
The [`tfstate`](/enterprise/sentinel/import/tfstate) import has had
...
The [output
namespace](/enterprise/sentinel/import/tfstate#namespace-outputs) is
no longer available within `tfstate`'s [module
namespace](/enterprise/sentinel/import/tfstate#namespace-module). The
...
generation](/enterprise/sentinel/mock) has also been updated to
...
1.  Follow the instructions on [configuring the Terraform version of the
    workspace](/enterprise/workspaces/settings#terraform-version) and
    ensure that it set to the latest 0.11 release.
2.  [Start a run](/enterprise/run/ui#manually-starting-runs) for the workspace
    and let it finish the plan phase.
3.  Follow the instructions to [generate mock data using the
    UI](/enterprise/sentinel/mock#generating-mock-data-using-the-ui)
...
4.  [Discard the plan](/enterprise/run/ui#confirming-or-discarding-plans).
...
data](/enterprise/sentinel/mock#using-mock-data) section of our
[mocking guide](/enterprise/sentinel/mock), the following layout will
