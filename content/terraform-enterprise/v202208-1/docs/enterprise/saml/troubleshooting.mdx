...
**Note**: Verify you are on release version 201807-2 or later, as that is the version that introduced the debugging functionality that is described in this guide. If you would like assistance with upgrading, please [contact support](/enterprise/support).
...
Enable SAML SSO by following the [configuration instructions](/enterprise/user-management/saml/configuration).
...
If you're not able to resolve the error using the steps above, [reach out to support](/enterprise/support). When contacting support, please provide:
...
- The [SAMLResponse XML document](/enterprise/user-management/saml/idp-configuration#example-samlresponse).
- A [support bundle](/enterprise/support).
