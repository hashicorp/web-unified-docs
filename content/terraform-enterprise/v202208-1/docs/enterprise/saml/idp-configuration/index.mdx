---
page_title: SAML Identity Provider Sample Authentication Request - Terraform Enterprise
description: >-
...
We provide single sign-on setup instructions for specific identity providers (IdP):

- [ADFS](/enterprise/user-management/saml/idp-configuration/adfs)
- [Azure Active Directory](/enterprise/user-management/saml/idp-configuration/aad)
- [Okta](/enterprise/user-management/saml/idp-configuration/okta)
- [OneLogin](/enterprise/user-management/saml/idp-configuration/onelogin)

## Request and response

The following shows an example request from Terraform Enterprise before sign-on and the response from the identity provider after sign-on.
