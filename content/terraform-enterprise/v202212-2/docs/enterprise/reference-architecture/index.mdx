...
- [Amazon Web Services](/enterprise/reference-architecture/aws)

- [Microsoft Azure](/enterprise/reference-architecture/azure)

- [Google Cloud Platform](/enterprise/reference-architecture/gcp)

- [VMware](/enterprise/reference-architecture/vmware)
