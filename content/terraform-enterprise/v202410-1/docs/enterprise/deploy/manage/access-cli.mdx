---
page_title: Access the Terraform Enterprise command line
description: >-
  Learn how to access the Terraform Enterprise command line, which enables you to reconfigure Terraform Enterprise, stop the application safely, and produce support bundles.
