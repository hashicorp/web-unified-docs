...
For new users on HCP Terraform, we recommend using our [configuration-free GitHub App](/terraform/enterprise/application-administration/github-app-integration) to access repositories instead.
...
2.  Click **Add a VCS provider**. The **Add VCS Provider** page appears.

3.  Select **GitHub** and then select **GitHub.com (Custom)** from the menu. The page moves to the next step.
