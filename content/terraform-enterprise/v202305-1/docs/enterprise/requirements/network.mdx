...
The metrics endpoints are optional. You can enable them in the [application settings](/terraform/enterprise/install/automated/automating-the-installer#available-settings) when you install Terraform Enterprise.
