...
-> **Note**: [Automated license utilization reporting](/terraform/enterprise/admin/application/automated-license-utilization-reporting) (which securely sends HashiCorp the minimum data required to validate license utilization) is on by default.
