...
**Note**: [Automated license utilization reporting](/terraform/enterprise/admin/application/automated-license-utilization-reporting) automatically sends data to HashiCorp to validate your license entitlements.
