...
The [Vault Transit Secret Engine](https://developer.hashicorp.com/vault/docs/secrets/transit)
...
through the [Vault transit secret engine](https://developer.hashicorp.com/vault/docs/secrets/transit),
...
[datakey generation](https://developer.hashicorp.com/vault/api-docs/secret/transit#generate-data-key) creates the encryption key material using bit material from the kernel's cryptographically secure pseudo-random
