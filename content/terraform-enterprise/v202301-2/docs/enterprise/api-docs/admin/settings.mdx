...
See [SAML Configuration](/enterprise/saml/configuration) for more details on attribute values.
...
See [SAML Configuration](/enterprise/saml/configuration) for more details.
