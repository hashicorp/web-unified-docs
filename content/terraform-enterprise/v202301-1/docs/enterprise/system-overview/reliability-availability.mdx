...
- **Storage Layer**
  ...
  - _HashiCorp Vault_ - Used for encryption of sensitive data. There are
    ...
    [key material](https://developer.hashicorp.com/vault/docs/concepts/seal) and
    [storage backend data](https://developer.hashicorp.com/vault/docs/configuration/storage).
...
-> **NOTE:** Customers running an [optional external Vault cluster](/enterprise/requirements/data-storage/vault) are
