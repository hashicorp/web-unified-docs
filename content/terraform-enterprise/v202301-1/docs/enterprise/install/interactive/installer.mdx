...
-> **Important:** Before you begin, consult the [Pre-Install Checklist](/enterprise/install/pre-install-checklist) for prerequisites. You'll need to prepare data files and a Linux instance.
