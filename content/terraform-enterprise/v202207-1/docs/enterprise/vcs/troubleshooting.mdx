...
6.  [Delete each affected module](/enterprise/api-docs/modules#delete-a-module), then [create a new module](/enterprise/api-docs/modules#publish-a-private-module-from-a-vcs) from the new connection's version of the relevant repo.
