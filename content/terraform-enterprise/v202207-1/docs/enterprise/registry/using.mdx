...
-   **Authentication:** If you run Terraform on the command line, you must [authenticate](/enterprise/registry/using#authentication) to Terraform Cloud or your Terraform Enterprise instance to use providers and modules in your organization’s private registry.
