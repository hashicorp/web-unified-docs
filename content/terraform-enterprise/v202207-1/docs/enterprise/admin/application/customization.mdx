...
![screenshot: the Settings admin page](/img/docs/admin-customization.png)
...
![screenshot: where the error instructions appear](/img/docs/admin-error-message-customization.png)
...
![screenshot: where the login help content appears](/img/docs/admin-login-help-customization.png)
...
![screenshot: where the new user instructions appear](/img/docs/admin-new-user-customization.png)
...
![screenshot: where the footer content appears](/img/docs/admin-footer-customization.png)
