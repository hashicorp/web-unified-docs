...
- Ensure you are familiar with Terraform Enterprise's operation and [installation requirements](/enterprise/install/pre-install-checklist), and especially the [Operational Mode Decision](/enterprise/before-installing/#operational-mode-decision).
