---
page_title: Private Provider Versions and Platforms - API Docs - Terraform Enterprise
description: >-
...
The private registry does not automatically update private providers when you release new versions. You must use this endpoint to add each new version. Consumers cannot use new versions until you upload all [required release files](/enterprise/registry/publish-providers#release-files) and [Create a Provider Platform](#create-a-provider-platform).
