...
You can create a GitHub App installations using the HCP Terraform UI. Learn how to [create a GitHub App installation](/terraform/enterprise/application-administration/github-app-integration).
