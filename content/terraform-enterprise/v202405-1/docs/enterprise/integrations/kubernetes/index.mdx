...
The [Terraform Cloud Operator for Kubernetes](https://github.com/hashicorp/terraform-cloud-operator) allows you to manage HCP Terraform resources with Kubernetes custom resources. You can provision infrastructure internal or external to your Kubernetes cluster directly from the Kubernetes control plane. 
...
The Terraform Cloud operator for Kubernetes v2 offers several improvements over v1:
...
The Terraform Cloud Operator for Kubernetes allows you to create agent pools, deploy modules, and manage workspaces through Kubernetes controllers. These controllers enable you to automate and manage HCP Terraform resources using custom resources in Kubernetes.

### Agent pools

Agent pools in HCP Terraform manage the execution environment for Terraform runs. The Terraform Cloud operator for Kubernetes allows you to create and manage agent pools as part of your Kubernetes infrastructure.
...
HCP Terraform workspaces organize and manage Terraform configurations. The Terraform Cloud Operator for Kubernetes allows you to create, configure, and manage workspaces directly from Kubernetes.
