...
required, using [policy sets](/terraform/enterprise/policy-enforcement/manage-policy-sets) to only enforce the policy on non-development workspaces is more appropriate.
