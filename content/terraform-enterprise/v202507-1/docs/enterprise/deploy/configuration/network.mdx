...
last_modified: 2025-07-25T08:23:42+02:00
...
- `https://images.releases.hashicorp.com`: Hosts Terraform Enterprise release container images.
...
- Terraform Enterprise does not require ongoing direct access from the application host to `images.releases.hashicorp.com` or the Amazon S3 endpoints that back it.
- If you pull the image directly from the public release registry, the download may be served from one of the following Amazon S3 endpoints:
...
- Refer to the applicable Public Availability Override (PAO) process for approved image delivery and mirroring workflows when your organization requires it.
