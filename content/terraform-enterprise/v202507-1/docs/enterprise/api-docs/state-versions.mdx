...
| `data.relationships.hyok-encrypted-data-key.id`   | string  | (nothing) | **Optional** A reference to the HYOK encrypted data key that should secure this State Version if HYOK is enabled in the workspace.                                                                                                                                                                                                                    |
