...
| `data.attributes.hyok-enabled`                          | boolean         | `false`                     | Whether this workspace will secure Terraform artifacts using Hold Your Own Key (HYOK) encryption. Once enabled, this can not be disabled                                                                                                                                                                                                                                                                                                                                                                                 |
