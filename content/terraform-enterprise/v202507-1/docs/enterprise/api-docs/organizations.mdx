...
| `data.attributes.enforce-hyok`                                            | boolean | false            | Whether or not new workspaces within the org will be created with HYOK (Hold Your Own Key) enabled. Your organization must have a primary HYOK configuration before enabling `enforce-hyok`.                                                                                                                                                                                      |
