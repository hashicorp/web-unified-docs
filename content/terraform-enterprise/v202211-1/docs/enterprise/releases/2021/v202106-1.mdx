...
* Changed Terraform Cost Estimation to use the new, free Azure pricing API. This changes the [Azure egress hostname](/enterprise/requirements/network#prices-azure-com) to `prices.azure.com`.
...
* Updated [Registry Module APIs](/cloud-docs/api-docs/private-registry/modules).
  ...
  * updated [Module Delete APIs](/cloud-docs/api-docs/private-registry/modules#delete-a-module).
