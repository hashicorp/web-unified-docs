...
You can add providers and modules through the UI as detailed below or through the [Registry Providers API](/enterprise/api-docs/providers) and the [Registry Modules API](/enterprise/api-docs/modules#create-a-module-with-no-vcs-connection-).
...
3.  Enter any combination of namespaces (e.g. hashicorp), and module or provider names into the search field. You can click **Providers** and **Modules** to toggle between lists of providers and modules that meet the search criteria.
...
3.  Enter the provider or module name in the dialog box to confirm and then click **Remove** (providers) or **Delete** (modules). The provider or module is removed from the organization's private registry.
