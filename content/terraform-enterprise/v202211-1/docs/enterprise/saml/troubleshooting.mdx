...
Enable SAML SSO by following the [configuration instructions](/enterprise/saml/configuration).
...
- The [SAMLResponse XML document](/enterprise/saml/idp-configuration#example-samlresponse).
