...
To get started, follow the instructions in the [Terraform Cloud integration](https://www.tines.com/story-library/102061/respond-to-configure-terraform-cloud-run-task) user documentation.
