...
A new project page opens that displays information about the project.
...
!> **Warning:** Automatic destroy plans _do not_ prompt you for apply approval in the user interface. We recommend only using this setting for development environments.
