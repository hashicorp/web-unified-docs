...
Additionally, all of the port numbers are configurable via the configuration reference environment variables. See [Configuration Reference](/terraform/enterprise/flexible-deployments/install/configuration) for details.
