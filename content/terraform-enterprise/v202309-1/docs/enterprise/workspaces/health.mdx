...
Terraform Enterprise administrators can modify their installation's [assessment frequency and number of maximum concurrent assessments](/terraform/enterprise/application-administration/general#health-assessments) from the admin settings console.
