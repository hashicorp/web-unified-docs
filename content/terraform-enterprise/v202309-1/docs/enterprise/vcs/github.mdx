...
description: >-
  Learn how to use GitHub.com for VCS features, using a per-organization OAuth
...
For beginning users on Terraform Cloud, we recommend using our [configuration-free GitHub App](/terraform/enterprise/application-administration/github-app-integration) to access repositories instead.

<!-- END: TFC:only -->

For Terraform Enterprise site-admins, you can create your own [GitHub App](/terraform/enterprise/application-administration/github-app-integration) to access repositories.
...
3.  Select **GitHub** and then select **GitHub.com** from the menu. The page moves to the next step.
...
5.  <a href="/img/docs/tfe_logo.png" download>
      Download this image of the Terraform logo
    </a>
    , upload it with the "Upload new logo" button or the drag-and-drop target,
    and set the badge background color to `#5C4EE5`. This optional step helps
    you identify Terraform Cloud's pull request checks at a glance.
