...
1. Added functionality to the [backup and restore API](/terraform/enterprise/replicated/administration/infrastructure/backup-restore) that lets Terraform Enterprise skip backing up the object storage data.
