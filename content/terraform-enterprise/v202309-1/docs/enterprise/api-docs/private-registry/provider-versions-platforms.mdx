...
description: >-
  Use the `/registry-providers` to manage private providers in your private
  registry. Create, get, and delete versions, and create, get, and delete
