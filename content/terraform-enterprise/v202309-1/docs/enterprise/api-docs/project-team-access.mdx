...
-> **Note:** Team management is available in Terraform Cloud **Standard** Edition. [Learn more about Terraform Cloud pricing](https://www.hashicorp.com/products/terraform/pricing).
