...
- Only pull requests that originate from within the same repository can trigger speculative plans.
  ...
  -> **Note:** On Terraform Enterprise, administrators can choose to allow speculative plans on pull requests that originate from forks. To learn more about this setting, refer to the [general settings documentation](/terraform/enterprise/application-administration/general#allow-speculative-plans-on-pull-requests-from-forks)
