...
You can create a GitHub App installations using the Terraform Cloud UI. Learn how to [create a GitHub App installation](/terraform/enterprise/admin/application/github-app-integration).
