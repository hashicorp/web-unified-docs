...
> **Hands On:** Try the [Manage Variable Sets in Terraform Cloud tutorial](/terraform/tutorials/cloud/cloud-multiple-variable-sets) tutorial.
...
4.  Choose a variable set scope:
    -   **Apply globally:** Terraform Cloud will automatically apply this global variable set to all existing and future workspaces.
