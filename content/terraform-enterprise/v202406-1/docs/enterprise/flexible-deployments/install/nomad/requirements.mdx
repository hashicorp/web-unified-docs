...
- We recommend Nomad v1.5.0 and newer.
- You can deploy to Nomad v1.4.x and older by modifying the Terraform Enterprise job specification. Refer to [Configure Terraform Enterprise Nomad job specification](/terraform/enterprise/flexible-deployments/install/nomad/install#configure-terraform-enterprise-nomad-job-specification) for additional information.
