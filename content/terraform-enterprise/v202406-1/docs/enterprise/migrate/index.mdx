---
page_title: Migrating to Terraform Enterprise or HCP Terraform - Terraform Enterprise
description: >-
  Learn how to migrate existing Terraform state files to Terraform Enterprise or
  HCP Terraform to manage existing infrastructure without
  de-provisioning.
