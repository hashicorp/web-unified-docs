...
[these instructions](/terraform/enterprise/replicated/administration/infrastructure/automated-recovery). For the data types that do
...
Configure snapshot and restore by following the [automated recovery instructions](/terraform/enterprise/replicated/administration/infrastructure/automated-recovery).
...
-> **NOTE:** Customers running an [optional external Vault cluster](/terraform/enterprise/replicated/install/vault) are
