...
We strongly recommend the following:
 - Create a backup copy of the storage prior to upgrading your instance. Backup and restore responsibility varies depending on your Terraform Enterprise [operation mode](/enterprise/system-overview/reliability-availability#operation-modes).
 - Review the general [Terraform Enterprise requirements](https://www.terraform.io/enterprise/requirements/credentials), including credentials, hardware, operating system, data storage, and network. 
 - Review the upgrade requirements and release notes for the specific [Terraform Enterprise release](https://www.terraform.io/enterprise/releases).
