---
page_title: Annotations and Labels used by Terraform Enterprise Operator for Kubernetes
description: >-
  Full list of annotations and labels used by the Terraform Enterprise Operator
  for Kubernetes.
