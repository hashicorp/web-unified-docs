---
page_title: Configure operational mode for Terraform Enterprise installation
description: Learn how to specify the operational mode for your Terraform Enterprise deployment. The operational mode determines how Terraform stores the data, which affects procedures for ensuring resilience and scalability.
