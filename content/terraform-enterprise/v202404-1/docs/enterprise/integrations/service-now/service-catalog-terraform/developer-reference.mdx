...
| Create Run                    | Creates/queues a new run on the HCP Terraform workspace.                                                                                                                   |
| Apply Run                     | Applies a run on the HCP Terraform workspace.                                                                                                                              |
| Provision Resources           | Creates an HCP Terraform workspace (with auto-apply), creates/queues a run, applies the run when ready.                                                                     |
| Provision Resources with Vars | Creates an HCP Terraform workspace (with auto-apply), creates any variables, creates/queues a run, applies the run when ready.                                              |
