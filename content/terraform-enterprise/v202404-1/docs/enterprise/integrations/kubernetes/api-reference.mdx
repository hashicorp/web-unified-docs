...
Agent Token is a secret token that a Terraform Cloud agent uses to connect to the Terraform Cloud agent pool. Only the `Name` field is allowed in the `spec`  block. The other fields are used in `status`. [More information](/terraform/cloud-docs/agents)
...
| `agentPool` _[WorkspaceAgentPool](#workspaceagentpool)_          | Terraform Cloud agents allow HCP Terraform to communicate with isolated, private, or on-premises infrastructure. [More information](/terraform/cloud-docs/agents)                                                                                                                                                                                                                                                                |
