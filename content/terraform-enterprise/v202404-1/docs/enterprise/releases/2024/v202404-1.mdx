...
~> The v202404-1 release has been pulled and is unavailable to download due to a breaking bug. If you have already installed this release, we recommend restoring the previously installed version. A patch release of v202404-2 is expected the week of April 28th.
...
1. [Updated April 30, 2024] Customers that use S3 for backend blob storage should not upgrade to this release. The application will start, but will be unable to read or write data from the blob storage. A fix is available in v202404-2.
1. [Updated April 30, 2024] If your encryption password contains certain special characters (e.g. backslash, dollar sign, grave accent, double quotation, exclamation and tilde) the application will not start successfully and will log errors decrypting vault. A fix is available in v202404-2.
1. [Updated April 30, 2024] Customers that use TFE with an external vault server are unable to refresh application tokens. This is fixed in v202404-2.
1. [Updated April 30, 2024] The global run tasks feature is missing. This is fixed in v202404-2.
1. [Updated April 30, 2024] The private registry is unable to list module versions. A fix is available in v202404-2.
1. [Updated April 30, 2024] The footer shows `dev` instead of the application version. This is corrected in v202404-2.s
