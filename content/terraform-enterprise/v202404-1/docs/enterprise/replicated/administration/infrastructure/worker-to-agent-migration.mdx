...
image](/terraform/enterprise/replicated/install/interactive/installer#legacy) Terraform
...
image](/terraform/enterprise/replicated/install/interactive/installer#agent). If your
legacy custom image also [executes custom
scripts](/terraform/enterprise/replicated/install/interactive/installer#executing-custom-scripts),
...
image](/terraform/enterprise/replicated/install/interactive/installer#custom-image)
...
short-lived [Docker
containers](/terraform/enterprise/replicated/architecture/system-overview/security-model#terraform-enterprise-isolates-terraform-operations-via-docker-containers).
...
- You can now access previously inaccessible run logs (Sentinel, cost
  ...
  [Terraform Enterprise log forwarding](/terraform/enterprise/replicated/monitoring/logging).
...
| Required software             | The image must contain the software packages defined [here](/terraform/enterprise/replicated/install/interactive/installer#requirements).                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Certificates                  | The `/usr/local/share/ca-certificates` directory must contain all necessary PEM-encoded CA certificates. Each file added to this directory must end with the `.crt` extension. Terraform Enterprise will not automatically add the CA certificates configured in the CA Bundle settings to the image at runtime. | The `/usr/local/share/ca-certificates` directory must contain all necessary PEM-encoded CA certificates. Each file added to this directory must end with the `.crt` extension. Terraform Enterprise will not automatically add the CA certificates configured in the CA Bundle settings to the image at runtime. <br/><br/> This will be similar to the certificate config in this [Dockerfile example](/terraform/enterprise/replicated/install/interactive/installer#ubuntu). |
