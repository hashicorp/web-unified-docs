...
When you create a new run task, you can choose to apply it globally to every workspace in an organization. This feature requires the **global-run-task** [entitlement][].
...
4.  Choose when HCP Terraform should start the run task:
