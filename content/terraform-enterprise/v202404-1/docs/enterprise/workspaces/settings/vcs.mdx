...
This designates which branch of the repository HCP Terraform should use in the workspace. If left blank, HCP Terraform uses the repository's default branch.
