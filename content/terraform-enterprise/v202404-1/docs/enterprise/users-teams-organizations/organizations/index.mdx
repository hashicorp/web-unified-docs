...
You can leave an organization from your user account settings. Refer to [Account Settings: Organizations](/terraform/enterprise/users-teams-organizations/users#organizations) for details.
