...
[these instructions](/terraform/enterprise/admin/infrastructure/automated-recovery). For the data types that do
...
Configure snapshot and restore by following the [automated recovery instructions](/terraform/enterprise/admin/infrastructure/automated-recovery).
...
-> **NOTE:** Customers running an [optional external Vault cluster](/terraform/enterprise/requirements/data-storage/vault) are
