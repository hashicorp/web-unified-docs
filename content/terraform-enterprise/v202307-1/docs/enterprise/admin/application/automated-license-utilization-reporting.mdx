...
last_modified: 2026-04-06T18:25:11.000Z
...
Upgrade to Terraform Enterprise [v202305-01](/terraform/enterprise/releases/2023/v202305-1) or later.

### 3. Check logs

Automatic license utilization reporting will start sending data within 24 hours. [Check the product logs](/terraform/enterprise/admin/infrastructure/monitoring#monitoring-a-terraform-enterprise-instance) for records that the data sent successfully.
