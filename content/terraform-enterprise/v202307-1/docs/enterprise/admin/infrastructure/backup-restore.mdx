...
> **Note:** This page covers the technical details of the Backup and Restore API. For best practices read our recommended patterns, which cover the [backup](/terraform/tutorials/recommended-patterns/pattern-backups) and [restore](/terraform/tutorials/recommended-patterns/pattern-recovery) processes.
