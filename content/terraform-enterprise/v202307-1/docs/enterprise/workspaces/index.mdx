...
-> **Note:** On Terraform Cloud **Standard** Edition, you can assign project permissions to scope access to collections of workspaces based on business units and responsibilities. Refer to [Terraform Cloud pricing](https://www.hashicorp.com/products/terraform/pricing) for details.
