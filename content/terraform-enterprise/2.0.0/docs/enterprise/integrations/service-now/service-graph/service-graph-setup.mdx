...
last_modified: 2025-08-07T22:28:02.000Z
...
2.  Choose **Specific MID sever** from the **MID Selection** dropdown.
3.  Select your previously configured and validated MID server.
