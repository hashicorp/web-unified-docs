...
6.  If your flow has a **Approval Step**, open the **Ask for Approval** action and customize it by adding your approver and due date.
    This approver must have the **approver_user** role in order to approve requests.
    ![Screenshot: ServiceNow Update Process Engine](/img/docs/servicenow-catalog-approval-flow.png "Screenshot of how to customize ask for approval action")
...
2.  **Worker Poll Destroy Workspace**
3.  **Worker Poll Run State** 
