...
created_at: 2025-05-27T18:28:51.000Z
last_modified: 2025-11-13T18:38:10.000Z
...
| `organization` _string_                     | Organization name where the Workspace will be created. [More information](/terraform/enterprise/users-teams-organizations/organizations). |
| `token` _[Token](#token)_                   | API Token to be used for API calls.                                                                                                       |
| `agentPool` _[AgentPoolRef](#agentpoolref)_ | The Agent Pool name or ID from which the controller will collect runs. [More information](/terraform/enterprise/run/states).              |
