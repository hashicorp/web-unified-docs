...
You can explicitly set your workspace execution mode to **Agent** or configure your workspace to inherit an execution mode from [project settings](/terraform/enterprise/projects#execution-mode) or [organization settings](/terraform/enterprise/users-teams-organizations/organizations#organization-settings).    
