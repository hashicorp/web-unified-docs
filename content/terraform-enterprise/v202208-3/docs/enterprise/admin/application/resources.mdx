...
![screenshot: the Users admin page](/img/docs/admin-users.png)
...
![screenshot: a user detail admin page](/img/docs/admin-user-details.png)
...
![screenshot: the impersonation button on a 404 page, as viewed by an admin](/img/docs/admin-404-impersonate.png)
...
![screenshot: an organization details admin page](/img/docs/admin-organization-details.png)
...
![screenshot: the Terraform Versions admin page](/img/docs/admin-versions.png)
...
![screenshot: the Add Terraform Version page](/img/docs/admin-version-add.png)
