...
Cost Estimation integration allows Terraform Enterprise to estimate costs for resources during a run. Refer to the [usage instructions](/enterprise/cost-estimation).
...
![screenshot: the Cost Estimation admin page](/img/docs/admin-cost-estimation.png)
...
-> **Note:** Since enabling SAML is an involved process, there is a [separate SAML section of the documentation](/enterprise/user-management/saml). Consult those pages for detailed requirements and configuration instructions for both Terraform Enterprise and your IdP.
...
![screenshot: the SMTP admin page](/img/docs/admin-smtp.png)
...
![screenshot: the Twilio admin page](/img/docs/admin-twilio.png)
