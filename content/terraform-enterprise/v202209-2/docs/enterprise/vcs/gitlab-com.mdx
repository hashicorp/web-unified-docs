...
These instructions are for using GitLab.com for Terraform Cloud's VCS features. [GitLab CE and GitLab EE have separate instructions,](/enterprise/vcs/gitlab-eece) as do the [other supported VCS providers.](/enterprise/vcs)
...
3.  Locate the "Redirect URI" and copy it to your clipboard; you'll paste it in the next step.
