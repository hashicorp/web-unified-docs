...
We strongly recommend the following:
 ...
 - Review the general [Terraform Enterprise requirements](/enterprise/requirements/credentials), including credentials, hardware, operating system, data storage, and network. 
