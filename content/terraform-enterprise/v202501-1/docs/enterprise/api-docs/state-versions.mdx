...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `billable-rum-count`             | Count of billable Resources Under Management (RUM). Only present for organization members on [HCP Terraform RUM plans](/terraform/cloud-docs/overview/estimate-hcp-terraform-cost#what-is-a-managed-resource) with visibility of billable RUM usage.                                                                                                |
