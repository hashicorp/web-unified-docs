...
description: >-
  Use this log of Terraform Enterprise API changes to track new
...
- Clarifies tag-bindings and effective-tag-bindings on [workspaces](/terraform/enterprise/api-docs/workspaces) and [projects](/terraform/enterprise/api-docs/projects)
- Add new documentation for `PATCH`ing tag bindings on [projects](/terraform/enterprise/api-docs/projects) and [workspaces](/terraform/enterprise/api-docs/workspaces).
...
-   Introduced Workspace Tagging
    ...
    -   Added `tags` attribute to [`tfrun`](/terraform/enterprise/policy-enforcement/import-reference/tfrun)
