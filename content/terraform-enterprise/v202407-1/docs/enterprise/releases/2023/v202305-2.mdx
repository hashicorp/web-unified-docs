...
1. Added [automated license utilization reporting](/terraform/enterprise/replicated/administration/license/automated-license-utilization-reporting), which sends minimal product-license metering data to HashiCorp without requiring you to manually collect and report them.
