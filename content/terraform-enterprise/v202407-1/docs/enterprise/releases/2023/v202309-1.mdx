...
## Highlights
1. Terraform Enterprise now supports more [flexible deployment options](/terraform/enterprise/flexible-deployments). You can deploy Terraform Enterprise with cloud-managed Kubernetes services (Amazon EKS, Azure AKS, and Google Cloud GKE) using helm, or with Docker Engine using Docker Compose.
