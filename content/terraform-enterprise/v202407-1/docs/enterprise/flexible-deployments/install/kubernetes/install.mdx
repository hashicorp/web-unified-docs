---
page_title: Installation on Kubernetes & OpenShift - Flexible Deployment Options - Terraform Enterprise
description: >-
...
## 1. Requirements
  ...
  1. Before installing, ensure you meet the [shared requirements](/terraform/enterprise/flexible-deployments/install/requirements/) for all flexible deployment methods and the [requirements for Kubernetes and OpenShift deployments](/terraform/enterprise/flexible-deployments/install/kubernetes/requirements).
