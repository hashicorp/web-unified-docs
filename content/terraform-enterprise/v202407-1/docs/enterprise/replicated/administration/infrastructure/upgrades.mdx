...
- Review the [Upgrading Terraform Enterprise or Patching Terraform Enterprise Node Instances](/terraform/enterprise/replicated/administration/infrastructure/admin-cli#upgrading-tfe-or-patching-tfe-node-instances) for your Terraform Enterprise active/active architecture.
