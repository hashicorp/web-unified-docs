...
<EnterpriseAlert>
Data retention policies are exclusive to Terraform Enterprise and unavailable in Terraform Cloud. <a href="https://developer.hashicorp.com/terraform/enterprise">Learn more about Terraform Enterprise</a>.
</EnterpriseAlert>
