...
For more information on using a GitHub App and GitHub Permissions in Terraform Cloud, see [GitHub Permissions in Terraform Cloud](/terraform/cloud-docs/application-administration/github-app-integration#github-permissions).
