...
3.  [Create a test on the module](#create-a-test-run); Terraform Cloud completes this step automatically when you upload a configuration file.
...
| Source                      | Description                                                                              |
| --------------------------- | ---------------------------------------------------------------------------------------- |
| `terraform`                 | Indicates a test was queued from Terraform Cloud CLI.                                    |
| `tfe-api`                   | Indicates a test was queued from Terraform Cloud API.                                    |
...
| `data.relationships.configuration-version.data.id` | string               | none          | Specifies the configuration version that Terraform Cloud executes the test against.                |
