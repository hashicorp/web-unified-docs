---
page_title: API Changelog for Terraform Enterprise and Terraform Enterprise
page_id: api-changelog
description: >-
  Use this log of Terraform Enterprise and Enterprise API changes to track new
  features and evolving functionality over time.
...
-   Clarifies listing tag-bindings and effective-tag-bindings on [Workspaces](/terraform/enterprise/api-docs/workspaces) and [Projects](/terraform/enterprise/api-docs/projects)
-   Adds new documentation for PATCHing tag bindings on [Projects](/terraform/enterprise/api-docs/projects)/[Workspaces](/terraform/enterprise/api-docs/workspaces)
...
-   Add new properties to limit run tasks and policies for the Terraform Cloud free tier. We updated the [entitlement set](/terraform/enterprise/api-docs/organizations#show-the-entitlement-set), [feature set](/terraform/enterprise/api-docs#feature-entitlements#sample-response), and [subscription](/terraform/enterprise/api-docs/subscriptions#sample-response) endpoints with the following properties:
    -   `run-task-limit`
...
-   Updated [Feature Sets](/terraform/enterprise/api-docs#feature-entitlements#list-feature-sets) to add new `run-tasks` attribute.
...
-   Added pagination support to the following endpoints:
    -   [Feature Sets](/terraform/enterprise/api-docs#feature-entitlements#list-feature-sets) - `GET /feature-sets`
    ...
    -   [Organization Feature Sets](/terraform/enterprise/api-docs#feature-entitlements#list-feature-sets-for-organization) - `GET /organizations/:organization_name/feature-sets`
