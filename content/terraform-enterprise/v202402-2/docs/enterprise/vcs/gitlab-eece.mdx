...
2.  Click **Connect and continue.** This takes you to a page on GitLab asking whether you want to authorize the app. If this results in a 500 error, it usually means HCP Terraform was unable to reach your GitLab instance.
