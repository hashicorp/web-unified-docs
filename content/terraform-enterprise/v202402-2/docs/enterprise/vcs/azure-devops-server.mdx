...
3.  Select **Azure DevOps** and then select **Azure DevOps Server** from the menu. The page moves to the next step.
...
## Step 3: On HCP Terraform, Add the Personal Access Token
...
## Step 4: On Workstation, Create an SSH Key for HCP Terraform
...
## Step 6: On HCP Terraform, Add SSH Private Key
