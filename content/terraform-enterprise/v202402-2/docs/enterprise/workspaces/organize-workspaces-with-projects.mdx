...
You must be a member of a team with **Manage all projects** and **Manage all workspaces** [organization-level permissions](/terraform/enterprise/users-teams-organizations/permissions#organization-permissions) permissions to create a project.
...
1.  Click **Projects & workspaces**.
2.  Click the left chevron icon next to **Workspaces** to open the project drawer.
3.  Click the project you want to review. HCP Terraform now displays only the workspaces in the selected project.
...
HCP Terraform will return to the **Projects and workspaces** view with the deleted project removed from the list.
