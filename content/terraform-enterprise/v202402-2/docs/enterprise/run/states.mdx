...
Each run passes through several stages of action (pending, plan, cost estimation, policy check, apply, and completion), and HCP Terraform shows the progress through those stages as run states.
