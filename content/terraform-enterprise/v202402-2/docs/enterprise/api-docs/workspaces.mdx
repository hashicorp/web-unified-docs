...
[Terraform Cloud agents](/terraform/enterprise/api-docs/agents) are a solution to allow HCP Terraform to communicate with isolated, private, or on-premises infrastructure.
