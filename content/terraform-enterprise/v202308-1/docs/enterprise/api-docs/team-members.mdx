...
description: >-
  Use the team membership API to manage a team's users. Add and remove a user
...
-> **Note:** Team management is available in Terraform Cloud **Standard** Edition. Free organizations can also use this API, but can only manage membership of their owners team. [Learn more about Terraform Cloud pricing here](https://www.hashicorp.com/products/terraform/pricing).
