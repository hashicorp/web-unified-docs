...
* A [supported version](/terraform/enterprise/requirements/os-specific/supported-os) of CentOS.
...
profile](/terraform/enterprise/install/pre-install-checklist#option-3-docker-engine-using-a-modified-libseccomp-profile).
