...
mode](/terraform/enterprise/install/pre-install-checklist#opearational-mode-decision). For example,
...
For Redis version compatibility requirements, see the Terraform Enterprise [operational mode requirements](/terraform/enterprise/requirements/data-storage/operational-mode-requirements#active-active-mode).
