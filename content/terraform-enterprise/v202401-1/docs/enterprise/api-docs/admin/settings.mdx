...
## List Data Retention Policy Settings

`GET /api/v2/admin/data-retention-policy-settings`

| Status  | Response                                           | Reason                               |
| ------- | -------------------------------------------------- | ------------------------------------ |
| [200][] | [JSON API document][] (`type: "data-retention-policy-settings"`) | Successfully listed the data retention policy settings |
| [404][] | [JSON API error object][]                          | User unauthorized to perform action  |
...
curl \
  ...
  --header "Content-Type: application/vnd.api+json" \
  --request GET \
  https://app.terraform.io/api/v2/admin/data-retention-policy-settings
```
...
```json
{
  "data": {
    ...
    "type": "data-retention-policy-settings",
    "attributes": {
      "delete-older-than-n-days": 11
    }
  }
}
```
...
`PATCH /api/v2/admin/data-retention-policy-settings`

| Status  | Response                                           | Reason                                                         |
| ------- | -------------------------------------------------- | -------------------------------------------------------------- |
| [200][] | [JSON API document][] (`type: "data-retention-policy-settings"`) | Successfully updated the data retention policy settings                      |
| [404][] | [JSON API error object][]                          | User unauthorized to perform action                            |
| [422][] | [JSON API error object][]                          | Malformed request body (missing attributes, wrong types, etc.) |
...
| Key path                                                                  | Type    | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------- | ------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `data.attributes.delete-older-than-n-days`                                | integer | `0`     | Specifies the number of days before a data object is marked for garbage collection. You cannot set the value to less than `0`. To learn more about data retention policies, refer to the [data retention policy documentation][]                                                                                                                                                                                                                             |

[data retention policy documentation]: /terraform/enterprise/application-administration/general#data-retention-policies
