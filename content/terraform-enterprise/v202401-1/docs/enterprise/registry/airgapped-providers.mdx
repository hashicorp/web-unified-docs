---
page_title: Publishing Public Providers in Airgapped Terraform Enterprise - Private Registry
description: >-
...
- Do not upload your public GPG key. Instead, use HashiCorp's public key, which Terraform Enterprise version v202309-1 and newer includes by default. The key ID is `34365D9472D7468F`, and you can verify the ID by [importing the public key locally](/terraform/tutorials/cli/verify-archive#download-and-import-hashicorp-s-public-key).