---
page_title: >-
  Overview - ServiceNow Service Graph Connector for Terraform Integration -
...
Use the Service Graph Connector for Terraform to securely import Terraform Cloud resources into your ServiceNow instance. The ServiceNow Service Graph for Terraform is a certified scoped application available in the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/application/0b0600891b52c150c216ebd56e4bcb32).
...
The [resource mapping](/terraform/enterprise/integrations/service-now/service-graph/resource-coverage) documentation contains tables detailing the mapping of objects and attributes between Terraform Cloud and ServiceNow CMDB.
