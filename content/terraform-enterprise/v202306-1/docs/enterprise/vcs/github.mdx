...
For beginning users on Terraform Cloud, we recommend using our [configuration-free GitHub App](/terraform/enterprise/admin/application/github-app-integration) to access repositories instead.
