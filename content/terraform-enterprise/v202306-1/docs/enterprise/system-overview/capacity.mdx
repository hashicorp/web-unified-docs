...
the [application settings JSON file when using the automated install procedure](/terraform/enterprise/install/automated/automating-the-installer#available-settings).
