...
-> **Note:** Refer to [Microsoft's documentation](https://learn.microsoft.com/en-us/exchange/client-
developer/legacy-protocols/how-to-authenticate-an-imap-pop-smtp-application-by-using-oauth) for
instructions on registering the application in Microsoft Entra and configuring the necessary mailbox
settings.
