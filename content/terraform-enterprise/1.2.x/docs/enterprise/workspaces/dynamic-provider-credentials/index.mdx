...
last_modified: 2026-09-23T02:52:18.000Z
...
-   [Tencent Cloud](/terraform/enterprise/dynamic-provider-credentials/tencentcloud-configuration)
...
-   [Tencent Cloud](/terraform/enterprise/dynamic-provider-credentials/tencentcloud-configuration#required-environment-variables): `TFC_TENCENTCLOUD_RUN_ROLE_ARN`
