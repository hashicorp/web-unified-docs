...
1. [Perform diagnostics](/terraform/enterprise/deploy/troubleshoot/perform-diagnostics), such as checking service health status and logs and enabling debug mode on Kubernetes. 
