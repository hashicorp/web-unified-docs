...
| ----------------- | ------------------------------------------------------------------- |
| License  | Validates TFE license file format and ensures it is not expired |
| Config  | Validates semantic correctness of TFE configuration including operational mode settings, database configuration and object storage configuration |
...
| Vault  | Validates Vault health endpoint connectivity |
