...
curl \
  --request GET \
  "https://tfe.example.com:8443/api/v1/health/readiness?timeout=5"
```
...
| --- | --- | --- |
| [200][] | JSON or plain text | Terraform Enterprise is ready |
| [400][] | JSON error | Invalid timeout parameter |
| [503][] | JSON or plain text | Terraform Enterprise is not ready or draining |