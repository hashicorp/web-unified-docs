...
You can deploy Terraform Enterprise to cloud-hosted or cloud-managed Kubernetes instances, self-managed instances, and bare metal installations. When deploying to self-managed Kubernetes clusters, you are responsible for managing Terraform Enterprise's operating environment.

Terraform Enterprise supports the following cloud-managed Kubernetes environments:
