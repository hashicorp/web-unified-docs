...
Policy evaluations are run within the [Terraform Cloud Agents](/terraform/enterprise/api-docs/agents) in Terraform Cloud's infrastructure. Policy evaluations do not have access to cost estimation data.
