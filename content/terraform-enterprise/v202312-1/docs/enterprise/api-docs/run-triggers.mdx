...
description: >-
  Use the `/run-triggers` endpoint to manage run triggers. List, show, create,
...
| Parameter         | Description                                                                          |
| ----------------- | ------------------------------------------------------------------------------------ |
| `:run_trigger_id` | The ID of the run trigger to show. Use the [List Run Triggers](#list-run-triggers) endpoint to find IDs. |
...
| Parameter         | Description                                                                            |
| ----------------- | -------------------------------------------------------------------------------------- |
| `:run_trigger_id` | The ID of the run trigger to delete. Use the [List Run Triggers](#list-run-triggers) endpoint to find IDs. |
