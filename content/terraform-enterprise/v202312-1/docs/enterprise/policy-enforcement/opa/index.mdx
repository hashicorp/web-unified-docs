...
The following example policy called `block_auto_apply_runs` checks whether or not a Terraform Cloud workspace has been configured to automatically apply a successful Terraform plan.
...
| `created_by`    | String                                                                                           | A string that specifies the user name of the Terraform Cloud user for the specific run.                                                                                                                                                                                                                                                                                                                       |
