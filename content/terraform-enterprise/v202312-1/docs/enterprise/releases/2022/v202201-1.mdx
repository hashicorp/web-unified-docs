...
1. The [new `tfe-admin rotate-encryption-password` command](/terraform/enterprise/replicated/administration/infrastructure/admin-cli) rotates the encryption password on active/active installations of Terraform Enterprise.
