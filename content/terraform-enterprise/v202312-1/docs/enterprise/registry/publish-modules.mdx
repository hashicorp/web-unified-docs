...
-   To change from tag-based to branch-based publishing, you must configure a **Module branch** and [create a new module version](#branch-based-publishing-workflow). This is because Terraform Cloud does not automatically create new module versions.
