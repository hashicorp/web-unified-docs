...
The Terraform Versions Admin API lets site administrators manage which versions of Terraform are available to the HCP Terraform users within their enterprise.
