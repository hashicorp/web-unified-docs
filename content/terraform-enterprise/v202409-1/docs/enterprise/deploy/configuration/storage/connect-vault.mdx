...
description: Learn how to configure Terraform Enterprise to connect to an external Vault server so that your Terraform Enterprise instances can meet data encryption and auditing compliance requirements.
