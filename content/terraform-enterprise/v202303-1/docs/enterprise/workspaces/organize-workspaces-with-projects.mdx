...
You must be a member of a team with the **Manage Projects & Workspaces** [organization-level permissions](/terraform/enterprise/users-teams-organizations/permissions#organization-permissions) permissions to create a project.
