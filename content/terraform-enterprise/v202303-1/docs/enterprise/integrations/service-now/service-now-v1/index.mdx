...
-> **\[DEPRECATED] Integration version:** v1.1.0 (Find the latest version [here](/terraform/enterprise/integrations/service-now))
...
2.  [Create a team](/terraform/enterprise/users-teams-organizations/teams) for that organization called "ServiceNow", and ensure that it has the organization-level ["Manage workspaces only" permission](/terraform/enterprise/users-teams-organizations/permissions#manage-workspaces-only). You do not need to add any users to this team.
