...
installations can be found [here](/terraform/enterprise/integrations/service-now/service-now-v1)
...
2.  [Create a team](/terraform/enterprise/users-teams-organizations/teams) for that
    ...
    manage
    workspaces](/terraform/enterprise/users-teams-organizations/permissions#manage-workspaces-only).
...
Navigate to the [Service Catalog documentation](/terraform/enterprise/integrations/service-now/service-catalog) to
...
to the [developer documentation](/terraform/enterprise/integrations/service-now/developer-reference).

### ServiceNow Administrator's Guide.

Refer to the [ServiceNow Administrator documentation](/terraform/enterprise/integrations/service-now/admin-guide) for
...
customizations documentation](/terraform/enterprise/integrations/service-now/example-customizations).
