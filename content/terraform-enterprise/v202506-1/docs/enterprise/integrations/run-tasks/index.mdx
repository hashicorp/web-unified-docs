...
To get started, [create an HCP Packer account](https://cloud.hashicorp.com/products/packer) and follow the instructions for [automating artifact validation](/hcp/docs/packer/store/validate-version#automatic-validation).
