...
~> **Note:** The `url` and `sha` fields will soon be deprecated. The `url` and `sha` fields can still be used to set the URL and SHA-256 checksum of the Terraform binary for amd64 architectures, but it is preferred to use the `archs` field to set the URL and SHA-256 checksum for each architecture.
...
| `data.attributes.url`               | string |         | **Soon to be deprecated.** The URL where you can download the 64-bit Linux binary of this version. It is preferred to use the archs field to set the URL.              |
| `data.attributes.sha`               | string |         | **Soon to be deprecated.** The SHA-256 checksum of the Terraform binary. It is preferred to use the archs field to set the SHA.                                        |
...
| `data.attributes.archs`             | array  |         | **Preferred field to set Terraform version architectures.**  An array of objects containing the SHA-256 checksum, URL where you can download the binary, OS, and arch. |
...
| `data.attributes.url`               | string | (previous value) | **Soon to be deprecated.** The URL where you can download the 64-bit Linux binary of this version. It is preferred to use the archs field to set the URL.             |
| `data.attributes.sha`               | string | (previous value) | **Soon to be deprecated.** The SHA-256 checksum of the Terraform binary. It is preferred to use the archs field to set the SHA                                        |
...
| `data.attributes.archs`             | array  | (previous value) | **Preferred field to set Terraform version architectures.** An array of objects containing the SHA-256 checksum, URL where you can download the binary, OS, and arch. |
