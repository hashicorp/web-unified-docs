...
-   Add API documentation for multiple [team tokens](/terraform/enterprise/api-docs/team-tokens), and update documentation around [legacy team tokens](/terraform/enterprise/api-docs/team-tokens##legacy-team-tokens-api-reference).
...
-   Add the `version-id` property to the response for the Create, List, and Update [Workspace Variables endpoints](/terraform/enterprise/api-docs/workspace-variables).
