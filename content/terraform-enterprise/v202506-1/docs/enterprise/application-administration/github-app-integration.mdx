...
For more information on using a GitHub App and GitHub Permissions in HCP Terraform, see [GitHub Permissions in HCP Terraform](/terraform/cloud-docs/application-administration/github-app-integration#github-permissions).
