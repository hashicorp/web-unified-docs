...
last_modified: 2025-08-25T10:49:04+02:00
...
- `prod-us-east-1-starport-layer-bucket.s3.dualstack.us-east-1.amazonaws.com`
- `prod-us-west-1-starport-layer-bucket.s3.dualstack.us-west-1.amazonaws.com`
