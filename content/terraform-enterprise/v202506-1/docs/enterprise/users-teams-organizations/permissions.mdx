...
last_modified: 2025-10-28T13:16:42-04:00
...
Allows members to publish and delete providers, modules, or both providers and modules using an organization's [claimed namespaces](/terraform/enterprise/registry/public-namespace) in the [public registry](https://registry.terraform.io/). These permissions are otherwise only available to organization owners.
