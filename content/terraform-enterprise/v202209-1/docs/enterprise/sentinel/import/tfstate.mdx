...
[`applied`](/enterprise/sentinel/import/tfplan#value-applied) collection in `tfplan` more useful,
...
-> **NOTE:** This value is also available via the [`tfplan`](/enterprise/sentinel/import/tfplan)
...
[import-tfplan-terraform-version]: /enterprise/sentinel/import/tfplan#value-terraform_version
