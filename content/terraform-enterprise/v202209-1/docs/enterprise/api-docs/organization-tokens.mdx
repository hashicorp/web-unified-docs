...
Generates a new [organization API token](/enterprise/users-teams-organizations/api-tokens#organization-api-tokens), replacing any existing token.

Only members of the owners team, the owners [team API token](/enterprise/users-teams-organizations/api-tokens#team-api-tokens), and the [organization API token](/enterprise/users-teams-organizations/api-tokens#organization-api-tokens) can access this endpoint.
