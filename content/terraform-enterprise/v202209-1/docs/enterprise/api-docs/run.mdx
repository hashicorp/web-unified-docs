...
| `filter[operation]` | **Optional.** Options are listed in [Run Operations](/enterprise/api-docs/run#run-operations).                                                                                                                               |
| `filter[status]`    | **Optional.** Options are listed in [Run States](/enterprise/api-docs/run#run-states).                                                                                                                                       |
| `filter[source]`    | **Optional.** Options are listed in [Run Sources](/enterprise/api-docs/run#run-sources).                                                                                                                                     |
