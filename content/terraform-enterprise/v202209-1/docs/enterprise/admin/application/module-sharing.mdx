...
![screenshot: the Registry admin page](/img/docs/admin-registry-show.png)
...
![screenshot: selecting an organization to share](/img/docs/admin-registry-share-organization-registry.png)
...
![screenshot: manage shared registry page with global sharing enabled](/img/docs/admin-registry-share-global.png)
...
![screenshot: the Registry admin page with an organization sharing modules with all organizations](/img/docs/admin-registry-show-global.png)
...
![screenshot: manage shared registry page with module partnership sharing enabled](/img/docs/admin-registry-share-consumers.png)
...
![screenshot: the Registry admin page with an organization sharing modules with two organizations](/img/docs/admin-registry-show-consumers.png)
...
![screenshot: the Registry admin page with extended actions on a shared registry](/img/docs/admin-registry-stop-sharing.png)

Click **Stop sharing**. You will be prompted to confirm the action by typing in the name of the organization.

![screenshot: confirmation dialogue to stop sharing modules](/img/docs/admin-registry-stop-sharing-confirmation.png)
