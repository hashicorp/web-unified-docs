...
We recommend that you start using the updated [tfstate/v2](/terraform/enterprise/policy-enforcement/sentinel/import/tfstate-v2) import as soon as possible to avoid disruptions.
...
[`applied`](/terraform/enterprise/policy-enforcement/sentinel/import/tfplan#value-applied) collection in `tfplan` more useful,
...
-> **NOTE:** This value is also available via the [`tfplan`](/terraform/enterprise/policy-enforcement/sentinel/import/tfplan)
...
[import-tfplan-terraform-version]: /terraform/enterprise/policy-enforcement/sentinel/import/tfplan#value-terraform_version
