...
3.  Click on the drawer icon in the **Workspaces** bar to view projects you have access to.
...
-   Choose one or more tags from the **Tags** drop-down to filter workspaces by tag.
