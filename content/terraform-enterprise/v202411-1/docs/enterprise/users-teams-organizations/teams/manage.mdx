...
4.  Click the user to add them to the team. HCP Terraform now displays the user under **Members**.
...
1.  Click **Settings** and then click **Teams**. The **Team Management** page appears, containing a list of all teams within the organization.
2.  Click the team to go to its settings page.
3.  Click **...** next to the user's name and choose **Remove from team** from the menu. HCP Terraform removes the user from the list of team members.
...
1.  Click **Settings** and then click **Teams**. The **Team Management** page appears, containing a list of all teams within the organization.
2.  Click the team to go to its settings page.
3.  Enable one of the following settings:
