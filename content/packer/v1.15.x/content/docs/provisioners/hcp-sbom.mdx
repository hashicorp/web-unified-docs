...
When you enable `auto_generate` without specifying `scanner_url`, Packer automatically downloads the latest version of Syft for you. If you need to use a specific version of Syft, you can provide a direct URL to that version's binary using the `scanner_url` parameter.
