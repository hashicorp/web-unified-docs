...
When it runs your tests, Terraform policy loads values for input variables from your local environment that match the `TFPOLICY_INPUT_` prefix. For example:
