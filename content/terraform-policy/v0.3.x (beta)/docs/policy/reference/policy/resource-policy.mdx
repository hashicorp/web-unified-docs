...
| `meta.tfe_stack.deployment_name` | The deployment name for Terraform Stacks. Available when evaluating Stack policies. | String | `"production"`, `"staging"` |
| `meta.tfe_stack.stack_name` | The stack name for Terraform Stacks. Available when evaluating Stack policies. | String | `"my-stack"`, `"infrastructure-stack"` |
| `meta.tfe_stack.deployment_group` | The deployment group for Terraform Stacks. Available when evaluating Stack policies. | String | `"us-east-1"`, `"global"` |
