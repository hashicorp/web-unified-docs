...
- [`locals` argument in `provider_policy` blocks](/terraform/policy/reference/policy/provider-policy#locals)
- [`locals` argument in `resource_policy` blocks](/terraform/policy/reference/policy/resource-policy#locals)
- [`locals` argument in `module_policy` blocks](/terraform/policy/reference/policy/module-policy#locals) 
