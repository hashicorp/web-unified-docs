...
provider_policy "aws" "standard_configuration" {
  ...
  enforce {
    condition     = meta.source == "registry.terraform.io/hashicorp/aws"
...
| `meta.source` | The full source of the provider. | String | `"registry.terraform.io/hashicorp/aws"`, `"registry.terraform.io/hashicorp/azurerm"` |
