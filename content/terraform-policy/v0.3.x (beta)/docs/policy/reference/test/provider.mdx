...
- `provider` &nbsp "[`<provider_name>`](#provider-name)" &nbsp "[`<test_label>`](#test-label)" &nbsp block
  ...
  - [`meta`](#meta) &nbsp object | optional
    - [`alias`](#meta) &nbsp string
    - [`name`](#meta) &nbsp string
    - [`namespace`](#meta) &nbsp string
...
| `source` | String | The full source of the provider. (For example: `"registry.terraform.io/hashicorp/aws"`). |
...
provider "aws" "unapproved_source" {
  ...
  meta = {
    source  = "registry.terraform.io/custom/aws"
    version = "5.0.0"
  }
