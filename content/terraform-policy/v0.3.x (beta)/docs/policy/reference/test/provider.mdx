...
| `tfe_stack.deployment_name` | String | The deployment name for Terraform Stacks. Available when testing Stack policies. |
| `tfe_stack.stack_name` | String | The stack name for Terraform Stacks. Available when testing Stack policies. |
| `tfe_stack.deployment_group` | String | The deployment group for Terraform Stacks. Available when testing Stack policies. |
