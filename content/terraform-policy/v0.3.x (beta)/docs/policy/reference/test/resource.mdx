...
| `tfe_stack.deployment_name` | String | The deployment name for Terraform Stacks. Available when testing Stack policies. | `"production"`, `"staging"` |
| `tfe_stack.stack_name` | String | The stack name for Terraform Stacks. Available when testing Stack policies. | `"my-stack"`, `"infrastructure-stack"` |
| `tfe_stack.deployment_group` | String | The deployment group for Terraform Stacks. Available when testing Stack policies. | `"us-east-1"`, `"global"` |
