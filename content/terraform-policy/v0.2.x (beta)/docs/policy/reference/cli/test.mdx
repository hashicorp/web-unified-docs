...
if you specify targets in your test files with the [`targets`](/terraform/policy/reference/test/policytest#targets) block, Terraform policy will error if a target does not match at least one policy.
