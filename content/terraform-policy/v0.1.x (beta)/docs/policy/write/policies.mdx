...
Use the `policy {}` block to configure Terraform policy itself. Refer to [The `policy {}` block](/terraform/policy/reference/policy/policy) for more information.
...
- To write policies for Terraform providers, refer to [The `provider_policy {}` block](/terraform/policy/reference/policy/provider-policy).
- To write policies for Terraform resources, refer to [The `resource_policy {}` block](/terraform/policy/reference/policy/resource-policy).
- To write policies for Terraform modules, refer to [The `module_policy {}` block](/terraform/policy/reference/policy/module-policy).
...
- Refer to [Input variables](/terraform/policy/reference/policy/input) to learn how to parameterize your policies with inputs.
- Refer to [Local values](/terraform/policy/reference/policy/locals) to learn how to use local values.
