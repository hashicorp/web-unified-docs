...
Plugins provide a way to extend Terraform policy with additional functions that you can use to customize your policy authoring experience. Write Terraform policy plugins in Golang using the [`terraform-policy-plugin-framework`](https://github.com/hashicorp/terraform-policy-plugin-framework.git) open source library, and compile them for your testing environment and HCP Terraform execution environment.
...
Before you can use your plugin in your policies, you will compile it. You must compile your plugin into a binary that is compatible with the architecture it will run on. When you test your policies on your local machine, you will compile the plugin to match your system's OS and architecture. When you deploy your policies to HCP Terraform, you will compile the plugin to match the OS and architecture HCP Terraform will use to evaluate your policies: either an HCP Terraform worker or an HCP Terraform agent that you have configured for your organization.
