...
The `CGO_ENABLED=0` flag ensures the binary is statically linked and portable. The `GOOS` and `GOARCH` environment variables specify the target operating system and architecture.
