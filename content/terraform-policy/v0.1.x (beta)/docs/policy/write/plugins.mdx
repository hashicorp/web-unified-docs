...
HCP Terraform workers run a `linux/amd64` architecture. If you use HCP Terraform agents, your agents may use either a `linux/amd64` or a `linux/arm64` environment. Refer to [VCS setup for Terraform policy](/terraform/cloud-docs/policy-enforcement/manage-policy-sets/terraform-policy-vcs#terraform-policy-plugins) for more information about evaluating your policies in HCP Terraform.
