...
When you deploy your policies to an HCP Terraform policy set, you must build your plugins for the correct architecture and commit it to version control. For more information about writing and building plugins, refer to [Write policy plugins](/terraform/policy/write/plugins).
