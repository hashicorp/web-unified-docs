...
```hcl
core::gethttprequest(url, options)
```
...
| `options` | No | Map | Optional configuration for the request, including headers. |

### Options map

| Key | Type | Description |
|-----|------|-------------|
| `headers` | Map | A map of HTTP headers to include in the request. |
