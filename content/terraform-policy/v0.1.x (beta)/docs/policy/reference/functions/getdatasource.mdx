...
| `config` | Yes | Object | An object representing the data source configuration, which Terraform policy validates against the data source schema and uses to fetch the data source from the provider. |
