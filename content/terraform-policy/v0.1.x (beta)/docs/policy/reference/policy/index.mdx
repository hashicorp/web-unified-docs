...
|------|-------------|------|---------|
| `operations` | Set the lifecycle operations to enforce the policy against. If ommitted, Terraform policy enforces your policy during the `create` and `update` operations. | String | `"create"`, `"update"`, `"delete"` |
