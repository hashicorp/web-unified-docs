...
The following example demonstrates a top-level locals block with all configuration options specified, a locals block within an example policy block, and references to local values:
