...
- Pre-plan: HCP Terraform executes provider and module policies that evaluate meta-arguments such as their source and version during workspace initialization before Terraform installs the providers or modules. A policy violation prevents Terraform from downloading  the providers or modules.
