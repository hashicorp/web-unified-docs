...
- Commit your policies and tests to a VCS. Refer to [VCS setup for Terraform policy](/terraform/cloud-docs/policy-enforcement/manage-policy-sets/terraform-policy-vcs) for more information.
- Enforce your policies in HCP Terraform. Refer to [HCP Terraform policy enforcement overview](/terraform/cloud-docs/policy-enforcement) for more information.
