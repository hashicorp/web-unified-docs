...
HCP Terraform also supports policy enforcement with Sentinel and Open Policy Agent (OPA). This page summarizes the differences between Terraform policy and these policy frameworks.
