...
Similar to [Terraform modules](/language/modules), constructs let you reuse configurations, enforce infrastructure best practices, and abstract configuration details away from users. For example, you might create a construct that configures a Kubernetes deployment.
...
When you write constructs in the same language as your CDKTF application, you can use the same importing mechanisms you use with other applications. Refer to [Constructs](/cdktf/concepts/constructs) in the CDKTF Concepts documentation for more details about using constructs.
