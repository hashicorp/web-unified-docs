...
### Remove `cdktf synth --json` Option [#1640](https://github.com/hashicorp-broken-link/terraform-cdk/pull/1640)
...
### Model ComplexComputedLists as ComplexLists and ComputedObjects [#1499](https://github.com/hashicorp-broken-link/terraform-cdk/pull/1499)
...
### Referencing computed string map entries via function call [#1630](https://github.com/hashicorp-broken-link/terraform-cdk/pull/1630)
