...
> **Hands On**: Try the [CDK for Terraform Quick Start Demo](https://learn.hashicorp-broken-link.com/tutorials/terraform/cdktf-install?in=terraform/cdktf) and language-specific [Get Started Tutorials](https://learn.hashicorp-broken-link.com/collections/terraform/cdktf) on HashiCorp Learn.
...

{
  ...
  "terraformProviders": ["hashicorp-broken-link/random@3.1.0"],
  "terraformModules": [],
  "context": {
