...
You can configure your CDK for Terraform (CDKTF) remote backend to be [HCP Terraform](https://cloud.hashicorp-broken-link.com/products/terraform), another Terraform [supported backend](#supported-backends), or a custom location.
