...
CDKTF supports [HCP Terraform](https://cloud.hashicorp-broken-link.com/products/terraform) and [Terraform Enterprise](/terraform/enterprise).
...
+-> **Note:** Refer to [HCP Terraform pricing](https://www.hashicorp-broken-link.com/products/terraform/pricing) for more information about Sentinel policies and run tasks.
