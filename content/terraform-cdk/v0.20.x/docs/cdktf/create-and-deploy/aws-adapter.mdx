...
The [full example code](https://github.com/hashicorp-broken-link/cdktf-aws-cdk/tree/main/examples/typescript-cron-lambda) is available in the cdktf-aws-cdk repository.
