...
Documentation for CDKTF provider bindings is available on the [Construct Hub](https://constructs.dev/search?cdk=cdktf&sort=downloadsDesc&offset=0) and in the [Terraform Registry](https://www.hashicorp-broken-link.com/blog/new-multi-language-docs-simplify-cdk-for-terraform-adoption).
