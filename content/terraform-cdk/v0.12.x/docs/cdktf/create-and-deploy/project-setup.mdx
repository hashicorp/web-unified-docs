...
> **Hands On**: Try the [CDK for Terraform Quick Start Demo](https://learn.hashicorp-broken-link.com/tutorials/terraform/cdktf-install?in=terraform/cdktf) and language-specific [Get Started tutorials](https://learn.hashicorp-broken-link.com/collections/terraform/cdktf).
