...
![cdktf-terraform](/img/cdktf-terraform-workflow.png)

CDKTF also automatically extracts the schemas from existing Terraform [providers](/cdktf/concepts/providers-and-resources) or [modules](/cdktf/concepts/modules) and generates the necessary code bindings for your application.

![cdktf-terraform](/img/provider-modules.png)
...
![cdktf-terraform](/img/cdktf-app-architecture.png)
...
A `Resource` represents the definition for one or more infrastructure objects. Resources and their required attributes vary depending on the provider. Reference the [providers and resources documentation](/cdktf/concepts/providers-and-resources#resources) for more details.
