...
import (
	...
	"github.com/hashicorp-broken-link/terraform-cdk/examples/go/documentation/generated/hashicorp-broken-link/aws/dataawsavailabilityzones"
...
```csharp
            ...
            // https://github.com/hashicorp-broken-link/terraform-cdk/issues/2557
