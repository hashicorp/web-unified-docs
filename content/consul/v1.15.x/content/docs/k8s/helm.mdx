...
- `global` ((#v-global)) - Holds values that affect multiple components of the chart.
  ...
  - `cloud` ((#v-global-cloud)) - Enables installing an HCP Consul Central self-managed cluster.
    ...
    - `enabled` ((#v-global-cloud-enabled)) (`boolean: false`) - If true, the Helm chart will link a [self-managed cluster to HCP](https://developer.hashicorp.com/hcp/docs/consul/self-managed).
    ...
    - `clientId` ((#v-global-cloud-clientid)) - The client id portion of a [service principal](https://developer.hashicorp.com/hcp/docs/hcp/admin/iam/service-principals#service-principals) with authorization to link the cluster
    ...
    - `clientSecret` ((#v-global-cloud-clientsecret)) - The client secret portion of a [service principal](https://developer.hashicorp.com/hcp/docs/hcp/admin/iam/service-principals#service-principals) with authorization to link the cluster
      in global.cloud.resourceId to HCP Consul Central.
      This is required when global.cloud.enabled is true.
...
- `telemetryCollector` ((#v-telemetrycollector))
  ...
  - `cloud` ((#v-telemetrycollector-cloud))
    ...
    - `clientId` ((#v-telemetrycollector-cloud-clientid)) - The client id portion of a [service principal](https://developer.hashicorp.com/hcp/docs/hcp/admin/iam/service-principals#service-principals) with authorization to push metrics to HCP
    ...
    - `clientSecret` ((#v-telemetrycollector-cloud-clientsecret)) - The client secret portion of a [service principal](https://developer.hashicorp.com/hcp/docs/hcp/admin/iam/service-principals#service-principals) with authorization to push metrics to HCP.
