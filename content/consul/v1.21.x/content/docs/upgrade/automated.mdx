...
The following example uses an existing Consul Enterprise `1.20.0` datacenter with three servers and `bootstrap_expect = 3`. 
...
consul-server-1  172.18.0.12:8301  alive   server  1.20.0+ent  2         dc1  default    <all>
consul-server-2  172.18.0.8:8301   alive   server  1.20.0+ent  2         dc1  default    <all>
consul-server-3  172.18.0.6:8301   alive   server  1.20.0+ent  2         dc1  default    <all>
```
...
$ consul members
Node              Address            Status  Type    Build       Protocol  DC   Partition  Segment
consul-server-1a  172.18.0.17:8301   alive   server  1.21.0+ent  2         dc1  default    <all>
consul-server-2a  172.18.0.4:8301    alive   server  1.21.0+ent  2         dc1  default    <all>
consul-server-3a  172.18.0.15:8301   alive   server  1.21.0+ent  2         dc1  default    <all>
```
