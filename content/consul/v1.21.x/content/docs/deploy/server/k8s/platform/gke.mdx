...
If you do use WIF, you need to add an annotation to the Consul client service account. Replace `GSA_NAME` and `PROJECT_ID` with your GCP service account name and project ID.
