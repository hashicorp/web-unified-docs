...
This page describes the process to deploy Consul servers to Amazon Web Services Fargate to support Consul tasks in the AWS ECS runtime. For more information about ECS, refer to [Consul dataplanes on AWS ECS](consul/docs/deploy/dataplane/ecs).
...
After you deploy Consul servers on Fargate...
