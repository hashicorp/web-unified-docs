...
last_modified: 2026-08-28T14:20:53.000Z
...
- [`HTTPRoute` in Kubernetes documentation](https://gateway-api.sigs.k8s.io/reference/api-types/httproute/)
- [`TCPRoute`  in Kubernetes documentation](https://gateway-api.sigs.k8s.io/reference/api-types/tcproute/)
