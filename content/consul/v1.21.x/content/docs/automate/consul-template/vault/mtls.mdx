...
These instructions set the TTL for the certificate to 24 hours, at which point it expires. Try using a shorter TTL in a test environment to ensure certificates are revoked properly after the TTL expires.
