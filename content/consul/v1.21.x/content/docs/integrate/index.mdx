...
**Consul Enterprise integration verification badge**: Partners will be issued the Consul Enterprise badge for integrations that work with [Consul Enterprise features](/consul/docs/enterprise) such as namespaces. The badge would be displayed on HashiCorp's partner page as well as be available for posting on the partner's own website to provide better visibility and differentiation of the integration for joint customers.
...
Developing a valid integration with either Consul Enterprise also qualifies the partner for the Premier tier of the HashiCorp Technology Partners program. The process for verification of these integrations is detailed below.
...
- [Monitor Consul with New Relic Instant Observability](https://github.com/newrelic-experimental/hashicorp-quickstart-annex/blob/main/hcp-consul/README.md)
...
- [HAProxy Fusion and Consul Service Discovery](https://www.haproxy.com/blog/announcing-haproxy-fusion-1-3)
- [Configuring Ingress Controllers with Consul-on-Kubernetes](/consul/docs/north-south/ingress-controller)
...
- [Deploy Consul on Red Hat OpenShift](/consul/deploy/server/k8s/platform/openshift)
- [Consul Integration with Layer5 Meshery](https://www.hashicorp.com/integrations/layer5-io/consul)
- [Consul Integration with VMware Tanzu Application Service](https://docs.wavefront.com/consul.html)
...
- [Automate UltraDNS with Consul-Terraform-Sync](https://github.com/ultradns/terraform-ultradns-cts)
