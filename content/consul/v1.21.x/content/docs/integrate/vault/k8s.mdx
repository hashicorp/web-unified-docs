...
You can also use Vault to [store and manage your Consul Enterprise license](/consul/docs/deploy/server/k8s/vault/data/enterprise-license).
...
Enable a key/value v2 secrets engine at the `consul/` path.
