...
last_modified: 2026-04-21T13:06:12.000Z
...
1. Define rate limits in a control plane request limit configuration entry. You can set limits for different types of resources calls.
