...
created_at: 2026-03-31T20:44:53.000Z
last_modified: 2026-03-31T20:44:53.000Z
...
![NGINX and Consul template architecture](/img/discover/load-balancer/nginx/consul-nginx-template-arch.png 'Consul template gets healthy services from Consul service discovery and uses them to populate NGINX configuration')
...
![Healthy web service](/img/discover/load-balancer/nginx/consul-nginx-template-web.png 'The Consul UI displaying a healthy web service')
...
![Unhealthy web service](/img/discover/load-balancer/nginx/consul-nginx-template-web-unhealthy.png 'The Consul UI displaying an unhealthy web service')
