...
created_at: 2026-03-31T20:46:29.000Z
last_modified: 2026-03-31T20:46:29.000Z
...
These instructions describe how to upgrade the current installed version of the CLI to the latest version. If you are looking to upgrade to a specific version, please follow [Install a specific version of the CLI](/consul/docs/reference/cli/consul-k8s#install-the-cli).
