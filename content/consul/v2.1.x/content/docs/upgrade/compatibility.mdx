...
For more details on the specifics of upgrading, see the [upgrading page](/consul/docs/upgrade).
...
-> **Note:** Raft Protocol is versioned separately, but maintains compatibility with at least one prior version. See [here](/consul/docs/upgrade/version-specific#raft-protocol-version-compatibility) for details.
