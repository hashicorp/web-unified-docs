...
created_at: 2026-03-31T20:44:18.000Z
last_modified: 2026-03-31T20:44:18.000Z
...
The `services register` command registers a service with the local agent. This command simplifies service registration from
...
- `-port` - The port of the service. You cannot register a service that exposes multiple ports using CLI flags. To register a multi-port service, create a [service definition file that specifies the ports](/consul/docs/reference/service#ports).
