...
created_at: 2026-03-31T20:43:58.000Z
last_modified: 2026-03-31T20:43:58.000Z
...
- `-name=<string>` - Specifies an optional name for the token.
  If `-name` is empty and you use the [auth method `TokenNameFormat`
