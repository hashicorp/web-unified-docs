...
created_at: 2026-03-31T20:44:00.000Z
last_modified: 2026-03-31T20:44:00.000Z
...
- `-recursor` ((#\_recursor)) - Specifies the address of an upstream DNS
  ...
  to the [`recursors` configuration option](/consul/docs/reference/agent/configuration-file/dns#recursors).
