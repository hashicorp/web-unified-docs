...
last_modified: 2026-04-17T17:21:09.000Z
...
<VideoEmbed url="https://fast.wistia.net/embed/iframe/uts377k8pw" />
...
To run Consul Enterprise, you must configure Consul agents with an Enterprise license. There are two kinds of license:

- **Consul Self-Managed Standard license** includes support for service discovery features
- **Consul Self-Managed Premium license** includes support for service mesh features
