...
The [terraform-aws-consul-ecs GitHub repository](https://github.com/hashicorp/terraform-aws-consul-ecs) contains examples that you can reference to help you deploy Consul service mesh to your ECS workloads.
