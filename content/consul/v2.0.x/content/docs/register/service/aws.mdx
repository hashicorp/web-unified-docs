...
created_at: 2026-03-31T20:45:57.000Z
last_modified: 2026-03-31T20:45:57.000Z
...
Consul clusters is to use the Consul cluster's name in the prefix and provide it with the `-consul-service-prefix` flag.
...
One strategy for prefixing services when hosting services across multiple cloud providers is to add `aws` in the prefix. The `aws-service-prefix` flag allows you to customize the prefix.
