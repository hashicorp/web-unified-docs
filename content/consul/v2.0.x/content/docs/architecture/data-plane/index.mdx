...
created_at: 2026-03-31T20:44:24.000Z
last_modified: 2026-03-31T20:44:24.000Z
...
Our documentation follows [terminology in the Envoy documentation](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/intro/terminology) to describe the direction that data travels.

- The _downstream service_ connects to its sidecar proxy, which sends a request and receives a response on its behalf.
- The _upstream service_ receives connections and requests from its sidecar proxy, and then returns them through the sidecar.
