...
created_at: 2026-03-31T20:45:20.000Z
last_modified: 2026-03-31T20:45:20.000Z
# END AUTO GENERATED METADATA
---

# Monitor Consul with AppDynamics CNS

This page describes the process to monitor Consul telemetry data with the Consul
monitoring extension for AppDynamics CNS.

<Warning>

As of 2026, AppDynamics has been integrated into Splunk's Observability
portfolio. For the latest information on monitoring Consul with AppDynamics,
refer to the [Splunk
documentation](https://docs.splunk.com/Observability/gdi/consul/consul.html).

This content is provided for historical reference and may not reflect the latest
features or best practices for monitoring Consul with AppDynamics CNS. We
recommend checking the official Splunk documentation for the most up-to-date
information on monitoring Consul with AppDynamics CNS.
...
AppDynamics CNS can collect Consul telemetry data and node information using the
[HashiCorp Consul Monitoring
Extension](https://github.com/hashicorp/consul-appd-extension). The extension
provides you with two example dashboards that can be imported into your
AppDynamics controller. To use the extension, nodes with Consul agents need the
AppDynamics Machine Agent installed, and the system must meet the AppDynamics
system requirements. AppDynamics SaaS or On-Prem controller version 4.5 or
