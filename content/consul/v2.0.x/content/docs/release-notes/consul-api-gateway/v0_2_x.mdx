...
For detailed information on upgrading, including how to create the required reference policies, please refer to the [upgrade details page](/consul/docs/upgrade/api-gateway)
