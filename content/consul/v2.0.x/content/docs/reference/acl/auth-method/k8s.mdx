---
layout: docs
page_title: Access Control List (ACL) Kubernetes auth method configuration reference
description: >-
...
# ACL Kubernetes auth method configuration reference

<Tip> This feature is available in Consul versions 1.5.0 and newer. </Tip>
