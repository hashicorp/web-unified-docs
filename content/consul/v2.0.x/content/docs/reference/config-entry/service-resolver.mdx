...
Specifies the namespace that the service resolver applies to. Refer to [namespaces](/consul/docs/multi-tenant/namespace) for more information.
...
Specifies the admin partition that the service resolver applies to. Refer to [admin partitions](/consul/docs/multi-tenant/admin-partition) for more information.
