...
created_at: 2026-03-31T20:45:49.000Z
last_modified: 2026-03-31T20:45:49.000Z
...
| Virtual service              | `[<port-name>.]<service>.virtual` | None                           | &#9989;                     |
...
- Virtual IP DNS lookups that use the AAAA query type, such as `<service>.virtual.consul` or `<port-name>.<service>.virtual.consul`, must not return Consul-allocated IPv4 addresses.
