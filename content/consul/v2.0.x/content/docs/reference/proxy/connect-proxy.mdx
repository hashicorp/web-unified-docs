...
|`destination_port` | String value that specifies the name of the target non-default port that a multiport service is listening on. | Optional | None |
...
<CodeTabs heading="Example service destination multiport upstream">
