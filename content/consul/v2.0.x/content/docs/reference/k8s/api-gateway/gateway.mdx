...
| `version `    | Specifies the Kubernetes API version. The value should be `gateway.networking.k8s.io/v1` or `consul.hashicorp.com/v1beta1`.                                | Required |
