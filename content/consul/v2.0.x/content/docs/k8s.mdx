...
created_at: 2026-03-31T20:45:09.000Z
last_modified: 2026-03-31T20:45:09.000Z
...
The following table lists versions of Kubernetes across the three major cloud providers and the currently supported Consul versions they have been tested with.

@include 'tables/compatibility/k8s/providers.mdx'

The following table describes the general compatibility between Consul and Kubernetes versions.
...
- [Installing Consul](/consul/docs/deploy/server/k8s/helm) covers how to install Consul using the Helm chart.
- [Helm Chart Reference](/consul/docs/reference/k8s/helm) describes the different options for configuring the Helm chart.
