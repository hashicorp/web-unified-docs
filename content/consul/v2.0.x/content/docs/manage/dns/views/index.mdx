...
-  To perform DNS lookups on other admin partitions, you must [export services between partitions](/consul/docs/reference/config-entry/exported-services) before you can query them.
