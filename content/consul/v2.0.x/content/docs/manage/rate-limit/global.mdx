...
last_modified: 2026-04-16T15:22:26.000Z
...
Set the [config.priority](/consul/docs/reference/config-entry/rate-limit#config-priority) in the configuration file to `false` and re-appy the configuration entry to allow disable the rate limit. Other traffic limitations will still be applied.
