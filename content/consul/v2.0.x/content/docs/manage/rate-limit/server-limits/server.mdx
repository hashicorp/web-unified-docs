---
layout: docs
page_title: Set a limit on server traffic rates
description: Use rate limits to prevent excessive rates of requests to Consul servers.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-16T15:22:30.000Z
last_modified: 2026-04-16T15:22:30.000Z
# END AUTO GENERATED METADATA
---

# Set a limit on server traffic rates
...
You should continue to monitor request traffic to ensure that request rates remain within the threshold you defined. Refer to [Monitor traffic rate limit data](/consul/docs/manage/rate-limit/server-limits/monitor) for instructions about checking metrics and log entries, as well as troubleshooting information.
