...
created_at: 2026-03-31T20:45:15.000Z
last_modified: 2026-03-31T20:45:15.000Z
...
## Access Control List (ACL) system reset

If you lose access to a valid `global-management` token, you must reset the ACL system to regain access to your Consul datacenter. For more information, refer to [Reset Access Control List (ACL) system](/consul/docs/secure/acl/reset).