...
created_at: 2026-03-31T20:44:57.000Z
last_modified: 2026-03-31T20:44:57.000Z
...
Mesh gateways support multiport services across [admin partitions](/consul/docs/east-west/mesh-gateway/admin-partition) and [cluster peers](/consul/docs/east-west/mesh-gateway/cluster-peer). However, multiport services are currently not supported across [WAN-federated datacenters](/consul/docs/east-west/mesh-gateway/federation).

For more information about multiport services, refer to the [multiport documentation](/consul/docs/connect/proxy/multiport).
