...
created_at: 2026-03-31T20:44:59.000Z
last_modified: 2026-03-31T20:44:59.000Z
...
You can install Consul dataplane on ECS with the [HashiCorp Terraform modules](/consul/docs/deploy/workload/dataplane/ecs/terraform) or by [manually configuring the task definition](/consul/docs/deploy/workload/dataplane/ecs/manual). We strongly recommend using the Terraform modules and resources because Terraform automatically builds and enables Consul service mesh containers for your workloads. The Terraform module installation method also allows you to add your existing ECS task definitions to the Consul service mesh without additional configuration. 
...
Refer to the following resources for additional guidance about deploying and managing Consul on ECS.

### Documentation
 
- [Install Consul servers on AWS Fargate](/consul/docs/deploy/server/ecs/fargate)
- [Install Consul dataplane to ECS using Terraform](/consul/docs/deploy/workload/dataplane/ecs/terraform)
- [Install Consul dataplane to ECS manually](/consul/docs/deploy/workload/dataplane/ecs/manual)
- [Register ECS services in Consul](/consul/docs/register/service/ecs)
...
- [Integrate your AWS ECS services into Consul service mesh](/consul/tutorials/cloud-integrations/consul-ecs): Shows how to use Terraform to run Consul service mesh applications on ECS with self-managed Enterprise.
...
- [Consul with dev server on ECS using the EC2 launch type](https://registry.terraform.io/modules/hashicorp/consul-ecs/aws/latest/examples/dev-server-ec2)
- [Consul on Fargate Github repository](https://github.com/hashicorp-education/learn-consul-fargate)
