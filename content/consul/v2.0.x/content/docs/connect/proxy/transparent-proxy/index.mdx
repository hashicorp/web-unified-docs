...
Transparent proxy mode also supports multiport services - for more information, refer to the [Consul Multiport documentation](/consul/docs/connect/proxy/multiport).
