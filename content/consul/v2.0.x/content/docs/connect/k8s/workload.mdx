...
- Currently multi-port service routing is only supported in single datacenter, routing multi-port services across multiple datacenters(in peered consul clusters) is not supported.
