...
last_modified: 2026-04-08T21:59:00.000Z
# END AUTO GENERATED METADATA
---

# Consul Enterprise license

This topic provides an overview of the Consul Enterprise license. This information also
...
A license must be available at the time the agent starts.
...
variable should contain the license as the value. 
