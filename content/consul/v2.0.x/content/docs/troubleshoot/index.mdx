...
created_at: 2026-03-31T20:46:25.000Z
last_modified: 2026-03-31T20:46:25.000Z
...
The `consul debug` command can be run on a node without any other arguments. It captures metrics, logs, profiling data, and other data to the current directory for five minutes.
