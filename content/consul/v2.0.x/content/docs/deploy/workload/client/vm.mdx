...
The recommended way to join a cluster running within Kubernetes is to use the ["k8s" cloud auto-join provider](/consul/docs/deploy/server/cloud-auto-join#kubernetes-k8s).
