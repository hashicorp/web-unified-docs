...
- Consul server cluster version v1.14.0 and newer
- Consul K8s v1.0.0 and newer
...
If you wish to utilise a specific version of Consul Dataplane, you can define this in your Helm chart via the `global.imageConsulDataplane` stanza. Here's an example.
