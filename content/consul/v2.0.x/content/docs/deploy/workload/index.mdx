...
When you run a Consul _dataplane_, a lightweight process communicates with the Envoy proxies already running alongside your application workloads. Dataplane let you use Consul's security, monitoring, and traffic management features when you already have sidecar proxies and health checks configured in Kubernetes or ECS. For more information, refer to [Consul Dataplane architecture](/consul/docs/architecture/control-plane/dataplane).
