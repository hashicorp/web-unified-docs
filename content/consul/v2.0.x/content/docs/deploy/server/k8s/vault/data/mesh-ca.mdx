...
created_at: 2026-03-31T20:44:46.000Z
last_modified: 2026-03-31T20:44:46.000Z
...
-> **Note:** This usage applies to new installations, not existing Consul clusters. For instructions on existing clusters, refer to [Configure service mesh certificate authority (CA) for Consul on Kubernetes](/consul/docs/secure-mesh/certificate/k8s)
