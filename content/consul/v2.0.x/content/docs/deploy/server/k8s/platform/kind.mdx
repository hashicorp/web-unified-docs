...
This topic describes how to create a local Kubernetes cluster with `kind`, and deploy a Consul datacenter to your `minikube` cluster. After deploying Consul, you will interact with Consul using the CLI, UI, and/or API.
