...
last_modified: 2026-07-22T09:38:45.000Z
...
The following table shows the same information as the diagram and describes the required Helm values for each platform configuration:
...
Check if your cluster uses `TCPRoute`.
