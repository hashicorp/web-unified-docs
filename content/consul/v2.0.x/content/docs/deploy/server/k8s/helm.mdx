...
last_modified: 2026-07-31T15:57:31.000Z
...
1. Install Consul on Kubernetes using Helm. The Helm chart does everything to
   set up your deployment. After installation, agents automatically form
   clusters, elect leaders, and run the necessary agents.
