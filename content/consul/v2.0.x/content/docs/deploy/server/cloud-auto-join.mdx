...
Discovery requires a [GCE Service Account](https://docs.cloud.google.com/compute/docs/access/service-accounts). Credentials are searched using the following paths, in order of precedence.
