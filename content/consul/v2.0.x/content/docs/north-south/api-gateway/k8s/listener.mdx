...
Review to [When to choose the Standard API gateway or Consul API gateway](/consul/docs/north-south/api-gateway/k8s#introduction) for guidance on selecting the right gateway type.
