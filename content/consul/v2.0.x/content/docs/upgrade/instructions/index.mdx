...
created_at: 2026-03-31T20:46:28.000Z
last_modified: 2026-03-31T20:46:28.000Z
# END AUTO GENERATED METADATA
---

# Upgrade instructions

This page describes the process to update the version of Consul that runs in your datacenter.

## General upgrade path

If you are not running a Consul Enterprise
[Long Term Support](/consul/docs/upgrade/lts)
...
| ---------------------- | ------------------- | -------------------- |
| 1.21.7 (LTS) - 1.21.x  | 2.0.x               | Refer to [upgrading to Consul 2.0.x](/consul/docs/upgrade/instructions/upgrade-to-2-0-x) |
| 1.8.0 - 1.9.17         | 1.10.12             | Refer to [upgrading to latest 1.10.x](/consul/docs/upgrade/instructions/upgrade-to-1-10-x) |
| 1.6.9 - 1.8.18         | 1.8.19              | Refer to [upgrading to latest 1.8.x](/consul/docs/upgrade/instructions/upgrade-to-1-8-x) |
| 1.2.4 - 1.6.9          | 1.6.10              | Refer to [upgrading to latest 1.6.x](/consul/docs/upgrade/instructions/upgrade-to-1-6-x) |
| 0.8.5 - 1.2.3          | 1.2.4               | Refer to [upgrading to latest 1.2.x](/consul/docs/upgrade/instructions/upgrade-to-1-2-x) |
...
1. Upgrade to latest Consul 1.12.x after consulting the
   [version-specific upgrade details](/consul/docs/upgrade/version-specific)
   for 1.11 and 1.12.

To upgrade a Consul Enterprise cluster from an earlier release to 2.0.x:
1. Upgrade to Consul Enterprise 1.21.7 or later, consulting the
   [version-specific upgrade details](/consul/docs/upgrade/version-specific)
   for each major version along the way.
1. Switch to an IBM Consul Enterprise license, following
   [Upgrade to IBM Consul Enterprise license](/consul/docs/upgrade#upgrade-to-ibm-consul-enterprise-license).
1. Upgrade to Consul Enterprise 2.0.x using the
   [dedicated instructions](/consul/docs/upgrade/instructions/upgrade-to-2-0-x).
