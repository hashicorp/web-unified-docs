...
HashiCorp began Consul Enterprise Long Term Support (LTS) releases starting with version v1.15. These releases maintain longer fix eligibility and support larger upgrade jumps.

Starting with the April 2026 (2.x.x) release, Consul Enterprise follows the IBM Support Cycle-2 (SC2) model.
Read more on this in the [Consul enterprise support documentation](/consul/docs/enterprise/support).
...
[Support Period Policy](https://developer.hashicorp.com/consul/docs/enterprise/support#consul-versioning).
...
as described in the [standard upgrade instructions](/consul/docs/upgrade/instructions).
...
- A non-security bug must be a Severity 1 (Urgent) or Severity 2 (High) issue
  as defined in [HashiCorp Support's Severity Definitions](https://www.ibm.com/support/pages/ibm-enterprise-support-severity-definitions).
...
- [Kubernetes version compatibility with Consul](/consul/docs/upgrade/k8s/compatibility)
- [Envoy and Consul dataplane version compatibility with Consul](/consul/docs/reference/proxy/envoy)
