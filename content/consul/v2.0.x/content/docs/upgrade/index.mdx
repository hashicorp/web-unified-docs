...
last_modified: 2026-04-16T19:56:36.000Z
...
## Upgrade to IBM Consul Enterprise license

Beginning in v1.21, Consul licensing moved from HashiCorp to IBM. IBM offers two types of Consul Enterprise licenses for self-managed clusters: **Standard** and **Premium**. To review the full scope of the IBM licenses and their supported features, refer to [Consul Enterprise IBM licenses](/consul/docs/enterprise#ibm-consul-licenses).

If you used a HashiCorp Consul Enterprise license with a previous Consul version and now use an IBM Consul Enterprise license, you must follow a specific upgrade process for your Consul cluster. This process requires updating your Consul cluster to run Consul Enterprise v1.21.7 before changing the licenses. For the complete upgrade process, refer to [version specific upgrades](/consul/docs/upgrade/version-specific#consul-1-21-x).

If you plan to continue upgrading all the way to Consul Enterprise 2.0.x, complete this license migration first, then follow [Upgrade Consul to v2.0.x](/consul/docs/upgrade/instructions/upgrade-to-2-0-x).
...
for more information about how to perform those upgrades. For example, Consul
Enterprise clusters upgrading from 1.21.x (LTS) to 2.0.x should follow
[Upgrade Consul to v2.0.x](/consul/docs/upgrade/instructions/upgrade-to-2-0-x).
