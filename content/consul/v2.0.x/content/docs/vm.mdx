...
created_at: 2026-03-31T20:46:32.000Z
last_modified: 2026-03-31T20:46:32.000Z
...
- [Deploy Consul on VMs](/consul/docs/deploy/server/vm)
- [Upgrade Consul on VMs](/consul/docs/upgrade)
...
- [Register services on VMs](/consul/docs/register/service/vm)
- [Discover services on VMs](/consul/docs/discover/vm)
- [Connect service mesh workloads on VMs](/consul/docs/connect/vm)
- [Secure north/south network access on VMs](/consul/docs/north-south/vm)
- [Link networks east/west across regions, providers, and runtimes](/consul/docs/east-west/vm)
- [Secure service mesh traffic on VMs](/consul/docs/secure-mesh/vm)
- [Manage service traffic on VMs](/consul/docs/manage-traffic/vm)
- [Observe service mesh telemetry on VMs](/consul/docs/observe/telemetry/vm)

## Guidance

To learn more about the system architecture and requirements when operating Consul on VMs, refer to the following topics.

- [Control plane architecture](/consul/docs/architecture/control-plane) describes the underlying infrastructure and communication protocols Consul uses.
