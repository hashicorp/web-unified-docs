...
description: Learn about the Consul catalog, including what Consul servers record when they register a service.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-03-31T20:44:32.000Z
last_modified: 2026-03-31T20:44:32.000Z
# END AUTO GENERATED METADATA
---

# Consul catalog

This page provides conceptual information about the Consul catalog, which tracks registered services and their locations for both service discovery and service mesh use cases.

Refer to the [`/catalog` endpoint reference in the HTTP API documentation](/consul/api-docs/catalog) for reference documentation about the information returned when querying the catalog, including filtering options when querying the catalog for a list of nodes, services, or gateways.
...
Consul introduced an experimental v2 Catalog API in v1.17.0. This API supported multi-port Service configurations on Kubernetes, and we made it available for testing and development purposes. We deprecated the v2 catalog and its support for multi-port Kubernetes Services in the v1.19.0 release.

As of v1.22, Consul's catalog supports service discovery operations for multi-port services registered using Service sync. For more information, refer to [service ports](/consul/docs/register/service/k8s/service-sync#service-ports).
...
| Catalog field | Description | Source |
| :--------------- | :---------- | :----- |
