...
![Consul UI with NGINX registered](/img/discover/load-balancer/f5/consul-f5-nginx.png 'Consul web
...
![NGINX instances in BIG-IP](/img/discover/load-balancer/f5/consul-f5-partition.png 'NGINX
