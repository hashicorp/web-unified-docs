...
created_at: 2026-03-31T20:43:38.000Z
last_modified: 2026-03-31T20:43:38.000Z
...
- `Name` `(string: "")` - Specifies an optional friendly name. If `Name` is
  empty and you use the [auth method TokenNameFormat
  parameter](/consul/api-docs/acl/auth-methods#tokennameformat), Consul
 generates the token name from the `TokenNameFormat` value.
...
- `Name` `(string: "")` - Specifies an optional friendly name.
