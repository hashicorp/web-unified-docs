...
created_at: 2026-03-31T20:43:40.000Z
last_modified: 2026-03-31T20:43:40.000Z
...
If you encounter an `Unknown service ID` error when deregistering services through the `/agent/service` endpoint, you can deregister the service with the [`catalog/deregister` HTTP API endpoint](/consul/api-docs/catalog#deregister-entity):
