...
Alternatively, you can configure the [`limits.http_max_conns_per_client`](/docs/agent/options#http_max_conns_per_client) option to set a maximimum number of connections to meet your needs. 
