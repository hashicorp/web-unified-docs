...
2. [Configuration files](/docs/agent/options)
...
- ACL Tokens
- [Configuration Entry Bootstrap](/docs/agent/options#config_entries_bootstrap)
- Checks
- [Discard Check Output](/docs/agent/options#discard_check_output)
- HTTP Client Address
- Log level
- [Metric Prefix Filter](/docs/agent/options#telemetry-prefix_filter)
- [Node Metadata](/docs/agent/options#node_meta)
- Some Raft options (since Consul 1.10.0)
  - [`raft_snapshot_threshold`](/docs/agent/options#_raft_snapshot_threshold)
  - [`raft_snapshot_interval`](/docs/agent/options#_raft_snapshot_interval)
  - [`raft_trailing_logs`](/docs/agent/options#_raft_trailing_logs)
...
- [RPC rate limiting](/docs/agent/options#limits)
- [HTTP Maximum Connections per Client](/docs/agent/options#http_max_conns_per_client)
- Services
- TLS Configuration
  ...
  - To avoid a potential security issue, the following TLS configuration parameters do not automatically reload when [-auto-reload-config](/docs/agent/config/cli-flags#_auto_reload_config) is enabled:
    - [encrypt_verify_incoming](/docs/agent/options#encrypt_verify_incoming)
    - [verify_incoming](/docs/agent/options#verify_incoming)
    - [verify_incoming_rpc](/docs/agent/options#verify_incoming_rpc)
    - [verify_incoming_https](/docs/agent/options#verify_incoming_https)
    - [verify_outgoing](/docs/agent/options#verify_outgoing)
    - [verify_server_hostname](/docs/agent/options#verify_server_hostname)
    - [ca_file](/docs/agent/options#ca_file)
    - [ca_path](/docs/agent/options#ca_path)
