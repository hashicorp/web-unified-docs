...
[documented here](/docs/discovery/checks). The check name is automatically
...
-> **Note:** There is more information about [checks here](/docs/discovery/checks).
...
"mesh-gateway" for instances of a [mesh gateway](/docs/connect/gateways/mesh-gateway),
