...
For detailed instructions on setting up cluster peering, refer to [Create and Manage Peering Connections](/consul/docs/connect/cluster-peering/create-manage-peering).
