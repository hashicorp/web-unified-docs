...
when used with the [consistent](/api-docs/features/consistency#consistent) mode for queries.
...
document](/docs/install/bootstrapping) for more details.
...
[HTTP API](/api-docs/features/consistency).
