...
- [Get Started with Consul on VMs](https://learn.hashicorp.com/collections/consul/getting-started)
- [Get Started with Consul on HCP](https://learn.hashicorp.com/collections/consul/cloud-get-started)
- [Get Started with Consul on Kubernetes](https://learn.hashicorp.com/collections/consul/gs-consul-service-mesh)
