...
last_modified: 2026-07-14T23:21:25.000Z
...
registered by placing a [service definition](/consul/docs/agent/services)
...
as when constructing a standard [service definition](/consul/docs/agent/services).
