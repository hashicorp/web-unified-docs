...
last_modified: 2026-07-14T23:23:45.000Z
...
[automatic bootstrapping](/consul/docs/guides/bootstrapping) is available and is
...
for running the [consensus protocol](/consul/docs/architecture/consensus), and
...
datacenter provide the [`-bootstrap` configuration option](/consul/docs/agent/options#_bootstrap).
...
[deployment table](/consul/docs/architecture/consensus#toc_4) that covers various
