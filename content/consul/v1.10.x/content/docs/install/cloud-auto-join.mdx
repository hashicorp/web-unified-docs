...
last_modified: 2026-07-14T23:23:39.000Z
...
[`ports.serf_lan`](/consul/docs/agent/options#serf_lan_port) configuration option.
...
[`-serf-lan-port`](/consul/docs/agent/options#_serf_lan_port) command line flag.
