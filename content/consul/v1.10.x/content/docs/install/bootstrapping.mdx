...
last_modified: 2026-07-14T23:23:38.000Z
...
[architecture documentation](/consul/docs/internals/architecture) to learn more about
...
with [`-bootstrap-expect`](/consul/docs/agent/options#_bootstrap_expect).

## Bootstrapping the Servers

The recommended way to bootstrap the servers is to use the [`-bootstrap-expect`](/consul/docs/agent/options#_bootstrap_expect)
...
[`-bootstrap-expect`](/consul/docs/agent/options#_bootstrap_expect)
...
- Specify a list of servers with
  [-join](/consul/docs/agent/options#_join) and
  [start_join](/consul/docs/agent/options#start_join)
  options.
- Specify a list of servers with [-retry-join](/consul/docs/agent/options#_retry_join) option.
- Use automatic joining by tag for supported cloud environments with the [-retry-join](/consul/docs/agent/options#_retry_join) option.
