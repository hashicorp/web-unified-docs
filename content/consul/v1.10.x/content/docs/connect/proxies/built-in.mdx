...
last_modified: 2026-07-14T23:22:48.000Z
...
- `bind_port` - The port the proxy will bind its _public_
  ...
  configured proxy port range specified by [`sidecar_min_port`](/consul/docs/agent/options#sidecar_min_port)
  and [`sidecar_max_port`](/consul/docs/agent/options#sidecar_max_port).
