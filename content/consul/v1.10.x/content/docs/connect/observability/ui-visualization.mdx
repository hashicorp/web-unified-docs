...
last_modified: 2026-07-14T23:22:47.000Z
...
[`ui_config.enabled`](/consul/docs/agent/options#ui_config_enabled) to `true` in the
agent's configuration file.

To use the built-in Prometheus provider
[`ui_config.metrics_provider`](/consul/docs/agent/options#ui_config_metrics_provider)
...
[`ui_config.metrics_proxy.base_url`](/consul/docs/agent/options#ui_config_metrics_proxy_base_url).
...
Similarly, to configure the UI on Kubernetes, use this [reference](/consul/docs/k8s/connect/observability/metrics).
...
file](/consul/docs/agent/options#ui_config_dashboard_url_templates) for all agents that
...
[`server.extraConfig`](/consul/docs/k8s/helm#v-server-extraconfig) key as JSON:
...
[`metrics_provider_files`](/consul/docs/agent/options#ui_config_metrics_provider_files)
...
The
[`metrics_provider_options_json`](/consul/docs/agent/options#ui_config_metrics_provider_options_json)
...
[`http_config.response_headers`](/consul/docs/agent/options#response_headers).
