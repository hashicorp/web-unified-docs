...
last_modified: 2026-07-14T23:22:46.000Z
...
gRPC](/consul/docs/agent/options#grpc_port) on your client agents. To define the
metrics destination and service protocol you may want to enable [configuration
entries](/consul/docs/agent/options#config_entries) and [centralized service
configuration](/consul/docs/agent/options#enable_central_service_config).
...
[service registration](/consul/docs/agent/services). By default, proxies only give
