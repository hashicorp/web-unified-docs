...
last_modified: 2026-07-14T23:22:23.000Z
...
[`primary_datacenter`](/consul/docs/agent/options#primary_datacenter)
...
[replication token](/consul/docs/agent/options#acl_tokens_replication) must also
