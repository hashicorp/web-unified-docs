...
last_modified: 2026-07-14T23:22:28.000Z
...
- Consul [Connect](/consul/docs/agent/options#connect) must be enabled on the datacenter's Consul servers.
- [gRPC](/consul/docs/agent/options#grpc_port) must be enabled on all client agents.
