...
last_modified: 2026-07-14T23:22:30.000Z
...
~> This topic requires familiarity with [mesh gateways](/consul/docs/connect/gateways/mesh-gateway).
...
gateways](/consul/docs/connect/gateways/mesh-gateway) to do so.
...
Any references to [`start_join_wan`](/consul/docs/agent/options#start_join_wan) or [`retry_join_wan`](/consul/docs/agent/options#retry_join_wan) should be omitted.
