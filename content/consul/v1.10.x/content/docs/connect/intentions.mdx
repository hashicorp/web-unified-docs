...
last_modified: 2026-07-14T23:22:37.000Z
...
policy](/consul/docs/agent/options#acl_default_policy). If the default ACL policy is
...
[API](/consul/api-docs/connect/intentions) or [CLI](/consul/commands/intention). Please see
