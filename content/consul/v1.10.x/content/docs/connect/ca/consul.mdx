...
last_modified: 2026-07-14T23:21:54.000Z
...
either through the `ca_config` section of the [Agent configuration](/consul/docs/agent/options#connect_ca_config) (which can only be used during the cluster's
