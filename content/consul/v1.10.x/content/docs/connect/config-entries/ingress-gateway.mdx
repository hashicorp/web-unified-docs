...
For Kubernetes, see [Kubernetes Ingress Gateway](/docs/k8s/connect/gateways/ingress-gateways) for more information.
...
See [Ingress Gateway](/docs/connect/gateways/ingress-gateway) for more information.
