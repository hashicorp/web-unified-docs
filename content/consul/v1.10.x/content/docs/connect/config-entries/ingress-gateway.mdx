...
last_modified: 2026-07-14T23:22:01.000Z
...
For Kubernetes, see [Kubernetes Ingress Gateway](/consul/docs/k8s/connect/gateways/ingress-gateways) for more information.
For other platforms, see [Ingress Gateway](/consul/docs/connect/gateways/ingress-gateway).

~> **Note:** [Configuration entries](/consul/docs/agent/config-entries) are global in scope. A configuration entry for a gateway name applies
...
See [Ingress Gateway](/consul/docs/connect/gateways/ingress-gateway) for more information.
