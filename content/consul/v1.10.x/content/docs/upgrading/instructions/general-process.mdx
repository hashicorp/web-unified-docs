...
last_modified: 2026-07-14T23:25:39.000Z
...
**2.** Temporarily modify your Consul configuration so that its [log_level](/consul/docs/agent/options#_log_level)
...
- Enterprise and OSS users with paid support plans can contact [HashiCorp Support](https://www.ibm.com/mysupport)
...
- [Debug level logs](/consul/docs/agent/options#_log_level) from all servers in the cluster
