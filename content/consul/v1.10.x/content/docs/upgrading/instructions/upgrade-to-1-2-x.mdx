...
last_modified: 2026-07-14T23:25:43.000Z
...
[General Upgrade Process](/consul/docs/upgrading/instructions/general-process). If you are on a version
older than 0.8.0, please [contact support](https://www.ibm.com/mysupport).
...
**3.** Upgrade the Consul agents in all DCs to version 1.2.4 by following our [General Upgrade Process](/consul/docs/upgrading/instructions/general-process).
