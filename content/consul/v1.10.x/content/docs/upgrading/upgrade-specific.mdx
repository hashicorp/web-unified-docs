...
last_modified: 2026-07-14T23:25:47.000Z
...
agents require that either the [`start_join`](/consul/docs/agent/options#start_join) or
[`retry_join`](/consul/docs/agent/options#retry_join) configurations are set and that they resolve to server
...
The [`enable_central_service_config`](/consul/docs/agent/options#enable_central_service_config)
...
The [`acl_enforce_version_8`](/consul/docs/agent/options#acl_enforce_version_8)
...
Consul 1.7.0 introduced [limiting of connections per client](/consul/docs/agent/options#http_max_conns_per_client). The default value
...
Consul 1.6.3 introduced [limiting of connections per client](/consul/docs/agent/options#http_max_conns_per_client). The default value
...
block](/consul/docs/agent/options#acl).
...
Multi-datacenter](/consul/docs/connect/gateways/mesh-gateway/wan-federation-via-mesh-gateways).
...
and makes them tunable via the [raft_snapshot_interval](/consul/docs/agent/options#_raft_snapshot_interval) and
[raft_snapshot_threshold](/consul/docs/agent/options#_raft_snapshot_threshold) parameters. We recommend
keeping the new defaults. However, operators can go back to the old defaults by changing their
config if they prefer more frequent snapshots. See the documentation for [raft_snapshot_interval](/consul/docs/agent/options#_raft_snapshot_interval)
and [raft_snapshot_threshold](/consul/docs/agent/options#_raft_snapshot_threshold) to understand the trade-offs
when tuning these.
...
3](/consul/docs/agent/options#_raft_protocol) had an issue where performing
...
The [`-raft-protocol`](/consul/docs/agent/options#_raft_protocol) default has
...
[`-node-id`](/consul/docs/agent/options#_node_id) instead of their IP address
...
[`-config-file`](/consul/docs/agent/options#_config_file) argument to specify a
file directly.
...
| ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `-dc`                                                  | [`-datacenter`](/consul/docs/agent/options#_datacenter)                                                                                                                       |
| `-retry-join-azure-tag-name`                           | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-azure-tag-value`                          | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-ec2-region`                               | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-ec2-tag-key`                              | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-ec2-tag-value`                            | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-gce-credentials-file`                     | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-gce-project-name`                         | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-gce-tag-name`                             | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `-retry-join-gce-zone-pattern`                         | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `addresses.rpc`                                        | None, the RPC server for CLI commands is no longer supported.                                                                                                          |
| `advertise_addrs`                                      | [`ports`](/consul/docs/agent/options#ports) with [`advertise_addr`](/consul/docs/agent/options#advertise_addr) and/or [`advertise_addr_wan`](/consul/docs/agent/options#advertise_addr_wan) |
| `dogstatsd_addr`                                       | [`telemetry.dogstatsd_addr`](/consul/docs/agent/options#telemetry-dogstatsd_addr)                                                                                             |
| `dogstatsd_tags`                                       | [`telemetry.dogstatsd_tags`](/consul/docs/agent/options#telemetry-dogstatsd_tags)                                                                                             |
| `http_api_response_headers`                            | [`http_config.response_headers`](/consul/docs/agent/options#response_headers)                                                                                                 |
...
| `retry_join_azure`                                     | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `retry_join_ec2`                                       | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
| `retry_join_gce`                                       | [`-retry-join`](/consul/docs/agent/options#_retry_join)                                                                                                                       |
...
| `statsite_prefix`                                      | [`telemetry.metrics_prefix`](/consul/docs/agent/options#telemetry-metrics_prefix)                                                                                             |
| `telemetry.statsite_prefix`                            | [`telemetry.metrics_prefix`](/consul/docs/agent/options#telemetry-metrics_prefix)                                                                                             |
| (service definitions) `serviceid`                      | [`service_id`](/consul/docs/discovery/services)                                                                                                                                   |
| (service definitions) `dockercontainerid`              | [`docker_container_id`](/consul/docs/discovery/services)                                                                                                                          |
| (service definitions) `tlsskipverify`                  | [`tls_skip_verify`](/consul/docs/discovery/services)                                                                                                                              |
| (service definitions) `deregistercriticalserviceafter` | [`deregister_critical_service_after`](/consul/docs/discovery/services)                                                                                                            |
...
[`metrics_prefix`](/consul/docs/agent/options#telemetry-metrics_prefix).
...
The format for [`-retry-join`](/consul/docs/agent/options#retry-join) and
[`-retry-join-wan`](/consul/docs/agent/options#retry-join-wan) values that use
...
A new [`enable_script_checks`](/consul/docs/agent/options#_enable_script_checks)
...
series and can be enabled with the [`-ui`](/consul/docs/agent/options#_ui)
...
[`-ui-dir`](/consul/docs/agent/options#_ui_dir) option is still available for
...
[`acl_datacenter`](/consul/docs/agent/options#acl_datacenter) must be set on
...
The default for
[`disable_remote_exec`](/consul/docs/agent/options#disable_remote_exec) was
...
to set the [`-raft-protocol`](/consul/docs/agent/options#_raft_protocol) option
...
The default for [`max_stale`](/consul/docs/agent/options#max_stale) has been
...
defaulting [`allow_stale`](/consul/docs/agent/options#allow_stale) to true for
...
[performance configuration block](/consul/docs/agent/options#performance). Also,
...
The default behavior of [`leave_on_terminate`](/consul/docs/agent/options#leave_on_terminate)
and [`skip_leave_on_interrupt`](/consul/docs/agent/options#skip_leave_on_interrupt)
...
[HTTP endpoints](/consul/docs/agent/options#translate_wan_addrs). The servers
...
[`acl_token`](/consul/docs/agent/options#acl_token) is used, so be sure
...
[Consul Tools page](/consul/docs/download-tools).
