...
2. Create the config.hcl file, all the options are available [here](/consul/docs/nia/installation/configure).
...
4. Check status of tasks. Replace port number if configured in Step 2. See additional API endpoints [here](/consul/docs/nia/api)
