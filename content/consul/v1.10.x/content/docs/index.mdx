...
- Follow [the documentation](/consul/docs/install) to install Consul either with a precompiled binary or from source.
- Read more about the [configuration options](/consul/docs/agent/options) for Consul servers and clients.
