...
last_modified: 2026-07-14T23:21:51.000Z
...
[glossary](/consul/docs/glossary) of terms to help
...
All the agents that are in a datacenter participate in a [gossip protocol](/consul/docs/architecture/gossip).
...
all peers as part of the [consensus protocol](/consul/docs/architecture/consensus). Because of this
...
more details for each of the subsystems. The [consensus protocol](/consul/docs/architecture/consensus) is
documented in detail as is the [gossip protocol](/consul/docs/architecture/gossip). The [documentation](/consul/docs/security/security-models)
