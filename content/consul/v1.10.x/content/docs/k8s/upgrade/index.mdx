...
last_modified: 2026-07-14T23:24:37.000Z
...
1. Ensure you've read the [Upgrading Consul](/consul/docs/upgrading) documentation.
1. Ensure you've read any [specific instructions](/consul/docs/upgrading/upgrade-specific) for the version you're upgrading
...
clients will be redeployed in batches. Read [Upgrading Consul](/consul/docs/upgrading) and then continue
reading below.
...
If you are using Consul's service mesh features, as opposed to the [service sync](/consul/docs/k8s/service-sync)
...
please see
[Configuring TLS on an Existing Cluster](/consul/docs/k8s/operations/tls-on-existing-cluster).
