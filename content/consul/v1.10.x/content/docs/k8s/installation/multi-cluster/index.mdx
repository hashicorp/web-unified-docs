...
last_modified: 2026-07-14T23:24:24.000Z
...
[Federation Between Kubernetes Clusters](/consul/docs/k8s/installation/multi-cluster/kubernetes)
or [Federation Between VMs and Kubernetes](/consul/docs/k8s/installation/multi-cluster/vms-and-kubernetes)
