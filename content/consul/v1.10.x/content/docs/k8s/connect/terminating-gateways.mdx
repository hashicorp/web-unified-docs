...
last_modified: 2026-07-14T23:24:09.000Z
...
~> This topic requires familiarity with [Terminating Gateways](/consul/docs/connect/gateways/terminating-gateway).
...
Once the tokens have been updated, create the [TerminatingGateway](/consul/docs/connect/config-entries/terminating-gateway)
