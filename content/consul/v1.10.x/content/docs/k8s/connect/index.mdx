...
last_modified: 2026-07-14T23:24:01.000Z
# END AUTO GENERATED METADATA
---

# Connect Service Mesh on Kubernetes

[Connect](/consul/docs/connect) is a feature built into to Consul that enables
...
When the
[Connect injector is installed](/consul/docs/k8s/connect#installation-and-configuration),
...
[`consul.hashicorp.com/connect-service-upstreams` annotation](/consul/docs/k8s/connect#consul-hashicorp-com-connect-service-upstreams),
...
- `consul.hashicorp.com/connect-service-upstreams` - The list of upstream
  ...
  - [Prepared Query](/consul/docs/connect/proxies#dynamic-upstreams-require-native-integration)
