...
last_modified: 2026-07-14T23:24:05.000Z
...
~> This topic requires familiarity with [Ingress Gateways](/consul/docs/connect/ingress-gateway).
...
See [Ingress Gateways](/consul/docs/connect/ingress-gateway) for more information on use-cases and how it works.
