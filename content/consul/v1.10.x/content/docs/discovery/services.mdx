...
last_modified: 2026-07-14T23:23:09.000Z
...
Complete the [Getting Started tutorials](/consul/tutorials) to get hands-on experience registering a simple service with a health check on your local machine.
...
- `mesh-gateway`: Defines the configuration for a [mesh gateway](/consul/docs/connect/gateways/mesh-gateway#mesh-gateway-configuration)
