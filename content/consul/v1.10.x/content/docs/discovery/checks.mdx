...
last_modified: 2026-07-14T23:23:04.000Z
...
- Script + Interval - These checks depend on invoking an external application
  ...
  - [`enable_script_checks`](/consul/docs/agent/options#_enable_script_checks): enable
...
- `Docker + Interval` - These checks depend on invoking an external application which
  ...
  must be configured with [`enable_script_checks`](/consul/docs/agent/options#_enable_script_checks)
...
check can be registered dynamically using the [HTTP API](/consul/api-docs).
...
[`enable_script_checks`](/consul/docs/agent/options#_enable_script_checks) set to `true`
...
The [enable_agent_tls_for_checks](/consul/docs/agent/options#enable_agent_tls_for_checks)
