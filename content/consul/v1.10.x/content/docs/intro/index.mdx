...
last_modified: 2026-07-14T23:23:53.000Z
...
with the basics of Consul, the [documentation](/consul/docs) provides a more
...
[in-depth architecture overview](/consul/docs/internals/architecture).
...
[here](/consul/docs/architecture/anti-entropy#catalog).
