...
last_modified: 2026-07-14T23:23:57.000Z
...
The internal [gossip protocol](/consul/docs/architecture/gossip) used within Consul is in
...
of [multiple gossip pools](/consul/docs/internals/architecture) so that
