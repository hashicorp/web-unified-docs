...
last_modified: 2026-07-14T23:23:19.000Z
...
~> **Warning:** Consul Enterprise is currently only fully supported when [ACLs are enabled](/consul/docs/ecs/get-started/production-installation#deploy-acl-controller).

Consul Enterprise [requires a license](/consul/docs/enterprise/license/overview). If running
Consul on ECS with [ACLs enabled](/consul/docs/ecs/get-started/production-installation#deploy-acl-controller), the license
