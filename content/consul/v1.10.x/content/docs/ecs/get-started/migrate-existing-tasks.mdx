...
last_modified: 2026-07-14T23:23:21.000Z
...
- Start at the [ECS Service section](/consul/docs/ecs/get-started/install#ecs-service) of the Installation Guide to continue installing Consul on ECS.
