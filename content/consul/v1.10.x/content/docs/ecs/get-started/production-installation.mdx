...
last_modified: 2026-07-14T23:23:22.000Z
...
1. [Access Control (ACLs)](/consul/docs/security/acl) for authentication and authorization for Consul clients and services on the mesh.
...
for tasks on the service mesh. To learn more about the ACL Controller, please see [Automatic ACL Token Provisioning](/consul/docs/ecs/architecture#automatic-acl-token-provisioning).
...
Start with the basic configuration for the [Task Module](/consul/docs/ecs/get-started/install#task-module) and specify additional settings to make the configuration production-ready.
...
Now you can deploy your services! Follow the rest of the steps in the [Installation instructions](/consul/docs/ecs/get-started/install#task-module)
