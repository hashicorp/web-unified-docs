...
last_modified: 2026-07-14T23:21:34.000Z
...
[configuration files](/consul/docs/agent/options#config_entries_bootstrap)
...
server's configuration file](/consul/docs/agent/options#config_entries). When a
