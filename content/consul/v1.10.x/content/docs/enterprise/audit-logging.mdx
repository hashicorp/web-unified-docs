...
last_modified: 2026-07-14T23:23:26.000Z
...
the [`audit`](/consul/docs/agent/options#audit) stanza to the agent's configuration.
...
[ACL token](/consul/docs/security/acl#acl-tokens) which issued the request.
