...
last_modified: 2026-07-14T23:23:35.000Z
...
For more details, review the [Consul server configuration](/consul/docs/agent/options)
documentation and the [-read-replica](/consul/docs/agent/options#_read_replica)
configuration flag.
