...
last_modified: 2026-07-14T23:25:26.000Z
...
[ACL System documentation](/consul/docs/security/acl/acl-system) details the functionality
of Consul ACLs.
...
[documentation](/consul/docs/security/acl/acl-rules) to learn about rule specifications.
...
[documentation](/consul/docs/security/acl/auth-methods) to learn more about how they
...
overview, read the legacy [documentation](/consul/docs/security/acl/acl-legacy).

### ACL Migration

[The migration documentation](/consul/docs/security/acl/acl-migrate-tokens) details how to
