...
last_modified: 2026-07-14T23:19:55.000Z
...
- `Service` `(Service: nil)` - Specifies to register a service. If `ID` is not
  ...
  for service definition names for [compatibility with external DNS](/consul/docs/agent/services#service-and-tag-names-with-dns).
