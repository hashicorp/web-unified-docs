...
last_modified: 2026-07-14T23:20:13.000Z
...
- `near` `(string: "")` - Specifies a node name to sort the node list in
  ...
  [`use_streaming_backend`](/consul/docs/agent/options#use_streaming_backend) and always
...
endpoint does not support the [streaming backend](/consul/api-docs/features/blocking#streaming-backend).
