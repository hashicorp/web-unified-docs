...
last_modified: 2026-07-14T23:20:03.000Z
...
- `source` `(string: <required>)` - Specifies the source service. This
  ...
  This can take [several forms](/consul/commands/intention#source-and-destination-naming).
...
- `Permissions` `(array<IntentionPermission>)` - The list of all [additional L7
  ...
  policy](/consul/docs/agent/options#acl_default_policy).
