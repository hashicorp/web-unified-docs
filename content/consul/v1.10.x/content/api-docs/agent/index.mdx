...
last_modified: 2026-07-14T23:19:49.000Z
...
[Reloadable Configuration](/consul/docs/agent/options#reloadable-configuration)
...
[`prometheus_retention_time`](/consul/docs/agent/options#telemetry-prometheus_retention_time).
...
only if the [`acl.enable_token_persistence`](/consul/docs/agent/options#acl_enable_token_persistence)
...
[`default`](/consul/docs/agent/options#acl_tokens_default), [`agent`](/consul/docs/agent/options#acl_tokens_agent),
[`agent_master`](/consul/docs/agent/options#acl_tokens_agent_master), and
[`replication`](/consul/docs/agent/options#acl_tokens_replication).
...
The paths above correspond to the token names as found in the agent configuration:
[`acl_token`](/consul/docs/agent/options#acl_token_legacy), [`acl_agent_token`](/consul/docs/agent/options#acl_agent_token_legacy),
[`acl_agent_master_token`](/consul/docs/agent/options#acl_agent_master_token_legacy), and
[`acl_replication_token`](/consul/docs/agent/options#acl_replication_token_legacy).
