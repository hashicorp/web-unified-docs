...
last_modified: 2026-07-14T23:20:16.000Z
...
For multi-key updates, please consider using [transaction](/consul/api-docs/txn).
...
For multi-key reads, please consider using [transaction](/consul/api-docs/txn).
