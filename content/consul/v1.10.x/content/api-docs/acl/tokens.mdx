...
last_modified: 2026-07-14T23:19:42.000Z
...
- `ServiceIdentities` `(array<ServiceIdentity>)` - The list of [service
  identities](/consul/docs/security/acl/acl-system#acl-service-identities) that should be
...
- `NodeIdentities` `(array<NodeIdentity>)` - The list of [node
  identities](/consul/docs/security/acl/acl-system#acl-node-identities) that should be
