...
last_modified: 2026-07-14T23:19:34.000Z
...
management token if the [`acl.tokens.master`](/consul/docs/agent/options#acl_tokens_master)
...
- `SourceDatacenter` - The authoritative ACL datacenter that ACLs are being
  ...
  [`primary_datacenter`](/consul/docs/agent/options#primary_datacenter) configuration.
...
replication](/consul/docs/agent/options#acl_enable_token_replication) must be
