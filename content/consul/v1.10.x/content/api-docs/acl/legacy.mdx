...
last_modified: 2026-07-14T23:19:37.000Z
...
The check ACL replication endpoint has not changed between the legacy system and the new system. Review the [latest documentation](/consul/api-docs/acl/acl#check-acl-replication) to learn more about this endpoint.
