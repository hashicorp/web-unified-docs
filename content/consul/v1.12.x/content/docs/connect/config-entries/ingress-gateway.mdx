...
Refer to the [Kubernetes Ingress Gateway](/docs/k8s/connect/gateways/ingress-gateways) documentation for information about configuring ingress gateways on Kubernetes.
