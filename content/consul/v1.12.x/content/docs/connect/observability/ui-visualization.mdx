...
[`ui_config.enabled`](/docs/agent/config/config-files#ui_config_enabled) to `true` in the
agent's configuration file.

To use the built-in Prometheus provider
[`ui_config.metrics_provider`](/docs/agent/config/config-files#ui_config_metrics_provider)
...
file](/docs/agent/config/config-files#ui_config_dashboard_url_templates) for all agents that
