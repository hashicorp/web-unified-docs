...
See [`disable_anonymous_signature`](/docs/agent/config/config-files#disable_anonymous_signature)
and [`disable_update_check`](/docs/agent/config/config-files#disable_update_check).
...
The [Ports Used](/docs/agent/config/config-files#ports) section of the Configuration
...
[`kv_max_value_size`](/docs/agent/config/config-files#kv_max_value_size) configuration option.
