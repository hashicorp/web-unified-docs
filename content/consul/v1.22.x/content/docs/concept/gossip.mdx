...
Refer to the [Serf documentation](https://github.com/hashicorp/serf/blob/master/docs/architecture/gossip.html.markdown) for additional information about the gossip protocol.
...
[Serf gossip protocol guide](https://github.com/hashicorp/serf/blob/master/docs/architecture/gossip.html.markdown#lifeguard-enhancements)
