...
1. [Add service intentions that allow the API gateway](/consul/docs/secure-mesh/intention) to send traffic to services in the mesh. For an example configuration, refer to the [service intention configuration reference](/consul/docs/reference/config-entry/service-intentions#examples).
