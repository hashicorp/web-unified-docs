...
last_modified: 2026-01-23T13:22:04-08:00
...
- `global` ((#v-global)) - Holds values that affect multiple components of the chart.
  ...
  - `extraLabels` ((#v-global-extralabels)) (`map`) - Enables installing an HCP Consul Central self-managed cluster.
...
- `server` ((#v-server)) - Server, when enabled, configures a server cluster to run. This should
  ...
  - `extraInitContainers` ((#v-server-extrainitcontainers)) (`array<map>`) - A list of additinal init containers.
    Example:
...
- `client` ((#v-client)) - Values that configure running a Consul client on Kubernetes nodes.
  ...
  - `extraInitContainers` ((#v-client-extrainitcontainers)) (`array<map>`) - A list of additinal init containers.
    Example:
