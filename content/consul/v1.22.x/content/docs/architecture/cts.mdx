...
CTS runs as a daemon, and integrates your Consul service network with your Terraform network infrastructure to automatically scale both services and their underlying infrastructure up and down in response to network events such as traffic spikes and physical datacenter outages.
