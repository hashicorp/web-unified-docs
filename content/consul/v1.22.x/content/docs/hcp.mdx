...
In addition, you must migrate to an Enterprise cluster, which requires an Enterprise license. Migrating to Community edition clusters is not possible. If you do not have access to a Consul Enterprise license, [file a support request to let us know](https://www.ibm.com/mysupport). A member of the account team will reach out to assist you.
...
As of November 12, 2025, you cannot take a snapshot of an HCP Dedicated cluster. We will retain cluster snapshots for 30 days. [Contact HCP support](https://www.ibm.com/mysupport) if you need help accessing your most recent snapshot.
...
If have questions or need additional help when migrating to a self-managed Consul Enterprise cluster, [submit a request to our support team](https://www.ibm.com/mysupport).
