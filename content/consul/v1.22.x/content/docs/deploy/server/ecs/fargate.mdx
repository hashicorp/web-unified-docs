...
This page describes the process to deploy Consul servers to Amazon Web Services Fargate to support Consul tasks in the AWS ECS runtime. To learn how to run Consul on ECS with servers in a different runtime, refer to [Integrate your AWS ECS services into Consul service mesh](/consul/tutorials/connect-services/consul-ecs).
