...
To learn how to use Vault to manage Consul's ACL token generation refer to [Use Vault for ACL management with Consul on VMs](/consul/docs/secure/acl/vault/vm).
