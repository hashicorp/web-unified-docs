...
~> **Note:** The Consul license has been updated. Please ensure your servers and clients are upgraded to 1.21.7 or later before applying the renewed license. Your existing license is compatible with newer versions of Consul, so no downtime is expected.
