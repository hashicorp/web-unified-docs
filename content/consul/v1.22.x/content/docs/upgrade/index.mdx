...
last_modified: 2026-04-16T16:40:26.000Z
# END AUTO GENERATED METADATA
---

<Note> 

The Consul license has been updated. Please ensure your servers and clients are upgraded to 1.21.7 or later before applying the renewed license. Your existing license is compatible with newer versions of Consul, so no downtime is expected.
...
Beginning in v1.21, Consul licensing moved from HashiCorp to IBM. IBM offers two types of Consul Enterprise licenses: Standard and Premium. To review the full scope of the IBM licenses and their supported features, refer to [Consul Enterprise IBM licenses](/consul/docs/enterprise#ibm-consul-licenses).
