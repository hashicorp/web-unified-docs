...
last_modified: 2026-06-09T15:38:31.000Z
...
<VideoEmbed url="https://www.youtube.com/watch?v=mxeMdl0KvBI"/>
...
Consul supports both IPv4 and IPv6 networks. To learn more about Consul's service discovery features and how they compares to similar products, refer to [Consul compared to other DNS tools](/consul/docs/use-case/dns).
