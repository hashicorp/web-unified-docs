...
-> **1.3.0 and earlier:** This guide only applies in Consul versions 1.3.0 and before. If you are using the 1.4.0 or later please use the updated guide [here](/docs/guides/acl)
...
The [ACL guide](/docs/guides/acl) and [legacy ACL
guide](/docs/guides/acl-legacy) describes the new and old systems in
...
[`primary_datacenter`](/docs/agent/options#primary_datacenter) which enables ACL
...
For more detailed documentation, see the [Consul Sentinel Guide](/docs/guides/sentinel).
...
Consul clients must have [`primary_datacenter`](/docs/agent/options#primary_datacenter) configured
