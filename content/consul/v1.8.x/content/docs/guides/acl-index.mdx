...
The ACL system in Consul 1.3.1 and older is now called legacy. For information on bootstrapping the legacy system, ACL rules, and a general ACL system overview, read the legacy [documentation](/docs/security/acl/acl-legacy).

### ACL Migration

[The migration documentation](/docs/security/acl/acl-migrate-tokens) details how to upgrade
