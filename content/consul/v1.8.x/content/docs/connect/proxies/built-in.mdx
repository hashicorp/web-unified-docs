...
~> **Note:** [Envoy](/docs/connect/proxies/envoy) should be used for production deployments, or when [layer 7 traffic management](/docs/connect/l7-traffic) features are needed.
...
- `tcp_check_address` - The address the agent will
  run a [TCP health check](/docs/discovery/checks) against. By default this is the same
