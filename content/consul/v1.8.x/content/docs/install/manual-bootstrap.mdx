...
datacenter provide the [`-bootstrap` configuration option](/docs/agent/options#_bootstrap).
...
[deployment table](/docs/architecture/consensus#toc_4) that covers various
