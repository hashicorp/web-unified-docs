...
- [HTTP routes](/consul/docs/connect/config-entries/http-route) and [TCP routes](/consul/docs/connect/config-entries/tcp-route): The routes attach to listeners defined in the gateway and control how requests route to services in the network.
...
Refer to [HTTP Route Configuration Entry Reference](/consul/docs/connect/config-entries/http-route)
and [TCP Route Configuration Entry Reference](/consul/docs/connect/config-entries/tcp-route) for details about route configurations.
