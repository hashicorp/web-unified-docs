...
To test the high availability failover process, contact [HCP support](https://support.hashicorp.com/hc/en-us/requests/new) to coordinate a controlled failover test.
