---
page_title: Configure HCP Vault Dedicated audit log streaming to DataDog
...
1. From the **Enable audit logs streaming** view, select **Datadog** as the
   provider and click **Next**.

1. Under **Datadog configuration**, enter your **API Key** and select the
   **Datadog site region** that matches your existing Datadog environment.
...
documentation](https://docs.datadoghq.com/getting_started/logs/#explore-your-logs)
