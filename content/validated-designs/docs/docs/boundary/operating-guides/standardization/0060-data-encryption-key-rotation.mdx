---
title: Data encryption and key rotation 
description: Secure data at rest and in transit with Boundary's encryption framework and implement regular key rotation practices.
