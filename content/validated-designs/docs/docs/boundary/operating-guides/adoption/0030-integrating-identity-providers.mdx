---
title: Integrating identity providers
description: Integrate Boundary with LDAP, Active Directory, or OIDC providers to enable centralized user authentication and SSO.
