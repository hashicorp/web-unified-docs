...
- [Client-to-controller](/validated-designs/boundary-solution-design-guides-boundary-enterprise/detailed-design#client-to-controller)
- [Worker-to-controller](/validated-designs/boundary-solution-design-guides-boundary-enterprise/detailed-design#worker-to-controller)
- [Worker-to-worker (multi-hop sessions)](/validated-designs/boundary-solution-design-guides-boundary-enterprise/detailed-design#worker-to-worker-(multi-hop-sessions))
