---
page_title: Credential store management
description: Configure and manage Boundary credential stores and credential libraries, including static and Vault-backed stores.
...
This page covers the operator setup and management of credential stores. For how users consume brokered credentials, see the User Guide: [Credential management](/validated-designs/boundary/user-guide/credential-management).
