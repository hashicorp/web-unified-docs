---
page_title: Administrative governance
description: Monitor user access, manage sessions, and maintain compliance with Boundary's system of record for remote session activities.
