---
page_title: Transit and Transform secrets engines
description: Use Vault Transit and Transform secrets engines for cryptographic and data-protection workflows.
...
# Transit and Transform secrets engines

<Note>

Transit and Transform engines, roles, access controls, and scaling are configured and managed by platform operators. See the Administration Guide: [Transit and Transform management](/validated-designs/vault/administration-guide/transit-and-transform-management).
