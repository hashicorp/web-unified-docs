---
page_title: Transit and Transform examples
description: Examples for using Vault Transit and Transform secrets engines.
...
# Transit and Transform examples
...
You can monitor the Transform FPE operations through Vault's audit logs by tracking request to the configured mount path (`healthcare-transform/`). For comprehensive guidance on configuring audit logging, refer to the [Vault validated design guidance](/validated-designs/vault/administration-guide/introduction).
