---
page_title: Post-installation configuration
description: Complete first-run Vault Enterprise configuration, including audit devices and namespace bootstrap.
...
This page covers first-run configuration after the Vault cluster is deployed. Ongoing namespace, authentication, and policy administration is covered in the Administration Guide.
