---
page_title: Deploying Vault Enterprise in a private datacenter
...
This section details the steps to create a Vault cluster manually in a private datacenter. This guide assumes that you have already read the [Detailed Design](/validated-designs/vault/installation-guide/vms/detailed-design) section of this guide and have a basic understanding of the Vault architecture and the steps required to deploy Vault in a private datacenter.
...
Configure your load balancer with a new frontend for Vault that will route incoming traffic on TCP port 8200 to the Vault servers on TCP port 8200. Refer to the [Detailed Design](/validated-designs/vault/installation-guide/vms/detailed-design) section of the guide for more information on how to configure the load balancer.
...
Configuration of Vault snapshots can be found in [Vault: validated design guidance](/validated-designs/vault/administration-guide/introduction).
