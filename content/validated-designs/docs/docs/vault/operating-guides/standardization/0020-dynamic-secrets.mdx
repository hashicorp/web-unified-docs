...
description: Learn how to generate temporary, lease-based credentials for cloud services, databases, and other systems using Vault dynamic secrets.
...
A list of Vault integrations can be found here: <a href="https://developer.hashicorp.com/vault/integrations" target="_blank" rel="noreferrer">https://developer.hashicorp.com/vault/integrations</a>. 
...
![Dynamic Secret Network Considerations](/img/vault/operating-guides/standardization/image2.png)
...
![Dynamic Secret Network Considerations DR](/img/vault/operating-guides/standardization/image3.png)
...
![Dynamic Secret Network Considerations DR](/img/vault/operating-guides/standardization/image4.png)
...
Define the appropriate RBAC and account creation statements for your root and dynamic users with the help of your identity and access team and a cloud platform SME or database SME in your organization. For some examples related to specific databases, see the section of this document titled <a href="https://docs.google.com/document/d/1qxWGJ94BaKn_pAAoBBZMI91siM_C1Lj970jMpy_2yPE/edit#heading=h.gav5ttk3sqy" target="_blank" rel="noreferrer">Database account creation examples</a>. 
...
![Database Secrets Engine](/img/vault/operating-guides/standardization/image5.png)
...
For more information, see the server and API documentation: <a href="https://developer.hashicorp.com/vault/docs/secrets/databases" target="_blank" rel="noreferrer">https://developer.hashicorp.com/vault/docs/secrets/databases</a> and

<a href="https://developer.hashicorp.com/vault/api-docs/secret/databases#configure-connection" target="_blank" rel="noreferrer">https://developer.hashicorp.com/vault/api-docs/secret/databases#configure-connection</a>
...
The next command creates the role in Vault, using the statements from a file. The `db_name` value _must match_ the name of the database secrets engine object created earlier (not the database hostname). In this example, it is `postgresql`.
...
While DynamoDB is not supported by the database secrets engine, you can use the<a href="https://developer.hashicorp.com/vault/docs/secrets/databases#aws-dynamodb" target="_blank" rel="noreferrer"> AWS secrets engine</a> to provision dynamic credentials capable of accessing DynamoDB.

More information can be found here: <a href="https://developer.hashicorp.com/vault/docs/secrets/databases#aws-dynamodb" target="_blank" rel="noreferrer">https://developer.hashicorp.com/vault/docs/secrets/databases#aws-dynamodb</a>
...
More information about using Vault to manage DB2 credentials can be found here: <a href="https://developer.hashicorp.com/vault/tutorials/db-credentials/ibm-db2-openldap" target="_blank" rel="noreferrer">https://developer.hashicorp.com/vault/tutorials/db-credentials/ibm-db2-openldap</a>
