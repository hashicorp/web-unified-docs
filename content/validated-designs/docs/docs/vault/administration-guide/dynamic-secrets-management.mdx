---
page_title: Dynamic secrets management
...
A full list of Vault integrations is available in the <a href="https://developer.hashicorp.com/vault/integrations" target="_blank" rel="noreferrer">Vault integrations directory</a>.
...
For more information, see the <a href="https://developer.hashicorp.com/vault/docs/secrets/databases" target="_blank" rel="noreferrer">database secrets engine documentation</a> and the <a href="https://developer.hashicorp.com/vault/api-docs/secret/databases#configure-connection" target="_blank" rel="noreferrer">configure connection API reference</a>.
...
For more information, see the <a href="https://developer.hashicorp.com/vault/tutorials/db-credentials/ibm-db2-openldap" target="_blank" rel="noreferrer">IBM Db2 and OpenLDAP tutorial</a>.
