---
page_title: PKI certificate management
description: Design, configure, and govern Vault PKI certificate authority and access-control patterns.
...
This page covers the operator setup and management of Vault PKI. For certificate consumption workflows, see the User Guide: [PKI certificates](/validated-designs/vault/user-guide/pki-certificates).
