---
page_title: Secrets sync management
description: Configure and manage Vault Secrets Sync destinations, policies, lifecycle, and automation.
...
# Secrets sync management

<Note>

This page covers the operator setup and management of Secrets Sync. For how users consume the synchronized-secret workflow, see the User Guide: [Secrets Sync](/validated-designs/vault/user-guide/secrets-sync).
