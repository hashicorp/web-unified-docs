---
page_title: Monitoring and observability
description: Monitor Vault Enterprise, review audit and operational logs, and respond to incidents during day-2 operations.
...
This page covers recurring monitoring, alert response, audit-log review, operational-log review, and incident response. For install-time telemetry and health endpoint setup, see the Installation Guide: [Observability setup](/validated-designs/vault/installation-guide/vms/observability-setup).
...
The Vault [Installation Guide](/validated-designs/vault/installation-guide/vms/detailed-design#telemetry-stanza) explains how to configure the telemetry stanza in your Vault configuration.
...
Audit devices record a detailed audit log of requests and responses from Vault, helping organizations meet their compliance requirements. Refer to the [Vault audit log entry schema](https://developer.hashicorp.com/vault/docs/audit/schema) for the full description of request and response objects. Enable at least one audit device or Vault does not respond to requests as it cannot log them.
