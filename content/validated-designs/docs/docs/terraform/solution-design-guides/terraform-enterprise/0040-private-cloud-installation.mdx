...
description: Best practices for deploying Terraform Enterprise on private cloud infrastructure.
...
The supported Redis cache versions are 6.2 and later and version 7. We recommend the latter.
