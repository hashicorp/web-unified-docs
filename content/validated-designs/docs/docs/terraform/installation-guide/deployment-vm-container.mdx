...
The recommended cloud resource sizing (machine types, disk/IOPS, database, and cache) for AWS, Azure, and GCP, along with the cluster capacity calculations, are consolidated in the [Detailed design](/validated-designs/terraform/installation-guide/detailed-design#cloud-resource-sizing-reference) page.
