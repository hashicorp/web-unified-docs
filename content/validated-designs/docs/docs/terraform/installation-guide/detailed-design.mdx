...
description: Review Terraform Enterprise components, operational modes, and deployment-method decisions.
...
This page expands the Terraform Enterprise architecture into the component and operational-mode decisions that inform deployment.
...
The following diagram illustrates the logical architecture of a _`disk`_ Terraform Enterprise deployment:
