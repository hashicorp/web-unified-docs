...
description: Integrate VCS repositories with HCP Terraform using GitOps workflows and CI/CD pipelines.
...
At the time of writing, deployment group orchestration supports only auto-approve conditions.
