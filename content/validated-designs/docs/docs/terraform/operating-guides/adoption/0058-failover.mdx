---
title: Failover Terraform Enterprise
description: Fail an instance of Terraform Enterprise between regions in a multi region context.
...
None of the commands in the tabs below use exposed, dedicated "last write" APIs. They all work by listing objects and sorting by the LastModified/timestamp metadata. For large buckets with millions of objects, this can be slow. In scaled cases, consider enabling access logging instead. See the *Terraform: Solution Design Guide* [Multiple Regions](/validated-designs/terraform-solution-design-guides-terraform-enterprise/multiple-regions) page for more information. The commands below aim to widen your toolkit for understanding more about your failover scenario.
...
1. Check to find if there are any pending objects that did not replicate to the _secondary_ region. This process depends on your cloud provider, but recommendations regarding this are in the *Terraform: Solution Design Guide* [Multiple Regions](/validated-designs/terraform-solution-design-guides-terraform-enterprise/multiple-regions) page.
