---
title: Introduction
description: Learn how to adopt Terraform Enterprise for infrastructure-as-code as a shared service for your organization.
...
This document gives recommendations on how to implement Terraform infrastructure-as-code (IaC) as a shared service for your organization. Different organizations call the team responsible for this task different names, including the _platform team_ or _cloud center of excellence_ (CCoE). Irrespective, this document helps teams responsible for owning Terraform IaC in their organization.
...
- <a href="https://developer.hashicorp.com/validated-designs/terraform-solution-design-guides-terraform-enterprise" target="_blank" rel="noreferrer">Terraform: Solution Design Guide</a> (Self-Managed)
...
2. **Mitigate risk:** By securing Terraform state, protecting cloud credentials, and implementing RBAC (role-based access control), risk associated with your infrastructure reduces.
...
5. **Optimize cloud cost**: By implementing a central shared service for provisioning, you are more able to optimize cloud spend and costs. Standardizing and enforcing best practices on visibility into deployments across the organization minimizes resource sprawl. This guide is a necessary prerequisite towards this goal.
...
1. Establish regular cadences with the HashiCorp account team and participate in quarterly business reviews with sponsoring executives.
1. Enablement plan:
...
1. Business unit onboarding schedule: Create a schedule for onboarding business units and application teams. We recommend for the "adopt" phase that you start with one or a handful of business units. (see note below)
...
1. Establish core integrations:
   ...
   6. Audit logs
1. Establish a workflow to onboard application teams to HCP Terraform/Enterprise:
   - Workflow vending
   - Cloud credentials for Terraform
1. Test of initial end-to-end command line-driven run.
1. Test of end-to-end VCS-driven run.
1. Test SSO for the platform team and application teams.
1. Initial discussions with first set of early adopter teams regarding user onboarding experience and updates to the project backlog with next step improvements

#### Adoption checklist

1. Determine the consumption model most suited for your organization.
1. Establish a GitOps-based workflow for application teams. Map this to your existing organizational git repository standards.
1. Branching strategy: Decide on the branching strategy for managing environments.
1. Complete an adoption maturity assessment with a HashiCorp solution architect.
