...
description: Automate governance and compliance with HashiCorp Sentinel policy-as-code framework.
...
* HashiCorp's upcoming “HVD Terraform Operating Guide — Scale” will cover how to set up scaled policy authoring, including [automated mock generation](https://developer.hashicorp.com/terraform/cloud-docs/api-docs/plan-exports) for unit testing. 
