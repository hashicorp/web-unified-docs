...
description: Detect drift and validate infrastructure health with automated assessments.
...
* **Continuous validation:** Terraform doesn't just build your infrastructure – it enforces your standards over time. Set up rules for security, cost, or anything important, and Continuous Validation checks that they're always being met. Continuous Validation will be covered in the HVD Terraform — Scaling Guide. Please refer to [Docs](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/health#continuous-validation) for more details on Continuous Validation.
