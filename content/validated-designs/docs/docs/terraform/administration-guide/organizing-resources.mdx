---
page_title: Organizing resources
description: Design and manage Terraform organizations, projects, workspaces, and Stacks.
...
| ------------------------------------------------------------ | ----------------------------- | --------------- | ------------------------------- |
| Manage everything as **one unit**                            | Yes                           | Yes             | No                              |
| Repeat **selected components** across regions/accounts       | Yes                           | No              | No                              |
| Repeat the **entire Stack** across environments or contexts  | No                            | Yes             | No                              |
| Repeat across **regions**                                    | Yes                           | Yes             | Only if hard isolation needed   |
| Repeat across **environments** (dev, staging, prod)          | No                            | Yes             | Maybe (for strict separation)   |
| Use different **credentials or roles** per scope             | No                            | Yes             | Maybe (for org boundaries)      |
| Require different **orchestration or approval flows**        | No                            | Yes             | Yes                             |
| Infrastructure managed by **different teams**                | No                            | No              | Yes                             |
| **Differently scoped infrastructure** (shared base infra and per-app infra) | No                            | No              | Yes                             |
| Different **lifecycle or release schedule**                  | No                            | No              | Yes                             |
| Require **separate VCS branch or workflow**                  | No                            | No              | Yes                             |
