---
page_title: Private registry management
description: Publish, curate, and maintain Terraform modules and providers in the private registry.
...
This page covers operator setup and management of the private registry. For how users discover and consume modules and providers, see the User Guide: [Private Registry](/validated-designs/terraform/user-guide/private-registry).
...
### Publishing public providers or modules to an air-gapped private registry
...
![Publishing public providers or modules air-gapped](/img/terraform/operating-guides/standardization/publishing-public-providers-or-modules-airgapped.png)

For additional information and detailed examples, please refer to the [Publishing Public Providers in an Air-Gapped Terraform Enterprise](https://developer.hashicorp.com/terraform/enterprise/registry/airgapped-providers) section of the documentation.
