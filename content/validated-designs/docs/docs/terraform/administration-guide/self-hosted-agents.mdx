---
page_title: Self-hosted agents
description: Operate self-hosted Terraform agent capacity, images, deployment, authentication, and network access.
...
This page covers Terraform Enterprise self-hosted agent operations. HCP Terraform is operated by HashiCorp; HCP-only request forwarding guidance is marked inline where relevant.
...
<Note>
<p>This section is covered to some extent in <a href='/validated-designs/terraform/administration-guide/identity-and-access-management#hcp-terraform-agents'>/validated-designs/terraform/administration-guide/identity-and-access-management#hcp-terraform-agents</a>. Following contents are an extension to the same </p>
