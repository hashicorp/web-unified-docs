...
description: Bring existing infrastructure resources under Terraform management.
...
- Placing common resources together into modules helps standardize Terraform consumption.
