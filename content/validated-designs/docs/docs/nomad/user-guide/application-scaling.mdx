---
page_title: Application scaling
...
1. [**APM (Application Performance Monitoring)**](https://developer.hashicorp.com/nomad/tools/autoscaling/plugins/apm): Collects metrics from either Nomad API, Prometheus, or Datadog.
    Nomad Enterprise operators configured this on the client node configuration file and in the Autoscaler job specification. Prometheus is the recommended APM. See the [Observability](/validated-designs/nomad/administration-guide/observability-and-alert-management) section.
...
Implement [Service Discovery](/validated-designs/nomad/user-guide/service-discovery) or [Service Mesh](https://developer.hashicorp.com/nomad/tutorials/integrate-consul/consul-service-mesh) to dynamically manage network identities and route traffic appropriately.
