...
- Leverage [resource quotas](/validated-designs/nomad-operating-guides-nomad-enterprise/resource-quotas) to restrict resource utilization within a namespace.
