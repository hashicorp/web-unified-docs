...
description: Configure mTLS, ACLs, backups, and infrastructure-as-code workflows after deploying Nomad Enterprise.
...
2. [Enable and configure access control lists and OIDC for RBAC](/validated-designs/nomad-operating-guides-nomad-enterprise/identity-access-management)
3. [Set up automated upgrades to ensure Nomad cluster stays up-to-date with the latest features and security patches](/validated-designs/nomad-operating-guides-nomad-enterprise/automated-upgrades)
4. [Implement a robust backup strategy to protect your Nomad cluster's state and configuration](/validated-designs/nomad-operating-guides-nomad-enterprise/backups)
...
6. [Use Terraform to manage Nomad configuration as code, enabling version control and reproducibility](/validated-designs/nomad-operating-guides-nomad-enterprise/initial-configuration#configure-nomad-as-code)
