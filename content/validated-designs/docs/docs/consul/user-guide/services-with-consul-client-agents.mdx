---
page_title: Services with Consul client agents
description: Deploy services with Consul client agents on VMs using immutable infrastructure and CI/CD.
...
# Services with Consul client agents
