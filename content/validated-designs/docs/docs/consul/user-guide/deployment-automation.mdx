...
- **Teams and responsibilities**
    ...
    For more details, refer to the People and process section of the [Operating Guide for Adoption](/validated-designs/consul/administration-guide/people-and-process)document.
...
Deploying Consul servers on VMs is HashiCorp’s recommended approach. For more details, please refer to the [Solution Design Guide](/validated-designs/consul/installation-guide/consul-on-vm#recommended-deployment-architecture).
