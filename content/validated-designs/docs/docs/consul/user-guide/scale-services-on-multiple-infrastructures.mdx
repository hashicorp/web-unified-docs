...
Organizations adopting Consul service mesh can find a compatibility matrix, list of supported features, and technical constraints in the [Consul Installation Guide](/validated-designs/consul/installation-guide/consul-on-kubernetes#kubernetes-deployment-architecture). The Helm values file given below shows the options that are recommended to turn on the Consul dataplane:
...
- ["Consul: Installation Guide - Detailed Design"](/validated-designs/consul/installation-guide/detailed-design#firewalls)
