---
page_title: Scale services on multiple infrastructures
...
- [Consul User Guide — DNS discovery](/validated-designs/consul/user-guide/service-discovery-catalog#dns-discovery)
