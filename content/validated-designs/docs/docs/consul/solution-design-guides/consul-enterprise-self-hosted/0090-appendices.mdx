---
title: Appendices
description: Additional technical details on admin partitions, catalog sync, gossip protocol, Terraform configs, and telemetry.
