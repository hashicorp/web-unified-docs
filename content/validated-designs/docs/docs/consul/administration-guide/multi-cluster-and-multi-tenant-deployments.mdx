---
page_title: Multi-cluster and multi-tenant deployments
...
A complete HashiCorp recommended production deployment architecture can be found in the "[Consul: Installation Guide](/validated-designs/consul/installation-guide/consul-on-vm#recommended-deployment-architecture)".
