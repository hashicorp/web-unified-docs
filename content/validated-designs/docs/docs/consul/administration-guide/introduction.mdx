...
When using Consul Enterprise (Self-managed / Self-Hosted version of HCP Consul), this guide assumes that you have a basic understanding of Consul and have reviewed or implemented the [Consul Enterprise Solution Design Guide](/validated-designs/consul/installation-guide/introduction).
...
The following is a sample high-level architecture diagram that shows the Consul Enterprise deployment this Operating Guide recommends.  The Consul Enterprise server agents are deployed by the Terraform module from the [Solution Design Guide](/validated-designs/consul/installation-guide/deploying-consul-using-terraform).  Client workloads running in Amazon EKS are segregated into Consul Enterprise Admin Partitions corresponding to each Kubernetes cluster.

![Consul AWS Architecture](/img/consul/operating-guides/adoption/hvd-consul-oga-high-level-architecture.svg)

## Legacy maturity model
...
![cloud Adoption Framework](/img/consul/operating-guides/adoption/0000-com.png)
