---
title: Deployment
description: Installing and configuring Consul across multi-cloud, multi-runtime environments with mesh gateways and peering.
...
- **Kubernetes Environments:** Provision AWS EKS and Azure AKS clusters. Follow our recommendations for sizing and architecture described in the [Consul Solution Design Guidelines](/validated-designs/consul-solution-design-guides-consul-enterprise-self-hosted/consul-on-kubernetes).
- **EC2 Instances:** Provision EC2 instances that will host Consul and Nomad servers.

### Prerequisites
Walk through the following guides:
- [Configure Consul as code](/validated-designs/consul-operating-guides-adoption/initial-configuration#configure-consul-as-code)
...
### Setup DNS
Detailed instructions on configuring DNS for Kubernetes and VMs can be found in the Consul Operating Guides, under ["Initial Configuration"](/validated-designs/consul-operating-guides-adoption/initial-configuration#configure-dns-forwarding).
...
It is recommended that you refer to the cluster peering section in the [Operating Guide for Standardization](/validated-designs/consul-operating-guides-standardization/deployments#cluster-peering)documentation before proceeding with the next steps.
