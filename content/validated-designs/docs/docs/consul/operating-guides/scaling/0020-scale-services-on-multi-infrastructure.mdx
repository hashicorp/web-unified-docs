...
description: Securing service-to-service communications across clouds using identity-based networking and mesh gateways.
...
Organizations adopting Consul service mesh can find a compatibility matrix, list of supported features, and technical constraints in the [Consul Solution Design Guide](validated-designs/consul-solution-design-guides-consul-enterprise-self-hosted/consul-on-kubernetes#kubernetes-deployment-architecture). The Helm values file given below shows the options that are recommended to turn on the Consul dataplane:
...
- ["Consul: Solution Design Guide - Detailed Design"](/validated-designs/consul-solution-design-guides-consul-enterprise-self-hosted/detailed-design#firewalls)
- ["Consul: Operating Guide for Adoption - DNS discovery"](/validated-designs/consul-operating-guides-adoption/service-discovery-catalog#dns-discovery)
