---
title: Integrate with infrastructure tools
description: Automating Consul deployment and management using CI/CD pipelines and GitOps workflows.
...
- **Teams and responsibilities**
    ...
    For more details, refer to the People and process section of the [Operating Guide for Adoption](/validated-designs/consul-operating-guides-adoption/people-and-process)document.

- **Components of a typical Consul environment**

    A typical Consul environment consists of:
    - **Consul servers:** Six servers running on VMs as per the [HashiCorp Recommended Architecture](/validated-designs/consul-solution-design-guides-consul-enterprise-self-hosted/consul-on-aws-ec2#recommended-deployment-architecture).
...
Deploying Consul servers on VMs is HashiCorp’s recommended approach. For more details, please refer to the [Solution Design Guide](/validated-designs/consul-solution-design-guides-consul-enterprise-self-hosted/consul-on-aws-ec2#recommended-deployment-architecture).
