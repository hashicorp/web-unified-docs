...
description: Implementing multi-tenancy with namespaces, admin partitions, and cluster peering for scalable operations.
...
- [Bootstrap the ACL system](/validated-designs/consul-operating-guides-adoption/initial-configuration#bootstrap-the-acl-system)
...
A complete HashiCorp recommended production deployment architecture can be found in the "[Consul: Solution Design Guide](/validated-designs/consul-solution-design-guides-consul-enterprise-self-hosted/consul-on-aws-ec2#recommended-deployment-architecture)".
