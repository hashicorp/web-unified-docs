...
#### Networking
This Installation Guide deploys a highly available architecture that spans 3 availability zones. A VPC configured with private subnets to deploy Consul control plane and gateway components on AWS EC2 VMs.
