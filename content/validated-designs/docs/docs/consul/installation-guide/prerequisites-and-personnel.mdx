...
Platform teams can follow the recommended deployment architecture discussed in the [Consul Solution Design Guide](/validated-designs/consul/installation-guide/consul-on-vm) to right-size the deployment, check component compatibility, and follow the deployment sequence using the provided Terraform modules.
