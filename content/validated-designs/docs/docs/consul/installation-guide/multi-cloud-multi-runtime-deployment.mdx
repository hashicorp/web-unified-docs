---
page_title: Multi-cloud and multi-runtime deployment
...
### Setup DNS
Detailed instructions on configuring DNS for Kubernetes and VMs can be found in the Consul Installation Guide, under [Post-installation configuration](/validated-designs/consul/installation-guide/post-installation-configuration#configure-dns-forwarding).
...
It is recommended that you refer to the cluster peering section in the [Administration Guide](/validated-designs/consul/administration-guide/multi-cluster-and-multi-tenant-deployments#cluster-peering) before proceeding with the next steps.
...
- [Nomad HVD](/validated-designs/nomad-operating-guides-nomad-enterprise)
