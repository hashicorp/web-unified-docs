...
Actions](/terraform/plugin/testing/acceptance-tests/continuous-integration).
...
framework.build and verify real infrastructure. [Proceed to _Test
Cases_](/terraform/plugin/testing/acceptance-tests/testcase).
