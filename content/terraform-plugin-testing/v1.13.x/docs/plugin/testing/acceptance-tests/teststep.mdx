...
[_Import_ mode](/terraform/plugin/testing/acceptance-tests/import-mode/) is used
for testing resource functionality to import existing infrastructure into a
