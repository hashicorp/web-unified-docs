---
page_title: CSV output definitions
description: |-
  Definitions of the various fields that will be present in the CSV output.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-24T18:42:28.000Z
last_modified: 2026-04-24T18:42:28.000Z
...
The following are field definitions for fields that will be present when
scanning specific data sources.
