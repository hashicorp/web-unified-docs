...
created_at: 2026-08-24T01:04:25.000Z
last_modified: 2026-08-24T01:04:25.000Z
...
### 0.54.0
- Added volume metering support for Microsoft Teams scans
- Added volume metering support for AWS S3 scans
- Minor bug fixes and performance improvements

### 0.53.0
- Add support for identifying AWS ECR image repositories
- Minor bug fixes and performance improvements
...
- Added support to disable the activeness checks using the `config.json` for pre-commit
  hooks

### 0.49.0

- Improvements to the AWS EC2 and EBS Scanning
- Fixed a bug around resource specific custom ignore rules not being applied to Jira and
  Confluence sources
- Minor bug fixes and performance improvements
...
- Added support for Slack scanning attachments
...
- Improvements to logging around http request retries being exhausted for Confluence,
  Jira, and Slack
- AWS EC2 Runtime Scanning (Beta) support added for existing customers
- IBM Cloudant API Key detection and activeness check support added

### 0.44.0

- Fixed a bug preventing Docker scans from uploading results
- Fixed a bug where the scan timeout is not being applied for the Agent scans
- Minor bug fixes and performance improvements
...
- Added support for `scan tfe-variables` uploading results to a users HCP Vault Radar
  project
- Minor bug fixes and performance improvements

### 0.36.0

- Added support for `scan aws-parameter-store` uploading results to a users HCP Vault
  Radar project
- Minor bug fixes and performance improvements
...
- `scan folder` and `scan s3` support uploading results to a users HCP Vault Radar
  project
- Minor bug fixes and performance improvements
...
- Support for restricting repo and inline rules at the admin level
  - Please reach out to your HashiCorp support contact for more information and help
...
- New patterns added:
  ...
  - DigitalOcean tokens
- Vault Radar agent is released as a beta feature.
  [Check out the documentation for more details](/hcp/docs/vault-radar/manage/agent/overview).
...
- **Breaking Changes:**
  - This version introduces a breaking change for users that rely on `--offline` flag
    for their command usage.
    A new Vault Radar License will need to be generated and configured locally for the
    command to continue to work in offline mode.
    Please reach out to your Hashicorp customer success team to generate a new license.
- Jira user metering
...
** Note: Usage of `GITHUB_TOKEN` as a default ENV variable in the `vault-radar` binary
consumed was removed in this release.**
