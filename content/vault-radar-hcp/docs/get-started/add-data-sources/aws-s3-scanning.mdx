---
page_title: Scan AWS S3 for secrets
description: >-
  Add AWS S3 as a data source in HCP Vault Radar to scan your S3 buckets for sensitive data and secrets.
...
- [HCP Vault Radar agent](/hcp/docs/vault-radar/agent/deploy) version 0.38.0 or later
...
| S3                 | `s3:GetObjectVersion`           | [GetObject API](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html) |
| S3                 | `s3:ListBucketVersions`         | [ListObjectVersions API](https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListObjectVersions.html) |
| S3 (optional) | `s3:GetBucketPolicyStatus`           | [GetBucketPolicyStatus API](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketPolicyStatus.html) |
| S3 (optional) | `s3:GetBucketPublicAccessBlock`      | [GetPublicAccessBlock API](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetPublicAccessBlock.html) |
| S3 (optional) | `s3:GetBucketAcl`                    | [GetBucketAcl API](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketAcl.html) |
| S3 (optional) | `s3:GetObjectAcl`                    | [GetObjectAcl API](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObjectAcl.html) |

### Optional permission limitations

- `account:GetAccountInformation`: Scans without this
permission will not include the AWS account name on the UI for data source
metadata.

- `s3:GetBucketPolicyStatus`, `s3:GetBucketAcl`, `s3:GetBucketPublicAccessBlock`
  and `s3:GetObjectAcl`: Scans without these optional permissions do not include
  visibility values of the bucket or the detected secrets.
