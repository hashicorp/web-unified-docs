...
[Predefined Validators](/terraform/plugin/framework/migrating/validators-predefined) to learn how to use them.
...
- Use [predefined validators](/terraform/plugin/framework/migrating/validators-predefined) when there is a validator that meets
your requirements.
