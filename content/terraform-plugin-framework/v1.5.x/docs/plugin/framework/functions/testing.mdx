---
page_title: 'Plugin Development - Framework: Testing Functions'
description: >-
...
// The example implementation does not return any error diagnostics, however
...
func TestEchoFunctionRun(t *testing.T) {
    ...
    testCases := map[string]struct {
        ...
        // The example implementation does not return any diagnostics, however
        ...
        "value-invalid": {
            ...
            Expected: function.RunResponse{
                Diagnostics: diag.Diagnostics{
                    diag.NewArgumentErrorDiagnostic(0, "error summary", "error detail"),
                },
                Result: function.NewResultData(types.StringUnknown()),
            },
        },
