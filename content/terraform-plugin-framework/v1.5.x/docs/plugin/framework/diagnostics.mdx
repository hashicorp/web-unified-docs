...
func (f ExampleFunction) Run(ctx context.Context, req function.RunRequest, resp *function.RunResponse) {
    ...
    // Add warning diagnostic associated with first function argument position
    resp.Diagnostics.AddArgumentWarning(0, "Example Warning Summary", "Example Warning Detail")
