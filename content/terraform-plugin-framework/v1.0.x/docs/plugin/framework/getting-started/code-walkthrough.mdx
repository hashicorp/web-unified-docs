...
Examples of the various types of attributes and their representation within Terraform configuration and schema definitions is detailed in [Core Configuration Concepts](/terraform/plugin/framework/getting-started/core-configuration-concepts).
