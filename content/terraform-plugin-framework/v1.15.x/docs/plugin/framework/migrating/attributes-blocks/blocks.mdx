...
description: >-
  Learn how to migrate blocks from SDKv2 to the Terraform plugin framework.
  Blocks represent objects related to or embedded within the current block.
---
...
In the framework, implement nested blocks with the `Blocks` field of your
