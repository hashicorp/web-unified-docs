...
In the framework, you implement plan modification either by implementing the
...
functions on individual attributes. This page demonstrates how to implement the
plan modifiers on your resource type. Refer to [Attributes - Force
New](/terraform/plugin/framework/migrating/attributes-blocks/force-new) in this
guide for further information on how to implement a plan modifier on an
attribute.
