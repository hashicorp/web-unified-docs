...
or data source schema to the framework, refer to [Migrate attributes and blocks](#migrating-attributes-and-blocks) to learn how to migrate the attributes and
