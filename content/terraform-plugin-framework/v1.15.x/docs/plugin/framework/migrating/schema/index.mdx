...
This page explains the differences between the schema used by SDKv2 and the
framework.
...
or data source schema to the framework, refer to
(#migrating-attributes-and-blocks) to learn how to migrate the attributes and
blocks defined by your schema.
...
The following code blocks shows basic implementations using `schema.Schema`
...
The following code blocks shows the same section of provider, resource, and data
