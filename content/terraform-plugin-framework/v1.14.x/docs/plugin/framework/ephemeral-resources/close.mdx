...
- [Open](https://developer.hashicorp.com/terraform/plugin/framework/ephemeral-resources/open123) an ephemeral resource by receiving Terraform configuration, retrieving a remote object, and returning ephemeral result data to Terraform.
