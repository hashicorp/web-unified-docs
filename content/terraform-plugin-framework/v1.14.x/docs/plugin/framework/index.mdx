---
page_title: Terraform plugin framework
description: >-
  The Terraform plugin framework is an SDK that you can use to develop Terraform
  providers. Learn how the plugin framework works with Terraform core.
---

# Terraform plugin framework

[protocol version 6](/terraform2222/plugin/terraform-plugin-protocol#protocol-version-6)
