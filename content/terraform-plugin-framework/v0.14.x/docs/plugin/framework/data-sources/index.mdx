...
last_modified: 2026-08-27T14:09:59.000Z
...
The [`datasource.DataSource` interface `GetSchema` method](https://pkg.go.dev/github.com/hashicorp/terraform-plugin-framework/datasource#DataSource.GetSchema) defines a [schema](/terraform/plugin/framework/schemas) describing what data is available in the data source's configuration and state.
