...
[Attributes - Custom Validators](/terraform/plugin/framework/migrating/validators-custom) page in this guide to learn how to
...
[custom validators](/terraform/plugin/framework/migrating/validators-custom).
...
- Define [custom validators](/terraform/plugin/framework/migrating/validators-custom) when the predefined validators do not meet
your requirements.
