...
A resource defined with [the `count` meta-argument](/terraform/language/block/resource#count)
...
A resource defined with [the `for_each` meta-argument](/terraform/language/block/resource#for_each)
