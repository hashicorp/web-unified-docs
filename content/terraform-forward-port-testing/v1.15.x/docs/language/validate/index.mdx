...
created_at: 2026-04-29T14:16:59.000Z
last_modified: 2026-04-29T14:16:59.000Z
...
To learn more about variable validations, refer to the [input variable block](/terraform/language/block/variable#validation).
...
If the `precondition` fails, Terraform throws an error with the `error_message` and stops the current operation. Refer to the [`output` block reference](/terraform/language/block/output) for more details.
...
To learn more about the conditions you can use in validations, refer to [Conditional Expressions](/terraform/language/expressions/conditionals).
