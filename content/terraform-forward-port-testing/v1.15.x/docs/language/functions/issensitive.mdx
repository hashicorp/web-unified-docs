...
created_at: 2026-04-29T14:16:35.000Z
last_modified: 2026-04-29T14:16:35.000Z
...
[sensitive input variables](/terraform/language/block/variable#sensitive).

If a value not marked as sensitive is passed the function returns false.

See [`sensitive`](/terraform/language/functions/sensitive), [`nonsensitive`](/terraform/language/functions/nonsensitive), and [sensitive input variables](/terraform/language/block/variable#sensitive) for more information on sensitive values.
