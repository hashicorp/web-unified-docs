...
* [`provider`](/terraform/language/block/provider) blocks to configure
  providers, and the `alias` meta-argument.
* [`variable`](/terraform/language/block/variable),
  [`output`](/terraform/language/block/output), and
  [`locals`](/terraform/language/block/locals) blocks
  for declaring the various kinds of named values in a module.
* [`terraform`](/terraform/language/block/terraform) blocks, including the nested
  [`required_version`](/terraform/language/block/terraform#required_version)
  and
