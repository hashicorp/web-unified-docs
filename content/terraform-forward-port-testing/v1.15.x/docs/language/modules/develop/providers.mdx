...
created_at: 2026-04-29T14:16:52.000Z
last_modified: 2026-04-29T14:16:52.000Z
...
[default provider configurations](/terraform/language/block/provider#alias) from its parent. This means that
...
[multiple provider configurations](/terraform/language/block/provider#using-an-alternate-provider-configuration),
...
[the `provider` argument](/terraform/language/block/resource#provider)
