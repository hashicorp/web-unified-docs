...
created_at: 2026-04-29T14:16:53.000Z
last_modified: 2026-04-29T14:16:53.000Z
...
regions) before they can be used. The [`provider` block reference](/terraform/language/block/provider) documents how
...
[`terraform` block](/terraform/language/block/terraform) (which can also contain other settings).
...
name when [configuring the provider](/terraform/language/block/provider#using-an-alternate-provider-configuration):
