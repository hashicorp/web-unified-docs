...
| ------ | ----------- | ------- | -------- |
| `-config` | Specifies the path to an optional configuration file. Refer to  [`tf-migrate` configuration file reference](/terraform/migrate/reference/configuration) for more information. | None | No |
