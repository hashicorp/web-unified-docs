...
HashiCorp distributes `tf-migrate` as an executable CLI that you can install on supported operating systems, including Microsoft Windows, macOS, and several Linux distributions.
