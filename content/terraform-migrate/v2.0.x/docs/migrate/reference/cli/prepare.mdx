...
- If you would like to create a CLI or VCS-driven workspace. Refer to [supported workspace workflows](/terraform/migrate#supported-workspace-workflows) for the requirements your configuration must meet to support a VCS-driven workspace.
