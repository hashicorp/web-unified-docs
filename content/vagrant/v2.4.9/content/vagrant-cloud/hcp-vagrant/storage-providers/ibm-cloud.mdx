...
last_modified: 2026-09-16T23:27:29.000Z
...
- Your Vagrant boxes downloaded from HCP Vagrant Registry as `vagrant.box`
  files, as described in [Download your boxes](#download-your-boxes).
...
The process is the same for public and private boxes, except that a private box
...
A `--key` like `BOX_NAME/VERSION/PROVIDER/ARCHITECTURE/vagrant.box` keeps your
