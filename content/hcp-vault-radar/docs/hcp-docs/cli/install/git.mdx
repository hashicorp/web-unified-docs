...
created_at: 2026-07-02T19:16:01.000Z
last_modified: 2026-07-02T19:16:01.000Z
...
* `pre_commit_skip_activeness` - `true` results in skipping activeness checks. By default, activeness checks are enabled, i.e. the default value for this option is `false`

<Note> 

If you do not set the`fail_severity` configuration value, the default behavior is to not enforce any severity. As a result all risks identified will be allowed.
