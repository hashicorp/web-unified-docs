---
page_title: Scan Slack for secrets
description: >-
  Add Slack as a data source in HCP Vault Radar to scan your Slack channels for sensitive data and secrets.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-07-02T19:16:08.000Z
last_modified: 2026-07-02T19:16:08.000Z
# END AUTO GENERATED METADATA
---

# Scan Slack for secrets

Connect Slack as a data source to HCP Vault Radar to scan your Slack channels
for sensitive data and secrets.
...
<Highlight title="Scan up to 5000 channels">

HCP Vault Radar allows you to scan up to 5000 channels per workspace. If you
have more than 5000 channels, Vault Radar selects the 5000 channels with the
...
Learn more about the HCP Vault Radar agent in the [HCP Vault
Radar operations
...
1. Click **Install to Your Workspace**, a new page opens.
...
Return to the Slack app configuration page to verify that the app is properly
configured to listen for events.
