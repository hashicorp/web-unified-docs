...
should apply their license with the [`nomad license put ...`](/nomad/docs/commands/license/put) command.
...
[`raft_protocol_version`]: /nomad/docs/configuration/server#raft_protocol
