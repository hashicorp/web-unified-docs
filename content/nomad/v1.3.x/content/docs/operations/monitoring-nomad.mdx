...
[allocation-metrics]: /nomad/docs/telemetry/metrics#allocation-metrics
...
[metric-types]: /nomad/docs/telemetry/metrics#metric-types
...
[tagged-metrics]: /nomad/docs/telemetry/metrics#tagged-metrics
[telemetry-block]: /nomad/docs/configuration/telemetry
[Consensus Protocol (Raft)]: /nomad/docs/operations/telemetry#consensus-protocol-raft
