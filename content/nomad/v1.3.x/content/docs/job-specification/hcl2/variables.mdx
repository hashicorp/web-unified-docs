...
[expressions](/nomad/docs/job-specification/hcl2/expressions) as `var.<NAME>`, where
...
value](/nomad/docs/job-specification/hcl2/expressions#types-and-values) that will be
...
[usual syntax](/nomad/docs/job-specification/hcl2/expressions) can be used to assign
