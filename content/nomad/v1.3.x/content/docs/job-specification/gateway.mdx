...
last_modified: 2026-01-27T09:49:13-06:00
...
same network. For public ingress products like [NGINX](/nomad/tutorials/archive/load-balancing-nginx)
...
- `protocol` `(string: "tcp")` - The protocol associated with the listener. One
  ...
  set the [Protocol](/consul/docs/agent/config-entries/service-defaults#protocol)
...
[connect_timeout_ms]: /consul/docs/agent/config-entries/service-resolver#connecttimeout
...
[service-default]: /consul/docs/agent/config-entries/service-defaults
