...
last_modified: 2026-03-17T12:22:48.000Z
...
Find the source code for this plugin in the [`hashicorp/nomad-device-nvidia`
repository][source], with binaries on the [HashiCorp releases
site][nvidia_plugin_download]. To install the plugin, download the binary or
compile from source. Then place the binary in the [plugin
...
[Fingerprint RPC]: /nomad/plugins/author/device#fingerprint-context-context-chan-fingerprintresponse-error
