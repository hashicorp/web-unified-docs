...
for your Nomad client. You can find the latest release of these binaries in the
[GitLab project repository page]([gitlab-project]).
...
please raise an issue in the [GitLab project repository page][gitlab-project].
...
- [devicehunt.com](https://devicehunt.com/)

### Source Code & Compiled Binaries

The source code for this plugin can be found at
[CarbonCollins/nomad-usb-device-plugin][gitlab-project]. You
will also find pre built binaries on the releases
page.

[gitlab-project]: https://gitlab.com/CarbonCollins/nomad-usb-device-plugin