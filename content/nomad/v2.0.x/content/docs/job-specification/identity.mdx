...
created_at: 2026-02-16T16:53:52.000Z
last_modified: 2026-02-16T16:53:52.000Z
...
- `extra_claims` `[]string: nil)` - The extra claims added to the workload
  identity. The claim must be defined on the namespace as an
  `optional_extra_claim` to be successfully added. 
