...
guide](/nomad/docs/stateful-workloads/csi-volumes)
...
- [Nomad CSI plugin concepts](/nomad/docs/architecture/storage/csi)
- [Nomad CSI tutorial](/nomad/docs/stateful-workloads/csi-volumes)
...
- [Dynamic host volumes](/nomad/docs/architecture/storage/host-volumes)
- [Dynamic host volume guide](/nomad/docs/stateful-workloads/dynamic-host-volumes)
- [Custom host volume plugin](/nomad/plugins/host-volume)
