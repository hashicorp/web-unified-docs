...
[`cidrsubnet`](/nomad/docs/reference/hcl2/functions/ipnet/cidrsubnet).
...
- [`cidrsubnet`](/nomad/docs/reference/hcl2/functions/ipnet/cidrsubnet) calculates a subnet address under a given
