...
created_at: 2026-02-16T16:54:09.000Z
last_modified: 2026-02-16T16:54:09.000Z
...
returned from [`keys`](/nomad/docs/reference/hcl2/functions/collection/keys).
...
- [`keys`](/nomad/docs/reference/hcl2/functions/collection/keys) returns a list of the _keys_ from a map.
