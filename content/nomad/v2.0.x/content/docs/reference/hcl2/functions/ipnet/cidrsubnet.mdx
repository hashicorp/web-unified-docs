...
created_at: 2026-02-16T16:54:15.000Z
last_modified: 2026-02-16T16:54:15.000Z
...
Unlike the related function [`cidrsubnets`](/nomad/docs/reference/hcl2/functions/ipnet/cidrsubnets), `cidrsubnet`
...
While [`cidrhost`](/nomad/docs/reference/hcl2/functions/ipnet/cidrhost) allows calculating single host IP addresses,
...
[`cidrhost`](/nomad/docs/reference/hcl2/functions/ipnet/cidrhost) function to calculate those host addresses by
...
- [`cidrsubnets`](/nomad/docs/reference/hcl2/functions/ipnet/cidrsubnets) can allocate multiple consecutive
