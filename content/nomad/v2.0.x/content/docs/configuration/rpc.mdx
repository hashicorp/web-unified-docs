...
created_at: 2026-02-16T16:53:34.000Z
last_modified: 2026-02-16T16:53:34.000Z
...
- `dial_timeout` `(string: 10s)` - Controls the maximum amount of time allowed
  to establish new outbound RPC connections to peer servers.
