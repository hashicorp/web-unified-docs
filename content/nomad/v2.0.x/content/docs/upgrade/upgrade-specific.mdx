...
If you are upgrading from Nomad 1.8, use the [Migrate from Nomad 1.8 to Nomad
2.0](/nomad/docs/upgrade/migrate-1-8-to-2-0) guide, which consolidates all
required pre-upgrade actions and staged upgrade steps into a single workflow.
