...
created_at: 2026-02-16T16:52:41.000Z
last_modified: 2026-02-16T16:52:41.000Z
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:fail-deployment`|
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:pause-deployment`|
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:promote-deployment` |
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:set-alloc-health-deployment`|
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:unblock-deployment`|
