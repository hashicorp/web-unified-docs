...
last_modified: 2026-02-16T17:22:51.000Z
...
This allows a Nomad operator to trigger a reload of the agent's configuration
with the API. Refer to the [configuration
documentation](/nomad/docs/configuration#configuration-reload) for more details
on what configuration changes are applied on reload. 
