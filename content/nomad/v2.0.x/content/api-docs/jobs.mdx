...
created_at: 2026-02-16T16:52:42.000Z
last_modified: 2026-02-16T16:52:42.000Z
...
| Blocking Queries | ACL Required                                                                      |
| ---------------- | --------------------------------------------------------------------------------- |
| `NO`             | `namespace:submit-job` or `namespace:register-job`<br />`namespace:sentinel-override` is additionally required if `PolicyOverride` set |
...
- `PreserveResources` `(bool: false)` - If set, existing task resources are
  preserved, over those specified in the new job spec.
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:revert-job`|
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:stable-job`|
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:evaluate-job`|
...
| Blocking Queries | ACL Required                                                                      |
| ---------------- | --------------------------------------------------------------------------------- |
| `NO`             | `namespace:submit-job` or `namespace:plan-job`<br />`namespace:sentinel-override` is additionally required if `PolicyOverride` set |
...
| Blocking Queries | ACL Required                                       |
| ---------------- | -------------------------------------------------- |
| `NO`             | `namespace:dispatch-job` or `namespace:submit-job` or `namespace:force-periodic-job`|
...
| Blocking Queries | ACL Required           |
| ---------------- | ---------------------- |
| `NO`             | `namespace:submit-job` or `namespace:deregister-job` or `namespace:purge-job`|
...
| Blocking Queries | ACL Required                                                                                               |
| ---------------- | ---------------------------------------------------------------------------------------------------------- |
| `NO`             | `namespace:scale-job` or `namespace:submit-job`<br />`namespace:sentinel-override` is additionally required if `PolicyOverride` set |
...
| Blocking Queries | ACL Required                                                                                 |
| ---------------- | -------------------------------------------------------------------------------------------- |
| `NO`             | `namespace:alloc-exec` (and `namespace:alloc-node-exec` if task driver does not support [file system isolation](/nomad/plugins/author/task-driver#capabilities-capabilities-error)) |
