...
created_at: 2026-02-16T16:53:03.000Z
last_modified: 2026-02-16T16:53:03.000Z
...
Please note, that using this command against a PAO Installation Key will display the license inspect block below for each Nomad entitlement included in the PAO Key. Use `nomad license get` to display only the active license.
