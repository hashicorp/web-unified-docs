...
created_at: 2026-02-16T16:53:00.000Z
last_modified: 2026-02-16T16:53:00.000Z
...
- `-json-output`: Output the plan result in JSON format. This is separate from
  `-json`, which controls input job file parsing.

- `-t`: Format and display the plan result using a Go template.
