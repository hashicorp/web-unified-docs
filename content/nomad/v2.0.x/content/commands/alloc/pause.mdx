...
created_at: 2026-02-16T16:52:55.000Z
last_modified: 2026-02-16T16:52:55.000Z
...
When ACLs are enabled, this command requires either the `submit-job` or
`pause-allocation` capability for the allocation's namespace.
