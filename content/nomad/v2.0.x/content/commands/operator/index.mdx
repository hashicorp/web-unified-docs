...
last_modified: 2026-02-16T17:22:53.000Z
...
- [`operator raft migrate-backend`][migrate-backend] - Migrate the Raft log
  store from BoltDB to WAL backend
...
[gossip_keyring_list]: /nomad/commands/operator/gossip/keyring-list 'List
    available gossip encryption keys'
[migrate-backend]: /nomad/commands/operator/raft/migrate-backend
