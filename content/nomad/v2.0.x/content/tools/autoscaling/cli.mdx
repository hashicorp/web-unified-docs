...
created_at: 2026-02-16T16:54:42.000Z
last_modified: 2026-02-16T16:54:42.000Z
...
- `-nomad-namespace=<namespace>`: The namespace to monitor for scaling policies.
  Specify the flag multiple times to monitor policies across several namespaces.
  Use `*` to monitor all namespaces.
