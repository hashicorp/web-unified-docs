...
- [Nomad Pack](/nomad/docs/tools/nomad-pack) - An official package manager and templating tool for Nomad, currently a Tech Preview.
...
- [Caravan](https://github.com/bitrockteam/caravan/wiki) - Caravan is a tool to deploy and configure Nomad, Consul and Vault to AWS, Azure, or GCP, all with a single script.
...
- [Nomad MCP Server](https://github.com/kocierik/mcp-nomad) - An MCP server that exposes Nomad APIs to AI agents, enabling LLM-driven automation, job management, diagnostics, and cluster operations.
...
- [Nomad Port Forward](https://github.com/Mongey/nomad-port-forward) - A tool
  for forwarding ports from a Nomad job to your local machine
- [Nomad State Metrics](https://github.com/bhope/nomad-state-metrics) - A
  Prometheus exporter that generates metrics about the state of Nomad objects
  such as jobs, allocations, nodes, and deployments.
- [Nomad Toast](https://github.com/jrasell/nomad-toast) - A tool for receiving notifications based on HashiCorp Nomad events
- [Nomad Tools](https://github.com/Kamilcuk/nomad-tools) - Set of tools and utilities to ease interacting with HashiCorp Nomad scheduling solution.
