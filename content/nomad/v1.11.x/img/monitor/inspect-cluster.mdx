...
[img-client-allocations]: /img/nomad/web-ui/guide-ui-img-client-allocations.png
[img-client-attributes]: /img/nomad/web-ui/guide-ui-img-client-attributes.png
[img-client-detail]: /img/nomad/web-ui/guide-ui-img-client-detail.png
[img-client-drain]: /img/nomad/web-ui/guide-ui-img-client-drain.png
[img-client-driver-status]: /img/nomad/web-ui/guide-ui-img-client-driver-status.png
[img-client-events]: /img/nomad/web-ui/guide-ui-img-client-events.png
[img-client-resource-utilization]: /img/nomad/web-ui/guide-ui-img-client-resource-utilization.png
[img-clients-filters]: /img/nomad/web-ui/guide-ui-img-clients-filters.png
[img-clients-list]: /img/nomad/web-ui/guide-ui-img-clients-list.png
[img-server-detail]: /img/nomad/web-ui/guide-ui-img-server-detail.png
[img-servers-list]: /img/nomad/web-ui/guide-ui-img-servers-list.png
[metadata]: /nomad/docs/configuration/client#meta
[performed from the cli]: /nomad/tutorials/manage-clusters/node-drain
[securing the web ui with acls]: /nomad/tutorials/archive/access-control
[typically three or five]: /nomad/docs/architecture/consensus#deployment-table
