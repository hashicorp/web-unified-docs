...
| Blocking Queries | ACL Required                                                                      |
| ---------------- | --------------------------------------------------------------------------------- |
| `NO`             | `namespace:submit-job` or `namespace:register-job`<br />`namespace:sentinel-override` if `PolicyOverride` set |
...
| Blocking Queries | ACL Required                                                                      |
| ---------------- | --------------------------------------------------------------------------------- |
| `NO`             | `namespace:submit-job` or `namespace:plan-job`<br />`namespace:sentinel-override` if `PolicyOverride` set |
