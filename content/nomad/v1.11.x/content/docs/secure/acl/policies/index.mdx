...
Additionally, even finer-grain `capabilities` exist to grant explicit abilities
...
specific sets of ability. They include 
...
- `delete-service-registration` - Allows an individual service registration to be deleted, usually used by operators.
