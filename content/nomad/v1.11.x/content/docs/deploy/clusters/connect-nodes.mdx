...
[`nomad node intro create` command] or the
[`/v1/acl/identity/client-introduction-token` API endpoint](/nomad/api-docs/acl/identities#create-client-introduction-identity).
