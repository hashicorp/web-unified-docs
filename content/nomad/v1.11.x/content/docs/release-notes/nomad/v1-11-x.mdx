...
We added optional client fingerprinter configuration fields that you may use to
control how the environment fingerprinters perform retries and whether errors
should halt the agent startup. Refer to the [client `fingerprint` parameters
documentation](/nomad/docs/configuration/client#fingerprint-parameters) for
details.
