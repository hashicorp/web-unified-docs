...
created_at: 2026-02-16T16:53:43.000Z
last_modified: 2026-02-16T16:53:43.000Z
...
[![Nomad Job page with Actions dropdown open](/img/actions/actions-dropdown.png)](/img/actions/actions-dropdown.png)

Selecting one of those actions will open a fly-out, complete with output from your selected action:

[![Nomad Job page with Actions flyout open](/img/actions/actions-flyout.png)](/img/actions/actions-flyout.png)
...
[![Non-terminating Nomad Action run via the UI](/img/actions/actions-health-check.png)](/img/actions/actions-health-check.png)
