---
layout: intro
page_title: Introduction to Nomad
description: >-
...
See the [Use Cases](/nomad/intro/use-cases) page to understand the many ways Nomad is used in production today across many industries to solve critical, real-world business objectives.
