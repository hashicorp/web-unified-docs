...
last_modified: 2026-03-17T12:22:37.000Z
...
If you enabled ACLs, you must supply a token with the `operator:write` policy or
the `operator:snapshot-save` capability to save snapshots.
