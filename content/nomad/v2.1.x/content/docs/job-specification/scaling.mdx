...
created_at: 2026-02-16T16:53:55.000Z
last_modified: 2026-02-16T16:53:55.000Z
...
- `policy` - <code>(map<string|...>: nil)</code> - The autoscaling policy. This is
  ...
  [Nomad Autoscaler documentation][autoscaling_policy] for more details. This
  includes schedule-based policy and check controls documented in
  [Schedule-based Autoscaling][autoscaling_schedule].
