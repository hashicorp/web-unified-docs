...
[the same syntax as `format`](/nomad/docs/reference/hcl2/functions/string/format#specification-syntax).
...
- [`format`](/nomad/docs/reference/hcl2/functions/string/format) defines the specification syntax used by this
