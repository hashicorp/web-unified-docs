...
last_modified: 2026-04-03T22:12:34.000Z
...
instructions](/nomad/docs/deploy/nomad-agent#run-an-agent)
...
| job.driver.docker.count                  | Tasks in job specs with the "docker" driver              |
| job.driver.exec.count                    | Tasks in job specs with the "exec" driver                |
| job.driver.exec2.count                   | Tasks in job specs with the "exec2" driver               |
| job.driver.java.count                    | Tasks in job specs with the "java" driver                |
| job.driver.nomad-driver-virt.count       | Tasks in job specs with the "nomad-driver-virt" driver   |
| job.driver.other.count                   | Jobs with some other driver                              |
| job.driver.pledge.count                  | Tasks in job specs with the "pledge" driver              |
| job.driver.podman.count                  | Tasks in job specs with the "podman" driver              |
| job.driver.qemu.count                    | Tasks in job specs with the "qemu" driver                |
| job.driver.raw_exec.count                | Tasks in job specs with the "raw_exec" driver            |
...
| task.driver.docker.count                 | Allocated tasks with the "docker" driver                 |
| task.driver.exec.count                   | Allocated tasks with the "exec" driver                   |
| task.driver.exec2.count                  | Allocated tasks with the "exec2" driver                  |
| task.driver.java.count                   | Allocated tasks with the "java" driver                   |
| task.driver.nomad-driver-virt.count      | Allocated tasks with the "nomad-driver-virt" driver      |
| task.driver.other.count                  | Tasks with some other driver                             |
| task.driver.pledge.count                 | Allocated tasks with the "pledge" driver                 |
| task.driver.podman.count                 | Allocated tasks with the "podman" driver                 |
| task.driver.qemu.count                   | Allocated tasks with the "qemu" driver                   |
| task.driver.raw_exec.count               | Allocated tasks with the "raw_exec" driver               |
