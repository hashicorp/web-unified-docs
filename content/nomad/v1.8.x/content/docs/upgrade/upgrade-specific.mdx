...
[`nomad license inspect`](/nomad/commands/license/inspect) command
...
[`nomad alloc fs`](/nomad/commands/alloc/fs) through servers to the node,
...
[drain-cli]: /nomad/commands/node/drain
...
[tls-guide]: /nomad/tutorials/archive/security-enable-tls
...
[validate]: /nomad/commands/job/validate
