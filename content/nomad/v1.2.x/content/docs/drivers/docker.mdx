...
- `volumes` - (Optional) A list of `host_path:container_path` strings to bind
  ...
  client's configuration. We recommend using [`mount`](#mount) if you
  wish to have more control over volume definitions.
...
The `docker` driver implements the following [capabilities](/docs/concepts/plugins/task-drivers#capabilities-capabilities-error).
