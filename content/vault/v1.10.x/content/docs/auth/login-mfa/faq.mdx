...
~> **Note**: [The Legacy MFA](/vault/docs/auth/mfa) is a **deprecated** MFA workflow in Vault OSS. Refer to the [Q: What is the Legacy MFA feature?](#q-what-is-the-legacy-mfa-feature) for more details.
