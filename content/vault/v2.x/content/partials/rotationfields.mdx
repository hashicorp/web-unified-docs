...
- `rotation_schedule` `(string: "")` – <EnterpriseAlert product="vault" inline />
  ...
  defining the schedule on which Vault should rotate the root credential. Standard
  ...
  Vault to rotate the root credential every Saturday at 00:00. In 1.20.5 or later, Vault interprets the schedule in UTC.
