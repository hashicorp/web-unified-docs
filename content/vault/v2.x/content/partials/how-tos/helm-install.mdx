...
1. Create a file named `helm-vault-raft-values.yml` with your preferred
...
1. Check the status of the pods.  Wait for the Vault server instances to
   become ready:
   ...
   vault-agent-injector-64d7794784-s948r     1/1     Running   0          10m
   ```
