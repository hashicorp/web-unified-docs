...
1. Create a pod definition file for client applications. For example, to create
   ...
   metadata:
      ...
      annotations:
         ...
         vault.hashicorp.com/agent-inject-secret-credentials.txt: "creds/data/devwebapp/config"
   spec:
   ...
   See documentation on the Agent Pod injector on [secrets via annotations](/vault/docs/deploy/kubernetes/injector#secrets-via-annotations)
