...
For a key/value version 2 plugin, include the `data/` path prefix:
...
$ curl                                                                           \
    ...
    --header "X-Vault-Token: ${VAULT_TOKEN}"                                     \
    --header "X-Vault-Recover-Snapshot-Id: 9465df92-8236-4af9-8cc8-b7460d882e41" \
    ${VAULT_ADDR}/v1/kv/data/telemetry-systems/api-key
```
...
For a key/value version 2 plugin:
...
$ curl                                                                            \
    ...
    --header "X-Vault-Token: ${VAULT_TOKEN}"                                      \
    --header "X-Vault-Recover-Snapshot-Id: 9465df92-8236-4af9-8cc8-b7460d882e41"  \
    --header "X-Vault-Recover-Source-Path: kv/data/telemetry-systems/api-key"     \
    ${VAULT_ADDR}/v1/kv/data/telemetry-systems/api-key-recovered
```
