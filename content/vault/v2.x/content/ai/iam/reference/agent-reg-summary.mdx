...
last_modified: 2026-08-27T16:34:36.000Z
...
--------------------------------------------------- | -------------------- | -----------
`agent-registry/register`                           | Create, Update       | Create a new registration or update the registration whose `id` matches the value you provide
