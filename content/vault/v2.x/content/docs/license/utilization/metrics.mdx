...
description: Learn about the data IBM collects to measure Vault Enterprise license utilization.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-04-15T00:15:32.000Z
last_modified: 2026-04-15T00:15:32.000Z
...
- `snapshot_records` - An array of snapshot records. See [snapshot payload](#snapshot-payload) for the contents of each snapshot record.
...
- `decoded_snapshot` - The decoded contents of the snapshot, which is a structure containing the following fields:
  - `snapshot_version` - The version of the snapshot package that produced the reporting snapshot
  - `id` - A unique identifier for this snapshot
  ...
  - `metadata` - Optional product-specific metadata
    ...
    - `add_ons` - For IBM Passport Advantage Online license keys, the add-ons associated with the entitlement. For HashiCorp license keys, this field is empty.
    - `edition` - For IBM Passport Advantage Online license keys, the edition associated with the entitlement. For HashiCorp license keys, this field is empty.
...
| `gcp_kms_operation_count.current_month_estimate` | Number of GCP KMS data protection API calls in the current month. |
| `gcp_kms_operation_count.previous_month_complete` | Number of GCP KMS data protection API calls in the previous month. |
...
| `ldap_library_max_set_count.current_month_estimate` | High watermark count of LDAP service account library sets in the current month. |
| `ldap_library_max_set_count.previous_month_complete` | High watermark count of LDAP service account library sets in the previous month. |
...
| `normalized_oidc_tokens_issued.previous_month_complete` | The duration-adjusted count of OIDC tokens issued for the previous month. |
| `normalized_spiffe_jwt_token_units.current_month_estimate` | The duration-adjusted count of SPIFFE JWT tokens issued for the current month. |
| `normalized_spiffe_jwt_token_units.previous_month_complete` | The duration-adjusted count of SPIFFE JWT tokens issued for the previous month. |
| `normalized_external_ca_cert_units.current_month_estimate` | The duration-adjusted count of external CA certificates issued for the current month. |
| `normalized_external_ca_cert_units.previous_month_complete` | The duration-adjusted count of external CA certificates issued for the previous month. |
...
| `openldap_library_max_set_count.current_month_estimate` | High watermark count of OpenLDAP service account library sets in the current month. |
| `openldap_library_max_set_count.previous_month_complete` | High watermark count of OpenLDAP service account library sets in the previous month. |
  ...
  "snapshot_records": [
    {
      ...
      "decoded_snapshot": {
        ...
        "gauges": {
          ...
          "gcp_kms_operation_count.current_month_estimate": {
            "key": "gcp_kms_operation_count.current_month_estimate",
            "value": 0,
            "mode": "write"
          },
          "gcp_kms_operation_count.previous_month_complete": {
            "key": "gcp_kms_operation_count.previous_month_complete",
            "value": 0,
            "mode": "write"
          },
          ...
          "normalized_oidc_tokens_issued.current_month_estimate": {
            "key": "normalized_oidc_tokens_issued.current_month_estimate",
            "value": 0,
            "mode": "write"
          },
          "normalized_oidc_tokens_issued.previous_month_complete": {
            "key": "normalized_oidc_tokens_issued.previous_month_complete",
            "value": 0,
            "mode": "write"
          },
          "normalized_spiffe_jwt_token_units.current_month_estimate": {
            "key": "normalized_spiffe_jwt_token_units.current_month_estimate",
            "value": 0,
            "mode": "write"
          },
          "normalized_spiffe_jwt_token_units.previous_month_complete": {
            "key": "normalized_spiffe_jwt_token_units.previous_month_complete",
            "value": 0,
            "mode": "write"
          },
          "normalized_external_ca_cert_units.current_month_estimate": {
            "key": "normalized_external_ca_cert_units.current_month_estimate",
            "value": 0,
            "mode": "write"
          },
          "normalized_external_ca_cert_units.previous_month_complete": {
            "key": "normalized_external_ca_cert_units.previous_month_complete",
            "value": 0,
            "mode": "write"
          },
