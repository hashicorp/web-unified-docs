...
last_modified: 2026-05-11T22:04:52.000Z
...
| --------------------------- | --------------------------------------------------------------------------- |
| `vault.replication_status`  | Replication status of this cluster, e.g. `perf-disabled,dr-disabled`        |
| `vault.storage_type`        | Storage backend type, e.g. `raft` or `consul`                               |
| `vault.operating_system`    | Operating system this cluster is running on.                                |
| `vault.development_cluster` | Whether the cluster is operating as a development (non-production) cluster. |
