...
| `vault.secret.engine.ldap.dynamic.service.library.role.count` | Number of LDAP secret engine service account library sets, across all namespaces. |
...
| `vault.secret.engine.openldap.dynamic.service.library.role.count` | Number of OpenLDAP secret engine service account library sets, across all namespaces. |
