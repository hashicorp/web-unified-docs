...
| `vault.auth.method.azure.auth_type.aks_wi.count` | Number of Azure auth method mounts configured to use AKS Workload Identity (aks_wi) across all namespaces. |
