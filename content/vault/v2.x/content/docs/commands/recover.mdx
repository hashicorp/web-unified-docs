...
created_at: 2026-04-15T00:14:44.000Z
last_modified: 2026-04-15T00:14:44.000Z
...
Recover the KV version 2 secret at the path `my-secret` from the loaded snapshot with ID `2403d301-94f2-46a1-a39d-02be83e2831a`. KV version 2 stores secret data under the `data/` path prefix:

```shell-session
$ vault recover -snapshot-id=2403d301-94f2-46a1-a39d-02be83e2831a secret/data/my-secret
```

Recover the KV version 2 secret at the path `my-old-secret` from the loaded snapshot with ID `2403d301-94f2-46a1-a39d-02be83e2831a` but write the data to the path `my-new-secret`:

```shell-session
$ vault recover -snapshot-id=2403d301-94f2-46a1-a39d-02be83e2831a -from=secret/data/my-old-secret secret/data/my-new-secret
```
