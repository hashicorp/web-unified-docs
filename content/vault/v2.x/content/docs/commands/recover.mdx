...
Recover the KV version 2 secret at the path `my-old-secret` from the loaded snapshot with ID `2403d301-94f2-46a1-a39d-02be83e2831a`, writing the data to the path `my-new-secret`:
