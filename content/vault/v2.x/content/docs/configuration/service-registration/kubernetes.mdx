...
created_at: 2026-04-15T00:15:01.000Z
last_modified: 2026-04-15T00:15:01.000Z
...
- `vault-version` `(string: "2.0.3")` – Vault version is a string that will not change during a pod's lifecycle.
...
```shell-session
$ helm upgrade vault --set='server.image.tag=2.0.3'
