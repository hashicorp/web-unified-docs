...
You can manage key management secret resources programmatically with the Vault Terraform provider. Refer to the Terraform Registry documentation for more details:

- [Key management secrets engine key resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_key)
- [Key management AWS KMS resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_aws_kms)
- [Key management Azure Key Vault resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_azure_kms)
- [Key management Google Cloud KMS resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_gcp_kms)
- [Key management key rotate resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_key_rotate)
- [Key management distribute key resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_distribute_key)
- [Key management replicate key resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/keymgmt_replicate_key)
