...
You can manage AliCloud secret resources programmatically with the Vault Terraform provider. Refer to the Terraform Registry documentation for more details:

- [AliCloud secrets engine backend resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/alicloud_secret_backend)
- [AliCloud secrets engine role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/alicloud_secret_backend_role)
