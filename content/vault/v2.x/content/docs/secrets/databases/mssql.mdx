...
last_modified: 2026-05-19T16:12:51.000Z
...
Azure SQL Database are [contained databases](https://learn.microsoft.com/en-us/sql/relational-databases/databases/contained-databases?view=sql-server-ver17)
...
@include '../../../global/partials/secrets-engine/database/mssql-ag-constraint.mdx'
