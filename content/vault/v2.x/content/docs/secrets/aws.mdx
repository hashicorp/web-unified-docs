...
- Click **Enable new engine +** on the **Secrets Engines** page.
- Select **AWS**.
- Click **Next**.
- Set the mount path for the AWS plugin. For example, `aws`.
- If you use WIF, add the identity token key:
...
You can manage AWS secret resources programmatically with the Vault Terraform provider. Refer to the Terraform Registry documentation for more details:

- [AWS secrets engine backend resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_secret_backend)
- [AWS secrets engine role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_secret_backend_role)
- [AWS secrets engine static role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_secret_backend_static_role)
