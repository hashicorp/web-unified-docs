...
last_modified: 2026-08-12T01:20:29.000Z
...
- **You must a supported identity provider configured**:

    - [Configure IBM Verify for agent IAM](/vault/docs/ai/iam/providers/verify)

- **You must have [enabled OAuth functionality](/vault/docs/ai/oauth-server/activate-oauth) in Vault**.
...
1. Read the profile to check for correctness, and make a note of the
...
1. Construct the mount accessor string as follows:
