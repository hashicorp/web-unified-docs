...
created_at: 2026-04-15T00:15:35.000Z
last_modified: 2026-04-15T00:15:35.000Z
...
catalog. The catalog entry replicates to every node through Vault's storage
layer, but the artifact itself does not — each node must have the plugin binary
or `.zip` file present locally in its `plugin_directory`.
