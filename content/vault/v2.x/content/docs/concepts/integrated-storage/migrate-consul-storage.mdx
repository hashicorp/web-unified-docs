...
Before sending production traffic to the migrated cluster, refer to [Eventual
consistency in Vault replication](/vault/docs/enterprise/consistency) for
available mitigations and configuration options.
