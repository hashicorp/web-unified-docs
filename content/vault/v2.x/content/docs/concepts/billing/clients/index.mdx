...
last_modified: 2026-08-25T17:12:47.000Z
...
## Agentic workflow clients

@include '../../../global/partials/alerts/ent/ent-only.mdx'

An AI agent becomes a client on its first successful API action.
In a delegated workflow where an agent acts on behalf of a subject, Vault
records both the agent and the subject as separate entity clients.
...
<ul>
  <li>
    <a href="/vault/docs/concepts/billing/clients/counting">Client count calculation</a>
  </li>
  <li>
