...
last_modified: 2026-08-25T17:50:52.000Z
...
In agentic workflows, Vault counts each agent as a standard entity client on its 
first successful API action. In a delegated workflow, where an agent 
acts on behalf of a subject, Vault records the agent and the subject as separate
entity clients. 
...
<ul>
  <li>
    <a href="/vault/docs/concepts/billing/clients/counting">Clients and entities</a>
  </li>
  <li>
    <a href="/vault/docs/concepts/billing/clients/faq">Client count FAQ</a>
  </li>
</ul>
</Tab>
...
<ul>
  <li>
    <a href="/vault/docs/concepts/billing/clients/client-usage">
      Client Usage in Vault GUI
    </a>
  </li>
  <li>
    <a href="/vault/docs/concepts/billing/clients/client-usage">KMIP Client metrics</a>
  </li>
</ul>
</Tab>
