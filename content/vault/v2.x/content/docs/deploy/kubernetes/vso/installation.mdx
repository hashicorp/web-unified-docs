...
hashicorp/vault-secrets-operator	1.4.0       	1.4.0     	Official HashiCorp Vault Secrets Operator Chart
```

Then install the Operator:

```shell-session
$ helm install --version 1.4.0 --create-namespace --namespace vault-secrets-operator vault-secrets-operator hashicorp/vault-secrets-operator
```
...
For example, if you are upgrading to VSO 1.4.0:
```shell-session
$ helm upgrade --version 1.4.0 --namespace vault-secrets-operator vault-secrets-operator hashicorp/vault-secrets-operator
```
...
```shell-session
$ wget -q https://github.com/hashicorp/vault-secrets-operator/archive/refs/tags/v1.4.0.tar.gz
$ tar -zxf v1.4.0.tar.gz
$ cd vault-secrets-operator-1.4.0/
```
