...
<EnterpriseAlert>
Deploy Vault Secrets Operator <a href="/vault/docs/platform/k8s/vso/csi">with the CSI driver</a> to mount
secrets directly to pods without using Kubernetes Secrets.
</EnterpriseAlert>
...
- Support for syncing secrets from Vault.
...
The Vault Secrets Operator supports syncing secrets from Vault.
