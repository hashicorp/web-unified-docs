...
last_modified: 2026-09-23T12:08:22.000Z
...
|---|---|---|
| KV v1 & v2 | `kv` | Used by `VaultStaticSecret`.<br />Needs Vault Enterprise 1.16.3+ |
| Database | `database` | Static roles via `VaultDynamicSecret`.<br />Needs VSO v1.6.0+ and Vault Enterprise 1.16.3+ |
| LDAP | `ldap` | Static roles via `VaultDynamicSecret`.<br />Needs VSO v1.6.0+ and Vault Enterprise 1.16.3+ |
