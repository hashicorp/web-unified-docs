...
- **Auto/Manually rotated credentials for static-roles** (e.g. database and LDAP static roles) —
...
version depends on the engine and credential type — see
...
The distinction between static-role and dynamic lease credentials is controlled
