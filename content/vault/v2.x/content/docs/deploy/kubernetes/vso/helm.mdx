...
last_modified: 2026-04-15T00:15:13.000Z
# END AUTO GENERATED METADATA
---
<!-- DO NOT EDIT.
Generated from chart/values.yaml in the vault-secrets-operator repo.
commit SHA=345c093063c27337c79ab295d251573d6943d4c4
...
- `controller` ((#v-controller)) - Top level configuration for the vault secrets operator deployment.
  ...
  - `rbac` ((#v-controller-rbac))
    ...
    - `enabled` ((#v-controller-rbac-enabled)) (`boolean: true`) - enabled controls whether the chart creates the RBAC authorization resources
      (ClusterRole, ClusterRoleBinding, Role, RoleBinding) required by the operator.
      When set to false:
        - RBAC authorization resources are not created by the chart.
        - Non-RBAC resources (ServiceAccounts, Deployment, hook Jobs) are still
          created and require equivalent RBAC to be pre-provisioned out-of-band by
          a cluster administrator before running helm install/upgrade.
        - Resource names are derived from the Helm release name (or fullnameOverride),
          so the cluster admin must use the same name when pre-provisioning RBAC.
    ...
    - `clusterRoleAggregation` ((#v-controller-rbac-clusterroleaggregation)) - clusterRoleAggregation defines the roles included in the aggregated ClusterRole.
      ...
      - `viewerRoles` ((#v-controller-rbac-clusterroleaggregation-viewerroles)) (`array<string>: []`) - viewerRoles is a list of roles that will be aggregated into the viewer ClusterRole.
        The role name must be that of any VSO resource type. E.g. "VaultAuth".
  ...
  - `manager` ((#v-controller-manager)) - Settings related to the vault-secrets-operator container.
    ...
    - `image` ((#v-controller-manager-image)) - Image sets the repo and tag of the vault-secrets-operator image to use for the controller.
      ...
      - `tag` ((#v-controller-manager-image-tag)) (`string: 1.6.0`)
    ...
    - `volumes` ((#v-controller-manager-volumes)) (`array<map>`) - Defines additional volumes to be added to the vault-secrets-operator manager pod.
      This can be used to mount secrets, configmaps, or other volume types.
      Note: The operator pod already has a downwardAPI volume named 'podinfo' at
      /var/run/podinfo. User-defined volumes cannot override this.
      Example:
...
- `csi` ((#v-csi))
  ...
  - `securityContext` ((#v-csi-securitycontext)) - Configures the Pod level security context
    https://kubernetes.io/docs/tasks/configure-pod-container/security-context
  ...
  - `driver` ((#v-csi-driver))
    ...
    - `securityContext` ((#v-csi-driver-securitycontext)) - Configures the driver container's security context
      https://kubernetes.io/docs/tasks/configure-pod-container/security-context
    ...
    - `image` ((#v-csi-driver-image)) - Image information for the CSI driver.
      ...
      - `tag` ((#v-csi-driver-image-tag)) (`string: 1.0.3`) - The version of the CSI driver image to download.
