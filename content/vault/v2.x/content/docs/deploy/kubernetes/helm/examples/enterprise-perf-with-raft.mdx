...
last_modified: 2026-09-26T18:43:04.000Z
...
team or Technical Account Manager. If the secondary cluster's namespace differs
from the primary's, repeat this step in that namespace before installing the
secondary cluster.
