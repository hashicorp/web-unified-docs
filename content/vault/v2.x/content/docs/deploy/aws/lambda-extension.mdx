...
You can use the [quick-start](https://github.com/hashicorp/vault-lambda-extension/tree/main/quick-start) directory which has an end-to-end example.
...
### Add the extension to your existing Lambda and Vault infrastructure
...
In other words, the cache TTL is capped to the duration of the Lambda execution environment.
...
## Upload to your own AWS account and region
