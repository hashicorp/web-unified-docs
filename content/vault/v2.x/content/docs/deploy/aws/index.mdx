...
- Use an [HCP Vault Dedicated tier](https://portal.cloud.hashicorp.com) hosted on AWS.
...
- Use the [Vault Lambda Extension](/vault/docs/platform/lambda) for AWS Lambda functions.
- Use [Vault secrets sync to AWS Secrets Manager](/vault/docs/sync/awssm).
