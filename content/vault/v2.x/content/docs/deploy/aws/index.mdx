...
The following tools help you manage your AWS infrastructure with Vault.
...
- [Retrieve secrets for AWS applications with Vault Agent](/vault/tutorials/vault-agent/agent-aws) with Vault on an EC2 instance.
