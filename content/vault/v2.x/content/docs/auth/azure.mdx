...
1. As a **tenant B admin**, open the following URL in the Azure portal and grant
   admin consent to provision a service principal so you can create an app
   registration for Vault in tenant B:
