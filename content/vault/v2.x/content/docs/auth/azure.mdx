...
1. Configure the Azure auth method:
   ...
   - [Plugin Workload Identity Federation](#plugin-workload-identity-federation-wif) (WIF) — Vault issues its own OIDC identity token. Azure is configured to trust it via workload identity federation.
