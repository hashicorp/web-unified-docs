...
backward compatibility. Vault checks for `client_secret`, then `identity_token_audience`,
then the `AZURE_FEDERATED_TOKEN_FILE` environment variable, and finally Managed Identity.
