...
AWS can enforce IMDSv2 at the account or individual instance level, which
disables IMDSv1 access entirely.

The Vault AWS SDK automatically uses IMDSv2 when AWS supports it so the the
[Authentication](#authentication) section uses the IMDSv2 token flow for the
example PKCS#7 signature fetch commands.

For more information, refer to the
[AWS blog post on enforcing IMDSv2](https://aws.amazon.com/blogs/security/get-the-full-benefits-of-imdsv2-and-disable-imdsv1-across-your-aws-infrastructure/).
...
For the EC2 auth method, use the IMDSv2 token flow to fetch the PKCS#7 signature.

Using a two-step approach means the token flow works on all EC2 instances,
including those that have IMDSv1 access disabled.

If you plan to run Vault or the following example code behind an extra network
hop (containers, proxies), refer to the
[AWS instance metadata timeout](#aws-instance-metadata-timeout) section before
beginning.
...
If Vault or this script runs behind an extra network hop (containers,
proxies), see [AWS instance metadata timeout](#aws-instance-metadata-timeout).
...
You can manage AWS auth resources programmatically with the Vault Terraform provider. Refer to the Terraform Registry documentation for more details:

- [AWS auth method identity config resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_config_identity)
- [AWS auth method client resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_client)
- [AWS auth method certificate resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_cert)
- [AWS auth method role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_role)
- [AWS auth method STS role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_sts_role)
- [AWS auth method identity whitelist resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_identity_whitelist)
- [AWS auth method role tag resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_role_tag)
- [AWS auth method role tag blacklist resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_roletag_blacklist)
- [AWS auth method login resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/aws_auth_backend_login)
