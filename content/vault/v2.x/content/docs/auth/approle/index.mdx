...
You can manage AppRole auth resources programmatically with the Vault Terraform provider. Refer to the Terraform Registry documentation for more details:

- [AppRole auth method role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/approle_auth_backend_role)
- [AppRole auth method Secret ID resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/approle_auth_backend_role_secret_id)
- [AppRole auth method login resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/approle_auth_backend_login)
