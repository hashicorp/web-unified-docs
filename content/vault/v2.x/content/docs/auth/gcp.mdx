...
created_at: 2026-04-15T00:14:24.000Z
last_modified: 2026-04-15T00:14:24.000Z
...
impersonate the service account. `sub` claims have the form: `plugin-identity:<NAMESPACE_ID>:auth:<GCP_AUTH_MOUNT_ACCESSOR>`.
...
You can manage GCP auth resources programmatically with the Vault Terraform provider. Refer to the Terraform Registry documentation for more details:

- [GCP auth method backend resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/gcp_auth_backend)
- [GCP auth method role resource](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/gcp_auth_backend_role)
