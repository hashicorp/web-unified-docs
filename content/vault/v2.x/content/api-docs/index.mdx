...
created_at: 2026-04-15T00:13:46.000Z
last_modified: 2026-04-15T00:13:46.000Z
...
- `429` - Default return code for health status of standby nodes. Also returned
  for `Too Many Requests` when [client requests exceed the configured lease quota](/vault/docs/troubleshoot/lease-issues#429---too-many-requests).
...
- `503` - Vault is down for maintenance, currently sealed, or temporarily overloaded. Refer to [Adaptive overload protection](/vault/docs/concepts/adaptive-overload-protection) for details on handling overload responses.
