...
last_modified: 2026-06-17T22:18:19.000Z
...
build the signature, its signing algorithm is viewable [here](https://github.com/hashicorp/vault-plugin-auth-cf/tree/main/signatures).
