...
created_at: 2026-04-15T00:13:45.000Z
last_modified: 2026-04-15T00:13:45.000Z
...
- `endpoint_url` `(string: <required>)` - URL of an HTTPS server that can
  provide the PEM encoded X.509 certificate. This URL also supports the PKI
  `.well-known` endpoints (for example, `/.well-known/est/...`) documented in the
  [PKI EST certificate issuance API](/vault/api-docs/secret/pki/issuance#est-certificate-issuance).
