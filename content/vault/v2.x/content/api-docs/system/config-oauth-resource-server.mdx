...
last_modified: 2026-09-26T00:22:02.000Z
...
```json
{
  "data": {
    ...
    "authorization_details_claim": "authorization_details",
...
- `authorization_details_claim` `(string: "authorization_details")` - The JWT claim that contains the authorization details for [Rich Authorization Requests](/vault/ai/iam/concepts/rar).
