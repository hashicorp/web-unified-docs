...
last_modified: 2026-08-24T19:16:14.000Z
...
- You cannot change `local` after creating the profile. Omit the `local` parameter on updates
  or pass the value already stored. Vault returns an error if you attempt to change it.
