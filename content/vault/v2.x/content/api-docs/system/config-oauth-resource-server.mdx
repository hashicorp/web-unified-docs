...
Fetch the configuration of a specific OAuth Resource Server configuration
profile.
...
Delete an OAuth Resource Server configuration profile. Deleting a non-existent
profile succeeds without error.
