...
last_modified: 2026-09-14T14:51:27.000Z
...
- `local` `(bool: false)` - When set to `true`, the agent registration is stored in the
  cluster's local storage and is not replicated to performance secondaries. The `local` 
