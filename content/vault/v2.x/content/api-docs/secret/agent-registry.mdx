...
created_at: 2026-05-20T19:52:42-07:00
last_modified: 2026-09-17T23:50:40.000Z
...
Agent registry requires Vault Enterprise 2.1.0 or later.
...
- `no_default_ceiling_policy` `(bool: false)` – When set to `true`, opts out
  ...
  Agent Registry record. For more information about default ceiling policies, refer to [Default ceiling policies](/vault/ai/iam/concepts/agent-registry#default-ceiling-policies).
...
- `optional_authorization_details` `(bool: false)` – When set to `true`, allows
  ...
  By default, Vault requires RAR (rich authorization requests) for the agent registry and rejects non-RAR requests. For more information about RAR constraints, refer to [Rich Authorization Requests](/vault/ai/iam/concepts/rar).
...
- `no_default_ceiling_policy` `(bool: false)` – When set to `true`, opts out
  of automatically adding default ceiling policies. For more information about default ceiling policies, refer to [Default ceiling policies](/vault/ai/iam/concepts/agent-registry#default-ceiling-policies).
