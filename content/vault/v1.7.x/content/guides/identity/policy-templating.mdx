...
description: 'As of 0.11, ACL policies support templating to allow non-static policy paths.'
...
The [Policies](/guides/identity/policies) guide walks you through the
...
- [Policy API](/vault/api-docs/system/policy)
- [Identity: Entities and Groups](/guides/identity/identity)
...
Enterprise](/vault/docs/enterprise/sentinel).
...
Identities](/vault/docs/secrets/identity) to inject values into ACL policy
paths.
...
Started](/intro/getting-started/install) guide to install Vault.
...
[Policies](/guides/identity/policies) guide first.
...
[Policies](/guides/identity/policies#policy-requirements) guide.
...
the [Sentinel Policies](/guides/identity/sentinel) guide.
