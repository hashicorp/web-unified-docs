...
The Open Source Vault AMI is intended for development and test use cases. This listing will launch a non-HA Vault instance with Vault running and the Vault UI available. For production use cases, please see the [Architecture](/vault/docs/platform/aws-mp/run#architecture) section of this documentation.
