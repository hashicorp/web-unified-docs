...
[consul-consistency]: https://www.consul.io/api-docs/features/consistency 'Consul Consistency Modes'
...
[listener-example]: /docs/configuration/listener/tcp#listening-on-multiple-interfaces
