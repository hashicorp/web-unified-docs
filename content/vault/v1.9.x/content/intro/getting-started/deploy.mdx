...
`disable_mlock` in [Server Configuration](/vault/docs/configuration).
...
see the documentation on [using PGP, GnuPG, and Keybase](/vault/docs/concepts/pgp-gpg-keybase)
