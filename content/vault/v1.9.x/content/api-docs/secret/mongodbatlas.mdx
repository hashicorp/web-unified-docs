...
Private Key is returned to the caller. To learn more about Programmatic API Keys visit the [Atlas Administration API guide](https://www.mongodb.com/docs/atlas/configure-api-access).
