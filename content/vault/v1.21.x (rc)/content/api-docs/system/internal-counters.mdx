...
endpoint at once. Consider setting a [rate limit quota](/vault/docs/configuration/create-rate-limit-quota)
on the endpoint to prevent excessive requests.
...
```json
{
  "request_id": "253842db-02c5-d3bc-d0a2-044ac162109f",
  "lease_id": "",
  "renewable": false,
  "lease_duration": 0,
  "data": {
...
The following example retrieves the cumulative client count for the `ns1` namespace
...
```json
{
  "request_id": "2b2dcd81-34e4-b494-2540-f0dabbf4bb61",
  "lease_id": "",
  "renewable": false,
  "lease_duration": 0,
  "data": {
