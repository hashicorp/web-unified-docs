...
- `token_creation_time` in the response is the creation time of the token that was used by the client to perform the request. This time is distinct from the time the client was created and may lie outside of the queried time period.
   <Note>
