...
### Headers
- `X-Vault-Snapshot-Id` `(string: <required>)` - The ID of a snapshot previously loaded into Vault that contains secrets at the provided path.
...
$ curl \
    --header "X-Vault-Token: ..." \
    --request POST \
    --header "X-Vault-Snapshot-Id: 2403d301-94f2-46a1-a39d-02be83e2831a" \
