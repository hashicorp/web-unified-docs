...
- `exclude_deleted` `(bool: false)` – If set to true, only non-deleted entries will be returned.
...
$ curl \
    --header "X-Vault-Token: ..." \
    --request LIST \
    https://127.0.0.1:8200/v1/secret/metadata/my-secret?exclude_deleted=false
```
