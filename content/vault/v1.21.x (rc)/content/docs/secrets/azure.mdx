...
You can manually rotate secrets by calling the
[`rotate-role`](/vault/api-docs/secret/azure#manually-rotate-static-role-password)
endpoint. Refer to the
[Azure plugin API documentation](/vault/api-docs/secret/azure#create-update-static-role)
for more details.
