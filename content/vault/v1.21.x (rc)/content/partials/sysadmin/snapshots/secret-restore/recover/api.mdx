Use the `X-Vault-Snapshot-Id` header and the snapshot ID to read from
...
$ curl                                            \
   ...
   --header "X-Vault-Snapshot-Id: <snapshot_id>"  \
...
$ curl                                                                   \
    --request POST                                                       \
    --header "X-Vault-Token: ${VAULT_TOKEN}"                             \
    --header "X-Vault-Snapshot-Id: 9465df92-8236-4af9-8cc8-b7460d882e41" \
