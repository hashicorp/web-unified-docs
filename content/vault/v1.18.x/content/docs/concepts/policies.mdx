...
| [sys/config/ui/headers](/vault/api-docs/system/config-ui-headers#list-ui-headers)                                                                      | GET, LIST         | List all configured UI headers                                                                                      |
| [sys/config/ui/headers/:name](/vault/api-docs/system/config-ui-headers)                                                                                | POST, DELETE      | Configure custom HTTP headers to be served with the UI                                                              |
