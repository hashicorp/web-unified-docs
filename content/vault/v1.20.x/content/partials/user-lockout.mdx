...
~> **NOTE**: Because the user lockout occurs early in the request processing, this feature may leak some information
regarding the validity or existence of a user account, given a valid, existing user account name.
