...
--------------- | ---------- |---------------- | ---------- | ------
Support change  | 1.19.0     | N/A             | Enterprise | 1.16.x moves to [long term support](/vault/docs/enterprise/lts) and 1.19 becomes the current LTS version
...
1.19.7     | **Yes**         | All        | [File audit devices cannot use executable file permissions](/vault/docs/v1.19.x/updates/important-changes#file-audit-devices)
