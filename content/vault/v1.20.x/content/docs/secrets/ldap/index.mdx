...
By default, when no password policy is configured on the secrets engine, the plugin 
generates passwords that are 64 characters long and use uppercase letters, lowercase letters, 
and numbers. The default policy does not include special characters in generated passwords.
