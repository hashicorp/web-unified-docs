...
last_modified: 2025-09-25T18:27:54+02:00
...
- GCP must have a
  ...
  or configure the [`--jwk-json-path="JWK-FILE-PATH"` option](https://docs.cloud.google.com/iam/docs/workload-identity-federation-with-other-providers#expandable-3)
