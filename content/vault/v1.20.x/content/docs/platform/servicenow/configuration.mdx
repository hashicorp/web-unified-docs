...
1. Provide a fully qualified collection name (FQCN):
    - **Zurich**: Following setup steps are the same as "Yokohama Patch 7"
    - **Yokohama**: You will require, "Yokohama Patch 7" any other Yokohama version - CredentialResolver UI is missing
