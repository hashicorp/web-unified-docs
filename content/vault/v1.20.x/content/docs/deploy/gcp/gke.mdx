...
This guide focuses on setting up HashiCorp Vault on GKE and assumes a understanding of both Google Cloud and Kubernetes concepts and terminology. The user is familiar with Google Cloud projects, GKE, Kubernetes pods, service accounts, and manifests.
...
The user should already be logged in to Google Cloud via the CLI and have a project and region selected.
