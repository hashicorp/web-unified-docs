...
alternatively be used to mount Vault secrets directly to containers with its [CSI driver]() option. 
...
You can learn more about the CSI driver option on the [VSO CSI driver]() documentation page.
