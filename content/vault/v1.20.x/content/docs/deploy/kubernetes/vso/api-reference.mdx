...
<!--
  ...
  commit SHA=5ca5cf38fa9497da95933fcf0a23ba633bf3c2aa
-->
# API Reference
...
| `vaultStaticSecrets` _[VaultStaticSecretCommon](#vaultstaticsecretcommon) array_ | VaultStaticSecrets is a list of static secrets to be synced by the CSI driver. |  |  |
