...
[Vault Secrets Operator CSI driver](/vault/docs/platform/k8s/vso/vso-csi) with
...
Refer to the [Vault Secrets Operator CSI driver](/vault/docs/platform/k8s/vso/vso-csi)
