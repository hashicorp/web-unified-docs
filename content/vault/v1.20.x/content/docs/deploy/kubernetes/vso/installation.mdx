...
The Vault Secrets Operator Helm chart can also be used to deploy the [VSO CSI driver](/vault/docs/platform/k8s/vso/vso-csi). 
...
For more information about this operating mode, see the [VSO CSI driver](/vault/docs/platform/k8s/vso/vso-csi) documentation.
