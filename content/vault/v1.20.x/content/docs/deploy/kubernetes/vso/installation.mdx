...
The Vault Secrets Operator Helm chart can also be used to deploy the [VSO CSI driver](). 
...
For more information about this operating mode, see the [VSO CSI driver]() documentation.
