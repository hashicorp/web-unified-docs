...
Kubernetes Secrets, you can also use the "direct secrets" feature to mount Vault secrets directly to containers as [volumes](https://kubernetes.io/docs/concepts/storage/volumes/).
...
The Vault Secrets Operator watches for changes to custom resources such as [VaultStaticSecret][kv-spec] or [VaultDynamicSecret][dyn-spec]. 
