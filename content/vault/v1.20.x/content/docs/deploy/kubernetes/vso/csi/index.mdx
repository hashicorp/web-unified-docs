...
Kubernetes Secrets, you can also use the "direct secrets" feature to mount Vault secrets directly to containers as volumes.

The direct secrets feature installs the Vault Secrets
Operator [CSI](https://github.com/container-storage-interface/spec/blob/master/spec.md) driver, which hooks into the pod volume lifecycle directly,
