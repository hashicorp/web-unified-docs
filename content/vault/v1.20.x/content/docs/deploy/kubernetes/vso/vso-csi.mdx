...
[![Vault Secrets Operator flow of secrets](/img/vso-secrets-flow.png)](/img/vso-secrets-flow.png)

Vault Secrets Operator CSI driver:
[![Vault Secrets Operator CSI driver flow of secrets](/img/vso-csi-secrets-flow.png)](/img/vso-csi-secrets-flow.png)
