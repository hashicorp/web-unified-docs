---
layout: docs
page_title: Examples of Secrets Store CSI Provider for Vault
description: Examples of using the Secrets Store CSI Provider for Vault.
---

# Secrets Store CSI Provider for Vault examples

The following examples demonstrate how the Secrets Store CSI Provider for Vault can be used.

~> A common mistake is to not install the CSI Secret Store Driver before using the Secrets Store CSI Provider for Vault.
