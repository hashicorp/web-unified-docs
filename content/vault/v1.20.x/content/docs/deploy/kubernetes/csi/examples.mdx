---
layout: docs
page_title: Examples of Vault Secrets Store CSI Provider
description: Examples of using the Vault Secrets Store CSI Provider.
---

# Vault Secrets Store CSI Provider examples

The following examples demonstrate how the Vault Secrets Store CSI Provider can be used.

~> A common mistake is to not install the CSI Secret Store Driver before using the Vault Secrets Store CSI Provider.
