...
~> For HashiCorp's CSI driver which can be deployed as part of Vault Secrets Operator (VSO), 
see the documentation for the [VSO CSI driver](/vault/docs/platform/k8s/vso/vso-csi).
