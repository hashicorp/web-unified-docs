...
For a CSI driver that makes use of Vault Secrets Operator's approach to auth and secret templating instead, 
check out the [CSI driver option]() for Vault Secrets Operator.
