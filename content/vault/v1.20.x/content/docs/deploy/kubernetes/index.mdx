...
There are currently 4 different integrations to help Kubernetes workloads seamlessly consume secrets from Vault, 
without the need to modify the application to interact directly with Vault. 
...
Each integration addresses slightly different use-cases. 
