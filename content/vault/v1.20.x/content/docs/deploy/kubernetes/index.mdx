...
You can deploy Vault into Kubernetes using the official HashiCorp [Vault Helm chart](/vault/docs/deploy/kubernetes/helm).
The official Helm chart lets you deploy Vault in various configurations:
...
Vault provides the following integrations to seamlessly consume
secrets in your Kubernetes workloads without modifying your
existing application code:

* [Vault Secrets Operator](/vault/docs/platform/k8s/vso)
  * Protected secrets with [Vault Secrets Operator CSI driver](/vault/docs/platform/k8s/vso/csi)
* [Vault Secrets Store CSI provider](/vault/docs/platform/k8s/csi)
* [Vault Agent Injector](/vault/docs/platform/k8s/injector)

Refer to the [comparisons](/vault/docs/platform/k8s/comparisons) page for more details.
