...
Backend](/vault/api-docs/secret/databases/index.html#configure-connection), this plugin
...
revocation. For more information on configuring roles see the [Role API](/vault/api-docs/secret/databases/index.html#create-role)
...
- `creation_statements` `(string: <required>)` – Specifies the database
  ...
  [MongoDB Atlas documentation](https://www.mongodb.com/docs/atlas/security-add-mongodb-users).
