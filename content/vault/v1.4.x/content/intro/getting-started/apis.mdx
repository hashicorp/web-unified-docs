...
[dev mode](/vault/docs/concepts/dev-server), you could validate the
...
[AppRole](/vault/docs/auth/approle) for authentication, the application would
...
For the purposes of this guide lets enable [AppRole](/vault/docs/auth/approle)
authentication.
