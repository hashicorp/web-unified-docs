...
multiple Vault servers in [HA mode](/vault/docs/concepts/ha). Use a tool such
...
the [seal configuration](/vault/docs/configuration/seal) with the appropriate seal
...
the [seal configuration](/vault/docs/configuration/seal) and add `disabled = "true"`
...
cluster offline and update the existing [seal configuration](/vault/docs/configuration/seal)
