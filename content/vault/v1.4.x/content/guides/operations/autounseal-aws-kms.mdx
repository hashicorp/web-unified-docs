...
[**_sealed_**](/vault/docs/concepts/seal) state and it does not know how to
...
- [Vault Auto Unseal](/vault/docs/configuration/seal)
- [Configuration: `awskms` Seal](/vault/docs/configuration/seal/awskms)
...
stanza](/vault/docs/configuration/seal/awskms) which sets the AWS KMS key ID to
