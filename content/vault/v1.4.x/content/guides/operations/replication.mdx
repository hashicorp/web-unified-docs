...
description: Learn how to set up and manage Vault Enterprise Performance Replication.
...
[general information page](/vault/docs/vault-enterprise/replication). More
...
the [Vault Replication API documentation](/vault/api-docs/system/replication)
...
[general information page](/vault/docs/vault-enterprise/replication).
...
[general information page](/vault/docs/vault-enterprise/replication) for information on Vault's disaster recovery replication.
