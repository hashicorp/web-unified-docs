...
- [Production Hardening](/guides/operations/production) guide provides
  ...
  The recommendations are based on the [security model](/vault/docs/internals/security)
...
- [Replication Setup & Guidance](/guides/operations/replication)
  ...
  Please note that [Vault Replication](/vault/docs/vault-enterprise/replication)
