...
- [Secret Engines - Databases](/vault/docs/secrets/databases)
- [Role API](/vault/api-docs/secret/databases#create-role)
...
As most of the secret engines, the [database secret engine](/vault/docs/secrets/databases)
must be mounted.
