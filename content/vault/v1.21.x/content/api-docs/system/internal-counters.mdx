...
If `start_time` or `end_time` falls within the billing period or overlaps
multiple billing periods, Vault normalizes the client counts to the entire billing
period and includes a warning in the result:
