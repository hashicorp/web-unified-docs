---
layout: api
page_title: ConfigPlugin - Oracle plugin API
description: >-
  Configure the Oracle database plugin for Vault to automtically generates
  database credentials to access Oracle servers.
---

# Oracle plugin API: Config
