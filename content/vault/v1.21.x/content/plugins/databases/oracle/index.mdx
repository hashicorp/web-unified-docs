...
# Oracle database plugin overview

Use the Oracle database plugin with the Vault database secret engine to manage
dynamic database credentials based on configured roles.

Current version | Edition    | Runtime  | Code source
--------------- | ---------- | -------- | -----------
0.10.2          | Community  | Built-in | [`hashicorp/vault-plugin-secrets-openldap`](https://github.com/hashicorp/vault-plugin-secrets-openldap)
0.13.0          | Enterprise | Built-in | N/A
