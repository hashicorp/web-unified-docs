...
last_modified: 2026-02-04T16:03:23-06:00
...
1. Under **Token configurations**, add a groups claim. For "Customize token properties by type" in the claim, one of the selected options must be **ID**.

1. Confirm the permissions under **API permissions** include permission to read groups and users.
