...
description: >-
   Understand the configuration and limitations of Vault's PKI secrets engine implementation of the
...
implementation of the [ACME protocol](https://datatracker.ietf.org/doc/html/rfc8555)
...
provides the ability for a client to prove control over a domain name and request a TLS leaf certificate
...
token](/vault/api-docs/secrets/pki/issuance#get-acme-eab-binding-token). This returns two values: a key identifier
