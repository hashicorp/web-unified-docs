...
development kit (SDK) from functionally tested runtime versions for the Enterprise
Oracle database plugin. A build SDK version alone does not establish runtime coverage.

| Plugin release | Build SDK | 19.x runtime | 21.x runtime | 23.x runtime |
| -------------- | --------- | ------------ | ------------ | ------------ |
| `0.14.1+ent` | `19.26` | Tested: `19.26.0.0.0`, `19.32.0.0.0` | Tested: `21.19.0.0.0` | Tested: `23.9.0.25.07` |
| `0.14.0+ent` | `19.26` | Tested: `19.26.0.0.0` | Untested | Untested |
| `0.13.0+ent` | `19.26` | Tested: `19.26.0.0.0` | Untested | Untested |
| `0.12.3+ent` | `19.26` | Untested | Untested | Untested |
| `0.11.0+ent` | `19.26` | Untested | Untested | Untested |

**Tested** means the combination passes plugin registration and connection
...
rotation checks cover manual and automatic period-based rotation.
...
it does not mean incompatible. Versions not listed as tested remain untested,
including `19.32.0.0.0` with `0.13.0+ent` or `0.14.0+ent`. Results do not extend to
other platforms, database editions, package formats, or rotation scheduling modes.

### Instant Client family support

Plugin releases 0.11.0+ent through 0.14.1+ent are dynamically linked against
`libclntsh.so.19.1`. That shared-library name does not require the exact `19.26`
