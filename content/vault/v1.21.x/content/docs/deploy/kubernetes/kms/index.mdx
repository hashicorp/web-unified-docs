---
layout: docs
page_title: Vault Kubernetes KMS v2 plugin
description: Use the Vault Kubernetes KMS v2 plugin to encrypt Kubernetes data at rest with Vault Enterprise.
---

# Vault Kubernetes KMS v2 plugin

@include 'alerts/enterprise-only.mdx

The Vault Kubernetes KMS v2 plugin is a Kubernetes KMS v2 plugin that lets Kubernetes use
