...
Using a static Pod is the preferred installation method for running the Vault KMS plugin.
...
This assumes you place the AppRole [secret ID](https://developer.hashicorp.com/vault/api-docs/auth/approle#generate-new-secret-id) on each node at /etc/vault-kms/approle-secret-id (how you distribute that is up to your environment).
