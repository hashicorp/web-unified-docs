...
description: Telemetry for the Vault Kubernetes KMS plugin.
---

# Telemetry

The plugin exposes Prometheus-compatible metrics on the `/metrics` endpoint when
...
|-------------|---------------|-------------|
| histogram   | milliseconds  | Measures the duration of inbound gRPC requests handled by the plugin. |

The plugin emits this metric per gRPC method and status code.
...
| Metric type | Value       | Description |
|-------------|-------------|-------------|
| counter     | operations  | Counts successful Vault client operations performed by the plugin. |
...
| Metric type | Value      | Description |
|-------------|------------|-------------|
| counter     | errors     | Counts failed Vault client operations performed by the plugin. |
...
| Metric type | Value    | Description |
|-------------|----------|-------------|
| histogram   | seconds  | Measures the duration of Vault client operations performed by the plugin. |
