---
page_title: Security model for Vault Kubernetes Key Management 
description: >-
   Learn about the Vault Kubernetes Key Management security model and data process flow.

# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2026-03-17T12:26:00-07:00
last_modified: 2026-03-20T22:19:22.000Z
...
1. The `vault-kube-kms` process creates and caches a Vault client that authenticates to
