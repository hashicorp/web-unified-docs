...
- **Navigation**: Added a "Submit feedback" button to the sidebar navigation
  and the Help and Support dropdown, linking to an external feedback survey.
...
- **JSON editor**: Fixed the JSON editor (used in the create-secret flow)
  rendering blank under Vault's CSP policy.
