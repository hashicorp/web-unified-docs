...
client receives the [wrapping token](/vault/docs/concepts/response-wrapping) in
return. Only when all authorizations are satisfied, the wrapping token can be
used to unwrap the requested secrets.

## Reference Material

- [Vault Enterprise Control Group Support](/vault/docs/enterprise/control-groups)
- [Policies](/vault/docs/concepts/policies)
- [Identity Groups](/vault/docs/secrets/identity)
- [Control Group API](/vault/api-docs/system/control-group)
- [Sentinel Policies](/vault/docs/enterprise/sentinel)
...
Use **_Control Groups_** in your policies to implement dual controller
...
policies](/vault/docs/concepts/policies) as well as
[Identities](/vault/docs/secrets/identity). If you are not familiar,
go through the following guides first:

- [Policies](/guides/identity/policies)
- [Identity - Entities & Groups](/guides/identity/identity)
...
Properties](/vault/docs/enterprise/sentinel/properties#control-group-properties)
