...
Please read the [Plugins internals](/vault/docs/internals/plugins) docs for more
...
plugin directory as specified in the [plugin internals](/vault/docs/internals/plugins) docs.
