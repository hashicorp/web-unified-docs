...
1.20.0 | No      | **Yes**    | Enterprise | [Azure secrets engine roles can target Vault's own service principal](/vault/docs/v1.20.x/updates/important-changes#azure-static-role-self-target)
