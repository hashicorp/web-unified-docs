...
1.20.0 | 1.20.5 | No         | Enterprise | [Rotation strings may change timezone interpretation across restarts](/vault/docs/1.20.x/updates/important-changes#rotation-drift)