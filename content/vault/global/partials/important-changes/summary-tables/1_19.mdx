...
1.19.17| No     | No         | Enterprise | [Plugin signature verification failures](/vault/docs/v1.19.x/updates/important-changes#plugin-signature-verification-renewed-pgp-key)
