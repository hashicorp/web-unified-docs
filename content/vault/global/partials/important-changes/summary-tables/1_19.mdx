...
1.19.17| No     | No         | Enterprise | [Plugin signature verification fails for Enterprise plugins released since April 21, 2026](/vault/docs/v1.19.x/updates/important-changes#plugin-signature-verification-renewed-pgp-key)
