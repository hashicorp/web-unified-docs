...
last_modified: 2025-10-21T16:28:22-07:00
...
For `linux/amd64`, you can download prebuilt binaries from the [HashiCorp releases page](https://releases.hashicorp.com/vault-plugin-database-oracle/),
and refer to [Oracle database plugin release notes](/vault/docs/secrets/databases/oracle/release-notes) for recent changes.
