...
- **Dependency update**: Vulnerability patch for `markdown-it`.
...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more: <a href="/vault/docs/secrets/identity/deduplication">Find and resolve duplicate Vault identities</a>
    </td>
  </tr>
