...
[Vault plugins](/vault/docs/internals/plugins).

For more information about plugin development, refer to this [documentation
section](/vault/docs/internals/plugins#plugin-development) and this [Learn
...
[here](/vault/docs/internals/plugins#built-in-plugins).
...
[plugin-portal-mdx]: https://github.com/hashicorp/vault/blob/main/website/pages/docs/plugin-portal/index.mdx
