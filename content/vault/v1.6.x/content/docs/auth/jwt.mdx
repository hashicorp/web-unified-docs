...
By default, if [namespaces](/vault/docs/enterprise/namespaces) are being used,
...
[OIDC Provider Setup](/vault/docs/auth/jwt_oidc_providers)
...
- Azure requires some additional configuration when a user is a member of more
  ...
  configuration](/vault/docs/auth/jwt_oidc_providers#azure-specific-handling-configuration)
