...
This method allows you to create a roleset or update an existing roleset. See [roleset docs](/vault/docs/secrets/gcp#roleset-bindings) for the GCP secrets backend
...
See [bindings format docs](/vault/docs/secrets/gcp#roleset-bindings) for more information.
