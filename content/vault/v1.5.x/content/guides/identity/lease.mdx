...
- The [Validation](/guides/secret-mgmt/dynamic-secrets#validation) section of the
  [Secret as a Service](/guides/secret-mgmt/dynamic-secrets) guide demonstrates lease
  renewal and revocation
- [Tokens documentation](/vault/docs/concepts/tokens)
- [Token Auth Method (API)](/vault/api-docs/auth/token)
- [Lease, Renew, and Revoke](/vault/docs/concepts/lease)
...
optional [parameters](/vault/api-docs/auth/token#create-token) that you can pass
