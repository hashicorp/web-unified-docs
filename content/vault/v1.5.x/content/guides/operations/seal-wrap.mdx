...
**_Vault Enterprise_** integrates with [HSM platforms](/vault/docs/enterprise/hsm)
to opt-in automatic [unsealing](/vault/docs/concepts/seal#unsealing).
...
- [Seal Wrap documentation](/vault/docs/enterprise/sealwrap)
- [Vault Configuration - pkcs11 Seal](/vault/docs/configuration/seal/pkcs11)
- [Vault Enterprise HSM Support](/vault/docs/enterprise/hsm)
...
Integrate Vault with FIPS 140-2 certified HSM and enable the **_Seal Wrap_**
...
- A [supported HSM](/vault/docs/enterprise/hsm) cluster to be integrated
  with Vault
...
file must define the [`PKCS11 seal` stanza](/vault/docs/configuration/seal/pkcs11)
...
generate the key yourself. Refer to the [key generation attributes](/vault/docs/configuration/seal/pkcs11#vault-key-generation-attributes).
...
Sharing](/vault/docs/enterprise/hsm/behavior#initialization), similar to Vault's
...
The above command enabled [key/value version 1](/vault/docs/secrets/kv/kv-v1) with
...
HA with Consul](/guides/operations/vault-ha-consul) guide.
