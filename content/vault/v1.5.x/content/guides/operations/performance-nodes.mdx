...
In [Vault High Availability](/guides/operations/vault-ha-consul) guide, it
...
[transit](/vault/docs/secrets/transit) keys, GET requests of key/value
...
[`disable_performance_standby`](/vault/docs/configuration#vault-enterprise-parameters)
flag to `true`.
