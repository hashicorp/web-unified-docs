...
Defaults to the license start timestamp. If you use an IBM PAO license, Vault
ignores `billing_start_timestamp` in favor of the start time of the entitlement
selected by the `license_entitlement` stanza.
