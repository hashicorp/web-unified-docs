...
last_modified: 2026-02-18T02:23:33.000Z
...
Envelope encryption allows for client side symmetric encryption of
arbitrarily sized files and streams.

To [envelope encrypt](/vault/docs/commands/transit/envelope_encrypt) files and
streams, use `vault transit envelope encrypt <transit key path> <file> ...`.

To [decrypt](/vault/docs/commands/transit/envelope_decrypt), `vault transit envelope decrypt <transit key path> <file> ...`.

To extract [headers](/vault/docs/commands/transit/envelope_header), `vault transit envelope header <file> ...`
