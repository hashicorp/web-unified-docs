...
- You need to retrieve both the certificate and key at a later time.
 ...
 must be performed.
    ...
    <Tab heading="Identifier workflow">
     ...
     4. Fulfill challenges (place HTTP token or DNS records) as ACME server expects.
    ...
    <Tab heading="CSR workflow">
     ...
     5. Fulfill challenges (place HTTP token or DNS records) as ACME server expects.
