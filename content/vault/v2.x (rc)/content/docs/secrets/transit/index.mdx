...
Data key set generation <EnterpriseAlert inline="true" /> facilitates 
[envelope encryption](/vault/docs/secrets/transit/envelope-encryption) where
data of arbitrary size is encrypted and decrypted client side.
