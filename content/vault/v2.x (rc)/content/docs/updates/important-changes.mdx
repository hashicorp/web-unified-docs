...
sending key-update requests with bogus key fragments and prevent legitimate
...
be provided. Authenticating to the affected endpoints now requires a seal/recovery
key fragment and a valid Vault token.
