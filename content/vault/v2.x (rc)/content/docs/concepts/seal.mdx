...
last_modified: 2026-02-14T01:14:49.000Z
...
When you enable DR or PR replication in Vault Enterprise, [performance standby](/vault/docs/enterprise/performance-standby) nodes on the Vault DR or PR secondary cluster seal themselves, so you must restart them to unseal them.
