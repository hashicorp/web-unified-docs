...
It is the start of the period for which [automated](/vault/docs/enterprise/license/utilization-reporting) and [manual](/vault/docs/enterprise/license/manual-reporting) license utilization data will be reported for a cluster. 
If you do not have an explicit billing start date configured, this defaults to the HashiCorp license start date or the IBM Passport Advantage Online license entitlement start date.
