...
last_modified: 2026-02-18T02:24:55.000Z
...
| `vault.secretsync.destinations.wif.count`                           | The total number of secret destinations configured for secret sync using Workload Identity Federation(WIF).      |
| `vault.secretsync.destinations.aws-sm.wif.count`                    | The total number of AWS-SM secret destinations configured for secret sync using Workload Identity Federation(WIF). |
| `vault.secretsync.destinations.azure-kv.wif.count`                  | The total number of Azure-KV secret destinations configured for secret sync using Workload Identity Federation(WIF). |
| `vault.secretsync.destinations.gcp-sm.wif.count`                    | The total number of GCP-SM secret destinations configured for secret sync using Workload Identity Federation(WIF). |
| `vault.secretsync.destinations.inmem.wif.count`                     | The total number of InMem secret destinations configured for secret sync using Workload Identity Federation(WIF). |
| `vault.secretsync.destinations.static.count`                        | The total number of secret destinations configured for secret sync using static credentials.                     |
| `vault.secretsync.destinations.aws-sm.static.count`                 | The total number of AWS-SM secret destinations configured for secret sync using static credentials.              |
| `vault.secretsync.destinations.azure-kv.static.count`               | The total number of Azure-KV secret destinations configured for secret sync using static credentials.            |
| `vault.secretsync.destinations.gcp-sm.static.count`                 | The total number of GCP-SM secret destinations configured for secret sync using static credentials.              |
| `vault.secretsync.destinations.inmem.static.count`                  | The total number of InMem secret destinations configured for secret sync using static credentials.               |
...
| `vault.secret.engine.keymgmt.azurekeyvault.provider.kms.key.count`  | The total number of KMS keys across all namespaces from keymgmt secret engine mapped with Azure provider.        |
| `vault.secret.engine.keymgmt.awskms.provider.kms.count`             | The total number of AWS KMS providers across all namespaces from keymgmt secret engine.                          |
| `vault.secret.engine.keymgmt.gcpckms.provider.kms.count`            | The total number of GCP KMS providers across all namespaces from keymgmt secret engine.                          |
| `vault.secret.engine.keymgmt.azurekeyvault.provider.kms.count`      | The total number of Azure KMS providers across all namespaces from keymgmt secret engine.                        |
| `vault.secret.engine.keymgmt.kms.multi.region.key.count`            | The total number of multi-region KMS key across all namespaces from keymgmt secret engine.                       |
| `vault.secret.engine.keymgmt.kms.multi.region.key.secondary.region.count` | The total number of secondary region of multi-region KMS key across all namespaces from keymgmt secret engine. |
