...
last_modified: 2026-02-18T02:32:34.000Z
...
- `edition` is only applicable for IBM PAO licenses. For HashiCorp licenses, this field will always be empty.
- `add_ons` is only applicable for IBM PAO licenses. For HashiCorp licenses, this field will always be empty.
...
### Sample response for an IBM PAO license
