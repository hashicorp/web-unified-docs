...
- `edition` only applies to IBM PAO licenses. HashiCorp licenses leave `edition` empty.
- `add_ons` only applies to IBM PAO licenses. HashiCorp licenses leave `add_ons` empty.
