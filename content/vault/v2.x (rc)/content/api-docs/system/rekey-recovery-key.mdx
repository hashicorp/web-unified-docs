...
last_modified: 2026-02-18T02:32:42.000Z
...
<Note title="Conditionally unrestricted endpoint">
    Clients can call these endpoints without authenticating to Vault if the HCL config
    [`enable_unauthenticated_access`](/docs/configuration#enable_unauthenticated_access)
    includes "rekey".
</Note>
