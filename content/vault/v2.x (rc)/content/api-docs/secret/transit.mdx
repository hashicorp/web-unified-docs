...
~> **Note**: The context parameter is used if key derivation of the underlying
   transit key for encryption is desired.  This is unrelated to the key derviation 
   used to generate the data keys.
