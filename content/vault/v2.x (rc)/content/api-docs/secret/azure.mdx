...
- `defer_initial_creds` (`bool`, `false`) - If set to `true`, the initial credential generation
   will be deferred until the first read of credentials from this role. Defaults to `false`.
