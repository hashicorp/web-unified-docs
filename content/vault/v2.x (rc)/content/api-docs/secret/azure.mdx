...
Use this endpoint to import existing Azure credentials when creating a static role.
The import endpoint is only used during role creation. Any subsequent updates to the role
are applied using the standard Create/Update static role endpoint.
