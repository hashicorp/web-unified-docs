...
last_modified: 2026-04-08T00:18:30.000Z
...
| `get_provider_capabilities` | Get the capabilities of a provider including resources, data sources, functions, and guides | Summary of provider capabilities with counts and examples |
...
| `list_workspace_policy_sets` | Get the policy sets attached to a particular workspace | A list of policy sets |
| `attach_policy_set_to_workspaces` | Attach a policy set to a workspace | Confirmation of attachment |
...
| `OTEL_METRICS_ENABLED`         | Enable tools metrics using OpenTelemetry                                      | `false`                      |
