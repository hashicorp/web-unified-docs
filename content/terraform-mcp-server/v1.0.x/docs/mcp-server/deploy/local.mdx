...
Set the `TFE_TOKEN` environment variable to your HCP Terraform or Terraform Enterprise API token. Set the `TFE_HOSTNAME` environment variable to the URL of your Terraform Enterprise deployment. Refer to the [environment variables reference](/terraform/mcp-server/reference#environment-variables) for more information.
