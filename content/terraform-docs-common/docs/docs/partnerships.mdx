...
Moving forward, in order to qualify for the Partner tag on the Terraform Registry, the following must be met and verified by a HashiCorp-IBM Product Partnerships Manager:
