...
All Terraform providers listed as Partner or Partner Premier must contain one of the following open source licenses:
...
#### Requirements for the Partner Premier Tag
...
**Technical:**
- Include a Software Bill of Materials (SBOM) for the provider using the [GitHub SBOM Generator](https://docs.github.com/en/code-security/how-tos/secure-your-supply-chain/establish-provenance-and-integrity/exporting-a-software-bill-of-materials-for-your-repository), [Syft](https://github.com/anchore/syft), the [CycloneDX Generator](https://github.com/CycloneDX/cdxgen), or other SBOM generation tool.
...
- Terraform Search, which requires the implementation of both [resource identities](https://developer.hashicorp.com/terraform/plugin/framework/resources/identity) and [list resources](https://developer.hashicorp.com/terraform/plugin/framework/list-resources)
- [Terraform Actions](https://developer.hashicorp.com/terraform/plugin/framework/actions)
...
To qualify for the Partner tag on the Terraform Registry, a HashiCorp-IBM Product Partnerships Manager must verify that your provider meets the following requirements:
1. Participate in the [HashiCorp Technology Partner Program](https://www.hashicorp.com/en/lp/tech-partner).
...
- Include the following files in your module:
  ...
  - Changelog.txt: Documents changes and updates to the module over time.
