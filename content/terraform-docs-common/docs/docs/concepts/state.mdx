...
> THIS IS A COPY OF THE CLOSEST EXISTING PAGE WE HAVE ABOUT THE CONCEPT OF STATE. THIS TOPIC ALSO NEEDS TO MENTION one workspace = one state file, HOW TO STORE STATE, Sensitive data AND Ephemeral values
