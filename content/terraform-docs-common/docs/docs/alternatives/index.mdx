...
**_Talk about how it integrates with other products (Packer for image mgmt, Vault for secrets), How does Ansible expand your workflow/where is its place, IaC vs config mgmt_**
