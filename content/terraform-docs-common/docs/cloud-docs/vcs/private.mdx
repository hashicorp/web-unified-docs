...
We recommend creating a separate agent pool to test your Stacks private VCS operations. Refer to [software requirements](/terraform/cloud-docs/agents/requirements#software) to learn more.
</Note>
