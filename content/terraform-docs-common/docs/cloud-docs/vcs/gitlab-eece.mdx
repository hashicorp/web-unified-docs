...
description: >-
  Learn how to use on-premise installation of GitLab Enterprise Edition (EE) or GitLab Community Edition (CE) with workspaces and private registry module in HCP Terraform.
---
