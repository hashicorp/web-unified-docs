...
Terraform policy support for Stacks currently has the following limitatons:
...
- Policy evaluation is only supported for Stacks running Terraform 1.16alpha, 1.17alpha, and 1.17beta.
