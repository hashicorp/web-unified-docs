...
1. Optionally, click **Advanced options** to control the following behavior of your Stack:
    ...
    * By default, HCP Terraform uses a project's default execution mode to choose the execution platform for a stack. You can choose a different **Execution Mode** to use a different available option.
