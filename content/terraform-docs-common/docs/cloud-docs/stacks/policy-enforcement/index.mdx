...
Stacks support Terraform policy only. For information about using Sentinel or OPA policies with workspaces, refer to [Policy enforcement in workspaces](/terraform/cloud-docs/workspaces/policy-enforcement).
