...
last_modified: 2026-09-17T19:30:45.000Z
...
<!-- BEGIN: TFEnterprise:only name:request-body -->
...
<!-- END: TFEnterprise:only name:request-body -->

<!-- BEGIN: TFC:only name:request-body -->
| Key path | Type | Default | Description |
| --- | --- | --- | --- |
| `schemas[]`        | array  |         | Include `"urn:ietf:params:scim:schemas:core:2.0:User"`. |
...
| `name.givenName`   | string |         | Optional SCIM name field accepted from identity providers. HCP Terraform does not persist SCIM name fields.<!-- update when OIN gallery app support is ready --> |
| `name.familyName`  | string |         | Optional SCIM name field accepted from identity providers. HCP Terraform does not persist SCIM name fields.<!-- update when OIN gallery app support is ready --> |
<!-- END: TFC:only name:request-body -->
...
<!-- BEGIN: TFEnterprise:only name:create-sample-response -->
```json
{
	"schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
	"id": "52f5ecb9-59db-4f8d-9c9b-c2ec9a39e126",
...
```
<!-- END: TFEnterprise:only name:create-sample-response -->

<!-- BEGIN: TFC:only name:create-sample-response -->
```json
{
	"schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
	"id": "52f5ecb9-59db-4f8d-9c9b-c2ec9a39e126",
...
```
<!-- END: TFC:only name:create-sample-response -->
...
<!-- BEGIN: TFEnterprise:only name:replace-sample-response -->
```json
{
	"schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
	"id": "52f5ecb9-59db-4f8d-9c9b-c2ec9a39e126",
...
```
<!-- END: TFEnterprise:only name:replace-sample-response -->

<!-- BEGIN: TFC:only name:replace-sample-response -->
```json
{
	"schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
	"id": "52f5ecb9-59db-4f8d-9c9b-c2ec9a39e126",
...
```
<!-- END: TFC:only name:replace-sample-response -->
...
<!-- BEGIN: TFEnterprise:only name:patch-sample-response -->
```json
{
	"schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
	"id": "52f5ecb9-59db-4f8d-9c9b-c2ec9a39e126",
...
```
<!-- END: TFEnterprise:only name:patch-sample-response -->

<!-- BEGIN: TFC:only name:patch-sample-response -->
```json
{
	"schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
	"id": "52f5ecb9-59db-4f8d-9c9b-c2ec9a39e126",
...
```
<!-- END: TFC:only name:patch-sample-response -->
