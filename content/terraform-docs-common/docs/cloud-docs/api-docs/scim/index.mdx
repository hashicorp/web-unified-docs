...
You must use a SCIM provisioning token for authentication. You can't use a user, team, or organization API token. Refer to the [SCIM tokens API reference documentation](/terraform/cloud-docs/api-docs/scim/tokens) for more information.
