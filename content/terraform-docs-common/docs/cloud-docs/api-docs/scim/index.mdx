...
last_modified: 2026-09-17T19:30:44.000Z
...
You must authenticate with a SCIM provisioning token to call these endpoints. You can't use a user, team, or organization API token. Refer to the [SCIM tokens API reference documentation](/terraform/cloud-docs/api-docs/scim/tokens) for more information.
