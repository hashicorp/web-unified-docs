...
last_modified: 2026-09-10T23:12:47.000Z
...
HCP Terraform exposes the standard SCIM discovery endpoints below. These endpoints use the same SCIM bearer token as the provisioning endpoints.
