...
In HCP Europe organizations, you use HCP [groups]/hcp/docs/hcp/iam/groups) to manage permissions instead of teams. If your URL includes `portal.cloud.eu.hashicorp` or `app.eu.terraform.io`, then you are in an HCP Europe organization.
