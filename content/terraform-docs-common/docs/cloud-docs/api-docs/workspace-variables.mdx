---
page_title: /workspaces/vars API reference for HCP Terraform
description: >-
  Use the HCP Terraform API's workspace `/workspaces/vars` endpoint to manage workspace-specific variables. Read, create, update, and delete workspace variables.
---
