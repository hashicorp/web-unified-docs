...
last_modified: 2026-04-03T18:59:08.000Z
...
You can use [IP allowlists](/terraform/cloud-docs/users-teams-organizations/ip-allowlists) to restrict which IP addresses can access specific agent pools, enhancing security by ensuring that only requests from approved IP addresses can connect to your agents.
