...
| Parameter     | Description                                                                                                         |
|---------------|-------------------------------------------------------------------------------------------------------------------- |
| `deployments` | A comma separated list specifying the names of the deployments within the group that are to be rerun. If omitted, all failed or abandoned deployments will be rerun. If present, all requested deployments must be failed or abandoned. |
...
## TODO: Start a Stack deployment group

## TODO: Cancel a Stack deployment group
