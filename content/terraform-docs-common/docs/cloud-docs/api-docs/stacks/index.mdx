...
Each configuration summary is associated with a single Stack configuration, and includes counts of how many of its deployment groups and deployment runs are in each available status.
