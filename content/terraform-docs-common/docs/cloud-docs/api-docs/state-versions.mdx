...
| `sanitized-state-download-url`   | A URL to which you can download state data with sensitive values redacted. Only available for workspaces using [hold your own key](/terraform/cloud-docs/hold-your-own-key) encryption.                                                                                                                                                                                                   |
