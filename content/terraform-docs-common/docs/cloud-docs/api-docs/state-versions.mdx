...
| `hyok-encrypted-data-key`        | A reference to the HYOK encrypted data key used to secure this state version. Hold your own key is only available in HCP Terraform. Refer to [Encrypt your state and plan files](/terraform/cloud-docs/hold-your-own-key) for more information.                                                                                                                                                                                                   |
