...
| `hyok-encrypted-data-key`        | A reference to the [HYOK Encrypted Data Key](/terraform/cloud-docs/api-docs/hyok-encrypted-data-keys) used to encrypt this state version. This is only present if the workspace is configured for HYOK.                                                                 |
