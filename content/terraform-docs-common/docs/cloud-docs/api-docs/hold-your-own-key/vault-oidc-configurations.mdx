...
Vault OIDC configurations are models that represent the necessary information for HCP Terraform to request the use of your HashiCorp Vault key for Hold Your Own Key (HYOK) functionality.
