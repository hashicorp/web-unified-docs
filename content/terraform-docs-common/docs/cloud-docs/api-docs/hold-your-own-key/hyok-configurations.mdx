...
HYOK configurations configure the following in HCP Terraform: How to authenticate to your KMS via OIDC, Which key from your KMS should be used, What name should be used to identify the configuration within HCP Terraform
