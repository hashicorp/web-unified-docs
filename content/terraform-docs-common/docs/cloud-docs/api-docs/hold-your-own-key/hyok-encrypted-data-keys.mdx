...
An HYOK encrypted data key is a key that is encrypted using your Key Management Service (KMS) key. This key is used to HYOK encrypt your HCP Terraform artifacts, such as state files and module versions.
Your KMS key remains under your control and outside of HCP networks.
