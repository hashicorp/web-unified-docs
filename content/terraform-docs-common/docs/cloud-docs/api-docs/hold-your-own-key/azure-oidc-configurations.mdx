...
Azure OIDC configurations are models that represent the necessary information for HCP Terraform to request the use of your Microsoft Azure key for Hold Your Own Key (HYOK) functionality.
...
To learn more about hold your own key, refer to the feature [Overview](/terraform/cloud-docs/hold-your-own-key).
