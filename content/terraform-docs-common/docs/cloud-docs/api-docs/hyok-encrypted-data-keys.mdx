...
| `data.attributes.encrypted-dek` | string | The encrypted dek is the the key that is used to HYOK encrypt your Terraform artifacts. This dek is encrypted using your key management service key encryption key. |
