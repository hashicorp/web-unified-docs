...
##2025-10-01
* Add a new page for [member roles](/terraform/cloud-docs/api-docs/workspaces) APIs for retrieving information about permision groups in a HCP EU organization.
* Add a note about HCP EU organization to the [project-team-access](/terraform/cloud-docs/api-docs/project-team-access), [team-access](/terraform/cloud-docs/api-docs/team-access), [team-members](/terraform/cloud-docs/api-docs/team-members), [team-tokens](/terraform/cloud-docs/api-docs/team-tokens), and [teams](/terraform/cloud-docs/api-docs/teams) pages.
