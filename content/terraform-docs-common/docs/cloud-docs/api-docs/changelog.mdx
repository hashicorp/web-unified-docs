...
last_modified: 2026-09-17T18:23:40.000Z
...
<!-- BEGIN: TFC:only name:hyok -->

## 2026-09-17

- The [HYOK configurations API](/terraform/cloud-docs/api-docs/hold-your-own-key/configurations) supports a new `transit-path` KMS option. Set this option to the path where you mounted Vault's transit secrets engine when it is not the default `transit` path. This option requires HCP Terraform agents on version `1.31.2` or later.

<!-- END: TFC:only name:hyok -->
