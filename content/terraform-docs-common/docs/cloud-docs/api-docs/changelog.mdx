...
## 2025-9-30
* Add a new page for [member roles](/terraform/cloud-docs/api-docs/workspaces) APIs for retrieving information about group permissions for HCP EU organizations. To learn more about HCP Europe, refer to the [HCP Europe documentation](/hcp/docs/hcp/europe).
* Add a note that you cannot use teams in HCP EU organizations to the [project-team-access](/terraform/cloud-docs/api-docs/project-team-access), [team-access](/terraform/cloud-docs/api-docs/team-access), [team-members](/terraform/cloud-docs/api-docs/team-members), [team-tokens](/terraform/cloud-docs/api-docs/team-tokens), and [teams](/terraform/cloud-docs/api-docs/teams) pages. To learn more about HCP Europe, refer to the [HCP Europe documentation](/hcp/docs/hcp/europe).
