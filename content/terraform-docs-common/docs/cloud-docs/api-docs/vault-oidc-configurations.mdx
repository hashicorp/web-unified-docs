...
description: >-
 Use the HCP Terraform API's `/oidc-configuration` endpoint to create and view your Vault OIDC configurations for HYOK (Hold Your Own Keys) in HCP Terraform.
---
