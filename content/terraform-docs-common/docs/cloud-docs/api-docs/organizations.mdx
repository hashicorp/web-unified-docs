...
Refer to [Constraints and limitiation](/terraform/cloud-docs/stacks#constraints-and-limitations) for more information.
...
| `data.attributes.default-agent-pool-id`                                   | string  | (previous value) | Required when `default-execution-mode` is set to `agent`. The ID of the agent pool belonging to the organization. Do _not_ specify this value if you set `execution-mode` to `remote` or `local`.                                                                                                                      |
| `data.attributes.stacks-default-agent-pool-id`                            | string  | (previous value) | Required when `stacks-default-execution-mode` is set to `agent`. The ID of the agent pool belonging to the organization. Don't specify this value if you set `execution-mode` to `remote`.                                                                                                                      |
...
The `stacks-default-execution-mode` property and `stacks-default-agent-pool` relationship are only returned from organizations entitled to Stacks.
