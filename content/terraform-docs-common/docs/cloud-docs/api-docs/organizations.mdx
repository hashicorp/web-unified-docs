...
This endpoint shows organizations that are configured to share modules with an organization through [module sharing](/terraform/enterprise/admin/application-administration/registry-sharing).
