...
description: >-
 Use the HCP Terraform API's `/oidc-configuration` endpoint to create and view your Azure OIDC configurations for HYOK (Hold Your Own Keys) in HCP Terraform.
---
...
| -------------------------------- | ------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `data.type`                      | string  |           | Must be `"gco-oidc-configurations"`.                                                                                                                                                                               |
