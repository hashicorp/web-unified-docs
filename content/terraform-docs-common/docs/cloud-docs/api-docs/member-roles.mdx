...
-> **Note:** This API is currently only available for HCP Europe accounts. For standalone HCP Terraform accounts, please refer to [Teams](/terraform/cloud-docs/api-docs/teams) related APIs.
