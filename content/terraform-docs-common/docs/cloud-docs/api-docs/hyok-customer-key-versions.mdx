...
description: >-
 Use the HCP Terraform API's `/hyok-customer-key-versions` endpoint to view, revoke, and refresh your HYOK (Hold Your Own Key) customer key versions.
---
...
## List HYOK Customer Key Versions for HYOK Configuration
...
## Revoke HYOK Customer Key Versions
 `POST /api/v2/hyok-customer-key-versions/:hyok_configuration_id/actions/revoke`

| Parameter           | Description                  |
| ------------------- | ---------------------------- |
| `hyok_configuration_id` | The id of the hyok-customer-key-version


| Status  | Response                  | Reason                                                            |
|---------|---------------------------|-------------------------------------------------------------------|
| [204][] | [No content][]            | Successfully revoked a HYOK customer key version.                        |
| [404][] | [JSON API error object][] | HYOK customer key version not found, or user unauthorized to perform action.    |
