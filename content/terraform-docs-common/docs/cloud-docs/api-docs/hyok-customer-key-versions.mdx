...
|--------------------------------------|---------|-----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `data.type`                          | string  |           | Must be `"hyok-customer-key-versions"`.                                                                                                                                                                                                                                                                |
...
| `data.relationships.configuration.data.id`     | string         | (nothing) | The ID of the organization to associate with the HYOK configuration.                                                                                                                                                                                                                        |
...
| `data.attributes.error` | integer | The number of HCP workspaces that currently have data encryption keys secured with this HYOK customer key version   |
