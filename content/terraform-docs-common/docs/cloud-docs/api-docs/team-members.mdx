...
last_modified: 2026-09-14T18:39:01.000Z
...
Use the team membership API to add or remove users from teams. To create or destroy teams, refer to the [teams API documentation](/terraform/cloud-docs/api-docs/teams).

<!-- BEGIN: TFC:only name:pnp-callout -->

Team management is available in HCP Terraform **Essentials**, **Standard**, and **Premium** editions. Free organizations can also use this API, but can only manage membership of their owners team. Refer to the [Terraform pricing page](https://www.hashicorp.com/en/pricing?tab=terraform) for more information.
