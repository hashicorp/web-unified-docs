...
The following triggers are available for [project notifications](#project-notification-configuration).
...
Project notifications allow you to configure relevant alerts that notify users you specify whenever a certain event occurs.
...
```json
{
  "data": {
    ...
    "attributes": {
      "destination-type": "email",
      "enabled": true,
      "name": "Email project members about a completed run",
      "triggers": [
        "run:completed"
      ]
    },
...
curl \
  ...
  --request POST \
  --data @payload.json \
  https://app.terraform.io/api/v2/project/prj-ny19cRJJos5F5FQ5/notification-configurations
```
...
| Parameter       | Description                                                                                                                                                                                                                                                                                                                             |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `:project_id` | The ID of the projects to list configurations from. |
