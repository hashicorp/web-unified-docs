...
last_modified: 2026-07-15T13:51:40.000Z
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-modules/module-version-id/tag-bindings"
        }
      }
    },
    "links": {
...
`GET /api/v2/registry-module-versions/module_version-id/tag-bindings`

| Parameter | Description |
| :---- | :---- |
| `:module_name` | The specific module version id whose tags you want to list. |
...
`PATCH /api/v2/organizations/:organization_name/registry-modules/private/:namespace/:module_name/:module_provider/:module_version`
