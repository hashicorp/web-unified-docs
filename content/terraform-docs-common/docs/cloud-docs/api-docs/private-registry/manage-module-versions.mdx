...
last_modified: 2026-07-15T16:01:07.000Z
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-module-versions/modver-uKQCVs5vAKDmUMyw/tag-bindings"
        }
      }
    },
    "links": {
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/api/v2/registry-module-versions/modver-uKQCVs5vAKDmUMyw/tag-bindings"
        }
      }
    },
    "links": {
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-module-versions/modver-3tKAXyRnpGYCxW7d/tag-bindings"
        }
      }
    },
    "links": {
  ...
  "data": {
    ...
    // ... //
      ...
      // ... //
			"tag-bindings": {
        "links": {
          "related": "/api/v2/registry-modules/mod-u8BFFruSTSz8dN4C/tag-bindings"
        }
      }
    }
	}
...
## List all tags for a module version

Use this endpoint to list all tags assigned to a module version.

`GET /api/v2/registry-module-versions/:module_version_id/tag-bindings`

| Parameter | Description |
| :---- | :---- |
| `:module_version_id` | The specific module version id whose tag bindings you want to list. |
...
| [404](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/404) | [JSON API error object](http://jsonapi.org/format/#error-objects) | The module version does not exist. |
...
curl \
  --request GET \
  --header "Authorization: Bearer $TOKEN" \
  https://app.terraform.io/api/v2/registry-module-versions/modver-fdsgeGGR4ed14kyk5/tag-bindings
```
...
```json
{
  "data": [
    {
      "id": "tb-KjfdsjI79YFndd7e",
      "type": "tag-bindings",
      "attributes": {
        "key": "environment",
        "value": "staging",
        "created-at": "2026-06-11T02:39:03.363Z"
      }
    },
    {
      "id": "tb-fsdDG4jfPHyuC",
      ...
      "attributes": {
        "key": "environment",
        "value": "testing",
        "created-at": "2026-06-11T02:39:03.369Z"
      }
    }
  ],
  "links": {
    "target": "https://app.terraform.io/api/v2/organizations/my-organization/registry-modules/private/my-namespace/module/terraform/version?name=module&version=0.0.3"
  }
}
```

## Add or update tags for a module version

Use this endpoint to add or update tags for a module version in your organization's registry.
-> **Note:** Removing tags from a module version is made via PATCH requests, where the request body will contain only the tag keys and values that are currently needed.

`PATCH /api/v2/organizations/:organization_name/registry-modules/:registry_name/:namespace/:module_name/:module_provider/:module_version`

| Parameter | Description |
| :---- | :---- |
| `:organization_name` | The name of the organization the module belongs to. |
| `:registry_name` | Either `public` or `private`. |
| `:module_name` | The name of the module whose version you want to tag. |
| `:module_provider` | Specifies the provider that this module uses. |
| `:module_version` | The module version you want to add or update a tag for. |
...
curl \
  ...
  --request PATCH \
  --data @payload.json \
  https://app.terraform.io/api/v2/organizations/my-organization/registry-modules/private/namespace/my-module/terraform/0.0.4
```
...
{
  "data": {
    "id": "modver-GADfdsmkfu342d",
    "type": "registry-module-versions",
    "attributes": {
      "source": "tfe-api",
      "status": "ok",
      "version": "0.0.4",
      "commit-sha": "453f8da2f52487t7D6e59453f8da2f52487t7D6e59",
      "branch": "main",
      "created-at": "2026-04-29T03:41:13.011Z",
      "updated-at": "2026-04-29T03:41:15.121Z",
      "revocation": {
        "status": "unrevoked"
      }
    },
    "relationships": {
      "registry-module": {
        "data": {
          "id": "mod-ih4cBGFaxina84",
          "type": "registry-modules"
        }
      },
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-module-versions/modver-GADfdsmkfu342d/tag-bindings"
        }
      }
    },
    "links": {
      "upload": "https://archivist.terraform.io/v1/object/dmF1bHQ6djU6V08vOWE1NncrU2ZxSUdvT0J"
    }
  }
}
```
