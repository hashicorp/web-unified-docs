...
last_modified: 2026-06-25T19:29:22.000Z
        ...
        "organization": {
          "data": {
            ...
            "type": "organizations"
				...
				"tag-bindings": {
					"links": {
						"related": "/api/v2/registry-modules/module-id/tag-bindings"
					}
				}
      },
      "links": {
...
curl \
  --request GET \
  --header "Authorization: Bearer $TOKEN" \
  https://app.terraform.io/api/v2/registry-modules/module-id/tag-bindings
```
...
```json
{
  ...
  "links": {
    "target": "/api/v2/organizations/my-organization/registry-modules/registry-name/namespace/module-name/provider-name/"
  }
}
```
...
|---|---|---|---|
| `data.type` | string |  | Must be `"registry-modules"`. |
| `data.attributes.key` | string |  | The tag key. |
| `data.attributes.value` | string |  | The tag value. |
