...
last_modified: 2026-06-25T21:03:52.000Z
  ...
  "data": [
    {
      ...
      "relationships": {
        ...
        "tag-bindings": {
          "links": {
            "related": "/api/v2/registry-providers/provider-id/tag-bindings"
          }
        }
      },
      "links": {
...
curl \
  --request GET \
  --header "Authorization: Bearer $TOKEN" \
  https://app.terraform.io/api/v2/registry-providers/provider-id/tag-bindings
```
...
```json
{
	...
	"links": {
		"target": "/api/v2/organizations/my-organization/registry-providers/registry-name/namespace/test-provider"
	}
}
```
...
curl \
  ...
  --request PATCH \
  --data @payload.json \
  https://app.terraform.io/api/v2/organizations/my-organization/registry-providers/registry-name/namespace/provider-name
```
...
```json
{
  "data": {
    ...
    "links": {
      "self": "/api/v2/organizations/RAUC/registry-providers/private/RAUC/test-provider"
    }
  }
}
```
