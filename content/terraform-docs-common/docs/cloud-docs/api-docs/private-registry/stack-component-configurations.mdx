...
last_modified: 2026-06-28T18:54:59.000Z
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-components/comp-kdWEMRMEW20M/tag-bindings"
        }
      }
    },
    "links": {
      "self": "/api/v2/registry-components/comp-kdWEMRMEW20M"
    }
  }
}
```
