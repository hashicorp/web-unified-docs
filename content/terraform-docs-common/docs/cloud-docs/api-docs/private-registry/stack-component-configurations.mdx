...
last_modified: 2026-07-15T22:36:27.000Z
...
| GET | `/api/v2/registry-components/:component_id/versions` | [List the published versions](#versions-list-for-a-stack-component-configuration) of a Stack component configuration. |
  ...
  "data": [
    {
      ...
      "relationships": {
        ...
        "tag-bindings": {
          "links": {
            "related": "/api/v2/registry-components/comp-wed33EBTz4w8XeSS/tag-bindings"
          }
        }
      },
      "links": {
    ...
    },
    {
      ...
      "relationships": {
        ...
        "tag-bindings": {
          "links": {
            "related": "/api/v2/registry-components/comp-hGqAHmU28NE2hnjA/tag-bindings"
          }
        }
      },
      "links": {
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-components/comp-UnpBkfLQJZUXARc6/tag-bindings"
        }
      }
    },
    "links": {
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-components/comp-fZn7uHu99ZCpAKZJ/tag-bindings"
        }
      }
    },
    "links": {
...
```json
{
  "data": {
    ...
    "relationships": {
      ...
      "tag-bindings": {
        "links": {
          "related": "/api/v2/registry-components/comp-7GjfsTX1Yc5E1boD/tag-bindings"
        }
      }
    },
    "links": {
...
## List all tags for a Stack component configuration

[](#list-tags-for-a-stack-component-configuration)

Lists all tags assigned to a Stack component configuration.

`GET /api/v2/registry-components/:component-id/tag-bindings`

| Parameter       | Description                                          |
| --------------- | ---------------------------------------------------- |
| `:component-id` | The ID of the component configuration to be listed.  |

| Status  | Response                  | Reason                            |
| ------- | ------------------------- | --------------------------------- |
| [200][] | [JSON API document][]     | The request was successful        |
| [401][] | [JSON API error object][] | User unauthorized                 |
| [404][] | [JSON API error object][] | Component configuration not found |
...
curl \
  --request GET \
  --header "Authorization: Bearer $TOKEN" \
  https://app.terraform.io/api/v2/registry-components/comp-UnpBkfLQJZUXARc6/tag-bindings
```
...
```json
{
  "data": [
    {
      "id": "tb-vVzfvPfdwelCWSjbJEj",
      "type": "tag-bindings",
      "attributes": {
        "key": "billingID",
        "value": "1543",
        "created-at": "2026-06-28T19:18:49.312Z"
      }
    },
    {
      "id": "tb-1V8fdhepghjKNq",
      "type": "tag-bindings",
      "attributes": {
        "key": "env",
        "value": "staging",
        "created-at": "2026-06-28T19:18:49.318Z"
      }
    }
  ],
  "links": {
    "target": "/api/v2/registry-components/comp-UnpBkfLQJZUXARc6"
  }
}
```

## Add or update tags to a Stack component configuration

[](#add-tags-to-a-stack-component-configuration)

Adds or updates tags for a Stack component configuration in your organization's registry.
-> **Note:** Removing tags from a Stack component configuration is made via PATCH requests, where the request body will contain only the tag key and values that are currently needed.

`PATCH /api/v2/registry-components/:component_id`
...
| [400][] | [JSON API error object][] | Bad Request - Request body cannot be parsed                  |
| [401][] | [JSON API error object][] | User not authorized                                          |
| [404][] | [JSON API error object][] | Component configuration not found                            |
| [415][] | [JSON API error object][] | Invalid Content Type - content-type must be application/vnd.api+json" |

### Request body

[](#request-body)

This PATCH endpoint requires a body containing a JSON object with the following properties as a request payload.
It is also important to note that the request body must be sent with the `Content-Type` header set to `application/vnd.api+json`, that is different from modules and provides.
...
curl \
  ...
  --request PATCH \
  --data @payload.json \
  https://app.terraform.io/api/v2/registry-components/comp-kdWEMRMEW20M
```
...
{
	"data": {
		"id": "comp-ofwmg98KLJVAiG",
		"type": "registry-components",
		"attributes": {
			"name": "test-monorepo",
			"namespace": "namespace",
			"status": "completed",
			"created-at": "2026-05-20T04:47:13Z",
			"updated-at": "2026-05-20T04:47:13Z",
			"version-statuses": [
				{
					"version": "0.0.2",
					"status": "completed"
			...
			"vcs-repo": {
				"identifier": "test/test-monorepo",
				"display-identifier": "test/test-monorepo",
				"source-directory": "components/database",
				"tag-prefix": null,
				"github-app-installation-id": "fdsgf-gfs46jJJ5KmziM"
			}
		},
		"relationships": {
			"organization": {
				"data": {
					"id": "org-D4Xfmosgv4yfsK5PL",
					"type": "organizations"
				}
			},
			"registry-component-versions": {
				"links": {
					"related": "/api/v2/registry-components/comp-gfhjyhTv8JfdfvgiG/versions"
				}
			},
			"tag-bindings": {
				"links": {
					"related": "/api/v2/registry-components/comp-gfhjyhTv8JfdfvgiG/tag-bindings"
				}
			}
		},
		"links": {
			"self": "/api/v2/registry-components/comp-gfhjyhTv8JfdfvgiG"
		}
	}
}
```

## Versions List for a Stack Component Configuration

[](#versions-list-for-a-stack-component-configuration)

This endpoint returns all the published versions for a Stack component configuration with its tags' information.

`GET api/v2/registry-components/:component-id/versions`

| Parameter | Description |
|---|---|
| `:component-id` | The ID of the component configuration. |
...
| [404](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/404) | [JSON API error object](http://jsonapi.org/format/#error-objects) | Component configuration not found |
...
curl \
  --request GET \
  --header "Authorization: Bearer $TOKEN" \
  https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions
```
...
```json
{
  ...
  "links": {
    "self": "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?page%5Bnumber%5D=1&page%5Bsize%5D=20",
    "first": "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?page%5Bnumber%5D=1&page%5Bsize%5D=20",
    "prev": null,
    "next": null,
    "last": "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?page%5Bnumber%5D=1&page%5Bsize%5D=20"
  },
  "meta": {
    "pagination": {
      "current-page": 1,
...
The following request is very similar to the previous one, but it filters Component Configuration Versions where the key is `environment` and the value is `staging`.

```shell
$ curl \
  --header "Authorization: Bearer $TOKEN" \
  --header "Content-Type: application/vnd.api+json" \
  "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?page[number]=1&page[size]=20&filter[tagged][0][key]=environment&filter[tagged][0][value]=staging"
```
...
```json
{
  ...
  "links": {
    "self": "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?filter%5Btagged%5D%5B0%5D%5Bkey%5D=environment&filter%5Btagged%5D%5B0%5D%5Bvalue%5D=staging&page%5Bnumber%5D=1&page%5Bsize%5D=20",
    "first": "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?filter%5Btagged%5D%5B0%5D%5Bkey%5D=environment&filter%5Btagged%5D%5B0%5D%5Bvalue%5D=staging&page%5Bnumber%5D=1&page%5Bsize%5D=20",
    "prev": null,
    "next": null,
    "last": "https://app.terraform.io/api/v2/registry-components/comp-odB8kcGwTv8JVAiG/versions?filter%5Btagged%5D%5B0%5D%5Bkey%5D=environment&filter%5Btagged%5D%5B0%5D%5Bvalue%5D=staging&page%5Bnumber%5D=1&page%5Bsize%5D=20"
  },
  "meta": {
    "pagination": {
      "current-page": 1,
