...
last_modified: 2026-07-15T14:03:58.000Z
...
curl \
  --request GET \
  --header "Authorization: Bearer $TOKEN" \
  https://app.terraform.io/api/v2/registry-components/component-id/tag-bindings
```
...
```json
{
  ...
  "links": {
    "target": "/api/v2/registry-components/component-id"
  }
}
```
