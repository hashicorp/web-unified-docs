...
After you've added a Stack component configuration to the registry, you can assign tags so that you can apply consistent metadata to registry artifacts. 
