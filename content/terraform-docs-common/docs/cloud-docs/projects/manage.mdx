...
You can attach project tags to modules and providers uploaded to the private registry. Refer to [Manage artifact tags](/terraform/cloud-docs/registry/manage/tags) for more information.
