...
-> **Note:** Dynamic credentials for queries do not support run phase specific environment variables (plan and apply). Must use the requried Run-specific environment varaibles for the corresponding cloud platform.
