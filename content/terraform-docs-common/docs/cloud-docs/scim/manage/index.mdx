...
last_modified: 2026-09-14T22:57:32.000Z
...
When SCIM is enabled, the IdP creates user accounts owned by the organization. In some cases, you may need to change organization-owned users managed through SCIM into user-owned accounts that you can manually manage. Conversely, you may need to manually-managed users to SCIM-managed accounts owned by the organization. 
