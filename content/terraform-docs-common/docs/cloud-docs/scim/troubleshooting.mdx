...
last_modified: 2026-09-02T18:11:12.000Z
...
| `409` | Duplicate `userName` or `displayName` | Public SCIM | [Users not syncing](#users-not-syncing), [Duplicate users](#duplicate-users), [Groups not syncing](#groups-not-syncing) |
