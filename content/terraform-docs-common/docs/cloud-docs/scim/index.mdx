...
last_modified: 2026-09-24T17:24:59.000Z
...
The Terraform Enterprise API implements SCIM `User` and `Group` resources, as well as the discovery endpoints required by common identity providers.
...
- [Discovery endpoints](/terraform/cloud-docs/api-docs/scim#discovery-endpoints)
- [SCIM Groups API reference](/terraform/cloud-docs/api-docs/scim/groups)
- [SCIM Users API reference](/terraform/cloud-docs/api-docs/scim/users)
