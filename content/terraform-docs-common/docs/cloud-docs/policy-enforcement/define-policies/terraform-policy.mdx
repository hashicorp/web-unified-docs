...
To learn how to organize your policies into a VCS repository, refer to [VCS setup for Terraform policy](/terraform/cloud-docs/policy-enforcement/manage-policy-sets/vcs/terraform-policy-vcs).

#### Configure a policy set

After you have committed your policies to a VCS repository, you can configure a policy set within HCP Terraform to begin enforcing your policies. Refer to [Policy set configuration in HCP Terraform](/terraform/cloud-docs/policy-enforcement/manage-policy-sets/vcs/terraform-policy-vcs#policy-set-configuration-in-hcp-terraform) for more information.
