...
Members do not have access to projects or workspaces<!-- BEGIN: TFC:only name:stacks-tfe --> and Stacks<!-- END: TFC:only name:stacks-tfe -->. You can grant permissions to individual projects or workspaces<!-- BEGIN: TFC:only name:stacks-tfe --> and Stacks<!-- END: TFC:only name:stacks-tfe --> through [Project Permissions](/terraform/cloud-docs/users-teams-organizations/permissions/set-permissions#set-project-level-roles) or [Workspace Permissions](/terraform/cloud-docs/users-teams-organizations/permissions/set-permissions#set-workspace-level-roles).
...
| [Manage Stack component configurations](#manage-private-stack-component-configurations) | Publish and delete Stack component configurations in the private registry |
