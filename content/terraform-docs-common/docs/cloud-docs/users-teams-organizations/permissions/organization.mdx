...
| [Assign project tags to modules and providers](#assign-project-tags-to-modules-and-providers) | Lets team members assign project tags to modules and providers in the private registry |
| [Assign reserved keys to module and provider versions](#assign-reserved-keys-to-module-and-provider-versions) | Lets team members assign reserved keys to module and provider versions in the private registry |
...
### Assign project tags to modules and providers

Enable this setting to allow team members to attach existing project tags to modules and providers in the registry. Use these tags to organize registry artifacts. Refer to [Define project tags](/terraform/cloud-docs/projects/manage#define-project-tags) for more information.

### Assign reserved keys to module and provider versions
