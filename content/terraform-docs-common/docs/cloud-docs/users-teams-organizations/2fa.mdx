...
1. If you enabled **Application**, Terraform prompts you to scan a QR code and provide an authentication code to enable your TOTP-compliant application.
<!-- END: TFEnterprise:only name:block-sms-mfa-enrollment --><!-- BEGIN: TFC:only name:block-sms-mfa-enrollment -->
