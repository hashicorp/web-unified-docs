...
To allow mobile team members to access resources, they must connect from an IP address on the allowlist. You can use a VPN or another networking solution to provide static IP addresses for mobile team members. Refer to you system administrator for more information.
