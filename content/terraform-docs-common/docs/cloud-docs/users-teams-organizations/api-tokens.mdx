...
last_modified: 2026-09-24T19:10:59.000Z
...
For information about tokens for SCIM provisioning, refer to [Manage SCIM tokens](/terraform/cloud-docs/scim/manage/tokens). Tokens for SCIM provisioning are scoped to the SCIM configuration and are not associated with other API tokens. 
