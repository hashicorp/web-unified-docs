...
Before you configure SSO for your organization, we recommend that you create and designate two "Break glass" accounts, also known as emergency access accounts, with Owner permissions for your platform administrators. If you encounter problems with your SSO provider, you can use these accounts to access the organization for troubleshooting using their username and password.
