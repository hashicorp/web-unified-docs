...
Before you configure SSO for your organization, we recommend creating and designating two accounts with [owner permissions](/terraform/cloud-docs/users-teams-organizations/permissions/organization#organization-owners) that your platform administrators can use in case of an emergency. If you encounter problems with your SSO provider, you can use these accounts to access the organization for troubleshooting using their username and password.
