...
Before you configure SSO for your organization, we recommend that you create and designate two "Break-glass" accounts with Owner permissions for your platform administrators. These accounts can still access the organization with their username and password, to allow you to troubleshoot any problems with your SSO provider.
