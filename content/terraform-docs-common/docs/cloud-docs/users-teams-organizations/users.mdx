...
last_modified: 2026-08-14T20:47:41.000Z
...
This topic provides reference information about creating and managing users in <!-- BEGIN: TFC:only name:product-name -->HCP Terraform<!-- END: TFC:only name:product-name --><!-- BEGIN: TFEnterprise:only name:product-name -->Terraform Enterprise<!-- END: TFEnterprise:only name:product-name -->. You can also connect to an identity provider (IdP), such as Okta and Microsoft Entra ID, and automate user provisiong and management. Refer to [SCIM provisioning](/terraform/cloud-docs/scim-provisioning) for more information. 
