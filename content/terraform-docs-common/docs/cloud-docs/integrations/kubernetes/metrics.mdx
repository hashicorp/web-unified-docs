...
How metrics are scraped will depend on how you operate your Prometheus server. The below example assumes that you use the [Prometheus Operator](https://github.com/prometheus-operator/prometheus-operator) to run Prometheus.
...
Refer to your company policies before adding new Prometheus targets.
