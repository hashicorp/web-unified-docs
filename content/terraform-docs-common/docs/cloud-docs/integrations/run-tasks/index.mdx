...
Refer to the [run task integration API](/terraform/cloud-docs/api-docs/tasks/run-tasks-integration) for the exact payload specification.
...
```json
{
  ...
  "project_id": "prj-gFVyPJ2q2Aurn5DV",
  "project_name": "Default Project",
  "project_app_url": "https://app.terraform.io/app/hashicorp/projects/DefaultProject",
