...
last_modified: 2026-09-19T05:29:00.000Z
...
- Configure healthy key management policies to prevent data loss. Refer to [Protect your keys](/terraform/cloud-docs/hold-your-own-key/protect) for provider-specific deletion safeguards.
