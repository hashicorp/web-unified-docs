...
last_modified: 2026-03-13T20:27:51.000Z
...
To recover a workspace that has been deleted, the [**Allow deleted workspaces and stacks to be recoverable** option](/terraform/cloud-docs/users-teams-organizations/organizations/settings#allow-deleted-workspaces-and-stacks-to-be-recoverable) must be enabled for your organization.  
