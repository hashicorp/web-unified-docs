...
In the **Run List**, choose either **Direct action invocation** or **Lifecycle action invocation** from the **Type** list and click **Appy** to filter for runs that include action invocations. 
