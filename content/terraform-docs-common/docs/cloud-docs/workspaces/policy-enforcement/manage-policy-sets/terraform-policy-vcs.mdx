...
Terraform policy supports plugins that allow you to extend your policies with custom functions. In order for HCP Terraform workers or agents to execute your plugin, you must include a compiled binary in your policy VCS repository that is compatible with the HCP Terraform exeuction environment.
