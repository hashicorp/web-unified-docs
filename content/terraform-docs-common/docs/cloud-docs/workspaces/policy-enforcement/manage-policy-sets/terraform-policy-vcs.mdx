...
Terraform policy requires Terraform v1.16 or later. To enable alpha builds of Terraform, navigate to your organization's **Settings** page, select **General** from the left navigation, and enable the **Show Terraform pre-releases
** setting.
