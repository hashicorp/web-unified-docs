---
page_title: Pre-written policy repositories
description: Learn about HashiCorp's pre-written Sentinel policies for CIS, FSBP, PCI DSS, NIST SP 800-53 Revision 5, and ISO/IEC 27001:2013 Annex A.  
...
# Pre-written policy repositories reference

This topic provides reference information about the Sentinel policy repositories that HashiCorp authors and maintains. For instructions on how to run the policy libraries, refer to [Run pre-written Sentinel policies ](/terraform/cloud-docs/policy-enforcement/vcs/prewritten-sentinel).
