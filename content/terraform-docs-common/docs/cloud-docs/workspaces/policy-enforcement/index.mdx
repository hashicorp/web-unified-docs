...
- [Configure a Terraform policy policy set with a VCS repository](/terraform/cloud-docs/workspaces/policy-enforcement/manage-policy-sets/terraform-policy-vcs)
