...
You can implement policies using three frameworks:
- **Terraform policy:** Native HCL-based policy framework
...
You can use the Terraform policy, Sentinel, or OPA frameworks to create custom policies. You can also copy pre-written Sentinel policies created and maintained by HashiCorp.
