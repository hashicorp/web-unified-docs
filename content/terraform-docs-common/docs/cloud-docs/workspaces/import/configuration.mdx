---
page_title: Write queries and import resources
...
# Write queries and import resources
...
Instead of writing your queries with `list` blocks, you can use the [Query builder workflow](/terraform/cloud-docs/workspaces/import/query) to identify which resources to import.
