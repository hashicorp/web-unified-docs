...
-> **Example:** The last run applied 4 hours ago. It has not been assessed yet. And, automatic health assessments are set to run on a 24 hour cadence. Therefore, the next assessment is due in 20 hours.
