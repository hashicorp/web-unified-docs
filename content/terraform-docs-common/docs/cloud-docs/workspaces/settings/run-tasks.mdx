...
To associate a run task with individual workspaces, complete the following steps:
...
1. Click the ellipses (**...**) next to the run task you want to remove, and then click **Remove**. When prompted, click **Remove** to confirm the removal.
