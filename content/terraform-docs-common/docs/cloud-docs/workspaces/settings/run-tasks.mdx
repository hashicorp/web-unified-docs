...
Project-scoped run tasks are currently available as a beta feature.

</Note>

You can choose to apply a run task to individual workspaces or projects, or you can apply it globally to every workspace in an organization. To apply run tasks to individual workspaces, refer to [Associate run tasks with a workspace](#associate-run-tasks-with-a-workspace).
