...
The **Explorer** page lists types of platform resources in the sidebar that you can explore:
...
Click on a platform resource type to view subsets of information.
