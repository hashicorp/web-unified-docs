...
last_modified: 2026-06-08T23:48:03.000Z
...
- [Organization owner](/terraform/cloud-docs/users-teams-organizations/permissions/organization#organization-owners)
- [View all workspaces](/terraform/cloud-docs/users-teams-organizations/permissions/organization#view-all-workspaces) or greater
...
- **Workspaces with the most resources** lists workspaces with at least one [resource under management](/terraform/cloud-docs/overview/estimate-hcp-terraform-cost#what-is-a-managed-resource), sorted by resources under management (RUM) count descending. This use case is in beta and may not be visible to all users.
