...
last_modified: 2026-01-16T12:58:34-06:00
# END AUTO GENERATED METADATA
---

# Explorer for workspace visibility

As your organization grows, tracking your infrastructure estate becomes more complex. The explorer for workspace visibility surfaces a wide range of valuable information from across your organization.

Open the explorer for workspace visibility by clicking **Explorer** in your organization's top-level side navigation.

The **Explorer** page displays a left sidebar and a main card panel. The sidebar lists the available data types: **Workspaces**, **Modules**, **Providers**, and **Terraform Versions**. Select a type in the sidebar to immediately update the card panel.

Click a card to query the explorer and display results in a table of data.
