...
Follow these steps to activate HashiCorp Flex for a **Essentials**, **Plus**, or **Premium** edition HCP Terraform organization. 
...
## Step 5: Edit the HCP Terraform organization plan
