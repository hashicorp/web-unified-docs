...
last_modified: 2026-08-19T19:35:37.000Z
...
To activate pay-as-you-go billing, refer to [Activate pay-as-you-go](/terraform/cloud-docs/overview/activate-paygo.mdx).
...
To activate Flex billing, refer to [Activate Flex](/terraform/cloud-docs/overview/activate-flex.mdx).
...
Organizations on Standard or Premium plans can purchase additional concurrency. Refer to [Manage your plan](manage-plan.mdx#purchase-additional-concurrency) for details.
