...
Each higher paid upgrade plan is a strict superset of any lower plans — for example, the **Plus** edition includes all of the features of the **Essentials** Edition. The **Premium** edition includes all of the features of the **Plus** and **Essentials** editions. Paid feature callouts in the documentation indicate the _lowest_ edition at which the feature is available, but any higher plans also include that feature.
...
You can use projects to organize your workspaces into groups. Organizations with HCP Terraform [Essentials](https://www.hashicorp.com/products/terraform/pricing) Edition can assign teams permissions for specific projects. 
