...
| Team management | ✓ | ✓ | ✓ | ✓ |
| Run tasks | ✓ | ✓ | ✓ | ✓ |
| Concurrent runs | 1 remote, 1 agent | 3 remote, 1 agent | 10 remote, 10 agent | 200 remote, 300 agent |
| Policy enforcement | - | - | ✓ | ✓ |
| Cost estimation | - | - | ✓ | ✓ |
| Audit logging | - | - | - | ✓ |
| Custom RBAC | - | ✓ | ✓ | ✓ |
...
You can open the **Usage report** page for an at-a-glance view of resource usage and other information. Refer to [Estimate costs](/terraform/cloud-docs/overview/estimate-cost) for more information.
...
| Limit | Free | Essentials | Standard | Premium |
|-------|------|------------|----------|---------|
| Concurrent remote runs | 1 | 3 | 10 | 200 |
| Concurrent agent runs | 1 | 1 | 10 | 300 |
...
| Teams | Not available | Unlimited | Unlimited | Unlimited |
| SSO (SAML) | ✓ | ✓ | ✓ | ✓ |
| Custom RBAC | Not available | ✓ | ✓ | ✓ |
...
If you are working with a Stack, you can use the `terraform stacks` commands to manage your Stack and its configuration, deployments, and more from the command line. Refer to [`terraform stacks` reference](/terraform/cli/commands/stacks) for more information.
