---
page_title: Configure HCP Vault metric streaming to Grafana Cloud
sidebar_title: Grafana Cloud
description: |-
  Configure HCP Vault metric streaming to Grafana Cloud
---
...
1. To expedite monitoring configuration, HashiCorp has created a [sample HCP
   ...
   ![Select Provider](/img/cloud/hcp-vault-ui-grafana_dashboard.png)
