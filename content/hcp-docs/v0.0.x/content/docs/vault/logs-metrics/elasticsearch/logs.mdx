---
page_title: Configure HCP Vault audit log streaming to Elasticsearch
sidebar_title: Elasticsearch
description: |-
  Configure HCP Vault audit log streaming to Elasticsearch
---
...
To configure HCP Vault audit log streaming to Elasticsearch, you must provide
...
1. Enter a secure password in the **Password** and **Confirm password** textbox. Make
   note of the username and password - you will need this to configure audit log streaming in the HCP Portal.
...
1. Click **Manage** for the Elastic Cloud deployment you wish to send HCP Vault audit logs to.

1. Under **Applications** click **Copy endpoint** for Elasticsearch. Make
   note of the endpoint URL - you will need this to configure audit log streaming in the HCP Portal.
