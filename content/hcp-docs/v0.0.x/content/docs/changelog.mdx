...
Keep track of changes to the HashiCorp Cloud Platform (HCP).
...
**HCP Vault Radar Private Beta:** [HCP Vault Radar](/hcp/docs/vault-radar) is in
private beta. Currently, users must [accept the terms of
use](https://hashicorp.sjc1.qualtrics.com/jfe/form/SV_80uHYqXIVrWuVVk) to
...
** HCP Groups:** Introducing HCP Groups that allow the bundling of identities and treating them as one unit while assigning roles and associating with projects. This enables logical user management and clear auditing of permissions. See the [documentation](/hcp/docs/hcp/admin/iam/groups) and other information on how to get started.
