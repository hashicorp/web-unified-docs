...
Our Cloud Support Plan offers a number of support tiers and the response and resolution time are based on your [cluster tier](https://cloud.hashicorp.com/pricing) or annual contract terms.

For detailed information about our Cloud Support Plan, please refer to [Cloud Support](https://www.hashicorp.com/customer-success/cloud-support).
...
Cloud SLAs apply to all product-grade clusters.
...
| Hashicorp Cloud Platform | [Service Principals](/hcp/docs/hcp/admin/service-principals)         | 5                 | Global             | Yes              |
| Hashicorp Cloud Platform | [Keys per Service Principal](/hcp/docs/hcp/admin/service-principals) | 2                 | Global             | Yes              |
...
| HCP Consul               | [Consul clusters](/hcp/docs/consul)                                  | 6                 | Global             | Yes              |
| HCP Vault                | [Vault clusters](/hcp/docs/vault)                                    | 6                 | Global             | Yes              |
| HCP Vault                | [Vault performance secondaries](/hcp/docs/vault/perf-replication)    | 5                 | Global             | Yes              |
...
An organization can have up to 10 [projects](/hcp/docs/hcp/admin/projects);
however, the service quotas are enforced at the organization level. Therefore,
you may not be able to create a new resource for a project, if the quota has
already been met by other projects in the organization.

</Warning>

<Warning>

For HCP Vault, the performance secondaries quota is dependent on the overall 
