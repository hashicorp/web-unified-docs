...
You can create an [HCP](/hcp) account using one of the following methods:

- Email and password
- [Single Sign-On](/hcp/docs/hcp/admin/iam/sso) through GitHub or an identity provider configured for an [HCP organization](/hcp/docs/hcp/admin/orgs)

You can also use your HCP credentials to sign in to the following HashiCorp products and educational resources:

- [Terraform Cloud](https://cloud.hashicorp.com/products/terraform): Refer to the [Terraform Cloud documentation](/terraform/cloud-docs/users-teams-organizations/users#log-in-with-your-hcp-account) to learn how to log in with your HCP credentials.
