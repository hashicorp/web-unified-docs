...
1. Select **Microsoft Azure** as your provider.
1. Select a region from the dropdown menu. One HVN can be created in each available cloud region. Resources added to the HVN later are added in the same region.
1. Optionally, specify a CIDR block. To learn more, click **Show recommendations**.
1. Click **Create network**.

> **Tutorial**: For additional guidance on how to create an HVN, complete the [HashiCorp Virtual Network tutorials](/hcp/tutorials/networking).
