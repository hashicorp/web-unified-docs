...
1. In **Key** text box enter `VLT_ORGANIZATION_ID`, in the **Value** field enter the org ID you copied from the HCP Portal, then click
   the **Mask variable** checkbox and click **Add variable**.
