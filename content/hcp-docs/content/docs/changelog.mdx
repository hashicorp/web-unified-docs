...
**HCP user account deletion:** Users that log in through GitHub or with their email and password can now delete their own HCP accounts directly from the portal without filing a support ticket. Refer to [Delete your account](/hcp/docs/hcp/create-account#delete-your-account) for instructions and other details. 
