...
last_modified: 2026-06-17T01:09:28.000Z
...
### 2026-09-14
**HCP user account removal:** Users who log in through GitHub or with their email and password can now remove their own HCP accounts directly from the portal without filing a support ticket. Refer to [Remove your account](/hcp/docs/hcp/create-account#remove-your-account) for instructions and other details.

### 2026-09-11
**HCP Vault 2.0.4 for AWS and Azure:** Vault 2.0 has started rolling out to HCP Vault Dedicated clusters on AWS and Azure. Refer to [HCP Vault Dedicated changelog](/hcp/docs/vault/changelog#2026-09-11) to learn more about Vault 2.0.4 capabilities available to HCP Vault.


### 2026-08-26
**HCP Access Management:** You can assign access at the organization or project level when you invite users, which reduces follow-up access changes and helps new users start with the permissions they need. For more information, refer to the [users documentation](/hcp/docs/hcp/iam/users).

### 2026-08-20
**HCP Organizations:** Organization owners can now delete their HCP organization directly in the HCP Portal. Once all items in the deletion checklist are resolved, owners can initiate deletion without opening a support ticket. For more information, refer to [Delete an organization](/hcp/docs/hcp/admin/orgs#delete-an-organization).

### 2026-08-04
**HCP Organizations:** Enterprise constraints are now available for centralized governance and cost control. Organization administrators can restrict which HCP products (Vault, Boundary, Vault Radar, Packer, Waypoint, Vagrant) users may deploy within their organization, providing preventative controls that apply regardless of individual user permissions. This helps enterprises manage flexible consumption spending, meet security compliance requirements, and enforce organizational standards at scale. For more information, refer to the [enterprise constraints documentation](/hcp/docs/hcp/admin/enterprise-constraints).

### 2026-07-17
**HCP Access Management:** When an HCP organization's SSO connection is deleted, HCP will now delete all SSO users from the organization. Suspending an SSO connection will not result in HCP deleting SSO users from the organization. 

### 2026-07-07
**HCP Vault 2.0.3 for AWS and Azure:** Vault 2.0 has started rolling out to HCP Vault Dedicated clusters on AWS and Azure. Refer to [HCP Vault Dedicated changelog](/hcp/docs/vault/changelog#2026-07-07) to learn more about Vault 2.0.3 capabilities available to HCP Vault.

### 2026-06-30
**SCIM provisioning:** HCP now supports SCIM (System for Cross-domain Identity Management) provisioning for automated user and group lifecycle management. With SCIM enabled, you can automatically sync user and group changes from your identity provider to HCP, including:

- User creation, modification, and deletion
- Group creation, modification, and deletion
- Group membership updates

SCIM provisioning is available for organizations with SAML SSO configured. Supported identity providers include Microsoft Entra ID, Okta, Ping ID, and IBM Verify.

For more information, refer to [SCIM provisioning](/hcp/docs/hcp/iam/scim).

### 2026-06-15
**HCP Vault 2.0 for AWS and Azure:** Vault 2.0 has started rolling out to HCP Vault Dedicated clusters on AWS and Azure. Refer to [HCP Vault Dedicated changelog](/hcp/docs/vault/changelog#2026-06-14) to learn more about Vault 2.0 capabilities available to HCP Vault.
