...
### 2026-07-17
**HCP Access Management:** HCP organizations will now have all SSO users removed upon deletion of SSO connection. Suspending SSO connection will not delete users connected to the organization through SSO. 
