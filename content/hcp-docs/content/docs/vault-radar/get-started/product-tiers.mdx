...
| ------------------------------- | ------------------------------------------------------------------------------------- |---------------------------------------------------- | ------------------------------------------ |
| Data sources                    | Main entity that connects to Vault Radar (example: a GitHub organization)             | 2                                                   | 2,000                                      |
| Resources per data source       | Resources are the target to the scan (example: a GitHub Repository)                   | 50                                                  | 10,000                                     |
