...
The `Created streaming destination` event identifies add a streaming
...
data source such as adding or removing a GitHub or GitLab repository and HCP
Vault Radar.
...
a remediation option for HCP Vault Radar.
