...
1. Log into the [HCP Portal](https://portal.cloud.hashicorp.com/sign-in) with a user that has permission to configure Vault Radar data sources.
...
1. Verify the **Request URL** displays **Verified**
    <Note>
     ...
     If you see the message **Your URL didn't respond**, next to the **Request URL**, click **Retry**.
