...
last_modified: 2026-09-17T17:39:54.000Z
...
Organizations that use multiple projects in a HCP organization can enable Vault Radar in one project.
You cannot enable Vault Radar in multiple projects.
...
Secrets are often Base64 encoded in configuration files, container manifests, and
CI/CD pipeline definitions. Vault Radar decodes these values during a scan and
reports them under the matching
[secret type](/hcp/docs/vault-radar/manage/secret-types) instead of a generic
finding.
