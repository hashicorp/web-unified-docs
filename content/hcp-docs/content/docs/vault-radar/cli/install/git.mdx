...
* `pre_commit_skip_activeness` - `true` results in skipping activeness checks. By default, activeness checks are enabled - the default value for this option is `false`
