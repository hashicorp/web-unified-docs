...
* `pre_commit_skip_activeness` -  true results in skipping activeness checks. The default is true. Enabling activeness checks will likely add more time to the evaluation, set to false with caution.
