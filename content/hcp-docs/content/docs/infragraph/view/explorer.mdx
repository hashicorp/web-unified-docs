...
1. Choose an **Edge** relationship and node type to define the next step to traverse the graph.
1. Click **Add condition** to filter nodes based on their properties, or click **Add relationship** to add another step to your graph traversal.
