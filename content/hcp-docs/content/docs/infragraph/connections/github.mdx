...
To find the current sync status for your GitHub data, complete the following steps: 

1. Click **Connections** in your HCP organization's left navigation panel.
1. Check the GitHub connection sync status. 
...
- Query resources with any of the existing queries that include GitHub resources. 
