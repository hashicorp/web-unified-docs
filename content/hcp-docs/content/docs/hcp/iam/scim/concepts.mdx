...
When you enable SCIM provisioning, HCP checks your identity provider directory to determine if users or groups already exist in HCP. When HCP identities an existing user or group, it handles the conflict in the following ways:
