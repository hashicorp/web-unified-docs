...
- **SCIM quota exceeded** - Your organization has reached the maximum number of users, groups, or group members
...
## SCIM Quota exceeded errors

HCP enforces quotas for SCIM provisioning to ensure optimal performance. If you exceed a quota, SCIM sync fails for the affected resource type.
