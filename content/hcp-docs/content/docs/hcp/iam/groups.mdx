...
If SCIM provisioning is enabled for your organization, groups are automatically synchronized from your identity provider. Manual group creation is not available when SCIM is active. To manage groups, make changes in your identity provider. For more information, refer to [SCIM provisioning](/hcp/docs/hcp/iam/sso/scim).
