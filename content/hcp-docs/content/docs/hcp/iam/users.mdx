...
HCP supports two methods for adding and managing users in your organization:

- **Manual provisioning** - Invite users by email and manage them directly in HCP. This is the default method.
- **SCIM provisioning** - Automatically sync users from your identity provider when SCIM is enabled. Users are created, updated, and removed based on changes in your identity provider.
