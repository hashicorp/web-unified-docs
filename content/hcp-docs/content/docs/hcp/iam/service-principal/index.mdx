...
You can grant organization-level service principals additional permissions by assigning them roles at the organization level. This allows a single organization-level service principal to manage resources across multiple projects or even perform organization-wide actions, such as creating new projects.
