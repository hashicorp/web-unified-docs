...
You can use [organization constraints](/hcp/docs/hcp/admin/orgs-constraints) to restrict which HCP products can be deployed within your organization for centralized governance and cost control.
