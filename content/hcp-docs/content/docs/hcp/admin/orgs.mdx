...
1. From the **Manage** menu, select **Deletion checklist**.
  ...
  The **Deletion checklist** page displays the requirements for deleting an organization. It displays a status of `Done`, `Not Applicable` or `To Do` for each requirement.
