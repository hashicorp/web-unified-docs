...
last_modified: 2026-08-19T22:25:43.000Z
...
Available services include HCP Terraform, HCP Packer, HCP Vault Dedicated , and HCP Boundary.
...
[Terraform-specific Flex activation documentation](/terraform/cloud-docs/overview/activate-flex#edit-the-hcp-terraform-organization-plan),
[contact support](https://www.ibm.com/mysupport) with the
