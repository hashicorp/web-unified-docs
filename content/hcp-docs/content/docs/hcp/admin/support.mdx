...
last_modified: 2026-04-03T18:57:59.000Z
...
| Hashicorp Cloud Platform | [Identities assigned within a specific IAM policy](/hcp/docs/hcp/iam/access-management)            | 1000 <br /> (250 Groups and 750 Users or Service Principals)                 | Global             | No               |
| Hashicorp Cloud Platform | [Groups per organization](/hcp/docs/hcp/iam/groups)                                                | 250               | Global             | Yes              |
| Hashicorp Cloud Platform | [Users per group](/hcp/docs/hcp/iam/groups)                                                        | 5000              | Global             | Yes              |
| Hashicorp Cloud Platform | [Groups a single user can be a member of](/hcp/docs/hcp/iam/groups)                                | 5000              | Global             | Yes              |
...
Submit a request form with HashiCorp Support to request additional resources: [HCP Quota Request](https://www.ibm.com/mysupport)
