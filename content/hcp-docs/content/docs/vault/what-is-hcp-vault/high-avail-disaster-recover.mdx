...
## Test cluster high availability

@include 'beta-feature.mdx'

To test the high availability failover process, contact [HCP support](https://www.ibm.com/mysupport) to coordinate a controlled failover test.
...
If you need to delete a cross-region DR cluster, [contact support](https://www.ibm.com/mysupport).
...
of a cluster. Snapshots are only retained for non-development tiers post cluster deletion.
...
ticket [here](https://www.ibm.com/mysupport).
