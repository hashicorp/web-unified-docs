...
- Network Security Group (NSG) exists in the target VNet, which allows inbound traffic on port 53 (both UDP and TCP) from the HVN CIDR block to your self-managed DNS server or Azure Resolver inbound endpoint.
