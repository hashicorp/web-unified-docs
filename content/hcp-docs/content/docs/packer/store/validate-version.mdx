...
Choose **Warn** when you want to report untracked images without interrupting deployments. Choose **Block** when you want to enforce deployments that only use images tracked in HCP Packer.
