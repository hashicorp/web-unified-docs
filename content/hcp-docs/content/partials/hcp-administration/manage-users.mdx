...
- **Role assignments** - You can still assign roles to SCIM-provisioned users in HCP

To identify SCIM-provisioned users, check the **SCIM provisioning** column in the users list. Users with a status of "Syncing" are managed by SCIM.
