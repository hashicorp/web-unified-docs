...
In this section of [Monitor infrastructure](/well-architected-framework/optimize-systems/monitor-infrastructure), you learned about scaling container workloads and orchestrators. Monitoring infrastructure is part of the [Optimize systems pillar](/well-architected-framework/optimize-systems).