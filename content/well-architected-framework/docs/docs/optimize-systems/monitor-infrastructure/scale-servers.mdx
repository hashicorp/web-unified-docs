...
In this section of [Monitor infrastructure](/well-architected-framework/optimize-systems/monitor-infrastructure), you learned about scaling servers. Monitoring infrastructure is part of the [Optimize systems pillar](/well-architected-framework/optimize-systems).