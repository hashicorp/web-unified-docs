...
In this section of [Optimize systems](/well-architected-framework/optimize-systems), you learned about automatically detecting resource drift and health. Optimize systems is part of the [Well-Architected Framework](/well-architected-framework).