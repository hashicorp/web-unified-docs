...
- How many concurrent connections will this network serve? If a typical web application handles 10,000-50,000 concurrent connections, then high-traffic services may need to support millions.
