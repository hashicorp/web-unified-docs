...
![](/img/well-architected-framework/horizontal-vertical-scale.png)
...
- Try the [Manage AWS Auto Scaling Groups](https://developer.hashicorp.com/terraform/tutorials/aws/aws-asg) and [Manage Azure Virtual Machine Scale Sets with Terraform](https://developer.hashicorp.com/terraform/tutorials/azure/azure-virtual-machine-scale-sets) tutorials.
...
- Learn how [Nomad autoscaling](https://developer.hashicorp.com/nomad/tools/autoscaling) works.
...
- Learn how to [Setup monitoring agents](https://developer.hashicorp.com/well-architected-framework/define-and-automate-processes/monitor/setup-monitoring-agents) with Terraform and Packer.
- Read the [Define health checks](https://developer.hashicorp.com/consul/docs/register/health-check/vm) Consul documentation.
