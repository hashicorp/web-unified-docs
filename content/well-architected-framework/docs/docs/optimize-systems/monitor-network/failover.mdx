...
In this section of [Monitor network traffic](/well-architected-framework/optimize-systems/monitor-network), you learned about planning for failover. Monitoring network traffic is part of the [Optimize systems pillar](/well-architected-framework/optimize-systems).