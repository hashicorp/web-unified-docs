...
- [Rotate expired certificates](/well-architected-framework/optimize-systems/security/rotate-certs)
- [Seal Vault during a security incident](/well-architected-framework/optimize-systems/security/seal-vault-incident)