...
Once you deploy your infrastructure and applications, you may need a way to provide
...
In this section of [Develop applications](/well-architected-framework/automate-and-define-processes/develop-applications/introduction), you learned how to define a security strategy for your application, along with securely accessing your application infrastructure. Develop applications is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).