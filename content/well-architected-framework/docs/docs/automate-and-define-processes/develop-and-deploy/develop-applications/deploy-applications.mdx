...
In this section of [Develop applications](/well-architected-framework/automate-and-define-processes/develop-applications/introduction), you learned how to deploy your applications using Terraform,
Kubernetes, or Nomad. Develop applications is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).