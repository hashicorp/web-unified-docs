...
These documents describe the best practices for creating an application delivery
...
In this overview of Develop applications, you learned the components of an application delivery model. Visit the following documents to learn specifics on each component. Develop applications is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
