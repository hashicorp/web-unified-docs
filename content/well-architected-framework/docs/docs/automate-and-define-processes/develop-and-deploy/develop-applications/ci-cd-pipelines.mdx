...
In this section of [Develop applications](/well-architected-framework/automate-and-define-processes/develop-applications/introduction), you learned best practices for integrating your deployments into a CI/CD pipeline. Develop applications is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).