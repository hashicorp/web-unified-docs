...
![The application delivery cycle showing all five phases, connected together by a CI/CD pipeline.](/img/waf/app-delivery-cycle.png#light-theme-only) ![The application delivery cycle showing all five phases, connected together by a CI/CD pipeline.](/img/waf/app-delivery-cycle-dark.png#dark-theme-only)
