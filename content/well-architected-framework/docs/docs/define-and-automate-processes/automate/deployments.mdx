...
1. **Deploy:** Then, reference the stored images in your Terraform or container orchestrator configuration using the image ID, tag, or a data source query.
...
- Learn how to [package applications](/well-architected-framework/define-and-automate-processes/automate/packaging) with Packer before deployment
- Implement [automated testing](/well-architected-framework/define-and-automate-processes/automate/testing) for infrastructure and applications
