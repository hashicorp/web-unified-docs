...
- Use [infrastructure as code](/well-architected-framework/define-and-automate-processes/define/as-code/infrastructure) to test infrastructure configurations
- Read the [Sentinel documentation](/sentinel/docs) to learn about policy-as-code and the Sentinel language
...
- Follow the [Terraform test tutorial](/terraform/tutorials/configuration-language/test) to learn how to use Terraform's built-in testing framework
- Read the [Terraform test documentation](/terraform/language/tests)
- Learn [best practices for Terraform module testing](/terraform/language/modules/testing-experiment)
- Read the [HCP Terraform policy enforcement documentation](/terraform/cloud-docs/policy-enforcement) to configure policy sets in HCP Terraform
