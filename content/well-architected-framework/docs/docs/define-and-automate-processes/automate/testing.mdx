...
- Read the [Sentinel documentation](/sentinel/docs) and Learn the [Sentinel language syntax](/sentinel/docs/language)
...
- Learn about [Sentinel imports for Terraform](/terraform/cloud-docs/policy-enforcement/sentinel/import)
