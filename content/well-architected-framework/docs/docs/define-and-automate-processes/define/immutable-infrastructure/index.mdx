...
- Learn Packer with the Packer [tutorials](/packer/tutorials) and [documentation](/packer/docs)
...
- Learn Vault with the [Vault tutorials](/vault/tutorials) and read the [Vault documentation](/vault/docs) for secrets management
