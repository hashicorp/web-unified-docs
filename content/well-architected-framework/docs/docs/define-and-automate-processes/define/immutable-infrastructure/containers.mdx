...
description: Create immutable containers by building images with Docker or Packer and deploying them with orchestrators like Kubernetes and Nomad.
---
...
- Read the [Packer documentation](/packer/docs) for container image best practices
- Track image metadata with [HCP Packer](/hcp/docs/packer)

Nomad deployment resources:

- Read the [Nomad documentation](/nomad/docs) and [Nomad tutorials](/nomad/tutorials) for deployment examples
...
- Learn about [Nomad job specifications](/nomad/docs/job-specification) for containers
