...
- Learn about Packer [template structure](/packer/docs/templates/hcl_templates)
- Use the Packer [Ansible provisioner](/packer/integrations/hashicorp/ansible/latest/components/provisioner/ansible)
- Track images with [HCP Packer metadata and channels](/packer/tutorials/hcp-get-started)
