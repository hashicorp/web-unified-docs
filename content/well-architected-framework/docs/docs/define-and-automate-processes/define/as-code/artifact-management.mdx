...
Terraform manages artifact repositories through providers. Providers map your repository platform's API (for example, Artifactory or Nexus) to Terraform resources so you can review and apply repository configuration consistently.
