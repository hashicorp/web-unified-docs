...
- Read the [Terraform documentation](/terraform/docs) for comprehensive feature guide and learn the [Terraform language](/terraform/language) including syntax and constructs
- Browse [Terraform providers registry](https://registry.terraform.io/browse/providers) for thousands of integrations
- Learn HCL with [Terraform configuration tutorials](/terraform/tutorials/configuration-language) to write Terraform modules
