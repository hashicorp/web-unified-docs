...
- Learn how to [deploy infrastructure](/well-architected-framework/define-and-automate-processes/automate/deployments) after defining it as code
- Implement [automated testing](/well-architected-framework/define-and-automate-processes/automate/testing) for infrastructure code
...
- Implement [fully-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/fully-automated) with CI/CD
...
- Browse [Terraform providers registry](https://registry.terraform.io/browse/providers)
- Learn HCL with [Terraform configuration tutorials](/terraform/tutorials/configuration-language)
