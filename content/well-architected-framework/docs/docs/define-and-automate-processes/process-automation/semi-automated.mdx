...
- Scripts and infrastructure code stored in version control (Git)
- Team members can run Terraform and Packer scripts consistently
- Vault manages secrets for automation scripts
...
- Experience writing and reading YAML or HCL
...
- [Implement fully-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/fully-automated) - Advance to CI/CD automation
- [Implement GitOps workflow](/well-architected-framework/define-and-automate-processes/process-automation/gitops) for version-controlled deployments
- [Package applications](/well-architected-framework/define-and-automate-processes/automate/packaging) with Packer for consistent deployments
- [Deploy applications](/well-architected-framework/define-and-automate-processes/automate/deployments) with Terraform and orchestrators
- [Automate testing](/well-architected-framework/define-and-automate-processes/automate/testing) for infrastructure and applications
