...
description: Implement GitOps workflows using Git as the single source of truth for infrastructure and applications. Automate deployments with Terraform and version control.
---
...
GitOps follows the following four core principles that create a reliable, automated deployment process:
...
- [Implement semi-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/semi-automated) - Build GitOps foundations
- [Implement fully-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/fully-automated) - Advance to full CI/CD automation
- [Package applications](/well-architected-framework/define-and-automate-processes/automate/packaging) with Packer in GitOps pipelines
- [Deploy applications](/well-architected-framework/define-and-automate-processes/automate/deployments) with GitOps automation
- [Automate testing](/well-architected-framework/define-and-automate-processes/automate/testing) with Sentinel in GitOps workflows
- Use [infrastructure as code](/well-architected-framework/define-and-automate-processes/define/as-code/infrastructure) as foundation for GitOps
- [Build a GitOps pipeline to deploy a three-tier application](/terraform/tutorials/hashicorp/gitops) - Complete GitOps tutorial with Terraform and Packer
- [VCS-driven workflow with HCP Terraform](/terraform/tutorials/cloud-get-started/cloud-vcs-change) - Connect Git repositories to automate Terraform deployments
- [Automate Terraform with GitHub Actions](/terraform/tutorials/automation/github-actions) - CI/CD integration for GitOps workflows
- [HCP Terraform VCS integration](/terraform/cloud-docs/vcs) - Configure version control integration
- [Sentinel policy as code](/sentinel/docs) - Enforce policies in GitOps workflows
- [Dynamic secrets with Vault](/vault/tutorials/get-started-hcp-vault-dedicated/vault-get-started-intro) - Manage secrets in automated deployments
- [Automate Packer with GitHub Actions](/packer/tutorials/cloud-production/github-actions) - Build images in GitOps pipelines

External resources:

- [What is GitOps?](https://about.gitlab.com/topics/gitops/) - GitLab's comprehensive GitOps guide
- [Guide to GitOps](https://www.weave.works/technologies/gitops/) - Weaveworks GitOps patterns and principles
...
- [Automation maturity model](/well-architected-framework/define-and-automate-processes/process-automation) - Assess your current automation level
- [Implement semi-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/semi-automated) - Build GitOps foundations with version control and scripting
- [Implement fully-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/fully-automated) - Advance to Git-driven CI/CD and automated workflows
- [Automate deployments](/well-architected-framework/define-and-automate-processes/automate/deployments) - Deploy infrastructure and applications with automation
- [Automate testing](/well-architected-framework/define-and-automate-processes/automate/testing) - Validate changes before deployment in GitOps workflows