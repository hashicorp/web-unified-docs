...
- Learn Sentinel with the [Sentinel tutorials](/sentinel/tutorials) and read the introduction to [Sentinel](/sentinel/docs/intro) for policy language
...
- Use [HCP Packer channels](/hcp/docs/packer/manage-image-lifecycle) for promotion
...
- Browse [sample Sentinel policies](https://github.com/hashicorp/terraform-sentinel-policies)
