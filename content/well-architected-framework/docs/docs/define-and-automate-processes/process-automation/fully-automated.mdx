...
<Note title="Prerequisites for fully-automated deployments">

Before implementing fully-automated deployments, ensure you have the following foundations:

- Scripts and infrastructure code in version control
- Team comfortable running Terraform and Packer
- Vault managing secrets for automation scripts
- Regular Packer image builds in place
- Audit logs detecting manual changes
- Multiple team members able to deploy infrastructure

If you're missing these foundations, return to [semi-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/semi-automated) first.
...
- [Automation maturity model](/well-architected-framework/define-and-automate-processes/process-automation) - Assess your current automation level
- [Implement semi-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/semi-automated) - Review foundational automation practices
- [Implement GitOps workflow](/well-architected-framework/define-and-automate-processes/process-automation/gitops) for Git-driven deployments
- [Package applications](/well-architected-framework/define-and-automate-processes/automate/packaging) with Packer in CI/CD
- [Deploy applications](/well-architected-framework/define-and-automate-processes/automate/deployments) with automated pipelines
- [Automate testing](/well-architected-framework/define-and-automate-processes/automate/testing) with Sentinel and Terraform test
