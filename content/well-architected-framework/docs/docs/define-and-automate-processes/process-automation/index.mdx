...
description: Assess your automation maturity level and progress from manual deployments to fully automated deployments using the automation maturity model.
---
...
## Why understand the automation maturity model
...
Track the following metrics to measure your automation maturity progress:

**Manual stage metrics:**
- Time to deploy infrastructure: Hours to days
- Deployment failure rate: 30-50%
- Configuration drift incidents: Weekly
- Documentation accuracy: Low (outdated quickly)

**Semi-automated stage metrics:**
- Time to deploy infrastructure: 30-60 minutes (script execution time)
- Deployment failure rate: 10-20%
- Configuration drift incidents: Monthly (caught by audits)
- Script reuse rate: 70-80%

**Fully-automated stage metrics:**
- Time to deploy infrastructure: 10-15 minutes (automated pipeline)
- Deployment failure rate: <5%
- Configuration drift incidents: Rare (prevented by automation)
- Deployment frequency: Multiple times daily
- Lead time for changes: Hours instead of days
...
## Tool progression across stages

As you progress through automation stages, you build on previous tools while adding new capabilities:

**Manual → Semi-automated (foundational tools):**
- Add: Version control (GitHub, GitLab)
- Add: Infrastructure as code (Terraform)
- Add: Image building (Packer)
- Add: Secrets management (Vault)
- Add: Orchestration (Nomad)
- Add: Service discovery (Consul)

**Semi-automated → Fully-automated (automation tools):**
- Keep: All semi-automated tools
- Add: CI/CD pipelines (GitHub Actions, GitLab CI, HCP Terraform VCS)
- Add: Policy enforcement (Sentinel)
- Add: Self-service platforms (HCP Waypoint)
- Add: Automated testing and monitoring
- Evolve: Vault now provides dynamic secrets for CI/CD pipelines

## Assess your current state

To determine where your organization currently sits on the maturity model, consider the following questions:
...
These timelines help set realistic expectations for your automation journey:

**Manual → Semi-automated:**
- Small team (2-5 engineers): 2-3 months
- Medium team (5-15 engineers): 3-6 months
- Large team (15+ engineers): 6-12 months

**Semi-automated → Fully-automated:**
- Small team: 3-4 months
- Medium team: 6-9 months
- Large team: 9-18 months

Timelines vary based on existing infrastructure complexity, team experience, and organizational change management needs.
