...
- Learn Consul with the [Consul tutorials](/consul/tutorials) and  [Consul documentation](/consul/docs) for service networking
...
- Register [services to Consul](/consul/tutorials/get-started-vms/virtual-machine-gs-service-discovery)
