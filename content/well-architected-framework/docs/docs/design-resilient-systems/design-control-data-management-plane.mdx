...
platform to run your workloads and store your data. Most infrastructure
...
the capabilities needed to meet your requirements. Do not focus on specific vendors, 
but rather the type of tool or service needed, like whether you need a service mesh, 
...
- **Redundancy and failover:** Determine if services running within each plane
...
![Example requirements and constraints for a logical design](/img/well-architected-framework/example-logical-design.png#light-theme-only)
...
The primary tools used in the management plane are Terraform, Vault, and Boundary.
