...
- **Enables policy enforcement:** HCP Terraform and Terraform Enterprise can enforce organization-wide security policies that prevent non-compliant infrastructure deployment
