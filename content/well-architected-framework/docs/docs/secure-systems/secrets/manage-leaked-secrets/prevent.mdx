...
description: Learn how to prevent leaked secrets in your organization through separation of duties, dynamic credentials, SSO, centralized secret management, and zero trust remote access.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2025-07-21T16:57:08-07:00
last_modified: 2026-01-29T10:50:51-06:00
# END AUTO GENERATED METADATA
---

# Prevent leaked secrets

Organizations face constant risk from leaked secrets and exposed credentials. While no single solution eliminates this threat, you can significantly reduce your attack surface by implementing proven security strategies. 
...
- Get started with [HCP Vault Radar quickstart](/hcp/tutorials/get-started-hcp-vault-radar)
...
- Learn about [Vault dynamic database credential management](/vault/tutorials/db-credentials)
- Learn how to [Generate cloud provider credentials with Vault](/vault/tutorials/secrets-management/azure-secrets)
- Learn how to [Manage federated workload identities with Vault](/vault/tutorials/enterprise/plugin-workoad-identity-federation)
- Learn how to [Manage credentials for HCP Terraform with Vault](/vault/tutorials/secrets-management/terraform-secrets-engine)
- Use [HCP Terraform dynamic provider credentials](/terraform/cloud-docs/workspaces/dynamic-provider-credentials)
- Learn how to [Enable self-service workflows with Vault-backed dynamic credentials](/terraform/tutorials/cloud/dynamic-credentials-no-code)
- Learn how to [Inject secrets into Terraform using the Vault provider](/terraform/tutorials/secrets/secrets-vault)
...
- Follow the [Boundary OIDC authentication with Okta tutorial](/boundary/tutorials/identity-management/oidc-okta)
- Follow the [Vault OIDC authentication with Okta tutorial](/vault/tutorials/auth-methods/vault-oidc-okta)
- Read the [HCP SSO documentation](/hcp/docs/hcp/iam/sso)
- Read the [HCP Terraform SSO documentation](/terraform/cloud-docs/users-teams-organizations/single-sign-on)
- Learn about [HashiCorp Vault as an OIDC identity provider](/vault/docs/secrets/identity/oidc-provider)
- Use the [HashiCorp Vault OIDC/JWT authentication method](/vault/docs/auth/jwt)
- Follow the [HashiCorp Vault Enterprise workload identity federation tutorial](/vault/tutorials/enterprise/plugin-workoad-identity-federation)
...
- Learn [HashiCorp Vault foundations](/vault/tutorials/get-started)
- Get started with [HCP Vault Dedicated quickstart](/vault/tutorials/get-started-hcp-vault-dedicated)
...
- Get started with [HCP Boundary quickstart](/boundary/tutorials/get-started-hcp)
- Learn about [Boundary host management](/boundary/tutorials/host-management)
- Learn about [Boundary credential management](/boundary/tutorials/credential-management)
- Learn how to [Connect to Kubernetes using Boundary](/boundary/tutorials/kubernetes-connect)

## Next steps

In this document, you learned how to prevent leaked secrets in your organization through separation of duties, dynamic credentials, SSO, centralized secret management, and zero trust remote access.

Next, learn how to [identify leaked secrets](/well-architected-framework/secure-systems/secrets/manage-leaked-secrets/identify) in your systems and repositories.