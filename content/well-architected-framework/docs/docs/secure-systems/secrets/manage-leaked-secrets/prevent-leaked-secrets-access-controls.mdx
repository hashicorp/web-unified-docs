...
When reviewing tools and services for leaked secret scanning, ensure these services support SSO. This limits friction in adopting the tools.
...
- Follow the [HCP Vault Radar quickstart](/hcp/tutorials/get-started-hcp-vault-radar) to detect leaked secrets
...
- Use [Vault as an OIDC identity provider](/vault/docs/secrets/identity/oidc-provider) to federate authentication across services
