---
page_title: Secret rotation strategies to protect your applications
description: Learn how to rotate static secrets like passwords and API keys to prevent credential compromise.
---

# Secret rotation strategies to protect your applications
...
- Manage [Kubernetes native secrets](/vault/tutorials/kubernetes-introduction/vault-secrets-operator) with the Vault Secrets Operator
