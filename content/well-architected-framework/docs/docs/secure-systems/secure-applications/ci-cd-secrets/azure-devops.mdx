...
HashiCorp and Azure integration:

- Read [Integrating Azure DevOps pipelines with HashiCorp Vault](https://www.hashicorp.com/en/blog/integrating-azure-devops-pipelines-with-hashicorp-vault) for official HashiCorp guidance on workload identity federation and OIDC authentication (February 2024)
- Explore [Introduction to using HashiCorp Vault with Azure](https://www.hashicorp.com/en/resources/introduction-to-using-hashicorp-vault-with-azure) for HashiCorp resource covering Vault and Azure DevOps integration scenarios
