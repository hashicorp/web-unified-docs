...
| [Bitbucket Vault Secrets integration](https://bitbucket.org/product/features/pipelines/integrations?search=vault&p=atlassian/vault-secrets) | Low | Good | Bitbucket repository variables | Teams wanting a pre-built Atlassian-maintained connector |
...
- Explore the [Vault Secrets integration](https://bitbucket.org/product/features/pipelines/integrations?search=vault&p=atlassian/vault-secrets) in the Bitbucket Pipelines integrations marketplace for the official Atlassian-maintained Vault connector
