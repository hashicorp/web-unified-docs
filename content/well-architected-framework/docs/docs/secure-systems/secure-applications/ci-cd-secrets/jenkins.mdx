...
<VideoEmbed url="https://www.hashicorp.com/en/resources/building-efficient-ci-pipelines-with-nomad-vault-and-jenkins"/>

Additional resources:

- Read the [CloudBees HashiCorp Vault Plugin](https://docs.cloudbees.com/docs/cloudbees-ci/latest/secure/hashicorp-vault-plugin) documentation
- Watch [Using HashiCorp Vault With CloudBees CI](https://www.youtube.com/watch?v=05Rw1Qkjz4c) for CloudBees integration guide
