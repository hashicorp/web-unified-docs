...
In this section of [Secure applications](/well-architected-framework/secure-systems/secure-applications), you learned how the benefits of using TLS to authenticate your application workloads and how Vault and Consul can enable this use case. Secure applications is part of the [Secure systems pillar](/well-architected-framework/secure-systems).
