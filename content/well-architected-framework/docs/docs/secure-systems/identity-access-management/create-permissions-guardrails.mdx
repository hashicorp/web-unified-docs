...
description: Learn to write IAM policies that enforce least privilege. Convert access requirements into secure permission guardrails for your organization.
---
...
![Diagram showing IAM guardrails diagram showing how user permissions combine from organizational, group, and user-level policies to create effective permissions.](/img/well-architected-framework/diagram-iam-guardrails.png#light-theme-only)
![Diagram showing IAM guardrails diagram showing how user permissions combine from organizational, group, and user-level policies to create effective permissions.](/img/well-architected-framework/diagram-iam-guardrails-dark.png#dark-theme-only)
...
permissions in policies, such as IAM, as code allows you to use version control,
...
Watch the following video about policy as code implementation strategies:
