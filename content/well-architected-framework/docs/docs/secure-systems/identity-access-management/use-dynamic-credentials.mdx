...
description: Generate short-lived credentials on demand to minimize attack surfaces and prevent credential theft. Automatic expiration eliminates long-term security risks.
---
