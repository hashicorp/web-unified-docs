...
- **Secure applications** covers building security into the development process, including certificate management, [CI/CD secrets management](/well-architected-framework/secure-systems/secure-applications/ci-cd-secrets), and secure coding practices.
