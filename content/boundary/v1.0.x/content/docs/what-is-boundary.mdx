...
- Generate short-lived dynamic credentials via [HashiCorp Vault](https://www.vaultproject.io/)
...
![Boundary core workflow](/img/boundary-core-workflow_light-v2.png#light-theme-only)
![Boundary core workflow](/img/boundary-core-workflow_dark.png-v2#dark-theme-only)
...
- **User-preferred client tools**: Users connect using existing client tools (CLI ssh client, PuTTY, Remote Desktop Connection, database clients, web browsers, and others) without changing workflows.
