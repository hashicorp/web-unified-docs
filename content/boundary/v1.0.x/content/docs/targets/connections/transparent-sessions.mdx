---
layout: docs
page_title: Connect using Boundary transparent sessions
description: >-
  Use Boundary transparent sessions to connect to targets by alias without managing session IDs or ephemeral ports, simplifying end-user connection workflows.
...
# Connect using Boundary transparent sessions
...
## Troubleshoot transparent sessions
