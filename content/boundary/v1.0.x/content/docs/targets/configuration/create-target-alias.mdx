...
If you are creating an alias for an org or project scope and you have not yet created a suffix for the scope, you will be prompted to create one during these procedures.
...
1. Complete the following fields:
   ...
   - **Aliases**: (Optional) Complete the following fields, and then click **Add** to create an alias:
     - **Select scope**: Select the scope in which you want to create the alias.
     - **Alias value**: Enter the value for the alias you want to associate with this target. An alias's value can be a hostname or a DNS-like string.
