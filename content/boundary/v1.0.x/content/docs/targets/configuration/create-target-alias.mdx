...
Aliases created in project scopes require a suffix. Boundary automatically appends the suffix to any aliases created in the scope.

<Tip>

If you attempt to create an alias in a project scope using the UI, and there is no suffix, Boundary prompts you to create one. If you attempt to do it in the CLI, the attempt fails.

As a best practice, we recommend that you create suffixes for project-level aliases before you attempt to create aliases.

Refer to [Create a suffix for an alias](/boundary/docs/targets/configuration/create-suffix) for more information.
...
This topic describes how to create a target alias. You can associate the target alias with a target when you create the alias, or you can associate it with a target at a later time. Refer to [Edit an alias](/boundary/docs/targets/configuration/manage-alias/#edit-an-alias) for more information about updating an existing target alias to associate it with a target or update other details.

You can also create an alias and associate it with a target when you create a new target. For more information about creating targets, refer to [Overview of targets](/boundary/docs/targets).
...
1. Click **New Alias**.
  ...
  If you are creating an alias in an org or project scope, and you haven't created a suffix for the scope, you will be prompted to create one:

    1. Click **Create an Alias suffix**.
    1. Type a unique value for the suffix in the **Alias suffix** field, and then click **Save**.
...
1. Log in to Boundary.
1. Select **Aliases** in the navigation pane.
1. Select the alias you want to associate with a target.
1. Click **Edit Form**.
1. In the **Target ID** field, enter the ID of the target you want to associate with the alias.
1. Click **Save**.
...
1. Log in to Boundary.
1. Use the following command to update the target an alias is associated with:
...
- You can edit or delete existing aliases and suffixes. Refer to the following topics for more information:
  - [Manage alias suffixes](/boundary/docs/targets/configuration/manage-suffix)
  - [Manage target aliases](/boundary/docs/targets/configuration/manage-alias)
