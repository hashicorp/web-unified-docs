...
Aliases created in org or project scopes require a suffix. Boundary automatically appends the suffix to any aliases created in the scope.

<Note>

If you attempt to create an alias in an org or project scope using the UI, and there is no suffix, Boundary prompts you to create one. If you attempt to do it in the CLI, the attempt fails.

As a best practice, we recommend that you create suffixes for org and project level aliases before you attempt to create aliases.
