...
Aliases created in project scopes require suffixes. You must create suffixes for both the project scope and its containing org scope. Boundary automatically appends the org and project suffixes to any aliases created in the project scope using the following format:
