...
Aliases created in project scopes require suffixes. You must create suffixes for both the project scope and its containing org scope. Once you create them, you append the org and project suffixes to any aliases created in the project scope using the following format:
...
1. Click **New Alias**.
  ...
  If you haven't created alias suffixes for the project and containing org scopes, you will be prompted to create them.
...
1. Use the following command to create an alias. Make sure to provide the ID for the project scope:
  ...
  If the project and containing org scopes don't both have alias suffixes, the command will fail.
