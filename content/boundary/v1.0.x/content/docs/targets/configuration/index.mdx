...
Aliases created in project scopes require suffixes. You must create one suffix for the containing org scope and one suffix for the project scope in which the alias resides. Boundary automatically appends the suffixes to any aliases created in project scopes as follows:
