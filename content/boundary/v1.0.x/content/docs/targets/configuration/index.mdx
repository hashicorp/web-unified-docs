...
Aliases created in project scopes require a suffix. Boundary automatically appends the suffix to any aliases created in the scope. You can also create suffixes for org scopes. Suffixes ensure that aliases are globally unique across scopes, even when you use the same alias value across multiple org or project scopes.
