---
layout: docs
page_title: Configure Boundary transparent sessions
description: >-
  Configure Boundary transparent sessions so authenticated users connect to targets automatically, without running CLI commands or tracking ephemeral ports.
...
# Configure Boundary transparent sessions
