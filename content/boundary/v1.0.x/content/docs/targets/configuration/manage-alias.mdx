...
You can edit an existing alias to update the name, description, value, or Host ID. You can also associate the alias with a target or change the association to a new target.
