...
1. Before you assign permissions, principals need an account to authenticate with. Refer to [Configure authentication](/boundary/docs/authentication) to set up a password, OIDC, or LDAP auth method.
...
1. To update or delete scopes, refer to [Manage scopes](/boundary/docs/rbac/manage-scopes).
