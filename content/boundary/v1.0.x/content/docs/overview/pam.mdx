...
Boundary provides many of the security controls traditionally delivered by privileged access management (PAM) tools — including credential management, session monitoring, and automation-friendly workflows via REST, CLI, and Terraform. This page compares Boundary's approach to traditional PAM solutions.
...
It provides automation-friendly workflows for managing users and credentials, as well as the auto-discovery and configuration of new services:
