...
description: >-
  Find, view, and download Boundary SSH session recordings using the CLI or Admin Console. List all recordings, find by ID, and download channels for compliance review.
