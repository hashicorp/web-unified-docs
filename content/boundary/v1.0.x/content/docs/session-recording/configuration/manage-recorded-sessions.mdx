---
layout: docs
page_title: Find and view SSH session recordings
description: >-
  Find, view, and download Boundary SSH session recordings using the CLI or Admin UI. List all recordings, find by ID, and download channels for compliance review.
...
You can find all recorded sessions in the Admin UI from the global scope.
