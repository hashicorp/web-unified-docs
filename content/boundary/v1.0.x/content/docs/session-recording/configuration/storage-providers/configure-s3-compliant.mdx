...
description: >-
  Configure S3-compliant storage for Boundary session recordings using the MinIO plugin. Tested providers include Hitachi Content Platform and Backblaze B2.
...
## S3-compliant provider and worker requirements
...
- The storage bucket must be configured with read/write (R/W) access. If you use a
...
## S3-compliant provider documentation
