...
description: >-
  Export Boundary RDP session recordings as AV1/WebM video files using the Admin Console or CLI. Create exports, track processing, and download the finished video.
