...
- `Out of storage`: The worker has less than 1 MB of available disk space. It is not available to record new sessions or play back existing recordings. An administrator must free disk space on the worker to remedy the issue.
