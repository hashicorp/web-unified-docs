...
description: >-
  Configure Boundary workers for session recording storage. Review the requirements, and understand the local and remote storage states a worker can report.
