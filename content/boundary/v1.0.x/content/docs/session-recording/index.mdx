...
Playback support for recorded channels varies depending on the channel type. RDP session recordings do not support HTTP connections at this time.
...
Once you enable session recording, you can [Find and view SSH sessions](/boundary/docs/session-recording/configuration/manage-recorded-sessions) or [Export and view RDP sessions](/boundary/docs/session-recording/configuration/export-rdp).
...
- [Export a BSR file](/boundary/docs/session-recording/data/exports)
