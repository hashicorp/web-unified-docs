...
For versions prior to 1.0.1, if you use Amazon S3 as your external storage provider, recorded session files cannot be over 5 GB in size due to Amazon's size limitations for PUT operations.
...
This limitation is removed in Boundary version 1.0.1.
