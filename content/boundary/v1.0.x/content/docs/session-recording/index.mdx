...
last_modified: 2026-09-04T13:01:09.000Z
...
If an SSH session uses the `RemoteCommand` option or executes a non-interactive command, Boundary displays the command alongside its recorded output.
