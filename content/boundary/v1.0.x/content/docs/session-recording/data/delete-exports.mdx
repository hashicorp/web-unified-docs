...
description: >-
  Delete Boundary session recording exports and video artifacts via Admin UI or CLI. Learn when to remove the top-level recording versus only the video artifact.
---
