...
Canceling a **Pending** session transitions it to a **Completed** state, but the recording data is not captured and the **Active** session transitions to a **Failed** state.
