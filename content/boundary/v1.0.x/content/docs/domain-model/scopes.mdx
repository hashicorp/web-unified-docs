...
| -------------------- | -------------------- |
| Account              | Global, org          |
| Alias                | Global, org, project |
| Auth method          | Global, org          |
| Auth token           | Global, org          |
| Billing              | Global               |
| Credential           | Project              |
| Credential library   | Project              |
| Credential store     | Project              |
| Group                | Global, org, project |
| Host                 | Project              |
| Host catalog         | Project              |
| Host set             | Project              |
| Managed group        | Global, org          |
| Policy               | Global, org          |
| Role                 | Global, org, project |
| Scope                | Global, org          |
| Session              | Project              |
| Session recording    | Global, org          |
| Storage bucket       | Global, org          |
| Target               | Project              |
| User                 | Global, org          |
| Worker               | Global               |
...
You can also assign permissions across scopes, if you want a user from one scope to have access to a resource that is not normally granted to that user's scope.
