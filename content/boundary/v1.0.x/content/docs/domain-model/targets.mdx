...
- `description` - (optional)
  An optional description of the target for identification purposes.
...
- `ingress_worker_filter` - (optional)
...
- `session_max_seconds` - (required)
  ...
  If you do not specify a maximum duration, Boundary uses the default value.
