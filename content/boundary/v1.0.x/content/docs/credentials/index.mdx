---
layout: docs
page_title: Credentials in Boundary
description: >-
  Store and manage credentials centrally in Boundary using credential stores, then configure targets for credential brokering or credential injection.
# START AUTO GENERATED METADATA, DO NOT EDIT
created_at: 2025-11-18T17:04:41-05:00
last_modified: 2025-12-02T13:45:52-05:00
# END AUTO GENERATED METADATA
---

# Credentials in Boundary

Connecting to a target normally means a user must know its credentials. Boundary removes that requirement — it centralizes credential storage and can broker or inject credentials automatically, so users never have to manage them directly. This page explains Boundary's credential management model; refer to the linked pages below for the steps to create a credential store or configure brokering and injection.
