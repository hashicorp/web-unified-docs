...
description: >-
  Register a Boundary worker using the worker-led method. Submit the registration request that the worker generates to a controller using the Admin UI or CLI.
