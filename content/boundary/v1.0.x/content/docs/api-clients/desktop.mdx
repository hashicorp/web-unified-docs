...
Boundary Desktop is available for Linux, macOS, or Windows operating systems.
You can download the Boundary Desktop client

- releases.hashicorp.com
- The [Install page](https://developer.hashicorp.com/boundary/install/enterprise#desktop-client)
- As part of the Boundary installer
...
Homebrew is a free and open-source package management system for macOS. Install the official Boundary Desktop cask from the terminal.

</Tab>

<Tab heading="Direct download" group="download">

Download the latest disk image file from the releases page.
...
You can download the latest executable file from the releases page.
