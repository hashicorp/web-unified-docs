...
![Diagram of Boundary controller nodes load-balanced across three availability zones in a single region](/img/single-region.png)
...
![Diagram of ingress and egress Boundary workers tunneling a client session to a target across network boundaries](/img/worker-deployment.png)
