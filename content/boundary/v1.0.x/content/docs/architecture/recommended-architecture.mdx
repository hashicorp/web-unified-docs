...
# Boundary recommended architecture
...
It is ideal to have multiple ingress and egress workers with the same configurations within each network boundary to provide high availability. For more on worker redundancy and failure handling, refer to [high availability installation](/boundary/docs/architecture/high-availability) and [fault tolerance recommendations](/boundary/docs/architecture/fault-tolerance).
