...
For more on worker redundancy and failure handling, refer to [high availability installation](/boundary/docs/architecture/high-availability) and [fault tolerance recommendations](/boundary/docs/architecture/fault-tolerance).
