...
If you want to [export a BSR File](/boundary/docs/session-recording/data/exports), we recommend that you have a worker that supports hardware accelerated AV1 encoding,
