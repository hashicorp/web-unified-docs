...
last_modified: 2026-09-10T14:44:38.000Z
...
| ------------------------ | ------------------- | ------------------------ | ---------------|
| 0 - 20,000 | 34.1 seconds | 7.94 seconds | Recommended operating range |
...
For recommended performance, keep managed group counts at or below 20,000. The login times in the table reflect the upper end of the recommended operating range. At lower managed group counts, login times are shorter.
