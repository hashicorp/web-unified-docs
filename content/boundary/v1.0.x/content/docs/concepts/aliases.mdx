...
You can create aliases in the `global` or project scopes, but if you create them for project scopes, you must create one suffix for the containing org scope and one suffix for the project scope in which an alias resides. Boundary automatically appends the suffixes to any aliases created in project scopes as follows:
