...
description: >-
  Control access in Boundary with scopes, auth methods, accounts, users, groups, and roles — the six resources that make up Boundary's identity and access management (IAM) system, with example grant strings.
...
# Boundary identity and access management (IAM)
...
solves this with six resources — scopes, auth methods, accounts, users,
groups, and roles — that together define authentication and the permissions
granted after it.
