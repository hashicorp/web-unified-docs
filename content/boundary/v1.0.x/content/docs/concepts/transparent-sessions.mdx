---
layout: docs
page_title: Transparent sessions in Boundary
description: >-
  Connect to Boundary targets without entering resource IDs or port numbers — transparent sessions route traffic automatically once you're authenticated and have aliases configured.
...
# Transparent sessions in Boundary
...
## Related transparent sessions documentation
