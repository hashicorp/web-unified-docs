...
description: >-
  Learn how to build Boundary from the source. Discover resources to compile a cross-platform build and troubleshoot Admin UI assets.
...
The first time you run `make install` it will build Admin UI assets, which will take a
...
Admin UI assets are built inside a Docker container. If this build step fails, try
