---
layout: docs
page_title: Develop the Admin UI
description: >-
    Learn how to develop the Boundary Admin UI locally for testing. Use dev mode to run a local fork of the Admin UI without building it into the binary.
...
## Run a local fork of the Admin UI locally in dev mode

If you're developing the Boundary Admin UI locally you can point a dev mode server at a
