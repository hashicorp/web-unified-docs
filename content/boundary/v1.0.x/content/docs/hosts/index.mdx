...
Boundary host management onboards hosts to Boundary either by manually defining static host catalogs, or by using host catalog plugins that automatically discover and sync hosts from cloud providers such as AWS, Azure, and GCP, removing the need to track connection details by hand.
...
## Why does host discovery matter?
