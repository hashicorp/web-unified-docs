...
description: >-
  Use dynamic host catalogs to discover Azure resources via Azure Resource Manager and sync them as Boundary hosts. Create a host catalog and host set for Azure.
