...
description: >-
  Use static host catalogs to manually define a set of hosts within Boundary. Create a static host catalog, add hosts, and group them into host sets.
...
Boundary static host catalogs let you manually define a collection that includes hosts or host sets, for infrastructure a cloud provider can't automatically discover.
...
## Example: create host catalogs for MySQL and Postgres databases
...
If you're using the Admin UI, you can create a host and add it to a host set in one operation.
