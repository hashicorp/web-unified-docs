...
Boundary uses dynamic host catalogs to automatically discover GCP Compute Engine VM instances and add them as hosts, using filters you define to control which instances sync into a given host set.
...
1. Complete the following fields:
    ...
    The key must be PEM (Privacy-Enhanced Mail) encoded.
    It is required when you authenticate using the service account.
