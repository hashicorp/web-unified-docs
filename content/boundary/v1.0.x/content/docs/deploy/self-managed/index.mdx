...
To deploy HCP (HashiCorp Cloud Platform) Boundary instead, refer to [Deploy and log in](/boundary/docs/hcp/get-started/deploy-and-login) in the HCP Boundary Get started documentation.
