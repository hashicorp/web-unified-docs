---
layout: docs
page_title: Deploy a Boundary worker using a Helm chart
description: >-
...
To review or update the worker configuration, refer to [Configure workers using a Helm chart](/boundary/docs/deploy/helm-chart/configure-worker).
