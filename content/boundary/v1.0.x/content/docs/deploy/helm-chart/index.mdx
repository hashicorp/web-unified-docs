...
You can deploy Boundary on Kubernetes with separate Helm charts for the two Boundary runtime roles:
...
Boundary uses separate charts for controllers and workers because controllers they have different lifecycle, scaling, persistence, and exposure requirements.
...
The charts separate configuration into two layers:
...
1. [Deploy a controller using a Helm chart](/boundary/docs/deploy/helm-chart/deploy-controller)
1. [Configure a controller using a Helm chart](/boundary/docs/deploy/helm-chart/configure-controller)
1. [Deploy a worker using a Helm chart](/boundary/docs/deploy/helm-chart/deploy-worker)
1. [Configure a worker using a Helm chart](/boundary/docs/deploy/helm-chart/configure-worker)

## More information

To view example configurations, refer to the following topics:

- [Example controller configurations](/boundary/docs/deploy/helm-chart/controller-examples)
- [Example worker configurations](/boundary/docs/deploy/helm-chart/worker-examples)
