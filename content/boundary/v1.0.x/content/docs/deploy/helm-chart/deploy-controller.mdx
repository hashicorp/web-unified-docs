...
1. To review or update the controller configuration, refer to [Configure a controller using a Helm chart](/boundary/docs/deploy/helm-chart/configure-controller).
