...
hashicorp/boundary-controller 0.1.0           0.21-ent      Official HashiCorp Boundary controller Helm chart
```
...
The chart reads raw Boundary HCL from `controller.config`. You embed the HCL in a values file.
