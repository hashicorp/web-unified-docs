...
These inline AEAD KMS examples are suitable for development or testing. The keys are visible to anyone who can read the configuration. For production deployments, use an external KMS provider as described in [Configure KMS](https://developer.hashicorp.com/boundary/docs/configuration/kms).
