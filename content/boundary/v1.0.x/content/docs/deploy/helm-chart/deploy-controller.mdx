...
hashicorp/boundary-controller 0.1.0       1.0.0         Official HashiCorp Boundary Controller Chart
```
...
- For frequently asked questions, refer to the [Controller chart FAQ](https://github.com/hashicorp/boundary-controller-helm/blob/main/docs/FAQ.md).
