...
KMS-backed worker authentication is supported only in self-managed Boundary deployments. For additional details, refer to [KMS-led authorization and authentication](/boundary/docs/workers/registration#kms-led-authorization-and-authentication). It is not available for HCP Boundary workers.
