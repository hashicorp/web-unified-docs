...
description: >-
  Configure the Terraform Boundary provider to install and manage Boundary resources, including scopes, users, groups, hosts, credentials, and targets.
...
Use Terraform to deploy and manage Boundary resources — scopes, users, groups, hosts, credentials, session recording, and targets — through the official Boundary Terraform provider. This page shows how to configure the provider; each linked pattern page covers one resource type.
