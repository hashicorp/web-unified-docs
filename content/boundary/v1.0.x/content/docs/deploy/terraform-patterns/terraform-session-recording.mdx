...
This example does not demonstrate creating the S3 bucket or the associated IAM (Identity and Access Management) policies. Refer to the [create storage buckets](/boundary/docs/session-recording/configuration/create-storage-bucket) documentation to learn how to configure AWS.
