...
Subcommands:
    ...
    read                                 Read a scope
    remove-alias-suffix                  Remove an alias suffix from a scope
    rotate-keys                          Rotate the keys within a scope
    set-alias-suffix                     Set an alias suffix for a scope
...
- [remove-alias-suffix](/boundary/docs/commands/scopes/remove-alias-suffix)
- [rotate-keys](/boundary/docs/commands/scopes/rotate-keys)
- [set-alias-suffix](/boundary/docs/commands/scopes/set-alias-suffix)
