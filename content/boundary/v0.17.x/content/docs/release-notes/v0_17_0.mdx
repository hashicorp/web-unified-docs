...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
    Prior to this version, if you wanted to edit or update worker tags, you had to do it using the worker configuration file, the CLI, or the API. Now, you can edit worker tags directly in Boundary Admin UI.
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.17.x/concepts/filtering/worker-tags">Worker tags</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.17.x/configuration/identity-access-management">Permissions in Boundary</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.17.x/configuration/session-recording/configure-worker-storage">Configure workers for session recording</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.17.x/configuration/session-recording/storage-providers/configure-s3-compliant">Configure S3-compliant storage for session recording</a>.
    </td>
  </tr>
...
<table>
  ...
  <tr id="unsupported-recovery">
    ...
    <br /><br />
    Learn more:&nbsp;
    <a href="/boundary/docs/v0.17.x/troubleshoot/troubleshoot-recorded-sessions#unsupported-recovery-workflow">Unsupported recovery workflow</a>
    </td>
  </tr>
  ...
  <tr id="curl">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.17.x/operations/health#check-the-health-endpoint-using-wget">Check the health endpoint using <code>wget</code></a>
    <br /><br />
  ...
  <tr id="invalid-alias">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.17.x/concepts/aliases">Aliases</a>
    <br /><br />
  ...
  <tr id="scp">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.17.x/configuration/session-recording#storage-considerations">Session recording storage considerations</a>
    <br /><br />
    <a href="/boundary/tutorials/self-managed-deployment/upgrade-version">Upgrade to the latest version of Boundary</a>
    </td>
  </tr>
