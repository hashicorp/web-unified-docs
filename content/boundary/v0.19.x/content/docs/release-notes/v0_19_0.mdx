...
<tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more about control plane and client compatibility:&nbsp; <a href="/boundary/docs/v0.19.x/enterprise/supported-versions">Boundary Enterprise supported versions policy </a>
    </td>
  </tr>
...
<table>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.19.x/hosts">Host discovery</a> and <a href="/boundary/docs/v0.19.x/hosts/gcp">GCP dynamic hosts</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
    A new filter generator was added to the Admin UI, allowing you to more easily create worker filters for targets, credential stores, and storage buckets.
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.19.x/workers/worker-tags">Worker tags</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.19.x/configuration/credential-management/static-cred-vault">Create a Vault credential store</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.19.x/hosts/azure">Azure dynamic host catalogs</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.19.x/concepts/transparent-sessions">Transparent sessions</a> and <a href="/boundary/docs/v0.19.x/api-clients/client-agent">Client Agent</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.19.x/monitor/debug">Enable debug mode</a>, <a href="/boundary/docs/v0.19.x/commands/server"><code>server</code> command</a>, <a href="/boundary/docs/v0.19.x/commands/dev"><code>dev</code> command</a>.
    </td>
  </tr>
...
<table>
  ...
  <tr id="unsupported-recovery">
    ...
    <br /><br />
    Learn more:&nbsp;
    <a href="/boundary/docs/v0.19.x/troubleshoot/troubleshoot-recorded-sessions#unsupported-recovery-workflow">Unsupported recovery workflow</a>
    </td>
  </tr>
  ...
  <tr id="curl">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.19.x/operations/health#check-the-health-endpoint-using-wget">Check the health endpoint using <code>wget</code></a>
    <br /><br />
  ...
  <tr id="canceled-ssh-connections">
    <td style={{verticalAlign: 'middle'}}>
    0.17.0 - 0.19.0
    <br /><br />
    (Fixed in 0.19.2)
  ...
  <tr id="vault-ssh">
    ...
    <td style={{verticalAlign: 'middle'}}>
    Unable to change key type for Vault SSH certificate credential library using the Admin UI
    </td>
    <td style={{verticalAlign: 'middle'}}>
    When you attempted to change the key type for a Vault SSH certificate credential library using the Admin UI, the update failed.
    <br/><br />
    This issue is resolved in version 0.19.2. You can now change the key type using the Admin UI.
    <br /><br />
    <a href="/boundary/tutorials/self-managed-deployment/upgrade-version">Upgrade to the latest version of Boundary</a>
    </td>
  </tr>

  <tr id="go-cve-2025-22873">
    <td style={{verticalAlign: 'middle'}}>
    0.19.0
    <br /><br />
    (Fixed in 0.19.2)
  ...
  <tr id="hcp-grants">
    ...
    Learn more:
    <ul>
    <li><a href="/boundary/docs/v0.19.x/api-clients/client-agent#grants">Boundary Client Agent grants</a> requirements</li>
    <li><a href="/boundary/docs/v0.19.x/commands/roles/create"><code>roles create</code></a> command documentation</li>
    <li><a href="/boundary/docs/v0.19.x/commands/roles/add-grant-scopes"><code>roles add-grant-scopes</code></a> command documentation</li>
    <li><a href="/boundary/docs/v0.19.x/commands/roles/add-grants"><code>roles add-grants</code></a> command documentation</li>
    </ul>
    </td>
  </tr>

  <tr id="windows-shortcuts">
    <td style={{verticalAlign: 'middle'}}>
    0.18.0 - 0.19.0
    <br /><br />
    ...
    <br /><br />
    Learn more: <a href="/boundary/docs/v0.19.x/concepts/transparent-sessions">Transparent sessions</a>
    <br /><br />
    <a href="/boundary/tutorials/self-managed-deployment/upgrade-version">Upgrade to the latest version of Boundary</a>
    </td>
  </tr>
  ...
  <tr id="redundant-grants">
    ...
    Learn more:
      <ul>
      <li><a href="/boundary/docs/v0.19.x/concepts/domain-model/scopes">Scopes</a></li>
      <li><a href="/boundary/docs/v0.19.x/commands/roles/add-grant-scopes"><code>roles add-grant-scopes</code></a> command documentation</li>
      <li><a href="/boundary/docs/v0.19.x/commands/roles/remove-grant-scopes"><code>roles remove-grant-scopes</code></a> command documentation</li>
      <li><a href="/boundary/docs/v0.19.x/commands/roles/set-grant-scopes"><code>roles set-grant-scopes</code></a> command documentation</li>
      </ul>
    <a href="/boundary/tutorials/self-managed-deployment/upgrade-version">Upgrade to the latest version of Boundary</a>
    </td>
  </tr>

  <tr id="dns-resolution">
    <td style={{verticalAlign: 'middle'}}>
    ...
    Learn more: <a href="/boundary/docs/v0.19.x/concepts/transparent-sessions">Transparent sessions</a>
    <br /><br />
    <a href="/boundary/docs/v0.19.x/install-boundary/install-clients">Upgrade to the latest version of the Boundary clients</a>
    </td>
  </tr>
  ...
  <tr id="go-cve">
    ...
    0.19.x
    <br /><br />
    (Fixed in HCP Boundary and Boundary Enterprise version 0.19.4)
    </td>
    <td style={{verticalAlign: 'middle'}}>
    CVE-2025-61730
    <br /><br />
    ...
    <td style={{verticalAlign: 'middle'}}>
    The version of Go that was used in Boundary release 0.19.x contained security vulnerabilities. HCP Boundary and Boundary Enterprise release 0.19.4 were updated to use Go version 1.25.7 to address CVE-2025-61730.
    <br /><br />
  ...
  <tr id="cve-2026-7776">
    <td style={{verticalAlign: 'middle'}}>
    Boundary Community Edition and Boundary Enterprise up to version 0.19.4
    <br /><br />
    ...
    <td style={{verticalAlign: 'middle'}}>
    In previous editions, Boundary Community Edition and Boundary Enterprise workers were vulnerable to a denial-of-service condition during TLS handshakes. This vulnerability, CVE-2026-7776, is fixed in Boundary version 0.19.5.
    <br /><br />
