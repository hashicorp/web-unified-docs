...
Boundary supports audit logs for [Boundary Community Edition](/boundary/tutorials/self-managed-deployment/event-logging) and [audit log streaming](/hcp/docs/boundary/audit-logging)
