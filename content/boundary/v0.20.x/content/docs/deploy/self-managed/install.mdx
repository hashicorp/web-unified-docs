...
You can also manually install a Boundary package you get from the [HashiCorp Linux Repository](https://www.hashicorp.com/blog/announcing-the-hashicorp-linux-repository), [build Boundary from source](https://github.com/hashicorp/boundary), or get the package from another trusted location.

If you choose to install Boundary manually, ensure the Boundary packages you deploy on your controllers and workers in the next step are the same version.
