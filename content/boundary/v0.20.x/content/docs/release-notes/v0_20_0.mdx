...
<table>
  ...
  <tr>
    <td style={{verticalAlign: 'middle'}}>
    Client Agent 0.1.0 - 0.20.0
    <br /><br />
    (Fixed in Client Agent version 0.20.1)
    </td>
    <td style={{verticalAlign: 'middle'}}>
    Boundary Client Agent does not maintain its operational state after a system restart
    </td>
    <td style={{verticalAlign: 'middle'}}>
    If you paused the Boundary Client Agent and then restarted the system, the Client Agent ignored the pause command and resumed running when the system restarted.
    <br /><br />
    This known issue was resolved in Client Agent version 0.20.1. Now, if you pause the Client Agent and then restart the system, the Client Agent remains paused after the restart.
    <br /><br />
    Install the latest version of the Client Agent to ensure the operational state persists through system restarts.
    <br /><br />
    Learn more: <a href="/boundary/docs/client-agent/manage">Manage the Client Agent</a>
    <br /><br />
