...
last_modified: 2025-12-03T13:54:54-05:00
...
<table>
  ...
  <tr>
    ...
    <br /><br />
    Learn more about control plane and client compatibility:&nbsp; <a href="/boundary/docs/v0.20.x/enterprise/supported-versions">Boundary Enterprise supported versions policy </a>
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.20.x/client-agent">Boundary Client Agent</a>
    </td>
  </tr>
...
<table>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.20.x/domain-model/targets#target-types">Target types</a> and <a href="/boundary/docs/v0.20.x/commands/targets/create">targets create command</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.20.x/concepts/credential-management">Credential management</a>, <a href="/boundary/docs/v0.20.x/credentials">Credentials in Boundary</a>, and <a href="/boundary/docs/v0.20.x/commands/credentials/create">credentials create command</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.20.x/credentials/rdp-testing-and-compatibility-matrix">RDP credential injection compatibility</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.20.x/secure/encryption/data-encryption">Data encryption in Boundary</a> and <a href="/boundary/docs/v0.20.x/configuration/kms/ibmkp">ibmkp KMS</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.20.x/monitor/debug">Enable debug mode</a>, <a href="/boundary/docs/v0.20.x/commands/server"><code>server</code> command</a>, <a href="/boundary/docs/v0.20.x/commands/dev"><code>dev</code> command</a>.
    </td>
  </tr>
...
<table>
  ...
  <tr id="unsupported-recovery">
    ...
    <br /><br />
    Learn more:&nbsp;
    <a href="/boundary/docs/v0.20.x/troubleshoot/troubleshoot-recorded-sessions#unsupported-recovery-workflow">Unsupported recovery workflow</a>
    </td>
  </tr>
  ...
  <tr id="curl">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.20.x/operations/health#check-the-health-endpoint-using-wget">Check the health endpoint using <code>wget</code></a>
    <br /><br />
  ...
  <tr id="operational-state">
    ...
    <br /><br />
    Learn more: <a href="/boundary/docs/v0.20.x/client-agent/configuration">Configure the Client Agent</a> or <a href="/boundary/docs/v0.20.x/client-agent/manage">Manage the Client Agent</a>
    <br /><br />
    <a href="/boundary/docs/v0.20.x/deploy/self-managed/install-clients">Install the latest version of the Boundary Client Agent</a>
    </td>
  </tr>
  ...
  <tr id="cve-2026-7776">
    <td style={{verticalAlign: 'middle'}}>
    Boundary Community Edition and Boundary Enterprise up to version 0.20.2
    <br /><br />
    (Fixed in version 0.20.3)
    </td>
    <td style={{verticalAlign: 'middle'}}>
    Vulnerability to denial-of-service during TLS handshakes<br /><br />(CVE-2026-7776)
    </td>
    <td style={{verticalAlign: 'middle'}}>
    In previous editions, Boundary Community Edition and Boundary Enterprise workers were vulnerable to a denial-of-service condition during TLS handshakes. This vulnerability, CVE-2026-7776, is fixed in Boundary version 0.20.3.
    <br /><br />
  ...
  <tr id="SECVULN-42113">
    <td style={{verticalAlign: 'middle'}}>
    Up to version 0.20.5
    <br /><br />
    (Fixed in version 0.20.5)
    </td>
    <td style={{verticalAlign: 'middle'}}>
