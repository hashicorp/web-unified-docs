...
last_modified: 2026-09-11T14:49:51.000Z
...
types are supported for credential injection, but only username_password can be set up using the Admin UI. If you experience this error,
attempt to create the Vault ssh_private_key credential library using the CLI instead of the Admin UI.
...
For more information, refer to [Boundary Client in Docker Additional Configuration When Using IMDSv2](https://www.ibm.com/support/pages/node/7264032).
