...
We also recommend referring to [What is Boundary](/docs/overview/what-is-boundary) and [Why Boundary](/docs/overview/what-is-boundary#why-boundary) for a better understanding of Boundary and the problems that it solves.
