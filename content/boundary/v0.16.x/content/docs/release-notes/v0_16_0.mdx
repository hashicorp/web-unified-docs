...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
     A new resource was introduced in this release. Aliases let you associate a string with a Boundary target. You can then establish a session to the target by referencing its alias, instead of having to provide a target ID or target name and scope ID.
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.16.x/concepts/aliases">Aliases</a>.
    </td>
  </tr>
   ...
   <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.16.x/configuration/session-recording">Session recording overview</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.16.x/api-clients/api/pagination">List pagination</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.16.x/configuration/session-recording/configure-worker-storage#local-storage">Local storage for session recording</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.16.x/api-clients/api#http-headers">HTTP headers</a>.
    </td>
  </tr>
...
<table>
  ...
  <tr id="unsupported-recovery">
    ...
    <br /><br />
    Learn more:&nbsp;
    <a href="/boundary/docs/v0.16.x/troubleshoot/troubleshoot-recorded-sessions#unsupported-recovery-workflow">Unsupported recovery workflow</a>
    </td>
  </tr>
