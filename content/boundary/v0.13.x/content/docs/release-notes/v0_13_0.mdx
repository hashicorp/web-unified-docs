...
To learn about what Boundary consists of, we highly recommend you review the [Getting Started Page](/boundary/docs/v0.13.x/getting-started).
...
For more information, refer to [Boundary Enterprise](/boundary/docs/v0.13.x/enterprise).
...
For more information, refer to [Auditing](/boundary/docs/v0.13.x/concepts/auditing).
To configure session recording for targets, refer to the session recording [overview](/boundary/docs/v0.13.x/configuration/session-recording).
...
You can use LDAP to log in through any of the Boundary clients, including the CLI, Boundary Desktop Client, and the Boundary Admin UI.
...
- [Accounts](/boundary/docs/v0.13.x/concepts/domain-model/accounts#ldap-account-attributes-beta)
- [Auth methods](/boundary/docs/v0.13.x/concepts/domain-model/auth-methods#ldap-auth-method-attributes-beta)
- [Managed groups](/boundary/docs/v0.13.x/concepts/domain-model/managed-groups#ldap-managed-group-information-and-attributes-beta)
...
For more information, refer to the [worker configuration](/boundary/docs/v0.13.x/configuration/worker) documentation.
...
**Dynamic host catalog external name**: You can now view the AWS or Azure host name when listing hosts in CLI, Admin UI, and desktop client.
