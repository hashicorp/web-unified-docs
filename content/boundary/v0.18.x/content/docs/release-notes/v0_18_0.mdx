...
<table>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/v0.18.x/concepts/transparent-sessions">Transparent sessions</a> and <a href="/boundary/docs/v0.18.x/api-clients/client-agent">Client Agent</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.18.x/configuration/session-recording/storage-providers/configure-s3-compliant">Configure an S3-compliant storage provider</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more:&nbsp;<a href="/boundary/docs/v0.18.x/concepts/host-discovery/aws">AWS dynamic host catalogs</a>.
    </td>
  </tr>
...
<table>
  ...
  <tr id="unsupported-recovery">
    ...
    <br /><br />
    Learn more:&nbsp;
    <a href="/boundary/docs/v0.18.x/troubleshoot/troubleshoot-recorded-sessions#unsupported-recovery-workflow">Unsupported recovery workflow</a>
    </td>
  </tr>
  ...
  <tr id="curl">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.18.x/operations/health#check-the-health-endpoint-using-wget">Check the health endpoint using <code>wget</code></a>
    <br /><br />
  ...
  <tr id="managed-groups">
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.18.x/concepts/domain-model/managed-groups">Managed groups</a>
    <br /><br />
    <a href="/boundary/tutorials/self-managed-deployment/upgrade-version">Upgrade to the latest version of Boundary</a>
    </td>
  </tr>

  <tr id="session-recording-failure">
    <td style={{verticalAlign: 'middle'}}>
    0.18.0
    <br /><br />
    (Fixed in 0.18.2)
    ...
    <br /><br />
    Learn more:&nbsp; <a href="/boundary/docs/v0.18.x/configuration/session-recording/storage-providers/configure-s3">Configure Amazon S3 as a storage provider</a>
    <br /><br />
    <a href="/boundary/tutorials/self-managed-deployment/upgrade-version">Upgrade to the latest version of Boundary</a>
    </td>
  </tr>
