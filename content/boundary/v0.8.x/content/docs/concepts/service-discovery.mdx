...
**[Service discovery via configuration as code with Terraform](/boundary/tutorials/get-started-community/community-get-started-config)**:
...
**[Runtime service discovery via dynamic host catalogs](boundary/tutorials/host-management/azure-host-catalogs)**:
...
You can get started with dynamic host catalogs [here](/boundary/tutorials/host-management/azure-host-catalogs).