...
See our [basic administration workflows](https://developer.hashicorp.com/boundary/tutorials/community-administration) for in depth discussion on managing scopes, targets,
