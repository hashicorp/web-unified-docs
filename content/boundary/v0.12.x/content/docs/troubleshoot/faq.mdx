...
Boundary supports audit logs for [Boundary OSS](/boundary/tutorials/self-managed-deployment/event-logging) and [audit log streaming](/hcp/docs/boundary/audit-logging)
