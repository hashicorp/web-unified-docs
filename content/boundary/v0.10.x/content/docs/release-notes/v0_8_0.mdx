...
**UI Support for Worker Tags:** Users can now set and edit [worker tag](/docs/concepts/filtering/worker-tags) filters in the Boundary Admin UI.

**Performance Improvements:** We have implemented changes to improve performance on larger deployments; such as adding a refresh button in the Admin UI and Boundary Desktop Client,
