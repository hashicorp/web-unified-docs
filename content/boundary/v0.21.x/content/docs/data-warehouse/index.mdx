---
layout: docs
page_title: Boundary data warehouse
description: >-
  Learn about how to use Boundary's built-in PostgreSQL data warehouse schema for access analytics, session auditing, and BI integration.
---
...
This table features pre-populated conformed dimensions for time-series analysis from 2019-10-09 through a fixed future date. `wh_time_of_day_dimension` contains pre-populated rows at one per second in a day. These tables enable efficient date/time grouping without runtime calculations.
