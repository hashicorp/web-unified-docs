...
To use an IBM Passport Advantage Online license key, you must configure the [`license`](/boundary/docs/configuration/controller#license) attribute in the `controller` block to select the desired entitlement from the license.
