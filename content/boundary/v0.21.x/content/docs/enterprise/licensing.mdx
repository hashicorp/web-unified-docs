...
To use an IBM Passport Advantage Online license key, add it to the `controller` block using the [`license`](/boundary/docs/configuration/controller#license) attribute.
