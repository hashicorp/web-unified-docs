...
<table>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/commands/search"><code>search</code></a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/enterprise/licensing#ibm-passport-advantage-online-license-keys">IBM Passport Advantage Online license keys</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/monitor/debug">Enable debug mode</a>, <a href="/boundary/docs/commands/server"><code>server</code> command</a>, <a href="/boundary/docs/commands/dev"><code>dev</code> command</a>.
    </td>
  </tr>
...
<table>
  ...
  <tr id="default-port">
    ...
    <br /><br />
    Learn more: <a href="/boundary/docs/targets/configuration/configure-transparent-sessions#rdp-targets">RDP targets</a>
    <br /><br />
  ...
  <tr id="terminal-functionality">
    ...
    <br /><br />
    <a href="/boundary/docs/deploy/self-managed/install-clients">Upgrade to the latest version of the Boundary Desktop Client</a>
    <br /><br />
    </td>
  </tr>
