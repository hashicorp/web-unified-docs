...
<table>
  ...
  <tr>
    <td style={{verticalAlign: 'middle'}}>
    SSH key validation for workers
    </td>
    <td style={{verticalAlign: 'middle'}}>
    GA
    </td>
    <td style={{verticalAlign: 'middle'}}>
    You can now validate workers' SSH keys.
    <br /><br />
    Learn more:&nbsp;<a href="/boundary/docs/workers">Workers</a>.
    </td>
  </tr>

   <tr>
    <td style={{verticalAlign: 'middle'}}>
    Inactive timeout for connections
    </td>
    <td style={{verticalAlign: 'middle'}}>
    GA
    </td>
    <td style={{verticalAlign: 'middle'}}>
    A new argument was added to the <code>boundary connect</code> command. The new argument, <code>inactive-timeout=&lt;duration&gt;</code> lets you configure an amount of time between connections before Boundary closes unused sessions.
    <br /><br />
