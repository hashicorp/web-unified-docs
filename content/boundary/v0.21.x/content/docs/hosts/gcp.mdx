...
1. Use the following command to create a host set:
  ...
  Refer to the [host sets](/boundary/docs/domain-model/host-sets) domain model documentation for additional fields that you can use when you create host sets.
