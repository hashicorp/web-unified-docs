...
**Static host catalogs** enable operators to manually define sets of hosts for targets.
**Host catalog plugins** enable host discovery, allowing operators to sync sets of hosts from cloud providers like Amazon Web Services, Microsoft Azure, and Google Cloud Platform.
...
Static host catalogs contain manual definitions of host sets. This allows operators to onboard and maintain sets of hosts manually. 
