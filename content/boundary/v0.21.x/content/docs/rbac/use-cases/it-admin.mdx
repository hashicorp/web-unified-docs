...
IT Admin require mid-level access to Boundary.
They update Boundary when new team members are added.

## Responsibilities

IT Admin may be responsible for some or all of the following tasks.
...
You may want to configure the following roles and permissions for IT Admin, based on their responsibilities.
