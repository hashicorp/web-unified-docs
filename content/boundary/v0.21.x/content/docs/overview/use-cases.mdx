...
These are just some of the possible use cases.

</Note>

Before understanding use cases, it's useful to know [what Boundary is](/boundary/docs/what-is-boundary). This page lists some concrete use cases for Boundary, but the possible use cases are much broader than what we cover.
...
- [Zero trust](/boundary/docs/overview/zero-trust)
- [Bastion hosts](/boundary/docs/overview/bastion-hosts)
- [VPNs](/boundary/docs/overview/vpn)
- [Privileged access management](/boundary/docs/overview/pam)
- [Software-defined-perimeter](/boundary/docs/overview/sdp)
- [Secrets management tools](/boundary/docs/overview/secrets-management)
