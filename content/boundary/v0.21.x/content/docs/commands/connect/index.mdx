...
If you do not specify a timeout value, Boundary uses a default value based on the subcommand:
  - `connect` without a subcommand = 30 seconds
  - `rdp` = 5 seconds
  - `ssh` = 1 second
  - All other protocols = 3 seconds
