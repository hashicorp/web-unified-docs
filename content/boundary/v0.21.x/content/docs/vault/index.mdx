...
The LDAP secrets engine lets you configure static or dynamic credentials in Vault and interate them with your LDAP server. You can create roles that map to specific LDAP groups or users to control access and permissions.
