...
For more about event logging usage, see our [documentation](/docs/configuration/events/overview).

**Credential CRUD operations for Admin UI:** The 0.5.0 release enables administration to configure Vault credential libraries and Vault credential set resources through the Admin UI.
