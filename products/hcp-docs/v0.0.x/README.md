# HashiCorp Cloud Website

This repository contains content files for [HashiCorp Cloud Platform Documentation](https://developer.hashicorp.com/hcp/docs)

This includes "data" (`json`) files, which power the left hand navigation tree, and "content" (`mdx`) files which are rendered in the body of the associated page.
