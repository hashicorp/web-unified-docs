...
Only organization owners can edit an SSO configuration. 
...
After deletion, the organization owner can [re-invite users](/hcp/docs/hcp/admin/iam/users#invite-users) with the default Access Controls (IAM) system.
