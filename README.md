...
The project in this repository, `hashicorp/web-unified-docs`, aims to implement [DEVDOT-023: Unified Product Documentation Repository][DEVDOT-023]. The RFC for this project was intentionally light on implementation details, in order to foster consensus on the broad direction.
...
Monitoring Documentation](./.github/BROKEN_LINK_MONITORING.md). The [EDU-053: Unified Education Style Guide][EDU-053]
...
[EDU-053]: https://hermes-sharepoint.hashicorp.services/document/01XOO7K4KLLV22I7VTKBALQC55YEB6TXZN
[DEVDOT-023]: https://hermes-sharepoint.hashicorp.services/document/01XOO7K4NGQTFCAWZCHJBY5ZPCZLO6Y2ZB
