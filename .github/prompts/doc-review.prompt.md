...
The passing threshold is provided in the prompt at runtime. If no threshold is stated, use 65% as the default.
...
**Status**: [✅ Passes scoring threshold / ❌ Below scoring threshold — not ready for review]
